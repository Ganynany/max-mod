...
.field public H0:Loaj;

.field public I0:Lpaj;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lqaj;->d:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, Lqaj;->getBorderColor()I
    ...
    iput-object p1, p0, Lqaj;->o:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, Lqaj;->getCursorColor()I

    move-result v2

    invoke-virtual {p1, v2}, Landroid/graphics/Paint;->setColor(I)V

    iput-object p1, p0, Lqaj;->B0:Landroid/graphics/Paint;
    ...
    invoke-direct {p0}, Lqaj;->getCursorBorderColor()I
    ...
    iput-object p1, p0, Lqaj;->C0:Landroid/graphics/Paint;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lqaj;->D0:Landroid/graphics/RectF;

    new-instance p1, Landroid/graphics/RectF;

    invoke-direct {p1}, Landroid/graphics/RectF;-><init>()V

    iput-object p1, p0, Lqaj;->E0:Landroid/graphics/RectF;
    ...
    iput p1, p0, Lqaj;->F0:F

    new-instance p1, Landroid/graphics/Path;

    invoke-direct {p1}, Landroid/graphics/Path;-><init>()V

    iput-object p1, p0, Lqaj;->G0:Landroid/graphics/Path;
...
.method public final getFramesListBitmap()Landroid/graphics/Bitmap;
    ...
    iget-object v0, p0, Lqaj;->b:Landroid/graphics/Bitmap;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0, v0, v1}, Lqaj;->a(II)I
    ...
    iget-object v4, p0, Lqaj;->G0:Landroid/graphics/Path;

    invoke-virtual {p1, v4}, Landroid/graphics/Canvas;->clipPath(Landroid/graphics/Path;)Z

    :try_start_0
    iget-object v4, p0, Lqaj;->b:Landroid/graphics/Bitmap;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object v5, p0, Lqaj;->d:Landroid/graphics/Paint;
    ...
    :cond_1
    :goto_0
    iget-object v4, p0, Lqaj;->J0:Landroid/graphics/Bitmap;
    ...
    iget v0, p0, Lqaj;->F0:F

    iget-object v1, p0, Lqaj;->o:Landroid/graphics/Paint;

    iget-object v3, p0, Lqaj;->E0:Landroid/graphics/RectF;
    ...
    iget v4, p0, Lqaj;->z0:F

    sub-float/2addr v0, v4

    invoke-static {v1, v4, v0}, Ld2c;->w(FFF)F
    ...
    iget-object v1, p0, Lqaj;->C0:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lqaj;->D0:Landroid/graphics/RectF;

    invoke-virtual {v3, v2, v5, v0, v4}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object v0, p0, Lqaj;->B0:Landroid/graphics/Paint;

    iget v2, p0, Lqaj;->A0:F
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-virtual {p0, p1, p2}, Lqaj;->a(II)I
    ...
    iget-object v0, p0, Lqaj;->H0:Loaj;
    ...
    iput p4, v0, Llbj;->B0:I

    iput p3, v0, Llbj;->C0:I

    :cond_1
    iget-object p3, p0, Lqaj;->o:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lqaj;->E0:Landroid/graphics/RectF;
    ...
    iget-object p1, p0, Lqaj;->G0:Landroid/graphics/Path;

    invoke-virtual {p1}, Landroid/graphics/Path;->reset()V

    iget-object p1, p0, Lqaj;->G0:Landroid/graphics/Path;

    iget-object p2, p0, Lqaj;->E0:Landroid/graphics/RectF;

    iget p3, p0, Lqaj;->F0:F
...
.method public final onThemeChanged(Lrmc;)V
    ...
    iget-object p1, p0, Lqaj;->o:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, Lqaj;->B0:Landroid/graphics/Paint;
    ...
    iget-object p1, p0, Lqaj;->C0:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v2, p0, Lqaj;->z0:F

    sub-float/2addr v1, v2

    invoke-static {v0, v2, v1}, Ld2c;->w(FFF)F
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lqaj;->setProgress(F)V

    iget-object p1, p0, Lqaj;->I0:Lpaj;
    ...
    sget-object v2, Lone/me/chatscreen/videomsg/VideoMessageWidget;->T0:[Lbv8;
    ...
    invoke-direct {v2, v0}, Ld7j;-><init>(F)V
    ...
    invoke-direct {v2, v0}, Le7j;-><init>(F)V
...
.method public final setFramesListBitmap(Landroid/graphics/Bitmap;)V
    ...
    iput-object p1, p0, Lqaj;->b:Landroid/graphics/Bitmap;

    return-void
.end method

.method public final setFramesProvider(Loaj;)V
    .locals 0

    iput-object p1, p0, Lqaj;->H0:Loaj;
...
.method public final setPreviewBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object v0, p0, Lqaj;->J0:Landroid/graphics/Bitmap;
    ...
    :cond_0
    iput-object p1, p0, Lqaj;->J0:Landroid/graphics/Bitmap;
...
.method public final setSeekListener(Lpaj;)V
    .locals 0

    iput-object p1, p0, Lqaj;->I0:Lpaj;
