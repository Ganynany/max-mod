...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v6, v3, Lh42;->j1:Lj62;

    const/4 v2, 0x1

    if-eqz v6, :cond_12

    iget-object v5, v6, Lj62;->a:Landroid/view/View;

    iget-object v7, v6, Lj62;->q:[F

    iget-object v8, v6, Lj62;->r:[F

    iget-object v9, v6, Lj62;->j:Landroid/view/ScaleGestureDetector;

    iget-object v11, v6, Lj62;->h:Landroid/graphics/Matrix;

    iget-object v12, v6, Lj62;->t:Landroid/graphics/Matrix;

    iget-boolean v10, v6, Lj62;->v:Z

    if-nez v10, :cond_0

    invoke-virtual {v6}, Lj62;->g()V

    :cond_0
    iget-boolean v10, v6, Lj62;->x:Z
    ...
    :cond_3
    iget-object v10, v6, Lj62;->n:Landroid/view/GestureDetector;
    ...
    iget-boolean v10, v6, Lj62;->k:Z

    if-nez v10, :cond_4

    iget-boolean v10, v6, Lj62;->l:Z
    ...
    :cond_8
    iput-boolean v4, v6, Lj62;->x:Z

    iget-boolean v15, v6, Lj62;->m:Z

    iput-boolean v4, v6, Lj62;->m:Z

    if-eqz v14, :cond_b

    iget-boolean v9, v6, Lj62;->A:Z
    ...
    iget-object v5, v6, Lj62;->s:[F

    invoke-virtual {v11, v5, v7}, Landroid/graphics/Matrix;->mapPoints([F[F)V

    invoke-virtual {v6, v8}, Lj62;->c([F)Lrvc;

    move-result-object v5

    iget-object v7, v5, Lrvc;->a:Ljava/lang/Object;
    ...
    invoke-direct/range {v5 .. v10}, Lew1;-><init>(Lj62;FFFF)V

    invoke-static {v12}, Lr5i;->a(Landroid/graphics/Matrix;)F

    move-result v16

    invoke-static {v11}, Lr5i;->a(Landroid/graphics/Matrix;)F
    ...
    invoke-direct {v5, v6}, Lf62;-><init>(Lj62;)V
    ...
    invoke-direct {v7, v5, v6}, Lg62;-><init>(Lew1;Lj62;)V

    invoke-virtual {v4, v7}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    :goto_5
    iget-object v5, v6, Lj62;->w:Ld62;
    ...
    iput-object v4, v6, Lj62;->u:Landroid/animation/ValueAnimator;
    ...
    :goto_8
    iget-object v3, v3, Lh42;->i1:Landroid/view/GestureDetector;
