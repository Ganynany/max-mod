...
.method public final b(Lkdi;)V
    ...
    iget-object v2, v1, Lkdi;->d:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lhsb;->b:Ljava/lang/CharSequence;
    ...
    iget-object v3, v0, Lprb;->e:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v3}, Lorb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V
    ...
    :cond_5
    :goto_1
    iget-boolean v3, v0, Lprb;->g:Z

    if-eqz v3, :cond_7

    iget-object v3, v0, Lprb;->f:Landroidx/core/graphics/drawable/IconCompat;
    ...
    invoke-static {v2, v1}, Lnrb;->a(Landroid/app/Notification$BigPictureStyle;Landroid/graphics/drawable/Icon;)V

    :cond_7
    :goto_2
    iget-boolean v1, v0, Lhsb;->d:Z

    if-eqz v1, :cond_8

    iget-object v1, v0, Lhsb;->c:Ljava/lang/CharSequence;
    ...
    invoke-static {v2, v1}, Lorb;->c(Landroid/app/Notification$BigPictureStyle;Z)V

    invoke-static {v2, v5}, Lorb;->b(Landroid/app/Notification$BigPictureStyle;Ljava/lang/CharSequence;)V
