...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lr22;->a:Landroid/content/Context;
...
# virtual methods
.method public final a(Lr2i;)Lv2i;
    .locals 4

    new-instance v0, Landroid/text/SpannableStringBuilder;

    iget-object v1, p0, Lr22;->a:Landroid/content/Context;
...
.method public final b(Lwkj;)Lsh1;
    .locals 11
    ...
    iget-object v3, p0, Lr22;->a:Landroid/content/Context;

    if-eqz v1, :cond_0

    sget v1, Lcje;->check_outline_16:I
    ...
    sget v1, Lcje;->ic_microphone_off_fill_16:I
    ...
    invoke-direct/range {v4 .. v10}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;-><init>(Landroid/graphics/drawable/Drawable;Lfs6;ZZILf75;)V
    ...
    invoke-direct {p1, v2, v3, v1}, Lsh1;-><init>(JLandroid/text/SpannableStringBuilder;)V
...
.method public final c(Z)Landroid/text/SpannableStringBuilder;
    ...
    iget-object v4, p0, Lr22;->a:Landroid/content/Context;

    if-eqz p1, :cond_1

    sget p1, Lvkf;->l1:I

    invoke-virtual {v2, v4}, Lov3;->j(Landroid/content/Context;)Lumc;
    ...
    invoke-direct/range {v5 .. v11}, Lone/me/sdk/uikit/common/span/FitFontImageSpan;-><init>(Landroid/graphics/drawable/Drawable;Lfs6;ZZILf75;)V
...
.method public final d(Z)Landroid/text/SpannableStringBuilder;
    ...
    sget v0, Llpe;->call_incoming_video_call:I
    ...
    :cond_1
    sget p1, Llpe;->call_incoming_audio_call:I
...
.method public final e(Ljava/lang/CharSequence;ZIZZZLtc6;)Landroid/text/SpannableStringBuilder;
    .locals 9
    ...
    instance-of v5, v2, Lpc6;

    if-nez v5, :cond_0

    instance-of v5, v2, Lrc6;
    ...
    iget-object v6, p0, Lr22;->a:Landroid/content/Context;
    ...
    sget v1, Lkie;->ic_share_screen_20:I
    ...
    sget v1, Lkie;->ic_microphone_disable_12:I
    ...
    invoke-direct {v5, v8}, Lq22;-><init>(I)V

    invoke-direct {v3, v6, v1, v5}, Ll1h;-><init>(Landroid/content/Context;Lrmc;Lq22;)V
...
.method public final g(ZZZLtc6;)Ljava/lang/String;
    .locals 1

    iget-object v0, p0, Lr22;->a:Landroid/content/Context;

    if-nez p3, :cond_1

    if-nez p2, :cond_1

    instance-of p2, p4, Lpc6;

    if-nez p2, :cond_0

    instance-of p2, p4, Lrc6;
    ...
    :cond_1
    instance-of p1, p4, Lpc6;

    if-nez p1, :cond_2

    instance-of p1, p4, Lrc6;
    ...
    sget p1, Llpe;->call_connecting:I
    ...
    :cond_3
    instance-of p1, p4, Lmc6;

    if-eqz p1, :cond_4

    check-cast p4, Lmc6;

    iget-object p1, p4, Lmc6;->a:Llc6;
    ...
    :pswitch_1
    sget p1, Llpe;->call_opponent_reject_call:I
    ...
    :pswitch_2
    sget p1, Llpe;->call_participants_limit_reached:I
    ...
    :pswitch_3
    sget p1, Llpe;->call_user_restricted_info:I
    ...
    :pswitch_4
    sget p1, Llpe;->call_group_wait_admin:I
    ...
    :pswitch_5
    sget p1, Llpe;->call_group_user_not_in_chat:I
    ...
    :pswitch_6
    sget p1, Llpe;->call_group_was_removed_from_waiting_room:I
    ...
    :pswitch_7
    sget p1, Llpe;->call_group_was_removed_from_call:I
    ...
    :pswitch_8
    sget p1, Llpe;->call_opponent_failed_timout:I
    ...
    :pswitch_a
    sget p1, Llpe;->call_opponent_unavailable_privacy:I
    ...
    :pswitch_b
    sget p1, Llpe;->call_opponent_unavailable_busy:I
    ...
    :pswitch_c
    sget p1, Llpe;->call_opponent_unavailable_missed:I
...
.method public final h(ZILjava/lang/CharSequence;ZZZZLtc6;)Landroid/text/SpannableStringBuilder;
    .locals 8
    ...
    invoke-static {p3, p4}, Lhkh;->Y0(Ljava/lang/CharSequence;[C)Ljava/util/List;
...
.method public final i()Ln89;
    ...
    invoke-direct {v0, v1, v2, v3}, Ln89;-><init>(IILandroid/content/Context;)V
