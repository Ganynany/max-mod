...
.field public static final Y:Lo7f;

.field public static final Z:Lo7f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lyc7;->X:Ljava/lang/String;

    new-instance v0, Lb98;

    const/4 v2, 0x4

    invoke-direct {v0, v2}, Lu88;-><init>(I)V
    ...
    invoke-virtual {v0, v2}, Lu88;->b([Ljava/lang/Object;)V
...
.method public constructor <init>(Landroid/media/MediaMuxer;)V
    ...
    iput-object p1, p0, Lyc7;->a:Landroid/media/MediaMuxer;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lyc7;->b:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, Lyc7;->c:Landroid/util/SparseArray;
...
.method public final X(ILjava/nio/ByteBuffer;Lb41;)V
    ...
    iget-wide v3, v2, Lb41;->a:J

    iget-boolean v5, v1, Lyc7;->d:Z

    iget-object v6, v1, Lyc7;->a:Landroid/media/MediaMuxer;

    const/4 v7, 0x1

    iget-object v8, v1, Lyc7;->c:Landroid/util/SparseArray;
    ...
    iget-object v3, v1, Lyc7;->b:Landroid/util/SparseArray;

    invoke-static {v3, v0}, Lvyi;->k(Landroid/util/SparseArray;I)Z
    ...
    invoke-static {v8, v9, v5, v12}, Lhb2;->u(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3, v4, v6, v7}, Lhb2;->u(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final close()V
    ...
    :cond_0
    iget-boolean v0, p0, Lyc7;->d:Z

    const/4 v1, 0x1

    iget-object v2, p0, Lyc7;->a:Landroid/media/MediaMuxer;
    ...
    iput-boolean v0, p0, Lyc7;->d:Z

    :try_start_1
    invoke-static {v2}, Lyc7;->d(Landroid/media/MediaMuxer;)V
    :try_end_1
    .catch Ljava/lang/RuntimeException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public final k(Lf3b;)V
    ...
    iget-object v1, p0, Lyc7;->a:Landroid/media/MediaMuxer;
...
.method public final u0(Ls77;)I
    ...
    iget-object v5, p0, Lyc7;->a:Landroid/media/MediaMuxer;
    ...
    iget-object v6, p1, Ls77;->D:Lqy3;

    invoke-static {v4, v6}, Lyjk;->c(Landroid/media/MediaFormat;Lqy3;)V
    ...
    invoke-static {v4, v0}, Lyjk;->f(Landroid/media/MediaFormat;Ljava/util/List;)V
