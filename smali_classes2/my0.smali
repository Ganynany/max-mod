...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;Landroid/net/Uri;IILr3e;)V
    .locals 0
    ...
    iput-object p2, p0, Lmy0;->b:Landroid/net/Uri;

    iput-object p3, p0, Lmy0;->c:Landroid/net/Uri;

    iput p4, p0, Lmy0;->d:I

    iput p5, p0, Lmy0;->e:I

    iput-object p6, p0, Lmy0;->f:Lr3e;
...
.method public final a(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    iget-object v0, p0, Lmy0;->c:Landroid/net/Uri;
    ...
    :cond_0
    invoke-static {v2}, Lrwk;->b(Ljava/io/Closeable;)V

    invoke-static {p1}, Lrwk;->b(Ljava/io/Closeable;)V

    iput-object v0, p0, Lmy0;->b:Landroid/net/Uri;
    ...
    :goto_1
    invoke-static {v1}, Lrwk;->b(Ljava/io/Closeable;)V
...
.method public final b(Landroid/net/Uri;Landroid/net/Uri;)V
    ...
    invoke-direct {v2}, Lp0c;-><init>()V

    invoke-direct {v1, v2}, Lq0c;-><init>(Lp0c;)V

    iget-object v2, v1, Lq0c;->a:Lvth;
    ...
    invoke-direct {v4, v5}, Lne5;-><init>(I)V

    invoke-virtual {p1}, Landroid/net/Uri;->toString()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v4, p1}, Lne5;->h(Ljava/lang/String;)V

    invoke-virtual {v4}, Lne5;->a()Ly90;

    move-result-object p1

    invoke-virtual {v1, p1}, Lq0c;->b(Ly90;)Lpye;
    ...
    :try_start_2
    iget-object v5, p0, Lmy0;->a:Landroid/content/Context;
    ...
    sget-object v5, Lw0c;->a:Ljava/util/logging/Logger;
    ...
    invoke-direct {v5, p2, v7, v6}, Lq30;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    :try_start_3
    invoke-interface {v4, v5}, Lc51;->V(Lq30;)J
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    invoke-static {v4}, Lrwk;->b(Ljava/io/Closeable;)V

    invoke-static {v5}, Lrwk;->b(Ljava/io/Closeable;)V

    invoke-static {v1}, Lrwk;->b(Ljava/io/Closeable;)V

    invoke-virtual {v2}, Lvth;->a()V
    ...
    :goto_2
    invoke-static {v3}, Lrwk;->b(Ljava/io/Closeable;)V
...
.method public final c()Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lso4;->n(Landroid/content/Context;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lmy0;->b:Landroid/net/Uri;
    ...
    invoke-static {v1, v0, v2, v2}, Ltcl;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1, v2, v3, v0}, Ltcl;->b(Landroid/content/Context;Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/String;
...
.method public final d()Lly0;
    ...
    iget-object v3, v1, Lmy0;->a:Landroid/content/Context;

    iget-object v0, v1, Lmy0;->b:Landroid/net/Uri;
    ...
    invoke-direct {v0, v2}, Lly0;-><init>(Ljava/lang/Exception;)V

    return-object v0

    :cond_0
    :try_start_0
    invoke-virtual {v1}, Lmy0;->e()V
    :try_end_0
    ...
    iget-object v4, v1, Lmy0;->b:Landroid/net/Uri;
    ...
    :cond_1
    iget v12, v1, Lmy0;->d:I

    iget v13, v1, Lmy0;->e:I
    ...
    invoke-direct {v3, v0}, Lt68;-><init>(Ljava/io/InputStream;)V

    invoke-virtual {v3}, Lt68;->a()I
    ...
    :try_start_4
    invoke-static {v0}, Lrwk;->b(Ljava/io/Closeable;)V
    :try_end_4
    ...
    iput v11, v4, Ls86;->b:I

    iput v10, v4, Ls86;->c:I
    ...
    :cond_b
    :goto_7
    invoke-direct {v3, v13, v4}, Lly0;-><init>(Landroid/graphics/Bitmap;Ls86;)V
    ...
    invoke-direct {v0, v13, v4}, Lly0;-><init>(Landroid/graphics/Bitmap;Ls86;)V
    ...
    invoke-direct {v2, v0}, Lly0;-><init>(Ljava/lang/Exception;)V
...
.method public final e()V
    ...
    iget-object v3, p0, Lmy0;->c:Landroid/net/Uri;
    ...
    :try_start_0
    iget-object v1, p0, Lmy0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0}, Lmy0;->c()Ljava/lang/String;
    ...
    iput-object v1, p0, Lmy0;->b:Landroid/net/Uri;
    :try_end_1
    ...
    invoke-virtual {p0, v1, v3}, Lmy0;->a(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_2
    ...
    iget-object v2, p0, Lmy0;->b:Landroid/net/Uri;
    ...
    invoke-virtual {p0, v0, v3}, Lmy0;->b(Landroid/net/Uri;Landroid/net/Uri;)V
    :try_end_7
...
.method public final onPostExecute(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lly0;->b:Ljava/lang/Exception;

    iget-object v1, p0, Lmy0;->f:Lr3e;

    if-nez v0, :cond_1

    iget-object p1, p1, Lly0;->a:Landroid/graphics/Bitmap;
    ...
    iput-object v0, v1, Llfi;->G0:Ljava/lang/String;

    const/4 v0, 0x1

    iput-boolean v0, v1, Llfi;->D0:Z

    invoke-virtual {v1, p1}, Llfi;->setImageBitmap(Landroid/graphics/Bitmap;)V
    ...
    iget-object p1, v1, Lr3e;->a:Ljava/lang/Object;
