...
.method public static b(Ljava/lang/String;Ljte;)Lrn0;
    .locals 57
    ...
    invoke-direct/range {v6 .. v56}, Lm81;-><init>(DDDDDDDDDDDDDDDDZDDDZDDDDD)V
    ...
    :cond_1f
    invoke-direct {v5, v1, v7, v3, v4}, Lwaf;-><init>(IID)V
    ...
    :goto_12
    invoke-direct {v1, v3, v0}, Lqn0;-><init>(ZZ)V
    ...
    :cond_24
    invoke-direct {v2, v3, v4}, Lpn0;-><init>(ZZ)V

    new-instance v0, Lrn0;

    invoke-direct {v0, v6, v5, v1, v2}, Lrn0;-><init>(Lm81;Lwaf;Lqn0;Lpn0;)V
    ...
    invoke-interface {v4, v2, v3, v0}, Ljte;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
