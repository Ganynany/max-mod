...
.method public final bridge synthetic v(Lw5f;I)V
    ...
    invoke-virtual {p0, p1, p2}, Luu1;->L(Lfyg;I)V
...
.method public final x(Landroid/view/ViewGroup;I)Lw5f;
    ...
    invoke-direct {v0, p1}, Lylc;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p1}, Lylc;->setFilters([Landroid/text/InputFilter;)V
    ...
    invoke-virtual {v0, p1}, Lylc;->setBackgroundColorAttr(Ljava/lang/Integer;)V

    new-instance p1, Ll;

    const/16 v1, 0x15

    iget-object v2, p0, Luu1;->o:Lxak;

    invoke-direct {p1, v2, v1}, Ll;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, p1}, Lylc;->f(Lre7;)Landroid/text/TextWatcher;

    sget-object p1, Lwlc;->a:Lwlc;

    invoke-virtual {v0, p1}, Lylc;->setTypingMode(Lwlc;)V
