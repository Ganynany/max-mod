...
.method public constructor <init>(Lpx8;Lpx8;Lpx8;)V
    ...
    iput-object p3, p0, Lqxc;->a:Lpx8;

    iput-object p1, p0, Lqxc;->b:Lpx8;

    iput-object p2, p0, Lqxc;->c:Lpx8;
    ...
    iput-object p1, p0, Lqxc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;

    invoke-static {}, Ljava/util/concurrent/ConcurrentHashMap;->newKeySet()Ljava/util/concurrent/ConcurrentHashMap$KeySetView;

    move-result-object p1

    iput-object p1, p0, Lqxc;->o:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
...
.method public final clear()V
    ...
    iget-object v0, p0, Lqxc;->o:Ljava/util/concurrent/ConcurrentHashMap$KeySetView;
    ...
    invoke-virtual {v2}, Le52;->d()V

    const/4 v3, 0x0

    iput-object v3, v2, Le52;->B0:Loyi;

    const/4 v3, 0x0

    iput-boolean v3, v2, Le52;->C0:Z

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lqxc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final createVideoViewInstance(Landroid/content/Context;)Lru/ok/android/externcalls/sdk/ui/RendererView;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;IILf75;)V
...
.method public final d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
    ...
    invoke-virtual {p0}, Lqxc;->c()Lru/ok/android/externcalls/sdk/Conversation;
...
.method public final onCameraChanged()V
    ...
    invoke-virtual {v2}, Lvd1;->b()Z

    move-result v2

    check-cast v1, Le52;

    iget-object v3, v1, Le52;->D0:Llej;

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Llej;->c:Z

    const/4 v4, 0x1

    if-ne v3, v4, :cond_0

    iget-object v1, v1, Le52;->d:Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;
...
.method public final rebindParticipantViews()V
    ...
    iget-object v5, p0, Lqxc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
...
.method public final removeOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    iget-object v0, v0, Llej;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;

    invoke-virtual {p0, v0, p1}, Lqxc;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final bridge synthetic removeParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;)V
    ...
    invoke-virtual {p0, p1, p2}, Lqxc;->d(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/TextureViewRenderer;)V
...
.method public final setOwnVideoParticipantView(Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    invoke-virtual {p2}, Lnxc;->c()Lnwc;

    move-result-object p2

    iget-object p2, p2, Lnwc;->a:Lcu1;

    invoke-interface {p2}, Lcu1;->s()Llej;

    move-result-object p2

    iget-object p2, p2, Llej;->b:Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
...
.method public final setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Lru/ok/android/externcalls/sdk/ui/RendererView;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    iget-object p3, p0, Lqxc;->d:Lru/ok/android/externcalls/sdk/video/VideoRender;
    ...
    sget-object v2, Lsej;->a:Lsej;

    if-ne v1, v2, :cond_1

    iget-object v1, p0, Lqxc;->a:Lpx8;
    ...
    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lrr1;
    ...
    invoke-static/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init$default(Lru/ok/android/externcalls/sdk/ui/RendererView;Lrr1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;ILjava/lang/Object;)Z
