...
# direct methods
.method public static a(Landroid/net/Uri;Landroid/content/Context;Leo6;)Landroid/net/Uri;
    .locals 7
    ...
    iget-object v6, v6, Lgq6;->b:Lwz5;

    invoke-static {p1, v5, v6}, Ljrk;->e(Landroid/content/Context;Ljava/lang/String;Lwz5;)Lpo4;

    move-result-object v5

    if-eqz v5, :cond_1

    iget-object v5, v5, Lpo4;->b:Ljava/lang/String;

    invoke-static {v5}, Lhsg;->b0(Ljava/lang/CharSequence;)Z
    ...
    invoke-virtual {p2, v3}, Lgq6;->p(Ljava/lang/String;)Ljava/io/File;
    ...
    :try_start_2
    invoke-static {v4, v3}, Lag3;->k(Ljava/io/InputStream;Ljava/io/OutputStream;)J
...
.method public static final b(Ll7g;)Lou8;
    .locals 1

    instance-of v0, p0, Lto4;

    if-eqz v0, :cond_0

    check-cast p0, Lto4;

    iget-object p0, p0, Lto4;->b:Lou8;

    return-object p0

    :cond_0
    instance-of v0, p0, Lm7g;

    if-eqz v0, :cond_1

    check-cast p0, Lm7g;

    iget-object p0, p0, Lm7g;->a:Ll7g;

    invoke-static {p0}, Le3l;->b(Ll7g;)Lou8;
...
.method public static final c(Ll7g;Llyg;)V
    .locals 0
...
.method public static d(Landroid/content/Intent;)I
    ...
    invoke-static {v0, v3, v1}, Lpkh;->y0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-static {v0, p0, v1}, Lhkh;->z0(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Z)Z
...
.method public static e(Landroid/content/Intent;Landroid/content/Context;Lg76;Leo6;)Ljava/util/ArrayList;
    .locals 3
    ...
    invoke-static {v1, p1, p2}, Ljrk;->k(Landroid/net/Uri;Landroid/content/Context;Lg76;)Z
    ...
    invoke-static {v1, p1, p3}, Le3l;->a(Landroid/net/Uri;Landroid/content/Context;Leo6;)Landroid/net/Uri;
...
.method public static f(Landroid/content/Intent;Landroid/content/Context;Lg76;Leo6;)Ljava/util/ArrayList;
    .locals 3
    ...
    :cond_3
    invoke-static {p0, p1, p2}, Ljrk;->k(Landroid/net/Uri;Landroid/content/Context;Lg76;)Z
    ...
    invoke-static {p0, p1, p3}, Le3l;->a(Landroid/net/Uri;Landroid/content/Context;Leo6;)Landroid/net/Uri;
