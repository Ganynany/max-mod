...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lgkk;->a:Lwi6;

    filled-new-array {v0}, [Lwi6;

    move-result-object v0

    sput-object v0, Lgkk;->b:[Lwi6;
...
.method public static b(Landroid/media/MediaRoute2Info;)Lv4a;
    .locals 10
    ...
    invoke-static {p0}, Lqg;->m(Landroid/media/MediaRoute2Info;)Ljava/lang/String;

    move-result-object v2

    invoke-static {p0}, Lz3a;->n(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, v2, v3}, Li89;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v2, v1, Li89;->a:Ljava/lang/Object;

    check-cast v2, Landroid/os/Bundle;

    invoke-static {p0}, Lz3a;->b(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lz3a;->x(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lz3a;->C(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lz3a;->D(Landroid/media/MediaRoute2Info;)I
    ...
    invoke-static {p0}, Lqg;->i(Landroid/media/MediaRoute2Info;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Lz3a;->y(Landroid/media/MediaRoute2Info;)Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {p0}, Lz3a;->l(Landroid/media/MediaRoute2Info;)Landroid/net/Uri;
    ...
    invoke-virtual {v1, p0}, Li89;->y(Ljava/util/List;)V

    :cond_6
    invoke-virtual {v1}, Li89;->A()Lv4a;
