...
.method public constructor <init>(Lug0;Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lgd0;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v1}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, p0, Lgd0;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, Lgd0;->e:Ljava/util/concurrent/atomic/AtomicReference;

    iput-boolean v1, p0, Lgd0;->l:Z
    ...
    invoke-static {v0, p1, p2}, Lgd0;->b(ILug0;Landroid/content/Context;)Landroid/media/AudioRecord;

    move-result-object p1

    iput-object p1, p0, Lgd0;->a:Landroid/media/AudioRecord;
...
.method public static b(ILug0;Landroid/content/Context;)Landroid/media/AudioRecord;
    .locals 5
    ...
    invoke-static {v2, p2}, Lfo;->c(Landroid/media/AudioRecord$Builder;Landroid/content/Context;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lgd0;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final c(Z)V
    ...
    iget-object v0, p0, Lgd0;->i:Lk7g;

    iget-object v1, p0, Lgd0;->h:Liif;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Lgd0;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v2, v1, p1, v3}, Lil;-><init>(Ljava/lang/Object;ZI)V
...
.method public final d()V
    ...
    invoke-virtual {p0}, Lgd0;->a()V

    iget-object v0, p0, Lgd0;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v2, p0, Lgd0;->a:Landroid/media/AudioRecord;
    ...
    iput-wide v2, p0, Lgd0;->j:J

    iput-boolean v4, p0, Lgd0;->l:Z

    iget-object v0, p0, Lgd0;->e:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iget-object v0, p0, Lgd0;->a:Landroid/media/AudioRecord;

    invoke-static {v0}, Leo;->c(Landroid/media/AudioRecord;)Landroid/media/AudioRecordingConfiguration;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-static {v0}, Leo;->f(Landroid/media/AudioRecordingConfiguration;)Z
    ...
    :cond_4
    invoke-virtual {p0, v4}, Lgd0;->c(Z)V
...
.method public final read(Ljava/nio/ByteBuffer;)Lxg0;
    ...
    iget-object v5, p0, Lgd0;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, p0, Lgd0;->b:Lug0;

    iget v5, v5, Lug0;->b:I

    iget-wide v7, p0, Lgd0;->j:J
    ...
    invoke-static {v11, v9}, Lnjk;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {v9, v6}, Lnjk;->h(Ljava/lang/String;Z)V

    iget-wide v11, p1, Landroid/media/AudioTimestamp;->framePosition:J

    sub-long/2addr v7, v11

    invoke-static {v5, v7, v8}, Lyuk;->a(IJ)J
    ...
    sget-wide v7, Lgd0;->m:J

    cmp-long p1, v5, v7

    if-lez p1, :cond_5

    iput-boolean v10, p0, Lgd0;->l:Z
    ...
    invoke-static {p1, v1}, Lfte;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    iget-wide v3, p0, Lgd0;->j:J

    int-to-long v5, v0

    iget p1, p0, Lgd0;->g:I

    invoke-static {p1, v5, v6}, Lyuk;->c(IJ)J

    move-result-wide v5

    add-long/2addr v5, v3

    iput-wide v5, p0, Lgd0;->j:J

    :cond_7
    new-instance p1, Lxg0;

    invoke-direct {p1, v0, v1, v2}, Lxg0;-><init>(IJ)V
