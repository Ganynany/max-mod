...
.method private final a(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lzfb;->D0:Lg76;
    ...
    :cond_1
    iget-object v2, v0, Lzfb;->c:Lsa9;

    iget-boolean v2, v2, Lsa9;->a:Z
    ...
    :cond_2
    iget-object v2, v0, Lzfb;->G0:Lp62;

    sget-object v4, Ltlf;->a:Lheg;

    if-eqz v2, :cond_4

    invoke-virtual {v2}, Lp62;->f()Z
    ...
    :cond_5
    iget-object v2, v0, Lzfb;->X:Ljava/lang/Object;
    ...
    invoke-direct/range {v5 .. v15}, Lkee;-><init>(Liee;IIIJZIII)V
    ...
    :cond_7
    iget-object v2, v0, Lzfb;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    iget-object v0, v0, Lzfb;->Z:Lf3j;
    ...
    sget-object v4, Lkee;->j:Ld59;

    invoke-static {v4, v1}, Lly3;->w0(Ljava/util/Comparator;Ljava/util/List;)V
    ...
    invoke-direct {v6, v5}, Lpee;-><init>(Lkee;)V
    ...
    invoke-direct {v1, v5, v4}, Lrvc;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    filled-new-array {v1, v4, v5}, [Lrvc;
    ...
    invoke-virtual {v3, v0}, Landroidx/fragment/app/a;->e0(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, v0, v1}, Lru/ok/messages/views/dialogs/FrgDlgBase;->l0(Landroidx/fragment/app/c;Ljava/lang/String;)V

    invoke-virtual {v2}, Landroidx/fragment/app/b;->B()Leb7;

    move-result-object v0

    invoke-virtual {v2}, Lru/ok/messages/media/mediabar/ActLocalMedias;->P()Lru/ok/messages/media/mediabar/FrgLocalMedia;

    move-result-object v1

    iget-object v3, v1, Landroidx/fragment/app/a;->i1:Lnb7;
    ...
    invoke-direct {v1, v2, v4}, La8;-><init>(Ljava/lang/Object;I)V

    new-instance v2, Lb8;

    invoke-direct {v2, v4}, Lb8;-><init>(I)V

    new-instance v4, Lmbh;

    const/16 v5, 0x1a

    invoke-direct {v4, v2, v5, v1}, Lmbh;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-virtual {v3}, Lnb7;->b()V

    iget-object v1, v3, Lnb7;->d:Ln09;
    ...
    invoke-direct {v2, v0, v4, v1}, Lxa7;-><init>(Leb7;Lmbh;Ln09;)V

    iget-object v0, v0, Landroidx/fragment/app/c;->m:Ljava/util/Map;

    new-instance v3, Lab7;

    invoke-direct {v3, v1, v4, v2}, Lab7;-><init>(Ln09;Lmbh;Lxa7;)V
    ...
    iget-object v3, v0, Lab7;->a:Ln09;

    iget-object v0, v0, Lab7;->c:Lxa7;
    ...
    :cond_b
    invoke-virtual {v1, v2}, Ln09;->a(Li09;)V
...
.method private final b(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0}, Lx99;->e()Z

    move-result v0

    if-nez v0, :cond_a

    iget-object v0, p1, Lzfb;->B0:Leo6;

    const-string v2, "jpg"

    invoke-interface {v0, v2}, Leo6;->a(Ljava/lang/String;)Ljava/io/File;
    ...
    iget-object v3, p1, Lzfb;->z0:Le6d;

    const/4 v4, 0x0

    if-eqz v3, :cond_0

    iget-object v5, v3, Le6d;->b:Landroid/net/Uri;
    ...
    iget-object v3, v3, Le6d;->a:Landroid/net/Uri;
    ...
    iget-object v4, v3, Le6d;->o:Landroid/net/Uri;
    ...
    iget-object v1, p1, Lzfb;->C0:Liif;

    new-instance v3, Ljo;

    const/16 v5, 0x15

    invoke-direct {v3, v1, v2, v4, v5}, Ljo;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
    ...
    invoke-direct {v3, p1, v4, v0}, Lrta;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v0, Lxfb;

    invoke-direct {v0, p1, v2}, Lxfb;-><init>(Lzfb;I)V

    invoke-virtual {v1, v3, v0}, Lgyg;->j(Lwd4;Lwd4;)Lp62;

    return-void

    :cond_9
    iget-object p1, p1, Lzfb;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    invoke-virtual {p1, v2, v0, v6}, Lru/ok/messages/media/mediabar/ActLocalMedias;->X(Landroid/net/Uri;Ljava/io/File;Lrv4;)V
...
.method private final c(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lzfb;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    iget-object v1, p1, Lzfb;->d:Lx99;

    iget-object v1, v1, Lx99;->c:Ljava/lang/String;

    iget-object v2, p1, Lzfb;->Z:Lf3j;

    iget v3, v2, Lf3j;->b:F

    iget-wide v4, p1, Lzfb;->Y:J
...
.method private final d(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lzfb;->z0:Le6d;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iget-object v2, v0, Le6d;->d:Lyw5;
    ...
    :goto_0
    iget-object v3, p1, Lzfb;->d:Lx99;

    if-eqz v0, :cond_2

    iget-object v4, v0, Le6d;->o:Landroid/net/Uri;
...
.method private final e(Ljava/lang/Object;)V
    ...
    iget-object v0, p1, Lzfb;->Z:Lf3j;

    iget-boolean v1, v0, Lf3j;->d:Z
    ...
    iput-boolean v2, v0, Lt70;->d:Z

    new-instance v3, Lf3j;

    invoke-direct {v3, v0}, Lf3j;-><init>(Lt70;)V

    iput-object v3, p1, Lzfb;->Z:Lf3j;

    invoke-virtual {p1}, Lzfb;->S()V

    new-instance v0, Lcs2;

    const/16 v3, 0xa

    invoke-direct {v0, v2, v3}, Lcs2;-><init>(ZI)V
    ...
    invoke-virtual {p1, v1, v0}, Lru/ok/messages/media/mediabar/ActLocalMedias;->T(ZZ)V
...
.method private final f(Ljava/lang/Object;)V
    ...
    iget-object v1, v0, Lvgb;->Y:Lnj;

    iget-object v2, v0, Lvgb;->I0:Landroidx/appcompat/widget/AppCompatImageButton;

    invoke-virtual {v1, v2}, Lnj;->f(Landroid/view/View;)Lwy9;

    iget-object v2, v0, Lvgb;->J0:Landroid/widget/ProgressBar;

    invoke-virtual {v1, v2}, Lnj;->e(Landroid/view/View;)Lwy9;
    ...
    invoke-static {v0}, Lckk;->g(Landroid/view/ViewGroup;)V

    iget-object v2, p1, Lfgb;->b:Lru/ok/messages/media/trim/FrgTrimVideo;
    ...
    invoke-virtual {v0, v1}, Lgyg;->m(Lqqf;)Lazg;
    ...
    invoke-direct {v1, p1, v2}, Legb;-><init>(Lfgb;I)V

    new-instance p1, Lrdb;

    const/16 v2, 0xb

    invoke-direct {p1, v2}, Lrdb;-><init>(I)V
...
.method private final g(Ljava/lang/Object;)V
    ...
    iget-wide v0, p1, Lfgb;->o:J

    iget-object v2, p1, Lj3;->a:Ljava/lang/Object;

    check-cast v2, Lggb;

    iget-wide v3, p1, Lfgb;->X:J
    ...
    iput-wide v5, p1, Lfgb;->X:J

    iput-wide v0, p1, Lfgb;->Y:J

    check-cast v2, Lvgb;

    iget-object v0, v2, Lvgb;->E0:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;

    invoke-virtual {v0, v5, v6}, Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;->setStartPosition(J)V

    iget-wide v0, p1, Lfgb;->Y:J

    iget-object v3, v2, Lvgb;->E0:Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;

    invoke-virtual {v3, v0, v1}, Lru/ok/messages/media/trim/rangeSeekBar/RangeSeekBarView;->setEndPosition(J)V

    iget-wide v0, p1, Lfgb;->X:J
    ...
    invoke-static {v3, v4}, Lxw8;->w(J)Ljava/lang/String;

    move-result-object v1

    iget-object v3, v2, Lvgb;->C0:Landroid/widget/TextView;
    ...
    invoke-static {v0, v1}, Lxw8;->w(J)Ljava/lang/String;

    move-result-object v0

    iget-object v1, v2, Lvgb;->D0:Landroid/widget/TextView;

    invoke-virtual {v1, v0}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Lfgb;->d:Lfa9;

    iget-wide v1, p1, Lfgb;->X:J

    invoke-virtual {v0, v1, v2}, Lfa9;->h(J)V

    invoke-virtual {p1}, Lfgb;->U()V
...
.method private final h(Ljava/lang/Object;)V
    ...
    iput-boolean v1, v0, Lfa9;->j:Z

    iget-object v0, v0, Lfa9;->b:Ln96;

    invoke-virtual {v0}, Ln96;->play()V

    :goto_0
    iget-object v0, p1, Lfgb;->B0:Lcx8;
    ...
    iput-object v4, p1, Lfgb;->B0:Lcx8;
...
.method private final i(Ljava/lang/Object;)V
    ...
    iget-boolean v0, p1, Lfgb;->C0:Z

    xor-int/lit8 v0, v0, 0x1

    iput-boolean v0, p1, Lfgb;->C0:Z
    ...
    iget-object p1, p1, Lfgb;->d:Lfa9;

    invoke-virtual {p1}, Lfa9;->c()Z

    move-result p1

    invoke-virtual {v1, v0, p1}, Lvgb;->w(ZZ)V
...
.method private final j(Ljava/lang/Object;)V
    ...
    iget-object p1, p1, Ld6d;->c:Lc6d;

    invoke-interface {p1}, Lc6d;->o()V
...
.method public final accept(Ljava/lang/Object;)V
    ...
    sget-object v2, Lone/me/mediaeditor/PhotoEditScreen;->P0:[Lbv8;

    if-eqz v1, :cond_0

    iget-object v1, v1, Ld6d;->c:Lc6d;

    invoke-interface {v1}, Lc6d;->l()V

    :cond_0
    return-void

    :pswitch_0
    invoke-direct/range {p0 .. p1}, Lei5;->j(Ljava/lang/Object;)V
    ...
    invoke-interface {v1}, Lc6d;->h()V

    :cond_2
    return-void

    :pswitch_3
    invoke-direct/range {p0 .. p1}, Lei5;->i(Ljava/lang/Object;)V

    return-void

    :pswitch_4
    invoke-direct/range {p0 .. p1}, Lei5;->h(Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Lfgb;->b:Lru/ok/messages/media/trim/FrgTrimVideo;
    ...
    :pswitch_6
    invoke-direct/range {p0 .. p1}, Lei5;->g(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1}, Lfgb;->Q()V

    return-void

    :pswitch_8
    invoke-direct/range {p0 .. p1}, Lei5;->f(Ljava/lang/Object;)V

    return-void

    :pswitch_9
    invoke-direct/range {p0 .. p1}, Lei5;->e(Ljava/lang/Object;)V

    return-void

    :pswitch_a
    invoke-direct/range {p0 .. p1}, Lei5;->d(Ljava/lang/Object;)V

    return-void

    :pswitch_b
    invoke-direct/range {p0 .. p1}, Lei5;->c(Ljava/lang/Object;)V
    ...
    :pswitch_d
    invoke-direct/range {p0 .. p1}, Lei5;->b(Ljava/lang/Object;)V
    ...
    iget-object v1, v1, Lzfb;->b:Lru/ok/messages/media/mediabar/ActLocalMedias;

    iget-object v2, v1, Lru/ok/messages/media/mediabar/ActLocalMedias;->t1:Ldth;
    ...
    :pswitch_f
    invoke-direct/range {p0 .. p1}, Lei5;->a(Ljava/lang/Object;)V
    ...
    iput-boolean v15, v2, Lfa9;->j:Z

    iget-object v3, v2, Lfa9;->b:Ln96;

    invoke-virtual {v3}, Ln96;->play()V

    :goto_1
    iget-object v3, v1, Ldgb;->X:Lru/ok/messages/media/mediabar/FrgLocalVideo;
    ...
    :cond_6
    invoke-virtual {v2}, Lfa9;->c()Z

    move-result v2

    if-eqz v2, :cond_7

    invoke-virtual {v1}, Ldgb;->R()V

    invoke-virtual {v1}, Ldgb;->Q()V
    ...
    iput-boolean v14, v1, Lxcj;->b:Z

    iput-boolean v14, v1, Lxcj;->c:Z

    iput-boolean v15, v1, Lxcj;->a:Z
    ...
    iput-boolean v15, v1, Lxcj;->d:Z

    const/4 v2, 0x0

    iput-object v2, v1, Lxcj;->h:Lt2j;

    iput-boolean v15, v1, Lxcj;->i:Z
    ...
    invoke-virtual {v1, v0, v15}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v15, v13}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v7, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v13, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v14, v13}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v13, v12}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_19
    sget-object v12, Landroidx/camera/camera2/internal/compat/quirk/ExtraSupportedSurfaceCombinationsQuirk;->a:Lzph;
    ...
    invoke-virtual {v1, v12, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v5, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v2, v13}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v6, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v4, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v2, v4}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v1, v0, v14}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-direct {v0, v3}, Lov8;-><init>(Ljava/util/List;)V

    sput-object v0, Lii5;->a:Lov8;
    ...
    invoke-static {v1}, Lov8;->f(Lov8;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v5, v4}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v4, v14}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_3f
    invoke-direct {v2, v3}, Lov8;-><init>(Ljava/util/List;)V

    sput-object v2, Lhi5;->a:Lov8;
    ...
    sget-object v2, Lhi5;->a:Lov8;

    invoke-static {v2}, Lov8;->f(Lov8;)Ljava/lang/String;
    ...
    invoke-virtual {v0, v10, v13}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v6, v5}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v5, v6}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v12, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v4, v3}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v2, v1}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v1, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v1, v14}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-direct {v0, v9}, Lov8;-><init>(Ljava/util/List;)V

    sput-object v0, Lgi5;->a:Lov8;
    ...
    invoke-virtual {v0, v7, v13}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v14, v10}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v10, v2}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    invoke-virtual {v0, v3, v14}, Lige;->a(Ljava/lang/Class;Z)Z
    ...
    :cond_99
    invoke-direct {v4, v5}, Lov8;-><init>(Ljava/util/List;)V

    sput-object v4, Lfi5;->a:Lov8;
