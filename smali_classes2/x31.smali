...
.method public final run()V
    ...
    invoke-interface {v0, v1, v2}, Lz5j;->l(II)V
    ...
    invoke-virtual {v0, v1, v2}, Lxb7;->a(II)V
    ...
    iget-boolean v3, v0, Lxb7;->z0:Z

    if-eqz v3, :cond_4

    iget-boolean v3, v0, Lxb7;->A0:Z

    if-eqz v3, :cond_4

    iget-object v3, v0, Lxb7;->X:Lorg/webrtc/ScreenCapturerAndroid;
    ...
    invoke-interface {v0, v1, v3, v2}, Ljte;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_5
    iget-object v5, v0, Lz31;->i:Lts6;

    iget v6, v0, Lz31;->e:I

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v4, v6}, Ld2c;->i0(II)Lji8;
    ...
    invoke-virtual {v8}, Lii8;->nextInt()I

    move-result v8

    add-int/2addr v8, v3

    invoke-virtual {v5, v8}, Lts6;->j(I)I
    ...
    iget-object v8, v0, Lz31;->l:Ljava/util/Set;
    ...
    iget-object v7, v0, Lz31;->f:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v7}, Ljava/util/concurrent/ConcurrentHashMap;->keySet()Ljava/util/Set;

    move-result-object v7

    invoke-static {v7, v5}, Lgeg;->N(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    iget-object v10, v0, Lz31;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v12, v10, Ly31;->a:Lc75;

    invoke-virtual {v12}, Lxv3;->F()Lxv3;
    ...
    iget-object v12, v0, Lz31;->a:Lwed;

    invoke-virtual {v12}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v13, Landroid/graphics/Bitmap$Config;->ARGB_8888:Landroid/graphics/Bitmap$Config;

    invoke-virtual {v12, v1, v2, v13}, Lwed;->c(IILandroid/graphics/Bitmap$Config;)Lxv3;
    ...
    invoke-direct {v10, v13}, Ly31;-><init>(Lc75;)V

    invoke-virtual {v12}, Lxv3;->l()Lxv3;

    move-result-object v12

    :goto_8
    iput-boolean v9, v10, Ly31;->b:Z

    :try_start_1
    invoke-virtual {v0, v8, v12}, Lz31;->f(ILxv3;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    invoke-interface {v12}, Ljava/io/Closeable;->close()V

    iget-object v9, v0, Lz31;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v12, v0}, Lgbb;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-static {v2, v4, v1}, Ld2c;->x(III)I
