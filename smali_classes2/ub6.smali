...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    :cond_0
    iput-object p1, p0, Lub6;->b:Ljava/lang/CharSequence;
    ...
    invoke-direct {v0, v1, p0, p1}, Lhn;-><init>(ILandroid/view/View;Ljava/lang/Object;)V

    iput-object v0, p0, Lub6;->c:Lhn;
    ...
    invoke-virtual {p0}, Lub6;->getTypography()Ly2i;
    ...
    iput-object p1, p0, Lub6;->d:Landroid/text/TextPaint;

    const p1, 0x7fffffff

    iput p1, p0, Lub6;->z0:I
    ...
    invoke-virtual {p0, p1}, Lub6;->onThemeChanged(Lrmc;)V
...
.method public final a(ILjava/lang/CharSequence;)Landroid/text/Layout;
    ...
    invoke-static {p2}, Lhbb;->l(Ljava/lang/CharSequence;)Lw3h;
    ...
    iget-object v1, p0, Lub6;->a:Lmx8;

    iget-object v3, p0, Lub6;->d:Landroid/text/TextPaint;
...
.method public final b(I)V
    ...
    iget-object v0, p0, Lub6;->o:Landroid/text/SpannableString;
    ...
    :cond_0
    invoke-virtual {p0, p1, v0}, Lub6;->a(ILjava/lang/CharSequence;)Landroid/text/Layout;

    move-result-object v1

    iput-object v1, p0, Lub6;->C0:Landroid/text/Layout;

    invoke-virtual {v1}, Landroid/text/Layout;->getLineCount()I

    move-result v1

    iget v2, p0, Lub6;->z0:I

    if-gt v1, v2, :cond_1

    iget-object p1, p0, Lub6;->C0:Landroid/text/Layout;
    ...
    iget-object v3, p0, Lub6;->b:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Lub6;->d:Landroid/text/TextPaint;
    ...
    :cond_6
    invoke-static {v7, v0}, Lhkh;->f1(ILjava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v1, p0, v4}, Lt5k;-><init>(Ljava/lang/Object;I)V

    new-instance v4, Landroid/text/SpannableStringBuilder;

    invoke-static {v0}, Li35;->i0(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    :goto_5
    iput-object p1, p0, Lub6;->B0:Landroid/text/Layout;

    iget-boolean v0, p0, Lub6;->F0:Z
    ...
    :cond_8
    iput-object p1, p0, Lub6;->A0:Landroid/text/Layout;
...
.method public final c()V
    ...
    invoke-virtual {p0, v0}, Lub6;->b(I)V

    const/4 v0, 0x1

    iput-boolean v0, p0, Lub6;->D0:Z
    ...
    :cond_0
    iget-object v0, p0, Lub6;->H0:Lg01;
    ...
    invoke-direct {v0, p0, v1}, Lg01;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, Lub6;->H0:Lg01;

    invoke-virtual {p0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iget-object v1, p0, Lub6;->H0:Lg01;
...
.method public final getTextLayout()Landroid/text/Layout;
    ...
    iget-object v0, p0, Lub6;->A0:Landroid/text/Layout;

    return-object v0
.end method

.method public final getTypography()Ly2i;
    .locals 2

    sget-object v0, Lub6;->I0:[Lbv8;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lub6;->c:Lhn;
...
.method public final onMeasure(II)V
    ...
    iget-object p2, p0, Lub6;->G0:Ljava/lang/Integer;
    ...
    :cond_0
    iget-object p2, p0, Lub6;->A0:Landroid/text/Layout;
...
.method public final onSizeChanged(IIII)V
    ...
    invoke-direct {p1, p0, p2}, Ljc5;-><init>(Ljava/lang/Object;I)V
...
.method public final onThemeChanged(Lrmc;)V
    ...
    iget-object v0, p0, Lub6;->d:Landroid/text/TextPaint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lub6;->o:Landroid/text/SpannableString;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v1, p0, Lub6;->A0:Landroid/text/Layout;
    ...
    invoke-static {v2, v5, v1}, Lzf2;->x(FFI)I
...
.method public final setText(Landroid/text/SpannableString;)V
    ...
    .line 1
    iput-object p1, p0, Lub6;->o:Landroid/text/SpannableString;
...
.method public final setText(Ljava/lang/CharSequence;)V
    ...
    .line 6
    invoke-static {v0, v1, p1}, Lot7;->w(IILjava/lang/CharSequence;)Landroid/text/Spannable;
    ...
    .line 10
    iput-boolean p1, p0, Lub6;->F0:Z

    .line 11
    iput-boolean p1, p0, Lub6;->D0:Z
