...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lfuh;->J0:Ljava/util/ArrayList;
    ...
    sput-object v1, Lfuh;->K0:Ljava/util/ArrayList;
...
.method public constructor <init>(Landroid/content/Context;Lv5a;)V
    ...
    iput-object v0, p0, Lfuh;->H0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lfuh;->I0:Ljava/util/ArrayList;

    iput-object p2, p0, Lfuh;->z0:Lguh;
    ...
    iput-object p2, p0, Lfuh;->A0:Ljava/lang/Object;
    ...
    invoke-direct {v1, v0}, Lf6a;-><init>(Lfuh;)V

    iput-object v1, p0, Lfuh;->B0:Ljava/lang/Object;

    new-instance v0, Ld6a;

    invoke-direct {v0, p0}, Ld6a;-><init>(Lc6a;)V

    iput-object v0, p0, Lfuh;->C0:Ld6a;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v0, Lqqe;->mr_user_route_category_name:I
    ...
    iput-object p1, p0, Lfuh;->D0:Landroid/media/MediaRouter$RouteCategory;

    invoke-virtual {p0}, Lfuh;->v()V

    return-void
.end method

.method public static n(Ljava/lang/Object;)Leuh;
    .locals 1
...
.method public final a(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-static {p1}, Lfuh;->n(Ljava/lang/Object;)Leuh;

    move-result-object p1

    if-eqz p1, :cond_0

    iget-object p1, p1, Leuh;->a:Lz5a;
...
.method public final b(Landroid/media/MediaRouter$RouteInfo;I)V
    ...
    invoke-virtual {p1, p2}, Lz5a;->k(I)V
...
.method public final d(Ljava/lang/String;)Lo5a;
    ...
    invoke-virtual {p0, p1}, Lfuh;->k(Ljava/lang/String;)I

    move-result p1

    if-ltz p1, :cond_0

    iget-object v0, p0, Lfuh;->H0:Ljava/util/ArrayList;
    ...
    iget-object p1, p1, Lduh;->a:Ljava/lang/Object;

    invoke-direct {v0, p1}, Lcuh;-><init>(Ljava/lang/Object;)V
...
.method public final f(Lx4a;)V
    ...
    iget-object v1, p1, Lx4a;->b:Lr5a;

    invoke-virtual {v1}, Lr5a;->b()Ljava/util/ArrayList;
    ...
    :goto_2
    iget v1, p0, Lfuh;->E0:I

    if-ne v1, v0, :cond_5

    iget-boolean v1, p0, Lfuh;->F0:Z
    ...
    :cond_5
    :goto_3
    iput v0, p0, Lfuh;->E0:I

    iput-boolean p1, p0, Lfuh;->F0:Z
...
.method public final i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lfuh;->j(Ljava/lang/Object;)I

    move-result v0

    if-gez v0, :cond_5

    invoke-virtual {p0}, Lfuh;->m()Landroid/media/MediaRouter$RouteInfo;

    move-result-object v0

    const-string v1, ""

    iget-object v2, p0, Lp5a;->a:Landroid/content/Context;
    ...
    :goto_1
    invoke-virtual {p0, v0}, Lfuh;->k(Ljava/lang/String;)I
    ...
    invoke-static {v3, v0, v4}, Lhb2;->k(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0, v4}, Lfuh;->k(Ljava/lang/String;)I
    ...
    invoke-direct {v3, p1, v0}, Lduh;-><init>(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    :cond_3
    invoke-direct {v4, v0, v1}, Li89;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v3, v4}, Lfuh;->o(Lduh;Li89;)V

    invoke-virtual {v4}, Li89;->A()Lv4a;

    move-result-object p1

    iput-object p1, v3, Lduh;->c:Lv4a;

    iget-object p1, p0, Lfuh;->H0:Ljava/util/ArrayList;
...
.method public final j(Ljava/lang/Object;)I
    ...
    iget-object v3, v3, Lduh;->a:Ljava/lang/Object;
...
.method public final k(Ljava/lang/String;)I
    ...
    iget-object v3, v3, Lduh;->b:Ljava/lang/String;
...
.method public final l(Lz5a;)I
    .locals 4

    iget-object v0, p0, Lfuh;->I0:Ljava/util/ArrayList;
...
.method public o(Lduh;Li89;)V
    ...
    sget-object v2, Lfuh;->J0:Ljava/util/ArrayList;

    invoke-virtual {p2, v2}, Li89;->y(Ljava/util/List;)V
    ...
    sget-object v1, Lfuh;->K0:Ljava/util/ArrayList;

    invoke-virtual {p2, v1}, Li89;->y(Ljava/util/List;)V
...
.method public final p(Lz5a;)V
    ...
    iget-object v1, p0, Lfuh;->A0:Ljava/lang/Object;

    if-eq v0, p0, :cond_0

    check-cast v1, Landroid/media/MediaRouter;

    iget-object v0, p0, Lfuh;->D0:Landroid/media/MediaRouter$RouteCategory;
    ...
    invoke-direct {v2, p1, v0}, Leuh;-><init>(Lz5a;Landroid/media/MediaRouter$UserRouteInfo;)V

    invoke-virtual {v0, v2}, Landroid/media/MediaRouter$RouteInfo;->setTag(Ljava/lang/Object;)V

    iget-object p1, p0, Lfuh;->C0:Ld6a;
    ...
    invoke-virtual {p0, v2}, Lfuh;->w(Leuh;)V

    iget-object p1, p0, Lfuh;->I0:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Lfuh;->j(Ljava/lang/Object;)I

    move-result v0

    if-ltz v0, :cond_1

    iget-object v1, p0, Lfuh;->H0:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lduh;->b:Ljava/lang/String;
...
.method public final q(Lz5a;)V
    ...
    invoke-virtual {p0, p1}, Lfuh;->l(Lz5a;)I
    ...
    iget-object p1, p1, Leuh;->b:Ljava/lang/Object;
    ...
    iget-object v0, p0, Lfuh;->A0:Ljava/lang/Object;
...
.method public final r(Lz5a;)V
    ...
    invoke-virtual {p0, p1}, Lfuh;->t(Ljava/lang/Object;)V
...
.method public final s()V
    ...
    invoke-direct {v0, v2, v3}, Lq5a;-><init>(Ljava/util/ArrayList;Z)V
...
.method public final v()V
    ...
    invoke-virtual {p0, v1}, Lfuh;->i(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lfuh;->s()V

    :cond_2
    return-void
.end method

.method public w(Leuh;)V
    .locals 3

    iget-object v0, p1, Leuh;->b:Ljava/lang/Object;

    iget-object v1, p1, Leuh;->a:Lz5a;

    iget-object v2, v1, Lz5a;->d:Ljava/lang/String;
