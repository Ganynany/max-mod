...
.method public static g(Lxv3;I[B)Landroid/os/MemoryFile;
    .locals 8
    ...
    invoke-direct {v1, v4}, Lhod;-><init>(Llfa;)V
    :try_end_0
    ...
    invoke-direct {v4, v1, p1}, Lr09;-><init>(Ljava/io/InputStream;I)V
    :try_end_1
    ...
    invoke-static {v1}, Lzv3;->b(Ljava/io/InputStream;)V

    invoke-static {v4}, Lzv3;->b(Ljava/io/InputStream;)V

    invoke-static {v3}, Lzv3;->a(Ljava/io/Closeable;)V
    ...
    invoke-static {p2}, Lzv3;->a(Ljava/io/Closeable;)V
...
# virtual methods
.method public final c(Lxv3;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-virtual {p0, p1, v0, v1, p2}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lxv3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final d(Lxv3;ILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    invoke-static {p2, p1}, Lcom/facebook/imagepipeline/nativecode/DalvikPurgeableDecoder;->e(ILxv3;)Z
    ...
    :goto_0
    invoke-virtual {p0, p1, p2, v0, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->h(Lxv3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method public final h(Lxv3;I[BLandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 1

    const/4 v0, 0x0

    :try_start_0
    invoke-static {p1, p2, p3}, Lcom/facebook/imagepipeline/platform/GingerbreadPurgeableDecoder;->g(Lxv3;I[B)Landroid/os/MemoryFile;
    ...
    invoke-static {p2, p3}, Ld2c;->p(Ljava/lang/Object;Ljava/lang/String;)V
    :try_end_1
    ...
    :goto_0
    :try_start_3
    invoke-static {p2}, Lxal;->c(Ljava/lang/Throwable;)V
...
.method public final i(Landroid/os/MemoryFile;)Ljava/io/FileDescriptor;
    ...
    :try_start_3
    invoke-static {p1}, Lxal;->c(Ljava/lang/Throwable;)V
