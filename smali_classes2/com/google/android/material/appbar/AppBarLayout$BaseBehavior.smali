...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lkij;-><init>(I)V
...
.method public static K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;IIZ)V
    .locals 7
    ...
    invoke-virtual {p1, p2}, Liq;->g(Landroid/view/View;)Z

    move-result v3

    :cond_4
    invoke-virtual {p1, v3}, Liq;->f(Z)Z
    ...
    iget-object p0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Ly1c;

    iget-object p0, p0, Ly1c;->d:Ljava/lang/Object;

    check-cast p0, Lzwg;

    invoke-virtual {p0, p1}, Lzwg;->get(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;II[II)V
    .locals 6
    ...
    invoke-virtual {p2}, Liq;->getTotalScrollRange()I

    move-result p4

    neg-int p4, p4

    invoke-virtual {p2}, Liq;->getDownNestedPreScrollRange()I
    ...
    :cond_0
    invoke-virtual {p2}, Liq;->getUpNestedPreScrollRange()I
    ...
    :goto_2
    iget-boolean p1, v2, Liq;->F0:Z

    if-eqz p1, :cond_2

    invoke-virtual {v2, p3}, Liq;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {v2, p1}, Liq;->f(Z)Z

    :cond_2
    return-void
.end method

.method public C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;IIIII[I)V
    .locals 6

    if-gez p7, :cond_0

    invoke-virtual {p2}, Liq;->getDownNestedScrollRange()I
    ...
    invoke-static {v1}, Ljhj;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {p1, p0, v2, v1}, Ldq;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Liq;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, p1}, Ljhj;->m(Landroid/view/View;Ld5;)V
...
.method public D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;Landroid/view/View;II)Z
    .locals 0
...
.method public E(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;I)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {p0, p1, p2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;)V

    iget-boolean p1, p2, Liq;->F0:Z

    if-eqz p1, :cond_1

    invoke-virtual {p2, p3}, Liq;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p2, p1}, Liq;->f(Z)Z
...
.method public final F(Leq;Z)V
    .locals 1

    iget-object v0, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Leq;
    ...
    :cond_1
    :goto_0
    iput-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Leq;

    return-void
.end method

.method public final G(Landroid/os/Parcelable;Liq;)Leq;
    .locals 7
    ...
    invoke-virtual {p2}, Liq;->getTopInset()I
...
.method public final H(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    invoke-static/range {p3 .. p5}, Ld2c;->t(III)I

    move-result v2

    if-eq v4, v2, :cond_d

    iget-boolean v6, v3, Liq;->o:Z
    ...
    iget-object v11, v10, Lgq;->c:Landroid/view/animation/Interpolator;
    ...
    invoke-virtual {v3}, Liq;->getTopInset()I
    ...
    :goto_2
    invoke-virtual {v0, v8}, Lkij;->v(I)Z
    ...
    iget-object v11, v10, Lgq;->b:Lm4k;

    if-eqz v11, :cond_7

    iget v10, v10, Lgq;->a:I
    ...
    invoke-virtual {v0}, Lkij;->t()I

    move-result v12

    int-to-float v12, v12

    iget-object v13, v11, Lm4k;->c:Ljava/lang/Object;

    check-cast v13, Landroid/graphics/Rect;

    iget-object v11, v11, Lm4k;->b:Ljava/lang/Object;
    ...
    invoke-static {v15, v12, v8}, Ld2c;->s(FFF)F
    ...
    iget-object v6, v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b:Ly1c;

    iget-object v6, v6, Ly1c;->d:Ljava/lang/Object;

    check-cast v6, Lzwg;

    invoke-virtual {v6, v3}, Lzwg;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v10, v1, v9, v3}, Lds4;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v3, v6}, Liq;->d(I)V
    ...
    :goto_7
    invoke-static {v1, v3, v2, v8, v5}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;IIZ)V
    ...
    invoke-direct {v2, v0, v3, v1}, Ldq;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Liq;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {v1, v2}, Ljhj;->m(Landroid/view/View;Ld5;)V
...
.method public final J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;)V
    .locals 12
    ...
    invoke-static {v8, v0, v3}, Ld2c;->t(III)I

    move-result v0

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;I)V
...
.method public final h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    invoke-super {p0, p1, p2, p3}, Lkij;->h(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z

    invoke-virtual {p2}, Liq;->getPendingAction()I
    ...
    iget-object v3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Leq;

    iget-boolean v3, v3, Leq;->Y:Z
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;I)V
    ...
    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;I)V
    ...
    iput-object p3, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Leq;
    ...
    invoke-static {p3, v0, v1}, Ld2c;->t(III)I

    move-result p3

    invoke-virtual {p0, p3}, Lkij;->v(I)Z

    invoke-virtual {p0}, Lkij;->t()I

    move-result p3

    invoke-static {p1, p2, p3, v1, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->K(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;IIZ)V

    invoke-virtual {p0}, Lkij;->t()I

    move-result p3

    invoke-virtual {p2, p3}, Liq;->d(I)V

    invoke-static {p1}, Ljhj;->c(Landroid/view/View;)Landroid/view/View$AccessibilityDelegate;
    ...
    invoke-direct {p3, p0, p2, p1}, Ldq;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Liq;Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    invoke-static {p1, p3}, Ljhj;->m(Landroid/view/View;Ld5;)V
...
.method public bridge synthetic k(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;II[II)V
    ...
    invoke-virtual/range {p0 .. p7}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->B(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;II[II)V
...
.method public bridge synthetic l(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual/range {p0 .. p9}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->C(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;IIIII[I)V
...
.method public final n(Landroid/view/View;Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, p2, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->F(Leq;Z)V

    iget-object p1, p0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->m:Leq;
...
.method public final o(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-virtual {p0, v0, p1}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->G(Landroid/os/Parcelable;Liq;)Leq;
...
.method public bridge synthetic q(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;Landroid/view/View;II)Z
    ...
    invoke-virtual/range {p0 .. p6}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->D(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;Landroid/view/View;II)Z
...
.method public bridge synthetic r(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->E(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;Landroid/view/View;I)V
...
.method public final s(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1}, Liq;->getDownNestedScrollRange()I

    move-result v3

    neg-int v3, v3

    invoke-virtual {v1}, Liq;->getTopInset()I
    ...
    invoke-virtual {v9}, Liq;->getTotalScrollRange()I

    move-result v10

    neg-int v10, v10

    iget-object v11, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lfc;

    if-eqz v11, :cond_5

    invoke-virtual {v4, v11}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iput-object v2, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lfc;
    ...
    invoke-direct {v5, v0, v1, v4}, Lfc;-><init>(Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V

    iput-object v5, v0, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->c:Lfc;
    ...
    :cond_7
    invoke-virtual {v0, v1, v9}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;)V

    iget-boolean v4, v9, Liq;->F0:Z
    ...
    invoke-virtual {v9, v1}, Liq;->g(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v9, v1}, Liq;->f(Z)Z
...
.method public final y(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;I)V
    .locals 5
    ...
    sget-object v3, Lhj;->e:Landroid/view/animation/DecelerateInterpolator;
    ...
    invoke-direct {v3, p0, p1, p2, v4}, Lcq;-><init>(Ljava/lang/Object;Landroid/view/View;Landroid/view/View;I)V
