...
.method public static n0(Landroid/content/Context;)I
    ...
    invoke-static {}, Lqyi;->b()Ljava/util/Calendar;
    ...
    invoke-static {v1}, Lqyi;->a(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    sget v1, Lcie;->mtrl_calendar_day_width:I

    invoke-virtual {p0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    sget v2, Lcie;->mtrl_calendar_month_horizontal_padding:I
...
.method public static o0(Landroid/content/Context;I)Z
    ...
    sget v0, Lhhe;->materialCalendarStyle:I
    ...
    invoke-static {v0, p0, v1}, Lae7;->O(ILandroid/content/Context;Ljava/lang/String;)Landroid/util/TypedValue;
...
.method public final F(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->I1:Lp81;
...
.method public final H(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    sget p3, Lrne;->mtrl_picker_fullscreen:I

    goto :goto_0

    :cond_0
    sget p3, Lrne;->mtrl_picker_dialog:I
    ...
    sget p3, Ltje;->mtrl_calendar_frame:I
    ...
    :cond_1
    sget p3, Ltje;->mtrl_calendar_main_pane:I
    ...
    :goto_1
    sget p3, Ltje;->mtrl_picker_header_selection_text:I
    ...
    sget p3, Ltje;->mtrl_picker_header_toggle:I
    ...
    sget p3, Ltje;->mtrl_picker_title_text:I
    ...
    sget v3, Lkje;->material_ic_calendar_black_24dp:I

    invoke-static {p2, v3}, Lxw8;->B(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v4, Lkje;->material_ic_edit_black_24dp:I

    invoke-static {p2, v4}, Lxw8;->B(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final T(Landroid/os/Bundle;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->I1:Lp81;
    ...
    iget-object v3, v2, Lp81;->a:Le7b;

    iget-wide v3, v3, Le7b;->X:J

    iget-object v5, v2, Lp81;->b:Le7b;

    iget-wide v5, v5, Le7b;->X:J

    iget-object v7, v2, Lp81;->d:Le7b;

    iget-wide v7, v7, Le7b;->X:J

    invoke-static {v7, v8}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v7

    iput-object v7, v0, Lo81;->a:Ljava/lang/Long;

    iget v13, v2, Lp81;->o:I

    iget-object v2, v2, Lp81;->c:Le25;
    ...
    :cond_0
    iget-object v7, v7, Lcom/google/android/material/datepicker/MaterialCalendar;->r1:Le7b;
    ...
    invoke-static {v3, v4}, Le7b;->b(J)Le7b;

    move-result-object v9

    invoke-static {v5, v6}, Le7b;->b(J)Le7b;
    ...
    iget-object v0, v0, Lo81;->a:Ljava/lang/Long;
    ...
    invoke-static {v2, v3}, Le7b;->b(J)Le7b;
    ...
    :goto_1
    invoke-direct/range {v8 .. v13}, Lp81;-><init>(Le7b;Le7b;Le25;Le7b;I)V
...
.method public final U()V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->Y1:Lnn9;
    ...
    sget v2, Ltje;->fullscreen_header:I
    ...
    invoke-static {v9, v10, v8}, Lmb8;->x(IILandroid/content/Context;)I
    ...
    :cond_3
    invoke-static {v0, v6}, Lvni;->Z(Landroid/view/Window;Z)V
    ...
    invoke-static {v3, v10, v7}, Lmb8;->x(IILandroid/content/Context;)I

    move-result v3

    const/16 v7, 0x80

    invoke-static {v3, v7}, Liz3;->i(II)I
    ...
    invoke-direct {v11, v7}, Lwz5;-><init>(Landroid/view/View;)V
    ...
    new-instance v7, Lc8k;

    invoke-direct {v7, v0, v11}, Lc8k;-><init>(Landroid/view/Window;Lwz5;)V
    ...
    invoke-direct {v7, v0, v11}, Lb8k;-><init>(Landroid/view/Window;Lwz5;)V

    goto :goto_5

    :cond_7
    new-instance v7, La8k;

    invoke-direct {v7, v0, v11}, La8k;-><init>(Landroid/view/Window;Lwz5;)V

    :goto_5
    invoke-virtual {v7, v2}, Lso4;->R(Z)V

    if-eqz v8, :cond_8

    invoke-static {v8}, Liz3;->e(I)D
    ...
    invoke-direct {v3, v1, v2, v0}, Lt0d;-><init>(Landroid/view/View;II)V

    sget-object v0, Ljhj;->a:Ljava/util/WeakHashMap;

    invoke-static {v1, v3}, Lzgj;->l(Landroid/view/View;Lx0c;)V
    ...
    sget v6, Lcie;->mtrl_calendar_dialog_background_inset:I
    ...
    iget-object v8, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->Y1:Lnn9;
    ...
    invoke-direct {v6, v7, v3}, Loh8;-><init>(Landroid/app/Dialog;Landroid/graphics/Rect;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->I1:Lp81;
...
.method public final k0()Landroid/app/Dialog;
    ...
    sget v4, Lhhe;->materialCalendarStyle:I

    sget v5, Lbse;->Widget_MaterialComponents_MaterialCalendar:I

    invoke-direct {v2, v1, v3, v4, v5}, Lnn9;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->Y1:Lnn9;

    sget-object v2, Lmse;->MaterialCalendar:[I
    ...
    sget v3, Lmse;->MaterialCalendar_backgroundTint:I
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/MaterialDatePicker;->Y1:Lnn9;

    invoke-virtual {v2, v1}, Lnn9;->i(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v2}, Lnn9;->k(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2}, Lzgj;->e(Landroid/view/View;)F

    move-result v2

    invoke-virtual {v1, v2}, Lnn9;->j(F)V
