...
.method public final b(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcp4;->r(Landroid/os/Bundle;)Z
    ...
    invoke-direct {v4, v0}, Lcp4;-><init>(Landroid/os/Bundle;)V
    ...
    iput-object v5, v8, Li89;->a:Ljava/lang/Object;

    iput-object p0, v8, Li89;->b:Ljava/lang/Object;

    iput-object v4, v8, Li89;->c:Ljava/lang/Object;

    :try_start_0
    invoke-virtual {v8}, Li89;->H()Z
    ...
    invoke-static {p1}, Ltrk;->g(Landroid/content/Intent;)Z
    ...
    invoke-static {v4, v5}, Ltrk;->e(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-direct {v4, v0}, Li8f;-><init>(Landroid/os/Bundle;)V

    invoke-virtual {p0, v4}, Lcom/google/firebase/messaging/FirebaseMessagingService;->d(Li8f;)V
    ...
    :cond_10
    :goto_4
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->X:Ltjf;
    ...
    invoke-direct {v0, v4}, Ltjf;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->X:Ltjf;

    :cond_11
    iget-object v0, p0, Lcom/google/firebase/messaging/FirebaseMessagingService;->X:Ltjf;

    iget-object v4, v0, Ltjf;->c:Lt0d;

    invoke-virtual {v4}, Lt0d;->u()I
    ...
    :cond_14
    iget-object p1, v0, Ltjf;->b:Landroid/content/Context;
    ...
    invoke-direct {v0, v1, v6, v4, v7}, Lcbl;-><init>(IILandroid/os/Bundle;I)V
