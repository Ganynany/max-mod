...
# virtual methods
.method public final a(Lbb9;Lqx0;)V
    .locals 6

    iget-object v0, p0, Lrx0;->a:Leb7;
    ...
    invoke-direct {v4, v0}, Lql0;-><init>(Landroidx/fragment/app/c;)V

    const/4 v5, 0x0

    invoke-virtual {v4, v5, v2, v1, v3}, Lql0;->f(ILandroidx/fragment/app/a;Ljava/lang/String;I)V

    invoke-virtual {v4, v3}, Lql0;->d(Z)I
    ...
    iput-object p1, v1, Landroidx/biometric/BiometricViewModel;->c:Lbb9;
    ...
    iput-object p1, v1, Landroidx/biometric/BiometricViewModel;->d:Lqx0;

    goto :goto_1

    :cond_4
    iput-object p2, v1, Landroidx/biometric/BiometricViewModel;->d:Lqx0;
    ...
    sget p2, Ljpe;->confirm_device_credential_password:I
    ...
    invoke-direct {p2, v0}, Lhal;-><init>(Landroid/content/Context;)V

    invoke-direct {p1, p2}, Li89;-><init>(Lhal;)V

    const/16 p2, 0xff

    invoke-virtual {p1, p2}, Li89;->B(I)I
    ...
    invoke-direct {p2, v2}, Lmx0;-><init>(Landroidx/biometric/BiometricFragment;)V
