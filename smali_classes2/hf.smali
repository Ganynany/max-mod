...
.method public constructor <init>(Lq6f;)V
    ...
    iput-object v0, p0, Lhf;->b:Ljava/lang/ref/WeakReference;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v2, v0, Lhf;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object v3, v2, Lq6f;->h:Landroid/util/SparseArray;

    iget-object v4, v2, Lq6f;->i:Lv6f;

    iget-object v5, v4, Lv6f;->B0:Ljava/util/ArrayList;
    ...
    :pswitch_0
    iget-object v3, v4, Lv6f;->E0:Lq6f;
    ...
    :cond_1
    iget-object v2, v4, Lv6f;->G0:Lv5d;

    if-eqz v2, :cond_2

    instance-of v3, v12, Lo5a;
    ...
    iget-object v2, v2, Lpc2;->d:Ljava/lang/Object;

    check-cast v2, Lw6f;

    check-cast v2, Lv5a;

    iget-object v6, v2, Lv5a;->s:Lo5a;

    if-ne v6, v3, :cond_2

    invoke-virtual {v2}, Lv5a;->c()Lz5a;

    move-result-object v3

    const/4 v6, 0x2

    invoke-virtual {v2, v3, v6}, Lv5a;->g(Lz5a;I)V

    :cond_2
    invoke-virtual {v5, v12}, Ljava/util/ArrayList;->remove(Ljava/lang/Object;)Z

    invoke-interface {v12}, Lr6f;->c()V

    invoke-virtual {v4}, Lv6f;->o()V
    ...
    invoke-direct {v3, v1}, Lv4a;-><init>(Landroid/os/Bundle;)V
    ...
    invoke-direct {v10, v9}, Lv4a;-><init>(Landroid/os/Bundle;)V
    ...
    new-instance v15, Lm5a;

    invoke-direct/range {v15 .. v20}, Lm5a;-><init>(Lv4a;IZZZ)V
    ...
    :cond_7
    iget-object v1, v4, Lv6f;->E0:Lq6f;
    ...
    :cond_a
    instance-of v1, v12, Lt6f;

    if-eqz v1, :cond_16

    check-cast v12, Lt6f;

    invoke-virtual {v12, v3, v6}, Ln5a;->l(Lv4a;Ljava/util/ArrayList;)V
    ...
    invoke-virtual {v2, v9}, Ls6f;->b(Landroid/os/Bundle;)V
    ...
    invoke-static {v2, v9}, Ls6f;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-static {v9}, Lq5a;->b(Landroid/os/Bundle;)Lq5a;

    move-result-object v1

    invoke-virtual {v4, v2, v1}, Lv6f;->l(Lq6f;Lq5a;)V
    ...
    invoke-static {v12, v9}, Ls6f;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {v2, v3}, Lr6f;->b(Lq6f;)V
    ...
    :cond_12
    iget-object v1, v4, Lp5a;->o:Lx4a;

    if-eqz v1, :cond_16

    iget-object v5, v4, Lv6f;->E0:Lq6f;
    ...
    iget-object v9, v1, Lx4a;->a:Landroid/os/Bundle;
    ...
    invoke-static {v12, v12}, Ls6f;->a(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    iget-object v3, v0, Lhf;->b:Ljava/lang/ref/WeakReference;
