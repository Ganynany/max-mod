...
.method public final afterTextChanged(Landroid/text/Editable;)V
    ...
    sget-object v2, Lone/me/profileedit/screens/reactions/ProfileReactionsSettingsScreen;->G0:[Lbv8;

    invoke-virtual {v6}, Lone/me/profileedit/screens/reactions/ProfileReactionsSettingsScreen;->V0()Lm6e;

    move-result-object v2

    iget-object v6, v2, Lm6e;->D0:Lv9h;

    invoke-virtual {v6}, Lv9h;->getValue()Ljava/lang/Object;

    move-result-object v7

    instance-of v8, v7, Lu83;
    ...
    invoke-direct {v9, v10}, Lkw;-><init>(I)V

    invoke-static {v5}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object v10

    invoke-virtual {v9, v10}, Lkw;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v9, v13}, Lkw;->add(Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v9}, Lgy3;->b1(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {v2, v7}, Lm6e;->w(Lu83;)Z

    move-result v12

    iget-object v0, v7, Lu83;->c:Ljava/util/List;
    ...
    iget-object v1, v7, Lu83;->d:Ljava/lang/Object;
    ...
    invoke-static/range {v7 .. v13}, Lu83;->a(Lu83;ZILjava/util/List;ZZI)Lu83;
    ...
    :goto_a
    invoke-virtual {v6, v4}, Lv9h;->setValue(Ljava/lang/Object;)V
    ...
    :cond_e
    invoke-interface {v6, v4}, Lre7;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v1, v6, Lgic;->d:Ljava/lang/CharSequence;

    iget-object v0, v6, Lgic;->M0:Ljava/lang/Object;
    ...
    :cond_11
    iget-object v0, v6, Lgic;->A0:Lcic;

    if-eqz v0, :cond_12

    invoke-interface {v0, v1}, Lcic;->S(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v6, Lru/ok/messages/media/mediabar/MediaBarPreviewLayout;->Z0:Liq9;
    ...
    iget-object v0, v6, Lru/ok/messages/media/mediabar/MediaBarPreviewLayout;->X0:Laa9;
    ...
    invoke-direct {v0, v6, v1, v6, v2}, Lfc;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-static {v6, v0}, Lkoc;->a(Landroid/view/View;Ljava/lang/Runnable;)Lkoc;
...
.method public final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-virtual {v3}, Lylc;->getEndIconDrawable()Lpx8;

    move-result-object p2

    invoke-static {v3, p2}, Lylc;->b(Lylc;Lpx8;)V

    invoke-virtual {v3}, Lylc;->getMaxLengthForLabel()I
    ...
    :cond_0
    invoke-static {v3, p2, v2}, Lylc;->c(Lylc;II)V

    invoke-static {v3}, Lylc;->a(Lylc;)V

    iget-object p1, v3, Lylc;->a:Lj9c;

    invoke-virtual {v3}, Lylc;->getTypingMode()Lwlc;

    move-result-object p2

    sget-object p3, Lwlc;->b:Lwlc;
    ...
    iget-object p3, v3, Lylc;->d:Ljava/lang/Object;
    ...
    invoke-interface {v3, p1, p2, p3, p4}, Ljf7;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p2, Lone/me/devmenu/logsviewer/LogsViewerScreen;->Y:[Lbv8;

    invoke-virtual {v3}, Lone/me/devmenu/logsviewer/LogsViewerScreen;->U0()Lfg9;
    ...
    new-instance p4, Leg9;

    invoke-direct {p4, p2, p1, v1}, Leg9;-><init>(Lfg9;Ljava/lang/CharSequence;Lkotlin/coroutines/Continuation;)V

    iget-object p1, p2, Lwhj;->a:Lkotlinx/coroutines/internal/ContextScope;

    sget-object v0, Ljt4;->b:Ljt4;

    invoke-static {p1, p3, v0, p4}, Lkve;->E(Lgt4;Lxs4;Ljt4;Lff7;)Lm6h;

    move-result-object p1

    iget-object p3, p2, Lfg9;->z0:Lwz5;

    sget-object p4, Lfg9;->B0:[Lbv8;

    aget-object p4, p4, v2

    invoke-virtual {p3, p2, p4, p1}, Lwz5;->z(Ljava/lang/Object;Lbv8;Ljava/lang/Object;)V

    invoke-virtual {p2}, Lfg9;->v()V

    goto :goto_1

    :cond_3
    :goto_0
    iget-object p1, p2, Lfg9;->z0:Lwz5;

    sget-object p3, Lfg9;->B0:[Lbv8;

    aget-object p3, p3, v2

    invoke-virtual {p1, p2, p3, v1}, Lwz5;->z(Ljava/lang/Object;Lbv8;Ljava/lang/Object;)V

    iget-object p1, p2, Lfg9;->Z:Lv9h;
    ...
    :goto_2
    iget-object p2, p2, Lt8d;->A0:Lv9h;
