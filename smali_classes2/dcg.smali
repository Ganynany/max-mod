...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ldcg;->j:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;Lfi2;Lbcg;Landroid/hardware/camera2/params/InputConfiguration;ILzi0;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Ldcg;->a:Ljava/util/ArrayList;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ldcg;->c:Ljava/util/List;

    invoke-static {p3}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ldcg;->d:Ljava/util/List;

    invoke-static {p4}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Ldcg;->e:Ljava/util/List;

    iput-object p6, p0, Ldcg;->f:Lbcg;

    iput-object p5, p0, Ldcg;->g:Lfi2;

    iput-object p7, p0, Ldcg;->i:Landroid/hardware/camera2/params/InputConfiguration;

    iput p8, p0, Ldcg;->h:I

    iput-object p9, p0, Ldcg;->b:Lzi0;
...
.method public static a()Ldcg;
    ...
    iget-object v6, v8, Lrvh;->a:Landroid/util/ArrayMap;
    ...
    invoke-direct {v6, v3}, Lrvh;-><init>(Landroid/util/ArrayMap;)V
...
.method public final b()Ljava/util/List;
    ...
    iget-object v3, v2, Lzi0;->a:Lje5;

    invoke-virtual {v0, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v2, v2, Lzi0;->b:Ljava/util/List;
