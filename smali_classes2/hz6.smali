...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lhz6;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    return-void
.end method

.method public constructor <init>(Lua2;Lqr7;Lk7g;Lov8;)V
    .locals 4
    ...
    iput-boolean v0, p0, Lhz6;->d:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lhz6;->e:Landroid/util/Rational;
    ...
    iput-object v2, p0, Lhz6;->h:Ljava/lang/Integer;

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lhz6;->k:J

    iput-boolean v0, p0, Lhz6;->l:Z
    ...
    iput-object v1, p0, Lhz6;->o:Lez6;

    sget-object v2, Lhz6;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Lhz6;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Lhz6;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v2, p0, Lhz6;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lhz6;->s:Ls62;

    iput-boolean v0, p0, Lhz6;->t:Z

    iput-object v1, p0, Lhz6;->u:Lgz6;

    iput-object p1, p0, Lhz6;->a:Lua2;

    iput-object p3, p0, Lhz6;->b:Lk7g;

    iput-object p2, p0, Lhz6;->c:Lqr7;

    new-instance p1, Lt8;

    const/16 p2, 0x1b

    invoke-direct {p1, p4, p2}, Lt8;-><init>(Ljava/lang/Object;I)V

    iput-object p1, p0, Lhz6;->f:Lt8;
...
.method public final a(ZZ)V
    ...
    invoke-virtual {v2, p1, v0}, Lxeb;->k(Lgh0;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, p2, v0}, Lmt0;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, p1}, Lfa0;->c(Lm64;)V

    iget-object p1, p0, Lhz6;->a:Lua2;

    invoke-virtual {v1}, Lfa0;->e()Lfi2;
    ...
    invoke-virtual {p1, p2}, Lua2;->A(Ljava/util/List;)V
...
.method public final b()V
    ...
    iget-object v0, p0, Lhz6;->a:Lua2;

    iget-object v1, v0, Lua2;->b:Lsa2;

    iget-object v1, v1, Lsa2;->b:Ljava/lang/Object;
    ...
    iget-object v1, p0, Lhz6;->o:Lez6;

    iget-object v2, v0, Lua2;->b:Lsa2;

    iget-object v2, v2, Lsa2;->b:Ljava/lang/Object;

    check-cast v2, Ljava/util/HashSet;

    invoke-virtual {v2, v1}, Ljava/util/HashSet;->remove(Ljava/lang/Object;)Z

    iget-object v1, p0, Lhz6;->s:Ls62;
    ...
    invoke-virtual {v1, v3}, Ls62;->d(Ljava/lang/Throwable;)Z

    iput-object v2, p0, Lhz6;->s:Ls62;

    :cond_0
    iget-object v1, p0, Lhz6;->i:Ljava/util/concurrent/ScheduledFuture;
    ...
    iput-object v2, p0, Lhz6;->i:Ljava/util/concurrent/ScheduledFuture;

    :cond_1
    iget-object v1, p0, Lhz6;->j:Ljava/util/concurrent/ScheduledFuture;

    if-eqz v1, :cond_2

    invoke-interface {v1, v3}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v2, p0, Lhz6;->j:Ljava/util/concurrent/ScheduledFuture;

    :cond_2
    iget-object v1, p0, Lhz6;->p:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    invoke-virtual {p0, v3, v2}, Lhz6;->a(ZZ)V

    :cond_3
    sget-object v1, Lhz6;->v:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lhz6;->p:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lhz6;->q:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object v1, p0, Lhz6;->r:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-boolean v2, p0, Lhz6;->g:Z
...
.method public final c(Z)Lp69;
    ...
    invoke-static {v0, p1, v3}, Lvl4;->h(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, v0, Lua2;->e:Ltd2;

    const/4 v1, 0x5

    invoke-static {v0, v1}, Lua2;->t(Ltd2;I)I
    ...
    invoke-direct {v0, p0, p1, v1}, Lpc5;-><init>(Ljava/lang/Object;ZI)V
...
.method public final d(Ljava/util/List;ILandroid/util/Rational;Landroid/graphics/Rect;I)Ljava/util/List;
    ...
    iget-object v5, v5, Lu3b;->d:Landroid/util/Rational;
    ...
    iget-object v12, v8, Lhz6;->f:Lt8;

    iget-object v12, v12, Lt8;->b:Ljava/lang/Object;

    check-cast v12, Lov8;

    const-class v13, Landroidx/camera/camera2/internal/compat/quirk/AfRegionFlipHorizontallyQuirk;

    invoke-virtual {v12, v13}, Lov8;->b(Ljava/lang/Class;)Z
...
.method public final e(Ls62;)V
    ...
    invoke-static {v3}, Lnc2;->X(Landroid/hardware/camera2/CaptureRequest$Key;)Lgh0;

    move-result-object v3

    invoke-virtual {v2, v3, v1}, Lxeb;->k(Lgh0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, v0}, Lua2;->A(Ljava/util/List;)V
...
.method public final f(Z)V
    ...
    invoke-virtual {v2, v3, v4}, Lxeb;->k(Lgh0;Ljava/lang/Object;)V

    if-eqz p1, :cond_1

    sget-object p1, Landroid/hardware/camera2/CaptureRequest;->CONTROL_AE_MODE:Landroid/hardware/camera2/CaptureRequest$Key;

    iget-object v3, p0, Lhz6;->a:Lua2;

    iget-object v3, v3, Lua2;->e:Ltd2;

    invoke-static {v3, v1}, Lua2;->t(Ltd2;I)I
    ...
    invoke-virtual {v2, p1, v3, v1}, Lxeb;->j(Lgh0;Ll64;Ljava/lang/Object;)V
    ...
    invoke-direct {p1, v1}, Lki2;-><init>(I)V
