...
.method public final apply(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1}, Lcw;-><init>(Lkw;)V

    :cond_0
    :goto_0
    invoke-virtual {v0}, Lgc8;->hasNext()Z

    move-result v1

    iget-boolean v2, p0, Lda1;->a:Z

    if-eqz v1, :cond_2

    invoke-virtual {v0}, Lgc8;->next()Ljava/lang/Object;
    ...
    invoke-static {v3, v4}, Lvwc;->b(J)Lru/ok/android/externcalls/sdk/id/ParticipantId;

    move-result-object v1

    iget-object v3, p0, Lda1;->b:Lya1;

    if-eqz v2, :cond_1

    invoke-virtual {v3}, Lya1;->f()Lkr4;
