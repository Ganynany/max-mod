...
.method public constructor <init>(Lfv5;)V
    ...
    iput-object v0, p0, Lkc5;->o:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/16 v0, 0x10

    new-array v2, v0, [F

    iput-object v2, p0, Lkc5;->X:[F

    new-array v0, v0, [F

    iput-object v0, p0, Lkc5;->Y:[F

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Lkc5;->Z:Ljava/util/LinkedHashMap;

    iput v1, p0, Lkc5;->z0:I

    iput-boolean v1, p0, Lkc5;->A0:Z

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lkc5;->B0:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lkc5;->b:Landroid/os/HandlerThread;
    ...
    iput-object v1, p0, Lkc5;->d:Landroid/os/Handler;

    new-instance v0, Lqr7;

    invoke-direct {v0, v1}, Lqr7;-><init>(Landroid/os/Handler;)V

    iput-object v0, p0, Lkc5;->c:Lqr7;

    new-instance v0, Ltm5;

    invoke-direct {v0}, Ltm5;-><init>()V

    iput-object v0, p0, Lkc5;->a:Ltm5;

    :try_start_0
    new-instance v0, Lpa5;

    invoke-direct {v0, p0, p1}, Lpa5;-><init>(Lkc5;Lfv5;)V
    ...
    :try_start_1
    invoke-virtual {p1}, Lv62;->get()Ljava/lang/Object;
    :try_end_1
    ...
    invoke-virtual {p0}, Lkc5;->release()V
...
.method public final a(Lrqh;)V
    ...
    iget-object v0, p0, Lkc5;->o:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v1, p1, v2}, Lic5;-><init>(Lrqh;I)V

    invoke-virtual {p0, v0, v1}, Lkc5;->e(Ljava/lang/Runnable;Ljava/lang/Runnable;)V

    return-void
.end method

.method public final b(II)Lp69;
    .locals 1

    new-instance v0, Lna2;

    invoke-direct {v0, p1, p2, p0}, Lna2;-><init>(IILjava/lang/Object;)V
...
.method public final c(Lkqh;)V
    ...
    invoke-direct {v1, p1, v2}, Ljb2;-><init>(Ljava/lang/Object;I)V
...
.method public final d()V
    ...
    iget-boolean v0, p0, Lkc5;->A0:Z

    if-eqz v0, :cond_2

    iget v0, p0, Lkc5;->z0:I

    if-nez v0, :cond_2

    iget-object v0, p0, Lkc5;->Z:Ljava/util/LinkedHashMap;
    ...
    invoke-virtual {v2}, Lkqh;->close()V

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lkc5;->B0:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lkc5;->a:Ltm5;

    invoke-virtual {v0}, Ltm5;->r()V

    iget-object v0, p0, Lkc5;->b:Landroid/os/HandlerThread;
...
.method public final f(Ljava/lang/Exception;)V
    ...
    iget-object v0, p0, Lkc5;->B0:Ljava/util/ArrayList;
...
.method public final g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2}, Lzik;->a([FF)V

    invoke-static {v1}, Lzik;->b([F)V

    move-object/from16 v2, p1

    invoke-static {v2, v0}, Lmfi;->h(Landroid/util/Size;I)Landroid/util/Size;

    move-result-object v0

    move-object/from16 v2, p0

    iget-object v3, v2, Lkc5;->a:Ltm5;
    ...
    invoke-static {v6, v5}, Lnjk;->h(Ljava/lang/String;Z)V
    ...
    invoke-static {v6}, Lrg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v15}, Lrg7;->b(Ljava/lang/String;)V
    ...
    invoke-static/range {v16 .. v16}, Lrg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v7}, Lrg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v8}, Lrg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v9}, Lrg7;->b(Ljava/lang/String;)V
    ...
    iput-object v6, v3, Ltm5;->k:Ljava/lang/Object;
    ...
    iget-object v6, v3, Ltm5;->m:Ljava/lang/Object;

    check-cast v6, Lpg7;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    instance-of v10, v6, Lqg7;
    ...
    invoke-static {v1}, Lrg7;->b(Ljava/lang/String;)V
    ...
    invoke-static {v4}, Lrg7;->b(Ljava/lang/String;)V
...
.method public final h(Lxhi;)V
    ...
    invoke-virtual {p0, p1}, Lkc5;->f(Ljava/lang/Exception;)V
    ...
    :cond_3
    :goto_1
    iget-object v4, p1, Lxhi;->b:Ljava/lang/Object;

    check-cast v4, Landroid/util/Size;

    iget-object v5, p1, Lxhi;->c:Ljava/lang/Object;

    check-cast v5, [F

    invoke-virtual {p0, v4, v5, v9}, Lkc5;->g(Landroid/util/Size;[FI)Landroid/graphics/Bitmap;
    ...
    :cond_5
    iget-object v9, p1, Lxhi;->a:Ljava/lang/Object;
    ...
    iget-object v8, v8, Lih0;->c:Ls62;

    invoke-virtual {v8, v3}, Ls62;->b(Ljava/lang/Object;)Z
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v0, p0, Lkc5;->X:[F

    invoke-virtual {p1, v0}, Landroid/graphics/SurfaceTexture;->getTransformMatrix([F)V

    iget-object v1, p0, Lkc5;->Z:Ljava/util/LinkedHashMap;
    ...
    iget-object v5, p0, Lkc5;->Y:[F

    const/4 v6, 0x1

    invoke-virtual {v3, v5, v0, v6}, Lkqh;->I([F[FZ)V
    ...
    :try_start_0
    iget-object v3, p0, Lkc5;->a:Ltm5;

    invoke-virtual {p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v6

    invoke-virtual {v3, v6, v7, v5, v4}, Ltm5;->u(J[FLandroid/view/Surface;)V
    :try_end_0
    ...
    invoke-static {v7, v8}, Lnjk;->m(Ljava/lang/String;Z)V
    ...
    invoke-static {v2, v6}, Lnjk;->m(Ljava/lang/String;Z)V

    new-instance v2, Lxhi;

    iget-object v3, v3, Lkqh;->d:Landroid/util/Size;
    ...
    invoke-direct {v2, v4, v3, v5}, Lxhi;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    goto :goto_0

    :cond_4
    :try_start_1
    invoke-virtual {p0, v2}, Lkc5;->h(Lxhi;)V
    :try_end_1
...
.method public final release()V
    ...
    invoke-direct {v0, p0, v1}, Ljc5;-><init>(Ljava/lang/Object;I)V
