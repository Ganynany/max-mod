...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Llfk;->V(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    :cond_3
    invoke-virtual {p0, p1, p2, p3}, Llfk;->U(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
    ...
    iget-object p1, p3, Leuk;->f:Lgwk;

    iget-object p1, p1, Lgwk;->a:Lodl;

    if-eqz p1, :cond_9

    iget-object p2, p3, Leuk;->e:Lfzh;

    iget-object p4, p1, Lodl;->f:Ljava/lang/Object;

    monitor-enter p4

    :try_start_0
    iget-object v0, p1, Lodl;->e:Ljava/util/HashSet;
    ...
    invoke-direct {p2, p1, v3}, Lo6l;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1}, Lodl;->a()Landroid/os/Handler;
    ...
    :cond_9
    :goto_6
    iget-object p1, p3, Leuk;->d:Ln1a;

    const-string p2, "onGetLaunchReviewFlowInfo"

    new-array p4, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p4}, Ln1a;->b(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    new-instance p4, Lfhk;

    invoke-direct {p4, p1, p2}, Lfhk;-><init>(Landroid/app/PendingIntent;Z)V

    iget-object p1, p3, Leuk;->e:Lfzh;

    invoke-virtual {p1, p4}, Lfzh;->d(Ljava/lang/Object;)V
    ...
    iget-object p1, p3, Lgal;->f:Lgbl;

    iget-object p1, p1, Lgbl;->a:Lfhl;

    iget-object p2, p3, Lgal;->e:Lfzh;

    invoke-virtual {p1, p2}, Lfhl;->d(Lfzh;)V

    iget-object p1, p3, Lgal;->d:Lhif;

    const-string p2, "onCompleteUpdate"

    new-array p3, v3, [Ljava/lang/Object;

    invoke-virtual {p1, p2, p3}, Lhif;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p1, p4, v2}, Lhif;->a(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, p3}, Lfzh;->c(Ljava/lang/Exception;)Z

    goto/16 :goto_8

    :cond_13
    iget-object p1, p3, Lgal;->g:Lgbl;
    ...
    iget-object p1, p1, Lgbl;->d:Lmdl;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v3, Ljava/io/File;

    iget-object p1, p1, Lmdl;->a:Landroid/content/Context;
    ...
    invoke-static {v3}, Lmdl;->a(Ljava/io/File;)J
    ...
    invoke-direct {p1, v6}, Lxt;-><init>(I)V

    invoke-virtual {p2, p1}, Lfzh;->d(Ljava/lang/Object;)V
    ...
    :cond_1b
    invoke-virtual {p0, p1, p2, p3}, Llfk;->T(ILandroid/os/Parcel;Landroid/os/Parcel;)Z
