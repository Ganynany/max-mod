...
.method public constructor <init>(Le4j;)V
    ...
    iput-object v0, p0, Lh4j;->d:Ljava/util/HashSet;

    iput-object p1, p0, Lh4j;->a:Le4j;

    invoke-interface {p1}, Le4j;->b()I
    ...
    iput-object v1, p0, Lh4j;->b:Landroid/util/Range;

    invoke-interface {p1}, Le4j;->r()I
    ...
    iput-object p1, p0, Lh4j;->c:Landroid/util/Range;
...
.method public static c(Le4j;Landroid/util/Size;)Le4j;
    .locals 4

    instance-of v0, p0, Lh4j;
    ...
    invoke-interface {p0, v0, v1}, Le4j;->a(II)Z

    move-result v0

    if-nez v0, :cond_2

    invoke-interface {p0}, Le4j;->w()Landroid/util/Range;

    move-result-object v0

    invoke-interface {p0}, Le4j;->z()Landroid/util/Range;
    ...
    invoke-direct {v0, p0}, Lh4j;-><init>(Le4j;)V
    ...
    iget-object v0, v0, Lh4j;->d:Ljava/util/HashSet;
...
.method public final o(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lh4j;->c:Landroid/util/Range;

    invoke-virtual {v1, v0}, Landroid/util/Range;->contains(Ljava/lang/Comparable;)Z

    move-result v0

    iget-object v2, p0, Lh4j;->a:Le4j;
    ...
    iget-object p1, p0, Lh4j;->b:Landroid/util/Range;
...
.method public final q(I)Landroid/util/Range;
    ...
    iget-object v1, p0, Lh4j;->b:Landroid/util/Range;
    ...
    iget-object p1, p0, Lh4j;->c:Landroid/util/Range;
...
.method public final w()Landroid/util/Range;
    ...
    iget-object v0, p0, Lh4j;->b:Landroid/util/Range;
...
.method public final x(II)Z
    ...
    invoke-interface {v0, p1, p2}, Le4j;->x(II)Z
    ...
    :cond_0
    iget-object v1, p0, Lh4j;->d:Ljava/util/HashSet;
...
.method public final z()Landroid/util/Range;
    ...
    iget-object v0, p0, Lh4j;->c:Landroid/util/Range;
