...
# direct methods
.method public constructor <init>(Lmci;[ILgo0;JJJLe98;)V
    .locals 0
    ...
    :cond_0
    iput-object p3, p0, Lcb;->g:Lgo0;

    const-wide/16 p1, 0x3e8

    mul-long/2addr p4, p1

    iput-wide p4, p0, Lcb;->h:J

    mul-long/2addr p6, p1

    iput-wide p6, p0, Lcb;->i:J
    ...
    iput-object p1, p0, Lcb;->o:Le98;

    sget-object p1, Llv3;->a:Ljth;

    iput-object p1, p0, Lcb;->p:Ljth;
...
.method public static v([Lmb6;)Lo7f;
    ...
    invoke-direct {v7, v5, v6, v5, v6}, Lab;-><init>(JJ)V
    ...
    :cond_7
    invoke-static {v1, v9}, Lcb;->w(Ljava/util/ArrayList;[J)V
...
.method public static w(Ljava/util/ArrayList;[J)V
    ...
    invoke-direct {v4, v0, v1, v5, v6}, Lab;-><init>(JJ)V
...
.method public final e()V
    ...
    iput-wide v0, p0, Lcb;->t:J

    const/4 v0, 0x0

    iput-object v0, p0, Lcb;->u:Ldt9;
...
.method public final g(JLjava/util/List;)I
    ...
    :cond_4
    invoke-static {p3}, Lcb;->y(Ljava/util/List;)J

    move-result-wide v4

    invoke-virtual {p0, v0, v1, v4, v5}, Lcb;->x(JJ)I
...
.method public final r(JJJLjava/util/List;[Lft9;)V
    ...
    invoke-interface {p2}, Lft9;->next()Z
    ...
    invoke-interface {v3}, Lft9;->next()Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-interface {v3}, Lft9;->e()J

    move-result-wide p1

    invoke-interface {v3}, Lft9;->a()J
    ...
    :cond_2
    invoke-static/range {p7 .. p7}, Lcb;->y(Ljava/util/List;)J
    ...
    invoke-virtual {p0, v0, v1, v2, v3}, Lcb;->x(JJ)I
    ...
    iget-object v4, v4, Lgs3;->d:Ls77;

    invoke-virtual {p0, v4}, Lps0;->s(Ls77;)I
    ...
    invoke-virtual {p0, p2, v0, v1}, Lps0;->q(IJ)Z
...
.method public final x(JJ)I
    ...
    iget-wide v1, v1, Lab;->b:J

    iget-wide v3, v0, Lab;->b:J
