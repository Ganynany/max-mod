...
.method public S(Lhcg;)V
    ...
    iget-object p1, p1, Lhcg;->a:Lgcg;

    invoke-interface {p1}, Lgcg;->e()Landroid/hardware/camera2/CameraCaptureSession$StateCallback;

    move-result-object v1

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {p1}, Lgcg;->f()Ljava/util/List;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-interface {p1}, Lgcg;->c()Ljava/util/concurrent/Executor;
    ...
    iget-object v3, v3, Lktc;->a:Lmtc;

    invoke-virtual {v3}, Lmtc;->b()Ljava/lang/String;
    ...
    invoke-static {v6, v2, v4, v3, v5}, Lhb2;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    const-string v4, "CameraDeviceCompat"

    invoke-static {v4, v3}, Lfte;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v1, v2, v3}, Ljd2;-><init>(Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;)V

    invoke-interface {p1}, Lgcg;->f()Ljava/util/List;

    move-result-object v2

    iget-object v3, p0, Lir;->b:Ljava/lang/Object;

    check-cast v3, Lle2;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v3, v3, Lle2;->a:Landroid/os/Handler;

    invoke-interface {p1}, Lgcg;->b()Lmf8;
    ...
    :try_start_0
    iget-object p1, v4, Lmf8;->a:Lkf8;

    iget-object p1, p1, Lkf8;->a:Landroid/hardware/camera2/params/InputConfiguration;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v2}, Lhcg;->a(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v4, v4, Lktc;->a:Lmtc;

    invoke-virtual {v4}, Lmtc;->c()Landroid/view/Surface;
