...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v6, Ljhe;->checkedTextViewStyle:I
    ...
    iput-object p1, p0, Luq;->c:Lqs;

    invoke-virtual {p1, p2, v6}, Lqs;->f(Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Luq;->b:Lya;

    invoke-virtual {p1, p2, v6}, Lya;->t(Landroid/util/AttributeSet;I)V

    new-instance p1, Lvq;

    invoke-direct {p1, p0}, Lvq;-><init>(Landroid/widget/TextView;)V

    iput-object p1, p0, Luq;->a:Lvq;
    ...
    invoke-static {p1, p2, v0, v6}, Lyn6;->r(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lyn6;
    ...
    sget-object v3, Lbte;->CheckedTextView:[I
    ...
    :try_start_0
    sget p2, Lbte;->CheckedTextView_checkMarkCompat:I
    ...
    invoke-static {v3, p2}, Lxw8;->B(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Luq;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    sget p2, Lbte;->CheckedTextView_android_checkMark:I
    ...
    invoke-static {v2, p2}, Lxw8;->B(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    :goto_0
    sget p2, Lbte;->CheckedTextView_checkMarkTint:I
    ...
    :cond_2
    sget p2, Lbte;->CheckedTextView_checkMarkTintMode:I
    ...
    invoke-static {p2, v0}, Ljr5;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-direct {p0}, Luq;->getEmojiTextViewHelper()Lqr;

    move-result-object p1

    invoke-virtual {p1, v4, v6}, Lqr;->c(Landroid/util/AttributeSet;I)V
...
.method public setCheckMarkDrawable(I)V
    ...
    invoke-virtual {p0, p1}, Luq;->setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
