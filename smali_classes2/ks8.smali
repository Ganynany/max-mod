...
.method public final run()V
    ...
    iget-object v0, p0, Lks8;->b:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lf4f;->a:Lrqh;

    iget-object v2, v0, Lf4f;->b:Ln6i;

    iget-object v3, v0, Lf4f;->g:Lh4f;

    invoke-virtual {v3}, Lh4f;->z()Lp69;

    move-result-object v5

    new-instance v6, Lg0f;

    invoke-direct {v6, v0, v1, v2, v4}, Lg0f;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    iget-object v0, v3, Lh4f;->e:Lk7g;

    invoke-interface {v5, v6, v0}, Lp69;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    :try_start_1
    iget-object v2, v0, Le9e;->b:Ljava/lang/Object;

    check-cast v2, Ljava/net/DatagramSocket;

    invoke-virtual {v2, v4}, Ljava/net/DatagramSocket;->receive(Ljava/net/DatagramPacket;)V

    iget-object v2, v0, Le9e;->e:Ljava/lang/Object;

    check-cast v2, La7;

    invoke-virtual {v2, v4}, La7;->test(Ljava/lang/Object;)Z
    ...
    invoke-direct {v3, v4, v2}, Lbve;-><init>(Ljava/net/DatagramPacket;Ljava/time/Instant;)V

    iget-object v2, v0, Le9e;->g:Ljava/lang/Object;
    ...
    :cond_3
    iget-object v2, v0, Le9e;->c:Ljava/lang/Object;

    check-cast v2, Lgd9;

    const-string v3, "Terminating receive loop"

    invoke-interface {v2, v3}, Lgd9;->debug(Ljava/lang/String;)V
    :try_end_2
    ...
    :goto_1
    iget-object v3, v0, Le9e;->c:Ljava/lang/Object;

    check-cast v3, Lgd9;

    invoke-interface {v3, v1, v2}, Lgd9;->error(Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v0, v0, Le9e;->d:Ljava/lang/Object;

    check-cast v0, Lafe;

    invoke-virtual {v0, v2}, Lafe;->accept(Ljava/lang/Object;)V

    goto :goto_3

    :goto_2
    iget-boolean v3, v0, Le9e;->a:Z
    ...
    :cond_4
    iget-object v0, v0, Le9e;->c:Ljava/lang/Object;
    ...
    iget-object v0, v0, Lowe;->e:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v0, v0, Lete;->b:Lone/me/rlottie/RLottieDrawable;

    :try_start_3
    iget-object v1, v0, Lone/me/rlottie/RLottieDrawable;->y1:Ljz0;

    if-eqz v1, :cond_5

    invoke-virtual {v1}, Ljz0;->b()V
    :try_end_3
    ...
    iget-object v0, v0, Lone/me/rlottie/RLottieDrawable;->x1:Lete;
    ...
    invoke-static {v0}, Lone/me/profileedit/ProfileEditScreen;->U0(Lone/me/profileedit/ProfileEditScreen;)Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {v2, v1, v3, v0}, Ljg7;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    :goto_4
    :try_start_4
    iget-object v1, v0, Ltwc;->f:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Ltwc;->g:Ljava/util/ArrayList;
    ...
    iget-object v3, v0, Ltwc;->h:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Lp1c;->a:Landroid/view/View;

    iget-object v2, v0, Lp1c;->c:Landroid/view/ViewTreeObserver;
    ...
    iget-object v1, v0, Lwcb;->e:Lz5j;

    iget-wide v2, v0, Lwcb;->t:J
    ...
    :try_start_7
    iget-object v0, v0, Lwcb;->c:Lqia;

    invoke-static {}, Lcwc;->o()Landroid/opengl/EGLDisplay;

    move-result-object v1

    invoke-virtual {v0, v1}, Lqia;->v(Landroid/opengl/EGLDisplay;)V
    :try_end_7
    ...
    iget-boolean v5, v3, Landroidx/recyclerview/widget/RecyclerView;->M0:Z
    ...
    iget-object v3, v0, Lcfb;->b:[Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lone/me/keyboardmedia/MediaKeyboardWidget;->U0()V
    ...
    iget-object v0, v0, Ltgj;->b:Landroid/view/View;
    ...
    invoke-virtual {v0}, Lrg9;->g()Landroid/widget/LinearLayout;
    ...
    invoke-virtual {v0}, Lrg9;->e()Lone/me/sdk/richvector/EnhancedAnimatedVectorDrawable;
    ...
    iget-object v0, v0, Lvu5;->o:Ljava/lang/Object;

    check-cast v0, Ljava/util/HashSet;

    iget-object v2, v1, Lhte;->b:Ljava/lang/Object;
    ...
    :try_start_9
    iget-object v0, v1, Lhte;->c:Ljava/lang/Object;
    ...
    iget-object v4, v1, Lhte;->c:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Lhte;->Q(Lsz8;)V
    ...
    invoke-virtual {v3, v0}, Landroid/widget/ScrollView;->fullScroll(I)Z
