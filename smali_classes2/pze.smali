...
# instance fields
.field public final b2:Ll3k;

.field public final c2:Landroid/graphics/drawable/GradientDrawable;


# direct methods
.method public constructor <init>(Landroid/content/Context;Lyi3;)V
    .locals 7
    ...
    invoke-direct {v2, v3}, Lovf;-><init>(Llrf;)V
    ...
    invoke-direct {v1, p2, v2, v3}, Ll3k;-><init>(Ljava/lang/Object;Ljava/util/concurrent/ExecutorService;I)V

    iput-object v1, p0, Lpze;->b2:Ll3k;
    ...
    iput-object p2, p0, Lpze;->c2:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-virtual {p0, v1, v4}, Landroidx/recyclerview/widget/RecyclerView;->j(Lf5f;I)V

    new-instance v1, Lxl5;

    invoke-direct {v1, p1}, Lxl5;-><init>(Landroid/content/Context;)V

    iput-object p2, v1, Lxl5;->c:Ljava/lang/Object;
    ...
    invoke-direct {p1, p2, v0, v1}, Lo2b;-><init>(ILkotlin/coroutines/Continuation;I)V
...
.method public final setContacts(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lpze;->b2:Ll3k;
