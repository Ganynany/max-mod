...
.method public static a(Lr78;)V
    .locals 15

    invoke-static {p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lr78;)Z
    ...
    invoke-static {v1, p0}, Lfte;->c(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_0
    invoke-interface {p0}, Lr78;->getWidth()I

    move-result v10

    invoke-interface {p0}, Lr78;->getHeight()I

    move-result v11

    invoke-interface {p0}, Lr78;->v()[Lq78;
    ...
    invoke-interface {p0}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static b(Lrs9;[B)Lr78;
    .locals 2

    invoke-virtual {p0}, Lrs9;->h()I
    ...
    invoke-virtual {p0}, Lrs9;->getSurface()Landroid/view/Surface;
    ...
    invoke-static {v0, p0}, Lfte;->c(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static c(Lr78;)Landroid/graphics/Bitmap;
    .locals 14

    invoke-interface {p0}, Lr78;->getFormat()I
    ...
    invoke-interface {v1}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static d(Lr78;Lt78;Ljava/nio/ByteBuffer;IZ)Lk58;
    .locals 22

    invoke-static/range {p0 .. p0}, Landroidx/camera/core/ImageProcessingUtil;->h(Lr78;)Z
    ...
    :cond_1
    invoke-interface/range {p1 .. p1}, Lt78;->getSurface()Landroid/view/Surface;

    move-result-object v13

    invoke-interface/range {p0 .. p0}, Lr78;->getWidth()I

    move-result v15

    invoke-interface/range {p0 .. p0}, Lr78;->getHeight()I

    move-result v16

    invoke-interface/range {p0 .. p0}, Lr78;->v()[Lq78;
    ...
    invoke-interface {v7}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    :cond_6
    invoke-interface/range {p1 .. p1}, Lt78;->g()Lr78;
    ...
    invoke-direct {v1, v0}, Lk58;-><init>(Lr78;)V
    ...
    invoke-direct {v2, v0, v4, v3}, Ln78;-><init>(Lr78;Lr78;I)V

    invoke-virtual {v1, v2}, Lq97;->d(Lp97;)V
...
.method public static i(Lr78;Lt78;Landroid/media/ImageWriter;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lk58;
    .locals 25
    ...
    invoke-interface {v10}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v11}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v12}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
...
.method public static j(Lr78;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)Lk58;
    .locals 25
    ...
    invoke-interface {v5}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-interface {v6}, Lq78;->getBuffer()Ljava/nio/ByteBuffer;
    ...
    invoke-static {v0, v1}, Lfte;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct/range {v6 .. v12}, Lp78;-><init>(Lr78;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;II)V

    invoke-direct {v0, v6}, Lk58;-><init>(Lr78;)V
...
.method public static k([BLandroid/view/Surface;)V
    ...
    invoke-static {p0, p1}, Lfte;->c(Ljava/lang/String;Ljava/lang/String;)V
