...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/biometric/FingerprintDialogFragment;->F1:Llh;
...
.method public final F(Landroid/os/Bundle;)V
    ...
    iget-object p1, v4, Landroidx/biometric/BiometricViewModel;->w:Ljeb;
    ...
    iput-object p1, v4, Landroidx/biometric/BiometricViewModel;->w:Ljeb;
    ...
    invoke-direct {v0, p0, v1}, Luq6;-><init>(Landroidx/fragment/app/DialogFragment;I)V
    ...
    iget-object v0, p1, Landroidx/biometric/BiometricViewModel;->x:Ljeb;
    ...
    iput-object v0, p1, Landroidx/biometric/BiometricViewModel;->x:Ljeb;

    :cond_4
    iget-object p1, p1, Landroidx/biometric/BiometricViewModel;->x:Ljeb;
...
.method public final S()V
    ...
    sget v1, Ljpe;->fingerprint_dialog_touch_sensor:I
...
.method public final k0()Landroid/app/Dialog;
    ...
    :goto_0
    invoke-virtual {v0, v1}, Llf;->setTitle(Ljava/lang/CharSequence;)Llf;

    invoke-virtual {v0}, Llf;->getContext()Landroid/content/Context;
    ...
    sget v3, Lnne;->fingerprint_dialog_layout:I

    invoke-virtual {v1, v3, v2}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;)Landroid/view/View;

    move-result-object v1

    sget v3, Ljke;->fingerprint_subtitle:I
    ...
    :cond_2
    :goto_1
    sget v3, Ljke;->fingerprint_description:I
    ...
    :cond_5
    :goto_3
    sget v3, Ljke;->fingerprint_icon:I
    ...
    sget v3, Ljke;->fingerprint_error:I
    ...
    invoke-static {v3}, Lgvk;->a(I)Z

    move-result v3

    if-eqz v3, :cond_6

    sget v2, Ljpe;->confirm_device_credential_password:I
    ...
    :cond_7
    iget-object v3, v3, Landroidx/biometric/BiometricViewModel;->c:Lbb9;

    if-eqz v3, :cond_9

    iget-object v2, v3, Lbb9;->d:Ljava/lang/Object;
    ...
    invoke-direct {v3, p0}, Lux0;-><init>(Landroidx/biometric/FingerprintDialogFragment;)V

    iget-object v4, v0, Llf;->a:Lgf;

    iput-object v2, v4, Lgf;->i:Ljava/lang/CharSequence;

    iput-object v3, v4, Lgf;->j:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v0, v1}, Llf;->setView(Landroid/view/View;)Llf;

    invoke-virtual {v0}, Llf;->create()Lmf;
...
.method public final onCancel(Landroid/content/DialogInterface;)V
    ...
    invoke-static {p1, v0}, Landroidx/biometric/BiometricViewModel;->h(Ljeb;Ljava/lang/Object;)V
