...
.method public constructor <init>(Landroid/content/Context;Lwl4;Lop0;)V
    ...
    invoke-direct {v0, p1}, Lvdc;-><init>(Landroid/content/Context;)V

    invoke-direct {p0, v0}, Lw5f;-><init>(Landroid/view/View;)V

    iput-object p2, p0, Lwm4;->L0:Lwl4;

    iput-object p3, p0, Lwm4;->M0:Lop0;
    ...
    invoke-virtual {v0, p1}, Lvdc;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    new-instance p1, Lmw1;

    const/4 p2, 0x1

    invoke-direct {p1, p0, p2}, Lmw1;-><init>(Ljava/lang/Object;I)V
