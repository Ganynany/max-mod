...
.method public static c(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    sget-object v1, Lfz3;->a:Ljava/lang/ThreadLocal;
    ...
    invoke-static {p1, p0, p2}, Lfz3;->a(Landroid/content/res/Resources;Landroid/content/res/XmlResourceParser;Landroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method public static d(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;I)Lxc7;
    .locals 3
    ...
    invoke-direct {p1, p3, p3, p0}, Lxc7;-><init>(Landroid/graphics/Shader;Landroid/content/res/ColorStateList;I)V
    ...
    :try_start_0
    invoke-static {p1, p0, p2}, Lxc7;->D(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Lxc7;
    ...
    invoke-direct {p0, p3, p3, v0}, Lxc7;-><init>(Landroid/graphics/Shader;Landroid/content/res/ColorStateList;I)V
...
.method public static e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2}, Llcl;->g(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
...
.method public static h(Ljava/lang/String;)Lsl6;
    .locals 2
    ...
    invoke-direct {v0, p0}, Lsl6;-><init>(Ljava/lang/String;)V

    return-object v0

    :cond_2
    :goto_0
    sget-object p0, Lsl6;->c:Lsl6;
