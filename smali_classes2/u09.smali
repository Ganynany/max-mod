...
.method public final b(Landroid/graphics/Canvas;Landroid/graphics/Paint;II)V
    ...
    invoke-static {p3, p4}, Lmb8;->l(II)I

    move-result p3

    iget-object p4, p0, Lxr5;->a:Las0;
    ...
    invoke-virtual/range {v1 .. v7}, Lu09;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V

    :cond_0
    return-void
.end method

.method public final c(Landroid/graphics/Canvas;Landroid/graphics/Paint;Lwr5;I)V
    .locals 9

    iget v0, p3, Lwr5;->c:I

    invoke-static {v0, p4}, Lmb8;->l(II)I
    ...
    invoke-virtual/range {v1 .. v8}, Lu09;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final d(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p5, p6}, Lmb8;->l(II)I
    ...
    invoke-virtual/range {v0 .. v7}, Lu09;->g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
...
.method public final g(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFIII)V
    ...
    invoke-static {p3, v0, v1}, Ld2c;->s(FFF)F

    move-result p3

    move/from16 v2, p4

    invoke-static {v2, v0, v1}, Ld2c;->s(FFF)F
    ...
    invoke-static {v3, v1, p3}, Laib;->O(FFF)F
    ...
    invoke-static {v3, v1, v2}, Laib;->O(FFF)F
    ...
    invoke-static {p3, v0, v4}, Ld2c;->s(FFF)F
    ...
    invoke-static {v2, v6, v1}, Ld2c;->s(FFF)F
    ...
    invoke-virtual/range {v5 .. v11}, Lu09;->h(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/PointF;Landroid/graphics/PointF;FF)V
