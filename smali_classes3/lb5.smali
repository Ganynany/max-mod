...
# static fields
.field public static final j:[Lsej;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lsej;->a:Lsej;

    sget-object v1, Lsej;->b:Lsej;

    filled-new-array {v0, v1}, [Lsej;

    move-result-object v0

    sput-object v0, Llb5;->j:[Lsej;
...
.method public constructor <init>(Liga;Ljte;Lczc;Lil9;)V
    ...
    iput-object p1, p0, Llb5;->f:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Llb5;->g:Ljava/util/HashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Llb5;->h:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Llb5;->i:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final a(Ltt1;Lorg/webrtc/VideoFrame;)V
    ...
    iget-object v0, p0, Llb5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-virtual {v0, p2}, Lvdj;->a(Lorg/webrtc/VideoFrame;)V
...
.method public final d()V
    ...
    invoke-direct {v1, p0, v2}, Lud4;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v2, v0, v1, v3}, Lyek;-><init>(Lmzc;Lxd4;I)V

    const-string v1, "DefaultRemoteVideoTracks.clearRemoteVideoRenderers"

    invoke-virtual {v0, v2, v1}, Lmzc;->j(Ljava/lang/Runnable;Ljava/lang/String;)V
...
.method public final e(Ltt1;Ljava/lang/String;)V
    ...
    invoke-direct {v2, v3, v4}, Lpaa;-><init>(IZ)V

    iput-object v1, v2, Lpaa;->b:Ljava/lang/Object;

    iput-object p1, v2, Lpaa;->a:Ljava/lang/Object;

    invoke-virtual {v2}, Lpaa;->f()Lz42;

    move-result-object v1

    const/4 v2, 0x0

    invoke-virtual {p0, p2, v1, v2}, Llb5;->n(Ljava/lang/String;Lz42;Ljava/util/List;)V
...
.method public final f()V
    ...
    :try_start_0
    iget-object v2, p0, Llb5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iput-object v1, v4, Lvdj;->a:Lorg/webrtc/VideoSink;
...
.method public final n(Ljava/lang/String;Lz42;Ljava/util/List;)V
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Ljb5;-><init>(Llb5;Ljava/lang/String;Lz42;Ljava/util/List;)V
    ...
    invoke-direct {p2, p1, v1, p3}, Lyek;-><init>(Lmzc;Lxd4;I)V

    const-string p3, "DefaultRemoteVideoTracks.setRemoteVideoRenderersOnExecutor"

    invoke-virtual {p1, p2, p3}, Lmzc;->j(Ljava/lang/Runnable;Ljava/lang/String;)V

    return-void
.end method

.method public final p(Ljava/lang/String;Lz42;Ljava/util/List;)V
    .locals 6
    ...
    :try_start_0
    iget-object v3, p0, Llb5;->g:Ljava/util/HashMap;
    ...
    invoke-interface {p1, p3, p2}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v1, p0, Llb5;->f:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-interface {v1, v4, v0}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v4, v1, Lvdj;->a:Lorg/webrtc/VideoSink;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_4
    iget-object p3, p0, Llb5;->h:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Llb5;->h:Ljava/util/concurrent/ConcurrentHashMap;

    invoke-virtual {v1, p1}, Ljava/util/concurrent/ConcurrentHashMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v1, p0, Llb5;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p3, p0, Llb5;->i:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p0, Llb5;->f:Ljava/util/concurrent/ConcurrentHashMap;
