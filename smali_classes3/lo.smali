...
.method public synthetic constructor <init>(Lcom/my/tracker/applifecycle/o/d;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p4, p0, Llo;->d:Ljava/io/Serializable;

    iput-object p5, p0, Llo;->o:Ljava/io/Serializable;

    iput-object p6, p0, Llo;->X:Ljava/io/Serializable;

    return-void
.end method

.method public synthetic constructor <init>(Ljava/lang/String;Llp;Lmo;Lru/ok/android/api/core/ApiInvocationException;Li6f;Li6f;)V
    .locals 0
...
.method public c(Lqo;)Lqo;
    ...
    iget-object v1, v1, Lmo;->c:Lnp;

    iget-object v2, p0, Llo;->d:Ljava/io/Serializable;

    check-cast v2, Lru/ok/android/api/core/ApiInvocationException;

    iget-object v3, p0, Llo;->o:Ljava/io/Serializable;

    check-cast v3, Li6f;

    iget-object v4, p0, Llo;->X:Ljava/io/Serializable;

    check-cast v4, Li6f;

    iget-object v5, p1, Lqo;->c:Ljava/lang/String;

    iget-object v6, p0, Llo;->a:Ljava/lang/String;
    ...
    iget-object v6, p1, Lqo;->a:Ljava/lang/String;

    iget-object p1, p1, Lqo;->b:Ljava/lang/String;

    const/4 v7, 0x0

    invoke-direct {v5, v6, p1, v7, v7}, Lqo;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sget-object v6, Llp;->d:Llp;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    if-eq v0, v6, :cond_7

    sget-object v7, Llp;->c:Llp;
    ...
    :cond_2
    :try_start_1
    iget-object v5, p1, Lqo;->b:Ljava/lang/String;
    ...
    :cond_4
    invoke-interface {v1, p1}, Lnp;->i(Lqo;)Lqo;
    ...
    :goto_2
    iget-object v5, v1, Lqo;->c:Ljava/lang/String;
...
.method public invoke(Lcom/my/tracker/core/EngineCore$InsertEventTools;)[B
    ...
    iget-object v0, p0, Llo;->d:Ljava/io/Serializable;

    move-object v4, v0

    check-cast v4, Ljava/lang/String;

    iget-object v0, p0, Llo;->o:Ljava/io/Serializable;

    move-object v5, v0

    check-cast v5, Ljava/lang/String;

    iget-object v0, p0, Llo;->X:Ljava/io/Serializable;
