...
.field public final f:Lm6g;

.field public final g:Lgd9;
...
# direct methods
.method public constructor <init>(ILkkf;Lrmb;Lm6g;Lgd9;)V
    .locals 16
    ...
    iput-object v0, v2, Ls4f;->e:[Ldh9;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object v0, v2, Ls4f;->l:Ljava/lang/Object;
    ...
    iput-boolean v10, v2, Ls4f;->p:Z

    iput-object v1, v2, Ls4f;->a:Ljava/time/Clock;
    ...
    iput-object v3, v2, Ls4f;->c:Lkkf;

    move-object/from16 v4, p3

    iput-object v4, v2, Ls4f;->d:Lrmb;
    ...
    iget-object v14, v2, Ls4f;->e:[Ldh9;
    ...
    invoke-direct {v5, v7, v10}, Ln4f;-><init>(Lm6g;I)V

    invoke-interface {v8}, Lgd9;->getQLog()Ltce;

    move-result-object v6

    invoke-direct/range {v0 .. v6}, Ldh9;-><init>(Ljava/time/Clock;Ls4f;Lkkf;Lrmb;Ln4f;Ltce;)V
    ...
    :cond_0
    iput-object v7, v2, Ls4f;->f:Lm6g;

    iput-object v8, v2, Ls4f;->g:Lgd9;

    new-instance v0, Lyy4;

    const-string v1, "loss-detection"

    invoke-direct {v0, v1, v10}, Lyy4;-><init>(Ljava/lang/String;I)V
    ...
    iput-object v0, v2, Ls4f;->h:Ljava/util/concurrent/ScheduledExecutorService;

    iget-object v1, v2, Ls4f;->l:Ljava/lang/Object;
    ...
    iput-object v0, v2, Ls4f;->k:Ljava/util/concurrent/ScheduledFuture;
    ...
    invoke-interface {v8, v0}, Lgd9;->recovery(Ljava/lang/String;)V
...
# virtual methods
.method public final a(Ljava/util/function/Function;)Lqia;
    .locals 7
    ...
    invoke-direct {v2, v4, v6, v5}, Lqia;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    goto :goto_1

    :cond_0
    iget-object v6, v2, Lqia;->c:Ljava/lang/Object;
...
.method public final b(Laid;)Ljava/util/List;
    .locals 2

    iget-object v0, p0, Ls4f;->e:[Ldh9;
    ...
    iget-object p1, p1, Ldh9;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object p1, p1, Lgfe;->c:Ljava/util/ArrayList;
...
.method public final c()Lqia;
    .locals 15

    iget-object v0, p0, Ls4f;->c:Lkkf;

    invoke-virtual {v0}, Lkkf;->b()I

    move-result v0

    iget-object v1, p0, Ls4f;->c:Lkkf;
    ...
    invoke-direct {v0, v2, v3, v1}, Lqia;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v11, p0, Ls4f;->e:[Ldh9;
    ...
    iget-object v11, v11, Ldh9;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sget-object v11, Laid;->c:Laid;

    if-ne v10, v11, :cond_2

    iget v12, p0, Ls4f;->o:I

    invoke-static {v12}, Lhb2;->G(I)I

    move-result v12

    if-ge v12, v2, :cond_2

    iget-object v10, p0, Ls4f;->g:Lgd9;

    const-string v11, "getPtoTimeAndSpace is skipping level App, because handshake not yet confirmed!"

    invoke-interface {v10, v11}, Lgd9;->recovery(Ljava/lang/String;)V
    ...
    iget v11, p0, Ls4f;->j:I

    iget v12, p0, Ls4f;->m:I
    ...
    iget-object v11, v11, Ldh9;->k:Ljava/time/Instant;
    ...
    invoke-direct {v1, v9, v2, v0}, Lqia;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final d(I)V
    ...
    invoke-static {p1}, Lvl4;->p(I)Ljava/lang/String;
    ...
    invoke-interface {v0, p1}, Lgd9;->recovery(Ljava/lang/String;)V

    invoke-virtual {p0}, Ls4f;->k()V
...
.method public final e()V
    ...
    iget-object v0, p0, Ls4f;->n:Ljava/time/Instant;
    ...
    :cond_0
    iget-object v1, p0, Ls4f;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Ls4f;->g:Lgd9;

    iget-object v2, p0, Ls4f;->a:Ljava/time/Clock;
    ...
    invoke-interface {v1, v0}, Lgd9;->warn(Ljava/lang/String;)V

    iget-object v0, p0, Ls4f;->n:Ljava/time/Instant;

    invoke-virtual {p0, v0}, Ls4f;->i(Ljava/time/Instant;)V
    ...
    invoke-interface {v0, v2, v1}, Lgd9;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
    ...
    invoke-virtual {p0, v0}, Ls4f;->a(Ljava/util/function/Function;)Lqia;
    ...
    invoke-virtual {v0}, Ldh9;->b()V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Ls4f;->h(Z)V

    iget-object v0, p0, Ls4f;->f:Lm6g;
    ...
    invoke-interface {v0}, Lgd9;->logRecovery()Z
    ...
    iget-object v3, p0, Ls4f;->c:Lkkf;

    invoke-virtual {v3}, Lkkf;->b()I
    ...
    invoke-interface {v1, v2, v0}, Lgd9;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
    ...
    iget-object v2, p0, Ls4f;->c:Lkkf;

    invoke-virtual {v2}, Lkkf;->b()I
    ...
    invoke-interface {v0, v1}, Lgd9;->recovery(Ljava/lang/String;)V
    ...
    :cond_7
    iget-object v1, v1, Lqia;->b:Ljava/lang/Object;

    check-cast v1, Laid;

    invoke-virtual {p0, v1, v0}, Ls4f;->j(Laid;I)V
    ...
    invoke-virtual {p0, v0, v1}, Ls4f;->j(Laid;I)V
...
.method public final h(Z)V
    ...
    iget-object v0, p0, Ls4f;->d:Lrmb;

    iget-wide v0, v0, Lrmb;->c:J

    iget-object v0, p0, Ls4f;->d:Lrmb;

    iget-wide v0, v0, Lrmb;->b:J

    if-eqz p1, :cond_0

    iget-object p1, p0, Ls4f;->g:Lgd9;
...
.method public final i(Ljava/time/Instant;)V
    ...
    :try_start_0
    iget-object v0, p0, Ls4f;->l:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v1, p0, Ls4f;->k:Ljava/util/concurrent/ScheduledFuture;

    const/4 v2, 0x0

    invoke-interface {v1, v2}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object p1, p0, Ls4f;->n:Ljava/time/Instant;
    ...
    iget-object p1, p0, Ls4f;->h:Ljava/util/concurrent/ScheduledExecutorService;

    new-instance v3, Lo4f;

    const/4 v4, 0x0

    invoke-direct {v3, p0, v4}, Lo4f;-><init>(Ls4f;I)V
    ...
    iput-object p1, p0, Ls4f;->k:Ljava/util/concurrent/ScheduledFuture;
...
.method public final j(Laid;I)V
    .locals 5
    ...
    invoke-interface {v1, v0}, Lgd9;->recovery(Ljava/lang/String;)V

    new-instance v0, Lp4f;

    const/4 v1, 0x0

    invoke-direct {v0, p0, p1, v1}, Lp4f;-><init>(Ls4f;Laid;I)V

    invoke-static {v0, p2}, Ls4f;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-virtual {p0, v0}, Ls4f;->b(Laid;)Ljava/util/List;
    ...
    invoke-direct {v0, p0, p1, v1}, Lq4f;-><init>(Ls4f;Ljava/util/List;I)V
    ...
    invoke-interface {v1, p1}, Lgd9;->recovery(Ljava/lang/String;)V

    new-instance p1, Lo4f;

    const/4 v0, 0x1

    invoke-direct {p1, p0, v0}, Lo4f;-><init>(Ls4f;I)V

    invoke-static {p1, p2}, Ls4f;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-virtual {p0, p1}, Ls4f;->b(Laid;)Ljava/util/List;
    ...
    invoke-direct {v1, p0, p1, v0, v2}, Lg0f;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    invoke-static {v1, p2}, Ls4f;->g(Ljava/lang/Runnable;I)V
    ...
    invoke-direct {p1, p0, v1, v0}, Lm4f;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final k()V
    ...
    invoke-virtual {p0, v2}, Ls4f;->a(Ljava/util/function/Function;)Lqia;
    ...
    iget-object v2, v2, Lqia;->c:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v2}, Ls4f;->i(Ljava/time/Instant;)V
    ...
    iget-object v0, p0, Ls4f;->k:Ljava/util/concurrent/ScheduledFuture;

    invoke-interface {v0, v5}, Ljava/util/concurrent/Future;->cancel(Z)Z

    iput-object v3, p0, Ls4f;->n:Ljava/time/Instant;
    ...
    :cond_4
    iget-object v3, v6, Lqia;->c:Ljava/lang/Object;

    check-cast v3, Ljava/time/Instant;

    invoke-virtual {p0, v3}, Ls4f;->i(Ljava/time/Instant;)V

    invoke-interface {v1}, Lgd9;->logRecovery()Z

    move-result v5

    if-eqz v5, :cond_7

    iget-object v5, p0, Ls4f;->a:Ljava/time/Clock;
    ...
    iget-object v6, v6, Lqia;->b:Ljava/lang/Object;
    ...
    invoke-interface {v1, v0, v3}, Lgd9;->recovery(Ljava/lang/String;Ljava/time/Instant;)V
