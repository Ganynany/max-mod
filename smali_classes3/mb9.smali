...
# direct methods
.method public constructor <init>(Lpx8;Lpx8;Lpx8;Lpx8;Ljava/lang/String;Z)V
    .locals 0

    invoke-direct {p0}, Lwhj;-><init>()V

    iput-object p5, p0, Lmb9;->b:Ljava/lang/String;

    iput-boolean p6, p0, Lmb9;->c:Z

    iput-object p1, p0, Lmb9;->d:Lpx8;

    iput-object p2, p0, Lmb9;->o:Lpx8;

    iput-object p3, p0, Lmb9;->X:Lpx8;

    iput-object p4, p0, Lmb9;->Y:Lpx8;
    ...
    iput-object p1, p0, Lmb9;->Z:Ljava/util/List;
    ...
    iput-object p1, p0, Lmb9;->z0:Lv9h;

    new-instance p2, Ljye;

    invoke-direct {p2, p1}, Ljye;-><init>(Lffb;)V

    iput-object p2, p0, Lmb9;->A0:Ljye;
    ...
    iput-object p1, p0, Lmb9;->B0:Ljava/lang/String;
    ...
    invoke-direct {p2, p0, p3}, Ljb9;-><init>(Lmb9;Lkotlin/coroutines/Continuation;)V
...
.method public final u()Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Lmb9;->B0:Ljava/lang/String;
    ...
    iget-object v3, v0, Lmb9;->Z:Ljava/util/List;
    ...
    invoke-virtual {v9, v10, v11}, Li06;->e(ILjava/lang/CharSequence;)Landroid/text/Spannable;
    ...
    invoke-static {v12, v14}, Lvni;->f0(CLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {v8, v15}, Lv2i;-><init>(Ljava/lang/CharSequence;)V

    iget-boolean v12, v0, Lmb9;->c:Z

    if-eqz v12, :cond_4

    new-instance v12, Lajg;

    iget-object v14, v0, Lmb9;->b:Ljava/lang/String;

    if-nez v14, :cond_3

    iget-object v14, v0, Lmb9;->d:Lpx8;
    ...
    invoke-virtual {v14}, Lnvf;->n()Ljava/lang/String;

    move-result-object v14

    :cond_3
    invoke-static {v6, v14}, Ld2c;->e(Ljava/lang/Object;Ljava/lang/Object;)Z

    move-result v6

    invoke-direct {v12, v6, v13}, Lajg;-><init>(ZZ)V
    ...
    :cond_7
    invoke-direct {v15, v9}, Lzx8;-><init>(Ljava/lang/CharSequence;)V

    new-instance v14, Lrzf;

    move-object/from16 v16, v8

    move-wide/from16 v17, v10

    invoke-direct/range {v14 .. v20}, Lrzf;-><init>(Lzx8;Lv2i;JLajg;I)V
...
.method public final v()V
    ...
    iget-object v0, p0, Lmb9;->B0:Ljava/lang/String;

    const-string v1, "reinitSession"

    invoke-static {v0, v1}, Lgbb;->k(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lmb9;->X:Lpx8;
    ...
    invoke-direct {v1, p0, v2}, Llb9;-><init>(Lmb9;Lkotlin/coroutines/Continuation;)V
...
.method public final w(J)V
    ...
    iget-object v1, p0, Lmb9;->Z:Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, Lnvf;->F(Ljava/lang/String;)V

    iget-object p1, p0, Lmb9;->z0:Lv9h;

    invoke-virtual {p0}, Lmb9;->u()Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Lmb9;->B0:Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lnvf;->n()Ljava/lang/String;
