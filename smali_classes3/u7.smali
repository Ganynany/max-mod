...
.method public final run()V
    ...
    invoke-virtual {v2, v1}, Lru/ok/messages/media/mediabar/ActLocalMedias;->b0(Z)V
    ...
    iget-object v4, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->n1:Lfa9;

    invoke-virtual {v3, v4}, Lg3a;->l(Lfa9;)V
    ...
    iget-object v4, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->o1:Lfa9;

    invoke-virtual {v3, v4}, Lg3a;->l(Lfa9;)V

    :cond_2
    iget-object v3, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->c1:Lw1a;
    ...
    :cond_4
    iget-object v2, v2, Lru/ok/messages/media/mediabar/ActLocalMedias;->c1:Lw1a;

    iget-wide v3, v0, Lx99;->b:J

    invoke-virtual {v2, v3, v4}, Lw1a;->J(J)Lru/ok/messages/media/mediabar/FrgLocalMedia;
    ...
    iget-object v2, v0, Lru/ok/messages/media/mediabar/FrgLocalVideo;->H1:Ldgb;
    ...
    :cond_5
    iget-object v0, v0, Lru/ok/messages/media/mediabar/FrgLocalVideo;->F1:Lfa9;

    iget-object v3, v0, Lfa9;->b:Ln96;
    ...
    :cond_7
    iget v1, v3, Ln96;->B0:I

    :goto_2
    iget v2, v3, Ln96;->C0:I

    iget-object v0, v0, Lfa9;->e:Lj3;

    if-eqz v0, :cond_8

    invoke-interface {v0, v4, v1, v2}, Le3a;->l(III)V
