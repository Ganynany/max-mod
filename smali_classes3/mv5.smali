...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lso4;->s(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p1

    iput-object p1, p0, Lmv5;->b:Landroid/graphics/Path;
    ...
    iput-object v1, p0, Lmv5;->c:Landroid/graphics/Paint;

    new-instance v0, Landroid/graphics/RectF;

    invoke-direct {v0}, Landroid/graphics/RectF;-><init>()V

    iput-object v0, p0, Lmv5;->d:Landroid/graphics/RectF;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lmv5;->o:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Path;

    invoke-direct {v0, p1}, Landroid/graphics/Path;-><init>(Landroid/graphics/Path;)V

    iput-object v0, p0, Lmv5;->z0:Landroid/graphics/Path;
...
.method public final getStrokeWidthPx()F
    ...
    sget-object v0, Lmv5;->A0:[Lbv8;

    const/4 v1, 0x0

    aget-object v0, v0, v1

    iget-object v0, p0, Lmv5;->a:Lhn;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lmv5;->b:Landroid/graphics/Path;

    iget-object v2, p0, Lmv5;->d:Landroid/graphics/RectF;
    ...
    iget-object v8, p0, Lmv5;->o:Landroid/graphics/Matrix;
    ...
    iget-object v11, p0, Lmv5;->c:Landroid/graphics/Paint;
    ...
    :cond_0
    iget-object v0, p0, Lmv5;->z0:Landroid/graphics/Path;
