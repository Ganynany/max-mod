...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lwe;->s:Ljava/nio/charset/Charset;

    return-void
.end method

.method public constructor <init>(Lu0j;ILgd9;I)V
    .locals 0
    ...
    .line 3
    iput-boolean p4, p0, Lwe;->p:Z

    .line 4
    iput p2, p0, Lwe;->a:I

    .line 5
    iput-object p3, p0, Lwe;->b:Lgd9;

    .line 6
    iput-object p1, p0, Lwe;->c:Lu0j;

    return-void
.end method

.method public constructor <init>(Lu0j;[BILgd9;)V
    .locals 2
    ...
    :goto_0
    invoke-virtual {p0}, Lwe;->i()S

    move-result v1

    invoke-virtual {p0, p2, v0, v1}, Lwe;->m([BLjava/lang/String;S)[B

    move-result-object p2

    .line 14
    invoke-static {p3}, Ll0f;->q(I)Ljava/lang/String;
    ...
    invoke-interface {p4, p3, p2}, Lgd9;->secret(Ljava/lang/String;[B)V

    .line 15
    invoke-virtual {p0, p2, p1, p1}, Lwe;->f([BZZ)V
...
.method public final a([B)[B
    ...
    invoke-static {}, Lt30;->l()V

    invoke-static {p1, v3}, Lt30;->k(I[B)Ljavax/crypto/spec/ChaCha20ParameterSpec;

    move-result-object p1

    new-instance v3, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v4, p0, Lwe;->j:[B
    ...
    :pswitch_0
    iget-object v0, p0, Lwe;->k:Ljavax/crypto/Cipher;
    ...
    iput-object v0, p0, Lwe;->k:Ljavax/crypto/Cipher;

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lwe;->j:[B

    const-string v3, "AES"

    invoke-direct {v0, v2, v3}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    iget-object v2, p0, Lwe;->k:Ljavax/crypto/Cipher;
...
.method public final b([B[B[B)[B
    ...
    :try_start_0
    invoke-virtual {p0}, Lwe;->k()Ljavax/crypto/Cipher;
    ...
    invoke-virtual {p0}, Lwe;->l()Ljavax/crypto/spec/SecretKeySpec;
...
.method public final declared-synchronized d(Z)V
    ...
    invoke-virtual {p0, v3, v1, v2}, Lwe;->m([BLjava/lang/String;S)[B

    move-result-object v1

    iput-object v1, p0, Lwe;->e:[B

    iget-object v1, p0, Lwe;->b:Lgd9;
    ...
    iget-object v2, p0, Lwe;->e:[B

    invoke-interface {v1, v0, v2}, Lgd9;->secret(Ljava/lang/String;[B)V

    iget-object v0, p0, Lwe;->e:[B

    const/4 v1, 0x0

    invoke-virtual {p0, v0, v1, p1}, Lwe;->f([BZZ)V

    if-eqz p1, :cond_2

    iget-object p1, p0, Lwe;->e:[B

    iput-object p1, p0, Lwe;->d:[B
...
.method public final declared-synchronized e([B)V
    ...
    invoke-virtual {p0, p1, v0, v0}, Lwe;->f([BZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final f([BZZ)V
    ...
    invoke-virtual {p0}, Lwe;->j()S

    move-result v2

    invoke-virtual {p0, p1, v1, v2}, Lwe;->m([BLjava/lang/String;S)[B
    ...
    iput-object v1, p0, Lwe;->f:[B

    iput-object v2, p0, Lwe;->l:Ljavax/crypto/spec/SecretKeySpec;

    goto :goto_1

    :cond_1
    iput-object v1, p0, Lwe;->g:[B

    iput-object v2, p0, Lwe;->m:Ljavax/crypto/spec/SecretKeySpec;

    :goto_1
    iget v2, p0, Lwe;->a:I

    invoke-static {v2}, Ll0f;->q(I)Ljava/lang/String;
    ...
    iget-object v4, p0, Lwe;->b:Lgd9;

    invoke-interface {v4, v3, v1}, Lgd9;->secret(Ljava/lang/String;[B)V
    ...
    invoke-virtual {p0, p1, v1, v3}, Lwe;->m([BLjava/lang/String;S)[B

    move-result-object v1

    if-eqz p3, :cond_2

    iput-object v1, p0, Lwe;->h:[B

    goto :goto_2

    :cond_2
    iput-object v1, p0, Lwe;->i:[B
    ...
    invoke-interface {v4, p3, v1}, Lgd9;->secret(Ljava/lang/String;[B)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lwe;->m([BLjava/lang/String;S)[B

    move-result-object p1

    iput-object p1, p0, Lwe;->j:[B
    ...
    iget-object p2, p0, Lwe;->j:[B

    invoke-interface {v4, p1, p2}, Lgd9;->secret(Ljava/lang/String;[B)V
...
.method public final declared-synchronized g()V
    ...
    iput-object v0, p0, Lwe;->d:[B

    iget-object v0, p0, Lwe;->g:[B

    iput-object v0, p0, Lwe;->f:[B

    const/4 v0, 0x0

    iput-object v0, p0, Lwe;->l:Ljavax/crypto/spec/SecretKeySpec;

    iget-object v1, p0, Lwe;->i:[B
    ...
    iput-object v0, p0, Lwe;->e:[B

    const/4 v1, 0x0

    iput-boolean v1, p0, Lwe;->p:Z

    iput-object v0, p0, Lwe;->g:[B

    iput-object v0, p0, Lwe;->i:[B

    iget-object v0, p0, Lwe;->q:Lwe;
    ...
    invoke-virtual {v0, v2}, Lwe;->d(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final k()Ljavax/crypto/Cipher;
    ...
    iget-object v0, p0, Lwe;->n:Ljavax/crypto/Cipher;
    ...
    iput-object v0, p0, Lwe;->n:Ljavax/crypto/Cipher;
    :try_end_0
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljavax/crypto/NoSuchPaddingException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final l()Ljavax/crypto/spec/SecretKeySpec;
    ...
    iget-object v0, p0, Lwe;->m:Ljavax/crypto/spec/SecretKeySpec;

    if-nez v0, :cond_0

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lwe;->g:[B

    invoke-direct {v0, v2, v1}, Ljavax/crypto/spec/SecretKeySpec;-><init>([BLjava/lang/String;)V

    iput-object v0, p0, Lwe;->m:Ljavax/crypto/spec/SecretKeySpec;
    ...
    :cond_1
    iget-object v0, p0, Lwe;->l:Ljavax/crypto/spec/SecretKeySpec;

    if-nez v0, :cond_2

    new-instance v0, Ljavax/crypto/spec/SecretKeySpec;

    iget-object v2, p0, Lwe;->f:[B
...
.method public final m([BLjava/lang/String;S)[B
    ...
    sget-object v1, Lwe;->s:Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p2, p1, v0, p3}, Llh5;->f([B[BI)[B
