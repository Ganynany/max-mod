...
# virtual methods
.method public a(Lujf;Ljava/lang/Throwable;)V
    .locals 2
    ...
    iget-object p1, p0, Lzi5;->b:Laj5;

    iget-object p1, p1, Laj5;->a:Ljte;
    ...
    iget-object p2, p1, Laj5;->a:Ljte;

    const-string v0, "DisplayLayouts"

    const-string v1, "Resend next time after error"

    invoke-interface {p2, v0, v1}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V

    const/4 p2, 0x1

    iput-boolean p2, p1, Laj5;->e:Z
...
.method public b(Lujf;Lekf;)V
    ...
    :pswitch_0
    iget-object p1, p2, Ltsi;->a:Ljava/util/Map;
