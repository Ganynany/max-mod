...
.method private getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    iget-object v0, p0, Lfx5;->d:Landroid/graphics/Matrix;

    iget-object v1, p0, Lfx5;->B0:[F
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lfx5;->D0:Landroid/graphics/Rect;
    ...
    :cond_0
    iget-object v0, p0, Lfx5;->a:Ljava/util/ArrayList;
    ...
    invoke-interface {v1, p1}, Lxw5;->draw(Landroid/graphics/Canvas;)V
...
.method public getResultBounds()Landroid/graphics/Rect;
    ...
    :goto_0
    iget-boolean v1, p0, Lfx5;->E0:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Lfx5;->F0:Ldx5;
...
.method public final onScale(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object v2, p0, Lfx5;->d:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, v0, v1, p1}, Landroid/graphics/Matrix;->postScale(FFFF)Z

    iget-object v0, p0, Lfx5;->z0:Ljava/lang/Float;

    if-eqz v0, :cond_0

    iget-object v3, p0, Lfx5;->A0:Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lfx5;->o:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Lfx5;->z0:Ljava/lang/Float;

    invoke-static {p1}, Ljava/lang/Float;->valueOf(F)Ljava/lang/Float;

    move-result-object p1

    iput-object p1, p0, Lfx5;->A0:Ljava/lang/Float;
...
.method public final onScaleBegin(Landroid/view/ScaleGestureDetector;)Z
    ...
    iget-object p1, p0, Lfx5;->c:Lex5;

    if-eqz p1, :cond_1

    check-cast p1, Lbx5;

    iget-object v0, p1, Lbx5;->c:Lgx5;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lgx5;->f()Lyb;

    move-result-object v0

    iget-object v1, p1, Lbx5;->a:Lfx5;

    invoke-virtual {v0, v1}, Lyb;->a(Lzw5;)V

    :cond_0
    const/4 v0, 0x0

    iput-object v0, p1, Lbx5;->c:Lgx5;
...
.method public final onScaleEnd(Landroid/view/ScaleGestureDetector;)V
    ...
    iget-object v3, p0, Lfx5;->B0:[F

    const/4 p1, 0x0

    iput-object p1, p0, Lfx5;->z0:Ljava/lang/Float;

    iput-object p1, p0, Lfx5;->A0:Ljava/lang/Float;

    invoke-direct {p0}, Lfx5;->getCorrectionMatrix()Landroid/graphics/Matrix;
    ...
    invoke-direct {v0, p0, v4, v3, v2}, Lzj;-><init>(Ljava/lang/Object;Ljava/lang/Object;ZI)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lfx5;->E0:Z

    const/4 v1, 0x1

    if-eqz v0, :cond_3

    iget-object v0, p0, Lfx5;->F0:Ldx5;
    ...
    :cond_1
    iget-object v0, p0, Lfx5;->c:Lex5;

    if-eqz v0, :cond_2

    check-cast v0, Lbx5;

    invoke-virtual {v0, p1}, Lbx5;->d(Landroid/view/MotionEvent;)V
    ...
    :cond_3
    :goto_0
    iget-object v0, p0, Lfx5;->b:Landroid/view/ScaleGestureDetector;
...
.method public setBoundingListener(Ldx5;)V
    .locals 0

    iput-object p1, p0, Lfx5;->F0:Ldx5;
...
.method public setBounds(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Lfx5;->D0:Landroid/graphics/Rect;
...
.method public setDrawStickerEnabled(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Lfx5;->E0:Z

    iget-object v0, p0, Lfx5;->F0:Ldx5;

    if-eqz v0, :cond_1

    invoke-interface {v0, p1}, Ldx5;->setDrawStickerEnabled(Z)V
...
.method public setListener(Lex5;)V
    .locals 0

    iput-object p1, p0, Lfx5;->c:Lex5;
