...
# static fields
.field public static final B0:Lhh7;
...
.method public constructor <init>(ZZZZLjava/util/List;ZZZ)V
    ...
    iput-boolean p1, p0, Lhh7;->a:Z

    iput-boolean p2, p0, Lhh7;->b:Z

    iput-boolean p3, p0, Lhh7;->c:Z

    iput-boolean p4, p0, Lhh7;->d:Z

    iput-object p5, p0, Lhh7;->o:Ljava/util/List;

    iput-boolean p6, p0, Lhh7;->X:Z

    iput-boolean p7, p0, Lhh7;->Y:Z

    iput-boolean p8, p0, Lhh7;->Z:Z

    xor-int/lit8 p1, p2, 0x1

    iput-boolean p1, p0, Lhh7;->z0:Z

    xor-int/lit8 p1, p8, 0x1

    iput-boolean p1, p0, Lhh7;->A0:Z
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    iget-boolean v1, p0, Lhh7;->a:Z

    iget-boolean v3, p1, Lhh7;->a:Z
    ...
    :cond_5
    iget-object v1, p0, Lhh7;->o:Ljava/util/List;

    iget-object v3, p1, Lhh7;->o:Ljava/util/List;
    ...
    :cond_6
    iget-boolean v1, p0, Lhh7;->X:Z

    iget-boolean v3, p1, Lhh7;->X:Z
    ...
    :cond_7
    iget-boolean v1, p0, Lhh7;->Y:Z

    iget-boolean v3, p1, Lhh7;->Y:Z
    ...
    :cond_8
    iget-boolean v1, p0, Lhh7;->Z:Z

    iget-boolean p1, p1, Lhh7;->Z:Z
...
.method public final hashCode()I
    ...
    iget-boolean v2, p0, Lhh7;->b:Z

    invoke-static {v0, v1, v2}, Lidg;->n(IIZ)I

    move-result v0

    iget-boolean v2, p0, Lhh7;->c:Z

    invoke-static {v0, v1, v2}, Lidg;->n(IIZ)I

    move-result v0

    iget-boolean v2, p0, Lhh7;->d:Z

    invoke-static {v0, v1, v2}, Lidg;->n(IIZ)I

    move-result v0

    iget-object v2, p0, Lhh7;->o:Ljava/util/List;

    invoke-static {v2, v0, v1}, Lidg;->o(Ljava/util/List;II)I

    move-result v0

    iget-boolean v2, p0, Lhh7;->X:Z

    invoke-static {v0, v1, v2}, Lidg;->n(IIZ)I

    move-result v0

    iget-boolean v2, p0, Lhh7;->Y:Z
...
.method public final toString()Ljava/lang/String;
    ...
    iget-boolean v3, p0, Lhh7;->a:Z

    iget-boolean v4, p0, Lhh7;->b:Z
...
.method public final writeToParcel(Landroid/os/Parcel;I)V
    ...
    iget-object v0, p0, Lhh7;->o:Ljava/util/List;
    ...
    :cond_0
    iget-boolean p2, p0, Lhh7;->X:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-boolean p2, p0, Lhh7;->Y:Z

    invoke-virtual {p1, p2}, Landroid/os/Parcel;->writeInt(I)V

    iget-boolean p2, p0, Lhh7;->Z:Z
