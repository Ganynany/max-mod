...
.method public synthetic constructor <init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V
    ...
    iput-object p1, p0, Lee7;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
...
.method public accept(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lee7;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
    ...
    invoke-static {v1, v0, v2}, Lzal;->b(ILandroid/content/Context;Ljava/lang/String;)V
...
.method public run()V
    ...
    iget-object v0, p0, Lee7;->b:Lru/ok/messages/media/crop/FrgTamCropImage;
    ...
    iget-object v3, v3, Lone/me/image/crop/view/ImageCropView;->a:Lfk7;

    invoke-virtual {v3}, Lwi8;->getInitialMatrix()Landroid/graphics/Matrix;

    move-result-object v4

    iget-object v3, v3, Llfi;->A0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v3}, Lone/me/image/crop/view/ImageCropView;->getCropState()Lrv4;
    ...
    :goto_1
    iget-object v1, v1, Lone/me/image/crop/view/ImageCropView;->a:Lfk7;

    invoke-virtual {v1}, Llfi;->getViewBitmap()Landroid/graphics/Bitmap;

    move-result-object v2

    invoke-virtual {v1}, Llfi;->getImageOutputPath()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1}, Lwi8;->getCropState()Lrv4;
    ...
    iget-object v5, v1, Lrv4;->c:[F

    iget-object v1, v1, Lrv4;->a:Landroid/graphics/RectF;
    ...
    iget-object v2, p0, Lee7;->b:Lru/ok/messages/media/crop/FrgTamCropImage;

    invoke-direct {v0, v2, v1}, Lee7;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v1, Lx24;

    const/4 v3, 0x1

    invoke-direct {v1, v0, v3}, Lx24;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v3, v2, v4}, Lee7;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v4, Lee7;

    const/4 v5, 0x7

    invoke-direct {v4, v2, v5}, Lee7;-><init>(Lru/ok/messages/media/crop/FrgTamCropImage;I)V

    new-instance v2, Lp62;

    const/4 v5, 0x0

    invoke-direct {v2, v4, v5, v3}, Lp62;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    :try_start_2
    new-instance v3, Ld34;

    invoke-direct {v3, v2, v1}, Ld34;-><init>(Le34;Lqqf;)V
    ...
    iget-object v0, v0, Lone/me/image/crop/view/ImageCropView;->a:Lfk7;

    const/4 v1, 0x0

    iput v1, v0, Lwi8;->L0:F

    invoke-virtual {v0}, Lwi8;->a()V
    ...
    iget-object v2, v1, Lwi8;->I0:Landroid/graphics/RectF;
    ...
    iget-object v4, v1, Llfi;->A0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v1, v4}, Llfi;->setImageMatrix(Landroid/graphics/Matrix;)V
    ...
    iget-object v2, v1, Lwi8;->J0:Landroid/graphics/Matrix;
    ...
    iget-object v3, v1, Lwi8;->K0:Landroid/graphics/RectF;

    iget-object v1, v1, Lwi8;->I0:Landroid/graphics/RectF;
    ...
    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->a:Lfk7;

    iget-object v3, v2, Lwi8;->I0:Landroid/graphics/RectF;
    ...
    iget-object v6, v2, Llfi;->A0:Landroid/graphics/Matrix;

    const/high16 v7, 0x42b40000    # 90.0f

    invoke-virtual {v6, v7, v5, v3}, Landroid/graphics/Matrix;->postRotate(FFF)Z

    invoke-virtual {v2, v6}, Llfi;->setImageMatrix(Landroid/graphics/Matrix;)V

    iget-object v2, v0, Lru/ok/messages/media/crop/FrgTamCropImage;->y1:Lone/me/image/crop/view/ImageCropView;

    iget-object v2, v2, Lone/me/image/crop/view/ImageCropView;->b:Lauc;

    iget v3, v2, Lauc;->z0:F

    div-float v3, v4, v3

    iput v3, v2, Lauc;->z0:F

    iget-object v5, v2, Lauc;->a:Landroid/graphics/RectF;

    invoke-virtual {v2, v5, v3}, Lauc;->a(Landroid/graphics/RectF;F)V

    invoke-virtual {v2}, Lauc;->b()V

    iget-object v3, v2, Lauc;->S0:Lbuc;
    ...
    invoke-virtual {v3, v5}, Lwi8;->setCropRect(Landroid/graphics/RectF;)V
    ...
    iget-object v3, v2, Lwi8;->J0:Landroid/graphics/Matrix;
    ...
    iget-object v4, v2, Lwi8;->K0:Landroid/graphics/RectF;

    iget-object v2, v2, Lwi8;->I0:Landroid/graphics/RectF;
    ...
    iget-object v1, v3, Lone/me/image/crop/view/ImageCropView;->a:Lfk7;

    iget-object v3, v1, Lwi8;->I0:Landroid/graphics/RectF;
    ...
    iget-object v5, v1, Llfi;->A0:Landroid/graphics/Matrix;
    ...
    invoke-virtual {v1, v5}, Llfi;->setImageMatrix(Landroid/graphics/Matrix;)V
