...
# direct methods
.method public constructor <init>(Ldoh;Ljava/lang/CharSequence;Lkotlin/coroutines/Continuation;)V
    .locals 0

    iput-object p1, p0, Lcoh;->X:Ldoh;
...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v0, p0, Lcoh;->X:Ldoh;

    iget-object v1, p0, Lcoh;->Y:Ljava/lang/CharSequence;

    invoke-direct {p1, v0, v1, p2}, Lcoh;-><init>(Ldoh;Ljava/lang/CharSequence;Lkotlin/coroutines/Continuation;)V
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lcoh;->X:Ldoh;

    iget-object v2, v1, Ldoh;->L0:Ljqg;

    iget-object v3, v1, Ldoh;->Y:Lps9;

    iget v4, v0, Lcoh;->o:I

    sget-object v5, Ltpi;->a:Ltpi;

    iget-object v6, v0, Lcoh;->Y:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v3, v6}, Lps9;->s(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    invoke-virtual {v2, v10, v0}, Ljqg;->a(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v13, v13, Luja;->a:Lrja;

    iget-wide v13, v13, Lrja;->a:J
    ...
    :cond_5
    iget-object v4, v1, Ldoh;->W0:Liuc;

    if-eqz v4, :cond_7

    iput v8, v0, Lcoh;->o:I

    iget-object v8, v4, Liuc;->b:Ljava/lang/Object;
    ...
    invoke-direct {v13, v4, v12, v10}, Lmnh;-><init>(Liuc;Ljava/util/LinkedHashSet;Lkotlin/coroutines/Continuation;)V

    invoke-static {v8, v13, v0}, Lkve;->X(Lxs4;Lff7;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    :cond_8
    iget-object v8, v1, Ldoh;->Y0:Lpaa;

    if-eqz v8, :cond_9

    invoke-virtual {v8, v4}, Lpaa;->E(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-direct {v8, v1, v9}, Lynh;-><init>(Ldoh;I)V

    iget-object v1, v3, Lps9;->c:Ljava/lang/Object;
    ...
    invoke-static {v4, v9}, Liy3;->u0(Ljava/lang/Iterable;I)I
    ...
    iget-object v4, v6, Luja;->a:Lrja;

    iget-wide v6, v4, Lrja;->a:J
    ...
    iget-object v6, v3, Lps9;->b:Ljava/lang/Object;
    ...
    invoke-direct {v7, v8, v10}, Lkn;-><init>(Ljava/lang/Object;I)V

    new-instance v10, Lrnh;

    invoke-direct {v10, v6, v4, v7}, Lrnh;-><init>(Lpe7;Lwnh;Lff7;)V
