...
.method public synthetic constructor <init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    iput-object p1, p0, Lb0e;->b:Lone/me/profileedit/ProfileEditScreen;
...
.method public final invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v6, v0, Lb0e;->b:Lone/me/profileedit/ProfileEditScreen;
    ...
    invoke-virtual {v2, v7}, Ld3c;->setAddBadgeVisibility(Z)V

    new-instance v3, Lc0e;

    invoke-direct {v3, v6, v8}, Lc0e;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    sget-object v9, Lone/me/profileedit/ProfileEditScreen;->F0:[Lbv8;
    ...
    invoke-direct {v10, v3, v2}, Lay3;-><init>(II)V

    iput v8, v10, Lay3;->a:I
    ...
    sget-object v4, Lone/me/profileedit/ProfileEditScreen;->F0:[Lbv8;
    ...
    invoke-direct {v4, v7}, Lsnc;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v4, v7}, Lsnc;->setForm(Ljnc;)V

    new-instance v7, Lanc;

    new-instance v10, Lb0e;

    const/4 v11, 0x3

    invoke-direct {v10, v6, v11}, Lb0e;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V

    invoke-direct {v7, v10}, Lanc;-><init>(Lre7;)V

    invoke-virtual {v4, v7}, Lsnc;->setLeftActions(Lfnc;)V

    sget-object v7, Lcnc;->a:Lcnc;

    invoke-virtual {v4, v7}, Lsnc;->setRightActions(Lhnc;)V
    ...
    invoke-direct {v4, v6, v7}, Lb0e;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    invoke-direct {v9, v3, v2}, Lay3;-><init>(II)V
    ...
    invoke-virtual {v4, v6}, Lb0e;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v10}, Liq;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v9, v8}, Liq;->setLiftOnScroll(Z)V

    invoke-virtual {v9, v4}, Landroid/view/View;->setStateListAnimator(Landroid/animation/StateListAnimator;)V

    sget-object v10, Lone/me/profileedit/ProfileEditScreen;->F0:[Lbv8;

    new-instance v10, Lb0e;

    invoke-direct {v10, v6, v8}, Lb0e;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V
    ...
    invoke-direct {v8, v11}, Ldy3;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v11}, Lgq;-><init>()V

    const/16 v12, 0x13

    iput v12, v11, Lgq;->a:I

    invoke-virtual {v8, v11}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v8, v7}, Ldy3;->setTitleEnabled(Z)V

    invoke-virtual {v10, v8}, Lb0e;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v3, v3}, Lgs4;-><init>(II)V
    ...
    invoke-virtual {v9, v10}, Lgs4;->b(Lds4;)V
    ...
    iget-object v9, v6, Lone/me/profileedit/ProfileEditScreen;->X:Lb37;

    invoke-virtual {v8, v9}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lz4f;)V

    invoke-virtual {v8, v4}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Le5f;)V
    ...
    sget-object v10, Lli8;->a:Lieb;

    new-instance v10, Lieb;

    invoke-direct {v10, v4}, Lieb;-><init>(I)V
    ...
    invoke-virtual {v10, v12}, Lieb;->h(I)V
    ...
    :cond_1
    new-instance v14, Lrta;

    const/16 v4, 0xd

    invoke-direct {v14, v6, v4, v10}, Lrta;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v12, Lm0g;

    sget-object v4, Lbs3;->A0:Lov3;

    invoke-static {v8, v4}, Ln;->e(Landroidx/recyclerview/widget/RecyclerView;Lov3;)Lrmc;
    ...
    invoke-direct/range {v12 .. v17}, Lm0g;-><init>(Lrmc;Lk0g;Lre7;Lsze;I)V

    invoke-virtual {v8, v12, v3}, Landroidx/recyclerview/widget/RecyclerView;->j(Lf5f;I)V

    new-instance v9, Lwl9;

    invoke-direct {v9, v7}, Lwl9;-><init>(I)V

    invoke-virtual {v8, v9, v3}, Landroidx/recyclerview/widget/RecyclerView;->j(Lf5f;I)V
    ...
    invoke-direct {v9, v3, v2}, Lgs4;-><init>(II)V

    const/16 v10, 0x50

    iput v10, v9, Lgs4;->c:I
    ...
    invoke-virtual {v4, v9}, Lov3;->h(Landroid/content/Context;)Lbs3;
    ...
    invoke-static {v6, v4}, Lone/me/profileedit/ProfileEditScreen;->V0(Lone/me/profileedit/ProfileEditScreen;Lrmc;)V
    ...
    invoke-direct {v4, v6, v9, v8}, Ld52;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    invoke-virtual {v4, v9}, Lw4c;->setMode(Lt4c;)V

    sget-object v9, Lr4c;->d:Lr4c;
    ...
    invoke-direct {v2, v6, v7}, Lc0e;-><init>(Lone/me/profileedit/ProfileEditScreen;I)V

    invoke-static {v4, v2}, Lld7;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V
