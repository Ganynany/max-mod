...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lq03;->a:Landroid/graphics/drawable/ColorDrawable;

    new-instance v0, Lo03;

    const/4 v2, 0x0

    invoke-direct {v0, p0, v2}, Lo03;-><init>(Lq03;I)V
    ...
    iput-object v0, p0, Lq03;->b:Ljava/lang/Object;

    new-instance v0, Lo03;

    const/4 v3, 0x1

    invoke-direct {v0, p0, v3}, Lo03;-><init>(Lq03;I)V

    invoke-static {v2, v0}, Lcm0;->A(ILpe7;)Lpx8;

    move-result-object v0

    iput-object v0, p0, Lq03;->c:Ljava/lang/Object;
    ...
    invoke-direct {v5, v3}, Luj7;-><init>(Landroid/content/res/Resources;)V

    iput-object v1, v5, Luj7;->d:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v5}, Luj7;->a()Ltj7;

    move-result-object v1

    invoke-virtual {v0, v1}, Lvr5;->setHierarchy(Lsr5;)V

    iput-object v0, p0, Lq03;->d:Lone/me/sdk/uikit/common/views/OneMeDraweeView;
...
.method public final onThemeChanged(Lrmc;)V
    ...
    iget-object v1, p0, Lq03;->a:Landroid/graphics/drawable/ColorDrawable;

    invoke-virtual {v1, v0}, Landroid/graphics/drawable/ColorDrawable;->setColor(I)V

    iget-object v0, p0, Lq03;->b:Ljava/lang/Object;
    ...
    :cond_0
    iget-object p1, p0, Lq03;->c:Ljava/lang/Object;
...
.method public final setItem(Lrba;)V
    .locals 8

    iget-boolean v0, p1, Lrba;->B0:Z

    const/16 v1, 0x8

    const/4 v2, 0x1

    iget-object v3, p0, Lq03;->o:Ljava/lang/Object;

    iget-object v4, p0, Lq03;->d:Lone/me/sdk/uikit/common/views/OneMeDraweeView;

    const/4 v5, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v4, v5}, Lvr5;->setController(Lpr5;)V

    invoke-virtual {v4}, Lvr5;->getHierarchy()Lsr5;
    ...
    invoke-virtual {p1, v2, v0}, Ltj7;->i(ILandroid/graphics/drawable/Drawable;)V
    ...
    :cond_2
    iget-object v0, p1, Lrba;->d:Landroid/net/Uri;
    ...
    :goto_0
    iget-object v6, p1, Lrba;->z0:Landroid/net/Uri;

    if-eqz v6, :cond_3

    invoke-static {v6}, La88;->d(Landroid/net/Uri;)La88;

    move-result-object v6

    invoke-virtual {v6}, La88;->a()Lz78;
    ...
    invoke-virtual {v4, v0, v6}, Lone/me/sdk/uikit/common/views/OneMeDraweeView;->j(Lz78;Lz78;)V
    ...
    iget-object p1, p1, Lrba;->X:Ljava/lang/Long;
    ...
    sget-object v7, Liyh;->Y:Ldth;

    invoke-static {v6}, Lhb9;->U(Landroid/content/Context;)Liyh;
    ...
    invoke-static {v4, v6, p1}, Lcm0;->v(IILandroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, p1}, Lral;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)V

    invoke-static {v0, v5}, Lral;->a(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;)V
