...
.method public constructor <init>(Loge;)V
    ...
    iput-object v0, p0, Lpge;->c:Landroid/graphics/Paint;

    iget-object v0, p1, Loge;->e:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Loge;->c:Lfmc;

    invoke-virtual {p0, p1}, Lpge;->d(Lfmc;)V
...
.method public final chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;)V
    ...
    .line 1
    invoke-virtual/range {v0 .. v7}, Lpge;->chooseHeight(Ljava/lang/CharSequence;IIIILandroid/graphics/Paint$FontMetricsInt;Landroid/text/TextPaint;)V
...
.method public final copy()Ljs4;
    ...
    invoke-direct {v0, v1}, Lpge;-><init>(Loge;)V
...
.method public final d(Lfmc;)V
    ...
    iget-object v0, p0, Lpge;->a:Loge;

    iput-object p1, v0, Loge;->c:Lfmc;
    ...
    iget-object p1, v0, Loge;->e:Landroid/graphics/drawable/Drawable;
...
.method public final drawLeadingMargin(Landroid/graphics/Canvas;Landroid/graphics/Paint;IIIIILjava/lang/CharSequence;IIZLandroid/text/Layout;)V
    ...
    iget-object v6, v1, Lpge;->a:Loge;

    iget-object v7, v6, Loge;->f:Lbfe;

    iget-object v8, v6, Loge;->s:Landroid/graphics/Path;

    iget v9, v6, Loge;->j:I

    iget v10, v6, Loge;->g:I

    iget v11, v6, Loge;->k:I

    iget v12, v6, Loge;->q:F

    if-eqz v7, :cond_1

    invoke-virtual {v7}, Lbfe;->getAsInt()I
    ...
    iget-object v7, v1, Lpge;->b:Ljava/lang/String;

    const-string v8, "getSegment start&end failed"

    invoke-static {v7, v8, v5}, Lgbb;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v13, v1, Lpge;->c:Landroid/graphics/Paint;
    ...
    invoke-virtual/range {p5 .. p12}, Lpge;->c(Landroid/graphics/Paint;Landroid/graphics/Canvas;IFIFF)V
    ...
    iget-object v7, v6, Loge;->r:Landroid/graphics/Path;
    ...
    :try_start_5
    iget-object v7, v6, Loge;->v:Landroid/graphics/Path;
    ...
    iget-object v8, v6, Loge;->u:Landroid/graphics/Path;
    ...
    iget-object v2, v6, Loge;->t:Landroid/graphics/Path;
    ...
    :try_start_8
    iget-object v2, v6, Loge;->w:Landroid/graphics/Path;
    ...
    :cond_1a
    iget-object v0, v6, Loge;->e:Landroid/graphics/drawable/Drawable;
...
.method public final updateDrawState(Landroid/text/TextPaint;)V
    ...
    iget-object v1, v0, Loge;->d:Ly2i;

    iget-object v2, v0, Loge;->a:Landroid/content/Context;

    iget-object v0, v0, Loge;->b:Lo9h;
...
.method public final updateMeasureState(Landroid/text/TextPaint;)V
    ...
    iget-object p1, v0, Loge;->f:Lbfe;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lbfe;->getAsInt()I
