...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lpr1;->l:Ljava/util/concurrent/atomic/AtomicInteger;

    return-void
.end method

.method public constructor <init>(Ljte;Landroid/opengl/EGLContext;[ILaqa;Ljava/lang/String;)V
    .locals 13

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lpr1;->a:Ljte;

    move-object/from16 v0, p4

    iput-object v0, p0, Lpr1;->b:Laqa;
    ...
    iput-object v0, p0, Lpr1;->c:Landroid/os/HandlerThread;

    sget-object v1, Landroid/opengl/EGL14;->EGL_NO_SURFACE:Landroid/opengl/EGLSurface;

    iput-object v1, p0, Lpr1;->g:Landroid/opengl/EGLSurface;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Lpr1;->h:Ljava/lang/Object;
    ...
    :goto_1
    iput-object v2, p0, Lpr1;->j:Ljava/lang/String;
    ...
    invoke-direct {v3, v0, p1, v4, v5}, Lsek;-><init>(Landroid/os/Looper;Ljte;Ljava/lang/String;Laqa;)V

    iput-object v3, p0, Lpr1;->k:Lsek;
    ...
    :try_start_0
    iget-boolean v0, p0, Lpr1;->i:Z

    if-eqz v0, :cond_2

    const-string p2, "OpenGL context is already initialized"

    invoke-interface {p1, v2, p2}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public final b(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lpr1;->d:Landroid/opengl/EGLContext;

    if-eqz v0, :cond_3

    iget-object v1, p0, Lpr1;->e:Landroid/opengl/EGLDisplay;
    ...
    iget-object v3, p0, Lpr1;->d:Landroid/opengl/EGLContext;
    ...
    iget-object v2, p0, Lpr1;->g:Landroid/opengl/EGLSurface;
    ...
    iput-object p1, p0, Lpr1;->g:Landroid/opengl/EGLSurface;
...
.method public final c(Lre7;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lpr1;->k:Lsek;

    new-instance v1, Lor1;

    const/4 v2, 0x1

    invoke-direct {v1, p1, p0, v2}, Lor1;-><init>(Lre7;Lpr1;I)V
...
.method public final d(Landroid/opengl/EGLSurface;)V
    ...
    iget-object v0, p0, Lpr1;->e:Landroid/opengl/EGLDisplay;

    if-eqz v0, :cond_0

    invoke-static {v0, p1}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    sget-object p1, Lpr1;->l:Ljava/util/concurrent/atomic/AtomicInteger;
