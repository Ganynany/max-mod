...
.method public final a(Ljava/lang/Long;Ljava/lang/Long;J)V
    ...
    invoke-virtual {p2, v5, v6}, Ljs2;->J(J)Lbp2;
    ...
    invoke-virtual {p1, v5, v6}, Ljs2;->P(J)Lbp2;
    ...
    iget-object p2, p2, Lit2;->e0:Lc9c;

    if-nez p2, :cond_3

    const-string p1, "draft is null, ignore"

    invoke-static {v1, p1, v4}, Lgbb;->B(Ljava/lang/String;Ljava/lang/String;Ljava/util/concurrent/CancellationException;)V

    return-void

    :cond_3
    invoke-virtual {p2}, Lc9c;->d()Ljava/lang/Long;
    ...
    iget-wide p3, p1, Lbp2;->a:J

    invoke-virtual {p2, p3, p4}, Ljs2;->z(J)V
