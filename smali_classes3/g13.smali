...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v1, p0, Lg13;->M0:Landroid/widget/TextView;
    ...
    iput-object v8, p0, Lg13;->N0:Landroid/widget/TextView;
    ...
    iput-object v6, p0, Lg13;->O0:Lxec;
    ...
    invoke-virtual {p0, p1}, Lg13;->onThemeChanged(Lrmc;)V

    return-void
.end method

.method private final setButtonState(Liaj;)V
    .locals 3
    ...
    iget-object v0, p0, Lg13;->O0:Lxec;
    ...
    :cond_1
    invoke-virtual {v0, v1}, Lxec;->setPlaying(Z)V
    ...
    invoke-virtual {v0, p1}, Lxec;->setPlaying(Z)V
...
.method private final setState(Leu6;)V
    ...
    iput-object v0, p0, Lg13;->P0:Lpb0;
    ...
    iget-object p1, p0, Lg13;->P0:Lpb0;
...
.method private final setSubtitle(Ljava/lang/CharSequence;)V
    ...
    :goto_2
    iget-object v1, p0, Lg13;->N0:Landroid/widget/TextView;
...
.method private final setTitle(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lg13;->M0:Landroid/widget/TextView;
...
.method public final onThemeChanged(Lrmc;)V
    ...
    iget-object v1, p0, Lg13;->M0:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lg13;->N0:Landroid/widget/TextView;
...
.method public final setupVideo(Lsba;)V
    .locals 2

    iget-wide v0, p1, Lsba;->b:J

    invoke-static {v0, v1}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;

    move-result-object v0

    iput-object v0, p0, Lg13;->R0:Ljava/lang/Long;

    iget-object v0, p0, Lg13;->O0:Lxec;

    iget-object v1, p1, Lsba;->o:Landroid/net/Uri;

    invoke-virtual {v0, v1}, Lxec;->setCover(Landroid/net/Uri;)V

    iget-object v0, p1, Lsba;->X:Ljava/lang/String;

    invoke-direct {p0, v0}, Lg13;->setTitle(Ljava/lang/CharSequence;)V

    iget-object v0, p1, Lsba;->Y:Ljava/lang/String;

    invoke-direct {p0, v0}, Lg13;->setSubtitle(Ljava/lang/CharSequence;)V

    iget-object p1, p1, Lsba;->Z:Lfqg;

    invoke-interface {p1}, Lfqg;->b()Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Lg13;->t(Ljaj;)V

    :cond_0
    invoke-direct {p0, p1}, Lg13;->setState(Leu6;)V

    return-void
.end method

.method public final t(Ljaj;)V
    .locals 5

    if-eqz p1, :cond_0

    iget-object v0, p1, Ljaj;->X:Liaj;
    ...
    :goto_0
    iget-object v1, p0, Lg13;->S0:Liaj;
    ...
    iget-wide v1, p1, Ljaj;->b:J

    iget-object v3, p0, Lg13;->R0:Ljava/lang/Long;
    ...
    :cond_3
    invoke-direct {p0, v0}, Lg13;->setButtonState(Liaj;)V
    ...
    invoke-direct {p0, v1}, Lg13;->setButtonState(Liaj;)V

    :cond_5
    :goto_2
    iput-object v0, p0, Lg13;->S0:Liaj;
    ...
    invoke-virtual {v0, p1}, Lxec;->setProgress(F)V
