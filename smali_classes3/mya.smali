...
.method public constructor <init>(Lone/me/messages/list/ui/MessagesListWidget;)V
    ...
    iput-object p1, p0, Lmya;->g:Lone/me/messages/list/ui/MessagesListWidget;

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lmya;->a:Landroid/graphics/Rect;
    ...
    iput-boolean p1, p0, Lmya;->d:Z

    new-instance p1, Ljava/util/LinkedHashSet;

    invoke-direct {p1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object p1, p0, Lmya;->e:Ljava/util/LinkedHashSet;

    new-instance p1, Ljava/util/LinkedHashSet;

    invoke-direct {p1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object p1, p0, Lmya;->f:Ljava/util/LinkedHashSet;
...
.method public final a(Landroidx/recyclerview/widget/RecyclerView;I)V
    ...
    :goto_0
    iput-boolean v0, p0, Lmya;->d:Z

    if-nez p2, :cond_1

    const/4 p2, -0x1

    invoke-virtual {p0, p1, p2, p2}, Lmya;->b(Landroidx/recyclerview/widget/RecyclerView;II)V

    invoke-virtual {p0}, Lmya;->c()V
...
.method public final b(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-object v4, p0, Lmya;->a:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p1, p2}, Lmya;->d(II)V
...
.method public final c()V
    ...
    iget-object v0, p0, Lmya;->e:Ljava/util/LinkedHashSet;

    iget-object v1, p0, Lmya;->f:Ljava/util/LinkedHashSet;

    invoke-static {v0, v1}, Lgeg;->N(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    :cond_0
    iget-object v1, p0, Lmya;->e:Ljava/util/LinkedHashSet;

    iput-object v1, p0, Lmya;->f:Ljava/util/LinkedHashSet;

    new-instance v1, Ljava/util/LinkedHashSet;

    invoke-direct {v1}, Ljava/util/LinkedHashSet;-><init>()V

    iput-object v1, p0, Lmya;->e:Ljava/util/LinkedHashSet;

    sget-object v1, Lone/me/messages/list/ui/MessagesListWidget;->y1:[Lbv8;

    iget-object v1, p0, Lmya;->g:Lone/me/messages/list/ui/MessagesListWidget;

    invoke-virtual {v1}, Lone/me/messages/list/ui/MessagesListWidget;->g1()Ldya;

    move-result-object v1

    iget-object v2, v1, Ldya;->J0:Ljj6;
    ...
    invoke-virtual {v2, v3, v4}, Lvvf;->j(Lru/ok/tamtam/android/prefs/PmsKey;Z)Z
    ...
    :cond_1
    iget-object v2, v1, Ldya;->c:Lh63;

    invoke-virtual {v2}, Lh63;->b()Z
    ...
    iget-object v3, v1, Ldya;->z0:Ljwh;
    ...
    invoke-direct {v4, v0, v1, v5}, Lhxa;-><init>(Ljava/util/Set;Ldya;Lkotlin/coroutines/Continuation;)V
...
.method public final d(II)V
    ...
    invoke-direct {v1, p1, p2, v2}, Lhi8;-><init>(III)V
    ...
    iget-object v2, p0, Lmya;->g:Lone/me/messages/list/ui/MessagesListWidget;

    iget-object v2, v2, Lone/me/messages/list/ui/MessagesListWidget;->U0:Lcua;
