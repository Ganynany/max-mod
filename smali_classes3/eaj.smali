...
# direct methods
.method public constructor <init>(Landroid/util/Size;Lfv5;)V
    .locals 5

    invoke-direct {p0}, Ltm5;-><init>()V

    iput-object p1, p0, Leaj;->o:Landroid/util/Size;
    ...
    iput-object v0, p0, Leaj;->p:Ljava/lang/String;

    const/16 v1, 0x10

    new-array v1, v1, [F

    iput-object v1, p0, Leaj;->t:[F
    ...
    invoke-virtual {p0, p2}, Ltm5;->o(Lfv5;)Lth0;
...
.method public final r()V
    ...
    iget-object v0, p0, Leaj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v0, p0, Leaj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    iget-object v2, p0, Leaj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    :cond_1
    iput-object v0, p0, Leaj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    iget-object v2, p0, Leaj;->q:Labh;

    if-eqz v2, :cond_2

    iget-object v3, v2, Labh;->d:Ljava/lang/String;

    invoke-static {v3, v1}, Lgbb;->f0(Ljava/lang/String;Ljava/lang/String;)V

    iget-object v1, v2, Labh;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/VideoMessageStencilHolder;->release()V

    iget-object v1, v2, Labh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v1}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->release()V

    :cond_2
    iput-object v0, p0, Leaj;->q:Labh;

    iput-object v0, p0, Leaj;->w:Lo4g;

    invoke-super {p0}, Ltm5;->r()V
...
.method public final x(Landroid/graphics/SurfaceTexture;Landroid/view/Surface;[FZ)V
    ...
    invoke-virtual {v1, v0}, Ltm5;->m(Landroid/view/Surface;)Lli0;

    move-result-object v2

    sget-object v3, Lrg7;->j:Lli0;

    invoke-virtual {v2, v3}, Lli0;->equals(Ljava/lang/Object;)Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v1, v0}, Ltm5;->i(Landroid/view/Surface;)Lli0;
    ...
    :cond_0
    iget-object v3, v1, Ltm5;->d:Ljava/lang/Object;
    ...
    invoke-static {v3, v8}, Lrg7;->d(Ljava/util/concurrent/atomic/AtomicBoolean;Z)V

    iget-object v3, v1, Ltm5;->e:Ljava/lang/Object;
    ...
    iget v11, v2, Lli0;->b:I

    iget v12, v2, Lli0;->c:I

    iget-object v9, v2, Lli0;->a:Landroid/opengl/EGLSurface;

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/SurfaceTexture;->getTimestamp()J

    move-result-wide v13

    iget-object v2, v1, Leaj;->q:Labh;

    if-nez v2, :cond_2

    new-instance v2, Labh;

    iget-object v5, v1, Leaj;->o:Landroid/util/Size;

    invoke-direct {v2, v5}, Labh;-><init>(Landroid/util/Size;)V

    iput-object v2, v1, Leaj;->q:Labh;

    :cond_2
    move-object v10, v2

    iget-object v2, v1, Leaj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;
    ...
    iput-object v2, v1, Leaj;->r:Lone/me/sdk/gl/effects/objects/OesToImage2dRenderer;

    :cond_3
    iget-object v5, v1, Leaj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;
    ...
    iput-object v5, v1, Leaj;->s:Lone/me/sdk/gl/effects/objects/TrivialFragmentShader;

    :cond_4
    iget-wide v6, v1, Leaj;->u:J
    ...
    :cond_6
    :goto_0
    iget-object v6, v10, Labh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v6}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->bind()V

    iget v6, v10, Labh;->b:I

    iget v7, v10, Labh;->c:I
    ...
    iget-object v9, v10, Labh;->e:Lone/me/sdk/gl/effects/VideoMessageStencilHolder;

    iget-object v4, v10, Labh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;

    invoke-virtual {v4}, Lone/me/sdk/gl/effects/objects/FrameBuffer;->getTextureId()I

    move-result v4

    iget-object v5, v10, Labh;->a:Landroid/util/Size;
    ...
    iget-object v5, v1, Ltm5;->k:Ljava/lang/Object;
    ...
    invoke-virtual {v1, v3}, Ltm5;->p(Landroid/opengl/EGLSurface;)V

    iput-object v0, v1, Ltm5;->k:Ljava/lang/Object;

    :cond_7
    invoke-static {v4, v4, v13, v12}, Landroid/opengl/GLES20;->glViewport(IIII)V

    iget-object v5, v2, Labh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v5, v1, Leaj;->w:Lo4g;

    const/16 v8, 0x10

    if-eqz v5, :cond_9

    iget-object v2, v2, Labh;->f:Lone/me/sdk/gl/effects/objects/FrameBuffer;
    ...
    iget-object v2, v1, Leaj;->w:Lo4g;

    if-eqz v2, :cond_8

    invoke-virtual {v2, v11}, Lo4g;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_9
    :goto_2
    iget-object v2, v1, Ltm5;->f:Ljava/lang/Object;
    ...
    iget-object v11, v1, Leaj;->p:Ljava/lang/String;
    ...
    invoke-static {v8, v2, v3}, Lucl;->c(IJ)Ljava/lang/String;
    ...
    invoke-static/range {v9 .. v15}, Lhcc;->f(Lhcc;Lpc9;Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Throwable;I)V

    :cond_b
    invoke-virtual {v1, v0, v4}, Ltm5;->t(Landroid/view/Surface;Z)V
