...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lvkd;->a:Landroid/content/Context;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lvkd;->b:Landroid/graphics/Rect;

    new-instance v0, Landroid/text/TextPaint;

    invoke-direct {v0}, Landroid/text/TextPaint;-><init>()V

    iput-object v0, p0, Lvkd;->c:Landroid/text/TextPaint;
    ...
    iput-object v1, p0, Lvkd;->Y:Ldth;

    new-instance v0, Lukd;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lukd;-><init>(Lvkd;I)V

    new-instance v1, Ldth;

    invoke-direct {v1, v0}, Ldth;-><init>(Lpe7;)V

    iput-object v1, p0, Lvkd;->Z:Ldth;
    ...
    iput-object v1, p0, Lvkd;->z0:Ldth;
    ...
    invoke-virtual {p0, p1}, Lvkd;->onThemeChanged(Lrmc;)V
    ...
    iput-object p1, p0, Lvkd;->A0:Lwz5;
...
.method public final g(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Ls5f;)V
    ...
    invoke-static {p3, p4}, Lvkd;->j(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    :cond_3
    :goto_2
    iget-object p4, p0, Lvkd;->A0:Lwz5;
...
.method public final h(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Ls5f;)V
    ...
    invoke-static {p2, v2}, Lvkd;->j(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    invoke-static {p2, v5}, Lvkd;->j(Landroidx/recyclerview/widget/RecyclerView;I)Ljava/lang/Integer;
    ...
    :goto_3
    iget-object v3, p0, Lvkd;->z0:Ldth;
    ...
    iget-object v4, p0, Lvkd;->A0:Lwz5;

    iget-object v5, p0, Lvkd;->b:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Lvkd;->c:Landroid/text/TextPaint;
...
.method public final onThemeChanged(Lrmc;)V
    ...
    iget-object v2, p0, Lvkd;->a:Landroid/content/Context;

    iget-object v3, p0, Lvkd;->c:Landroid/text/TextPaint;
