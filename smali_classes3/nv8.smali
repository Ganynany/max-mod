...
.method static constructor <clinit>()V
    ...
    invoke-static {v7, v1}, Lbp8;->h(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v1, Lnv8;->c:Ljava/util/Map;

    sget-object v1, Ly8i;->b:Ly8i;
    ...
    sput-object v0, Lnv8;->d:Ljava/util/List;
...
.method public final a()[B
    ...
    iget-object v0, p0, Lnv8;->b:Ljava/util/ArrayList;
    ...
    sget-object v6, Lw8i;->B0:Lw8i;

    iget-short v6, v6, Lw8i;->a:S
    ...
    iget-object v2, v1, Lmv8;->a:Ly8i;

    iget-short v2, v2, Ly8i;->a:S

    invoke-virtual {v5, v2}, Ljava/nio/ByteBuffer;->putShort(S)Ljava/nio/ByteBuffer;

    iget-object v2, v1, Lmv8;->a:Ly8i;

    sget-object v3, Lnv8;->c:Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lmv8;->a()Ljava/security/PublicKey;
    ...
    invoke-static {v5, v2}, Lnv8;->f(Ljava/nio/ByteBuffer;[B)V
    ...
    invoke-static {v5, v1}, Lnv8;->f(Ljava/nio/ByteBuffer;[B)V

    goto :goto_1

    :cond_2
    sget-object v4, Ly8i;->o:Ly8i;
    ...
    invoke-static {v2}, Lze;->p(Ljava/security/PublicKey;)Ljava/security/interfaces/XECPublicKey;

    move-result-object v2

    invoke-static {v2}, Lze;->o(Ljava/security/interfaces/XECPublicKey;)Ljava/math/BigInteger;
    ...
    invoke-static {v2}, Lnv8;->e([B)V

    iget-object v1, v1, Lmv8;->a:Ly8i;
...
.method public final d(Ljava/nio/ByteBuffer;)I
    ...
    invoke-static {}, Ly8i;->values()[Ly8i;
    ...
    invoke-direct {v6, v2, v7}, Lhu3;-><init>(II)V
    ...
    sget-object v3, Lnv8;->d:Ljava/util/List;
    ...
    invoke-static {v4}, Lnv8;->c(Ljava/lang/String;)Ljava/security/spec/ECParameterSpec;
    ...
    invoke-direct {v4, v2, v3}, Llv8;-><init>(Ly8i;Ljava/security/interfaces/ECPublicKey;)V
    ...
    :cond_1
    sget-object v3, Ly8i;->o:Ly8i;

    if-eq v2, v3, :cond_2

    sget-object v3, Ly8i;->X:Ly8i;
    ...
    invoke-static {v5}, Laoc;->c(Ljava/lang/String;)Ljava/security/spec/NamedParameterSpec;

    move-result-object v5

    invoke-static {}, Lze;->t()V

    invoke-static {v5, v4}, Lze;->q(Ljava/security/spec/AlgorithmParameterSpec;Ljava/math/BigInteger;)Ljava/security/spec/XECPublicKeySpec;
    ...
    invoke-direct {v4, v2, v3}, Lmv8;-><init>(Ly8i;Ljava/security/PublicKey;)V
