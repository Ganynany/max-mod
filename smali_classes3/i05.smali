...
# direct methods
.method public constructor <init>(Lorg/webrtc/DataChannel;Ljte;)V
    .locals 1
    ...
    iput-object v0, p0, Li05;->c:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Li05;->d:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Li05;->e:Ljava/util/concurrent/CopyOnWriteArrayList;

    iput-object p1, p0, Li05;->a:Lorg/webrtc/DataChannel;

    iput-object p2, p0, Li05;->b:Ljte;

    new-instance p2, Lk34;

    const/4 v0, 0x5

    invoke-direct {p2, p0, v0, p1}, Lk34;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
# virtual methods
.method public final a(Lhkf;)V
    .locals 1

    if-eqz p1, :cond_0

    iget-object v0, p0, Li05;->d:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final b()Z
    ...
    iget-object v0, p0, Li05;->a:Lorg/webrtc/DataChannel;
...
.method public final varargs d([Ljava/nio/ByteBuffer;)V
    ...
    iget-object v4, p0, Li05;->b:Ljte;

    invoke-interface {v4, v1, v3, v2}, Ljte;->reportException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final e(I[B)Z
    ...
    iget-object p1, p0, Li05;->a:Lorg/webrtc/DataChannel;
