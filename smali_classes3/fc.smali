...
.method public synthetic constructor <init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Z)V
    ...
    iput-object p4, p0, Lfc;->c:Ljava/lang/Object;
...
.method public synthetic constructor <init>(Lp5l;Lr5l;Ljava/lang/String;)V
    .locals 1
...
.method public final run()V
    ...
    sget-object v4, Lbyk;->b:Lbyk;

    iget-object v6, p0, Lfc;->d:Ljava/lang/Object;

    check-cast v6, Ljava/lang/String;

    iget-object v7, v1, Lr5l;->a:Ljava/lang/Object;

    check-cast v7, Lf4d;

    iput-object v4, v7, Lf4d;->c:Ljava/lang/Object;

    iget-object v4, v7, Lf4d;->b:Ljava/lang/Object;

    check-cast v4, La3l;

    if-eqz v4, :cond_0

    iget-object v4, v4, La3l;->d:Ljava/lang/String;
    ...
    :cond_1
    new-instance v7, Lr2l;

    invoke-direct {v7}, Ljava/lang/Object;-><init>()V

    iget-object v8, v0, Lp5l;->a:Ljava/lang/String;

    iput-object v8, v7, Lr2l;->a:Ljava/lang/String;

    iget-object v8, v0, Lp5l;->b:Ljava/lang/String;

    iput-object v8, v7, Lr2l;->b:Ljava/lang/String;
    ...
    new-instance v11, Lgb9;

    invoke-direct {v11, v9}, Lgb9;-><init>(Landroid/os/LocaleList;)V

    invoke-direct {v10, v11}, Lfb9;-><init>(Lgb9;)V
    ...
    :goto_0
    invoke-virtual {v10}, Lfb9;->b()I

    move-result v11

    if-ge v5, v11, :cond_6

    iget-object v11, v10, Lfb9;->a:Lgb9;

    iget-object v11, v11, Lgb9;->a:Landroid/os/LocaleList;

    invoke-virtual {v11, v5}, Landroid/os/LocaleList;->get(I)Ljava/util/Locale;

    move-result-object v11

    sget-object v12, Lb14;->a:Lgo7;
    ...
    :cond_6
    sget-object v3, La9l;->b:Ls6l;

    if-nez v9, :cond_7

    sget-object v2, Lrel;->o:Lrel;
    ...
    invoke-direct {v3, v9, v2}, Lrel;-><init>(I[Ljava/lang/Object;)V

    move-object v9, v3

    :goto_1
    sput-object v9, Lp5l;->j:Lrel;
    :try_end_1
    ...
    :goto_2
    iput-object v9, v7, Lr2l;->k:Ljava/util/AbstractCollection;

    sget-object v2, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v2, v7, Lr2l;->g:Ljava/lang/Boolean;

    iput-object v4, v7, Lr2l;->d:Ljava/lang/String;

    iput-object v6, v7, Lr2l;->c:Ljava/lang/String;

    iget-object v2, v0, Lp5l;->f:Ltgl;
    ...
    :goto_3
    iput-object v2, v7, Lr2l;->e:Ljava/lang/String;
    ...
    iput-object v2, v7, Lr2l;->i:Ljava/lang/Integer;
    ...
    iput-object v2, v7, Lr2l;->j:Ljava/lang/Integer;

    iput-object v7, v1, Lr5l;->b:Ljava/lang/Object;

    iget-object v0, v0, Lp5l;->c:Lj5l;

    invoke-virtual {v0, v1}, Lj5l;->a(Lr5l;)V
    ...
    iget-object v2, v0, Law3;->a:Landroid/content/Intent;
    ...
    iget-object v6, v0, Law3;->a:Landroid/content/Intent;
    ...
    iget-object v0, v0, Law3;->a:Landroid/content/Intent;
    ...
    invoke-direct {v3, v4, v1, v2, v5}, Lcbl;-><init>(IILandroid/os/Bundle;I)V

    invoke-virtual {v0, v3}, Lofl;->f(Lcbl;)Ltgl;
    ...
    sget-object v2, Lwj5;->c:Lwj5;

    new-instance v3, Lash;

    invoke-direct {v3, v1}, Lash;-><init>(Ljava/lang/Object;)V

    invoke-virtual {v0, v2, v3}, Ltgl;->b(Ljava/util/concurrent/Executor;Lj1c;)Ltgl;
    ...
    invoke-virtual {v1}, Lrk2;->get()Ljava/lang/Object;
    ...
    iget-object v2, v2, Ldaj;->h:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v4}, Lgbb;->p(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0, v1, v3}, Le8j;->E(Le8j;Li6j;Z)V
    ...
    invoke-virtual {v0, v4}, Lgzh;->c(Ljava/lang/Object;)V
    ...
    invoke-direct {v2, p0, v5}, Luyh;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v1, v2}, Lbolts/Task;->continueWith(Llp4;)Lbolts/Task;
    :try_end_6
    ...
    iget-object v4, v2, Lone/me/stickersshowcase/StickersShowcaseScreen;->Y:Lcye;

    sget-object v5, Lone/me/stickersshowcase/StickersShowcaseScreen;->D0:[Lbv8;
    ...
    iget-object v4, v3, Lone/me/stickerssearch/StickersSearchScreen;->Z:Lcye;

    sget-object v5, Lone/me/stickerssearch/StickersSearchScreen;->C0:[Lbv8;

    aget-object v1, v5, v1

    invoke-interface {v4, v3, v1}, Lcye;->y(Ljava/lang/Object;Lbv8;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Lr67;->call()Ljava/lang/Object;
    ...
    invoke-direct {v2, v0, v3, v4}, Ljg7;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v1, v0, Lone/me/profileedit/screens/adminpermissions/ProfileEditAdminPermissionsWidget;->z0:Lcye;
    ...
    :try_start_8
    invoke-virtual {v1}, Lel6;->e()Landroid/net/Uri;

    move-result-object v3

    const/4 v5, 0x5

    invoke-virtual {v0, v3, v5}, Lo28;->a0(Landroid/net/Uri;I)Ljava/net/HttpURLConnection;
    ...
    :try_start_9
    iget-object v0, v0, Lo28;->h:Lcom/facebook/common/time/RealtimeSinceBootClock;

    invoke-interface {v0}, Lb7b;->now()J

    move-result-wide v5

    iput-wide v5, v1, Ln28;->e:J
    ...
    invoke-virtual {v2, v4, v0}, Lqia;->M(Ljava/io/InputStream;I)V
    :try_end_9
    ...
    :goto_c
    :try_start_b
    invoke-virtual {v2, v0}, Lqia;->K(Ljava/lang/Exception;)V
    :try_end_b
    ...
    invoke-virtual {v1, v0, v2}, Lcom/google/android/material/appbar/AppBarLayout$BaseBehavior;->J(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Liq;)V

    iget-boolean v1, v2, Liq;->F0:Z
    ...
    invoke-virtual {v2, v0}, Liq;->g(Landroid/view/View;)Z

    move-result v0

    invoke-virtual {v2, v0}, Liq;->f(Z)Z
    ...
    invoke-virtual {v1, v2}, Lx76;->b(Ljava/lang/Runnable;)Lll5;
    ...
    iget-object v8, v8, Ljn;->b:Lin;

    invoke-virtual {v8}, Lin;->start()V
    ...
    iget-object v6, v1, Lgc;->b:Landroid/text/TextPaint;

    iget-object v7, v1, Lgc;->a:Ljava/lang/String;
    ...
    invoke-interface {v8}, Lt3h;->a()Landroid/graphics/drawable/Drawable;
