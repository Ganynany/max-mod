...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v2, Lvhe;->markdown_dot_size:I
    ...
    sget v3, Lvhe;->markdown_button_size:I
    ...
    iput-object v5, p0, Lbm9;->a:Landroidx/appcompat/widget/AppCompatTextView;
    ...
    invoke-static {v8, v7}, Lcm0;->P(ILandroid/graphics/drawable/Drawable;)V

    invoke-virtual {v6, v7}, Landroid/view/View;->setBackground(Landroid/graphics/drawable/Drawable;)V

    iput-object v6, p0, Lbm9;->b:Landroid/view/View;
    ...
    :cond_0
    sget-object v2, Lpse;->MarkdownItemView:[I
    ...
    sget v0, Lpse;->MarkdownItemView_miv_title:I
    ...
    invoke-virtual {p0, v0}, Lbm9;->setTitle(I)V

    :cond_1
    sget v0, Lpse;->MarkdownItemView_miv_highlight_title:I

    invoke-virtual {p1, v0, v1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v0

    invoke-virtual {p0, v0, v1}, Lbm9;->a(ZZ)V

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    invoke-virtual {p0}, Lbm9;->b()V
...
.method public final a(ZZ)V
    ...
    invoke-direct {p1, v0, v1}, Lhi;-><init>(Ljava/lang/Float;Ljava/lang/Float;)V

    iget-boolean v2, p0, Lbm9;->c:Z
    ...
    invoke-direct {p1, v1, v0}, Lhi;-><init>(Ljava/lang/Float;Ljava/lang/Float;)V
    ...
    iget-object v1, p1, Lhi;->b:Ljava/lang/Float;
    ...
    invoke-static {p0}, Lqsk;->a(Landroid/widget/LinearLayout;)Lnj;

    move-result-object p2

    invoke-virtual {p2}, Lnj;->a()Z
    ...
    iget-object v0, p0, Lbm9;->d:Landroid/animation/ObjectAnimator;
    ...
    iput-object v0, p0, Lbm9;->d:Landroid/animation/ObjectAnimator;

    :cond_4
    iget-object v0, p1, Lhi;->a:Ljava/lang/Float;
    ...
    iget-object p2, p2, Lnj;->a:Lu65;

    const-wide/16 v1, 0xc8

    invoke-virtual {v0, v1, v2}, Landroid/animation/ObjectAnimator;->setDuration(J)Landroid/animation/ObjectAnimator;

    iget-boolean v1, p0, Lbm9;->c:Z

    if-eqz v1, :cond_5

    invoke-virtual {p2}, Lu65;->t()Landroid/view/animation/Interpolator;
    ...
    :cond_5
    invoke-virtual {p2}, Lu65;->w()Landroid/view/animation/Interpolator;
    ...
    invoke-direct {p2, p0, v1, p1}, Lfi;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final b()V
    ...
    iget-object v1, p0, Lbm9;->a:Landroidx/appcompat/widget/AppCompatTextView;
...
.method public final setTitle(I)V
    ...
    iget-object v0, p0, Lbm9;->a:Landroidx/appcompat/widget/AppCompatTextView;
