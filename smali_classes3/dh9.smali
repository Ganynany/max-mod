...
# direct methods
.method public constructor <init>(Ljava/time/Clock;Ls4f;Lkkf;Lrmb;Ln4f;Ltce;)V
    .locals 2
    ...
    iput-wide v0, p0, Ldh9;->i:J

    iput-object p1, p0, Ldh9;->a:Ljava/time/Clock;

    iput-object p2, p0, Ldh9;->b:Ls4f;

    iput-object p3, p0, Ldh9;->c:Lkkf;

    iput-object p4, p0, Ldh9;->d:Lrmb;

    iput-object p5, p0, Ldh9;->e:Ln4f;

    iput-object p6, p0, Ldh9;->f:Ltce;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Ldh9;->h:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>()V

    iput-object p1, p0, Ldh9;->g:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public final declared-synchronized a()V
    ...
    :try_start_0
    iget-object v0, p0, Ldh9;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Ldh9;->d:Lrmb;

    invoke-virtual {v1, v0}, Lrmb;->b(Ljava/util/List;)V

    iget-object v0, p0, Ldh9;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Ldh9;->j:Ljava/time/Instant;

    iput-object v0, p0, Ldh9;->k:Ljava/time/Instant;

    const/4 v0, 0x1

    iput-boolean v0, p0, Ldh9;->l:Z
    :try_end_0
...
.method public final b()V
    ...
    :cond_0
    iget-object v0, p0, Ldh9;->c:Lkkf;

    invoke-virtual {v0}, Lkkf;->b()I

    move-result v0

    iget-object v1, p0, Ldh9;->c:Lkkf;
    ...
    iget-object v1, p0, Ldh9;->a:Ljava/time/Clock;
    ...
    iget-object v1, p0, Ldh9;->g:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v4, p0, v5, v0}, Ll95;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v5, p0, Ldh9;->h:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-direct {v5, p0, v6}, Lbh9;-><init>(Ldh9;I)V

    invoke-interface {v4, v5}, Ljava/util/stream/Stream;->forEach(Ljava/util/function/Consumer;)V

    iget-object v4, p0, Ldh9;->e:Ln4f;

    invoke-virtual {v4}, Ln4f;->run()V

    iget-object v4, p0, Ldh9;->d:Lrmb;
    ...
    invoke-direct {v6, v7}, Liu3;-><init>(I)V
    ...
    iget-wide v9, v4, Lrmb;->b:J

    sub-long/2addr v9, v7

    iput-wide v9, v4, Lrmb;->b:J

    iget-object v9, v4, Lrmb;->d:Lm6g;

    invoke-virtual {v9}, Lm6g;->k()V
    ...
    iget-object v7, v4, Lrmb;->a:Lgd9;

    iget-wide v8, v4, Lrmb;->b:J
    ...
    invoke-interface {v7, v6}, Lgd9;->debug(Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-direct {v6, v7}, Ld59;-><init>(I)V
    ...
    iget-object v6, v4, Lrmb;->f:Ljava/time/Instant;
    ...
    iput-object v5, v4, Lrmb;->f:Ljava/time/Instant;

    iget-wide v5, v4, Lrmb;->c:J
    ...
    iput-wide v7, v4, Lrmb;->c:J

    :cond_2
    iget-object v5, v4, Lrmb;->a:Lgd9;

    iget-wide v6, v4, Lrmb;->c:J
    ...
    invoke-static {v6, v7, v10, v11}, Lhb2;->u(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {v5, v6}, Lgd9;->cc(Ljava/lang/String;)V

    iget-wide v5, v4, Lrmb;->c:J

    iput-wide v5, v4, Lrmb;->e:J

    :cond_3
    iget-object v4, v4, Lrmb;->a:Lgd9;

    invoke-interface {v4}, Lgd9;->getQLog()Ltce;
    ...
    invoke-direct {v4, p0, v5}, Lbh9;-><init>(Ldh9;I)V
    ...
    invoke-direct {v4, p0, v5}, Lah9;-><init>(Ldh9;I)V
    ...
    invoke-direct {v4, v5}, Ld59;-><init>(I)V
