...
.field public final C0:Lkec;

.field public final D0:Landroid/widget/Chronometer;

.field public final E0:Landroid/widget/LinearLayout;

.field public final F0:Lkec;

.field public final G0:Lrd2;

.field public final H0:Lkec;

.field public final I0:Lkec;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v4, v0, Ldge;->a:Landroid/animation/FloatEvaluator;
    ...
    iput-object v4, v0, Ldge;->A0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
    ...
    invoke-virtual {v10, v7}, Lov3;->h(Landroid/content/Context;)Lbs3;
    ...
    iput-object v5, v0, Ldge;->B0:Landroidx/appcompat/widget/AppCompatImageView;

    new-instance v7, Lkec;

    invoke-direct {v7, v1}, Lkec;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v7, v2}, Lkec;->setMode(Lhec;)V
    ...
    invoke-virtual {v7, v11, v9, v13}, Lkec;->a(FILjava/lang/String;)V

    new-instance v9, Lxfe;

    const/4 v13, 0x0

    invoke-direct {v9, v0, v13}, Lxfe;-><init>(Ldge;I)V

    invoke-static {v7, v9}, Lld7;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v7, v0, Ldge;->C0:Lkec;
    ...
    iput-object v9, v0, Ldge;->D0:Landroid/widget/Chronometer;
    ...
    invoke-static {v6, v3}, Lcm0;->P(ILandroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v8}, Lrmc;->l()Lhmc;
    ...
    iput-object v13, v0, Ldge;->E0:Landroid/widget/LinearLayout;

    new-instance v3, Lkec;

    invoke-direct {v3, v1}, Lkec;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v3, v2}, Lkec;->setMode(Lhec;)V

    new-instance v6, Lxfe;

    const/4 v8, 0x1

    invoke-direct {v6, v0, v8}, Lxfe;-><init>(Ldge;I)V

    invoke-static {v3, v6}, Lld7;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v3, v0, Ldge;->F0:Lkec;

    new-instance v6, Lrd2;

    invoke-direct {v6, v1}, Lrd2;-><init>(Landroid/content/Context;)V
    ...
    invoke-direct {v8, v0, v9}, Lxfe;-><init>(Ldge;I)V

    invoke-static {v6, v8}, Lld7;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v6, v0, Ldge;->G0:Lrd2;

    new-instance v8, Lkec;

    invoke-direct {v8, v1}, Lkec;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v8, v2}, Lkec;->setMode(Lhec;)V
    ...
    invoke-virtual {v8, v11, v9, v10}, Lkec;->a(FILjava/lang/String;)V

    new-instance v9, Lxfe;

    const/4 v10, 0x3

    invoke-direct {v9, v0, v10}, Lxfe;-><init>(Ldge;I)V

    invoke-static {v8, v9}, Lld7;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v8, v0, Ldge;->H0:Lkec;

    new-instance v9, Lkec;

    invoke-direct {v9, v1}, Lkec;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v9, v2}, Lkec;->setMode(Lhec;)V

    new-instance v2, Lxfe;

    const/4 v10, 0x4

    invoke-direct {v2, v0, v10}, Lxfe;-><init>(Ldge;I)V

    invoke-static {v9, v2}, Lld7;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iput-object v9, v0, Ldge;->I0:Lkec;
    ...
    invoke-direct {v3, v2, v1, v7}, Lsh8;-><init>(ILa21;I)V

    const/4 v8, 0x0

    invoke-static {v6, v3, v8}, Lmb8;->d(Landroid/view/View;Lsh8;Lre7;)V

    iput-object v6, v0, Ldge;->J0:Landroid/widget/FrameLayout;

    new-instance v1, Lyfe;

    const/4 v3, 0x0

    invoke-direct {v1, v0, v3}, Lyfe;-><init>(Ldge;I)V

    invoke-static {v2, v1}, Lcm0;->A(ILpe7;)Lpx8;

    move-result-object v1

    iput-object v1, v0, Ldge;->K0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Ldge;->L0:Ljava/lang/Object;
    ...
    iput-object v1, v0, Ldge;->M0:Ljava/lang/Object;
...
.method public static final synthetic a(Ldge;)Z
    .locals 0

    invoke-direct {p0}, Ldge;->getCanRecordingVideo()Z
...
.method public static final b(Ldge;Ltc2;)V
    .locals 6
    ...
    invoke-direct {p0}, Ldge;->getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    invoke-direct {p0}, Ldge;->getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    invoke-direct {p0}, Ldge;->getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    :cond_7
    :goto_1
    iget-object v1, p0, Ldge;->F0:Lkec;

    sget v2, Ldge;->N0:F

    invoke-virtual {v1, v0, v5, v2}, Lkec;->b(Landroid/graphics/drawable/Drawable;Ljava/lang/String;F)V

    invoke-virtual {p0}, Ldge;->getCameraApi()Luc2;
    ...
    invoke-interface {p0, p1}, Luc2;->setFlash(Ljava/lang/String;)V

    return-void
.end method

.method public static final c(Ldge;FFFFF)V
    .locals 2

    iget-object v0, p0, Ldge;->B0:Landroidx/appcompat/widget/AppCompatImageView;

    iget-object v1, p0, Ldge;->a:Landroid/animation/FloatEvaluator;
    ...
    iget-object p0, p0, Ldge;->J0:Landroid/widget/FrameLayout;
...
.method private final getFlashAutoDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Ldge;->K0:Ljava/lang/Object;
...
.method private final getFlashOffDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Ldge;->M0:Ljava/lang/Object;
...
.method private final getFlashOnDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Ldge;->L0:Ljava/lang/Object;
...
.method public final getCameraApi()Luc2;
    .locals 1

    iget-object v0, p0, Ldge;->A0:Lru/ok/tamtam/android/widgets/quickcamera/CameraxCameraApiView;
