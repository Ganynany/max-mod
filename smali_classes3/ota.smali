...
.field public final r:Lce3;

.field public volatile s:Ljava/lang/Integer;


# direct methods
.method public constructor <init>(Landroid/content/Context;IZLce3;)V
    .locals 0

    invoke-direct {p0, p1}, Lh19;-><init>(Landroid/content/Context;)V

    iput-boolean p3, p0, Lota;->q:Z

    iput-object p4, p0, Lota;->r:Lce3;
...
# virtual methods
.method public final n(IILs5f;Lq5f;)V
    .locals 10

    sget-object v0, Lpc9;->d:Lpc9;

    iget-object v1, p0, Lota;->s:Ljava/lang/Integer;
    ...
    invoke-virtual {v6, v0, v5, v7, v3}, Lhcc;->c(Lpc9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_1
    :goto_0
    iput v1, p4, Lq5f;->d:I

    iput-object v3, p0, Lota;->s:Ljava/lang/Integer;

    :cond_2
    invoke-super {p0, p1, p2, p3, p4}, Lh19;->n(IILs5f;Lq5f;)V
    ...
    iget-object p4, p4, Lq5f;->e:Landroid/view/animation/Interpolator;
    ...
    invoke-static {v9, p1, v7, p2, v8}, Lhb2;->x(Ljava/lang/String;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p1, v4, p2, v5, v7}, Lhb2;->E(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
...
.method public final o()V
    ...
    iget-object v1, p0, Lota;->r:Lce3;

    invoke-virtual {v1, v0}, Lce3;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-super {p0}, Lh19;->o()V

    return-void
.end method

.method public final p(Landroid/view/View;Ls5f;Lq5f;)V
    .locals 7

    iget-boolean p2, p2, Ls5f;->h:Z
    ...
    iget-object p2, p0, Lh19;->c:Landroidx/recyclerview/widget/a;
    ...
    invoke-virtual/range {v0 .. v5}, Lota;->t(IIIII)I
    ...
    invoke-virtual {p0, p2}, Lh19;->e(I)I
    ...
    :cond_3
    iget-object v1, v0, Lh19;->j:Landroid/view/animation/DecelerateInterpolator;

    invoke-virtual {p3, v6, p1, p2, v1}, Lq5f;->b(IIILandroid/view/animation/BaseInterpolator;)V
...
.method public final u(I)V
    ...
    iput-object p1, p0, Lota;->s:Ljava/lang/Integer;
