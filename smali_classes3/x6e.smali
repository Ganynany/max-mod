...
.method public constructor <init>(Lkotlin/coroutines/Continuation;Lone/me/profile/ProfileScreen;)V
    ...
    iput-object p2, p0, Lx6e;->X:Lone/me/profile/ProfileScreen;
...
.method public final l(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Lkotlin/coroutines/Continuation;
    ...
    iget-object v1, p0, Lx6e;->X:Lone/me/profile/ProfileScreen;

    invoke-direct {v0, p2, v1}, Lx6e;-><init>(Lkotlin/coroutines/Continuation;Lone/me/profile/ProfileScreen;)V

    iput-object p1, v0, Lx6e;->o:Ljava/lang/Object;
...
.method public final n(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v0, Lx6e;->o:Ljava/lang/Object;
    ...
    iget-object v2, v0, Lx6e;->X:Lone/me/profile/ProfileScreen;

    invoke-virtual {v2}, Lone/me/profile/ProfileScreen;->Z0()Lsnc;

    move-result-object v3

    iget-boolean v4, v1, Lyud;->b:Z

    iget-boolean v5, v1, Lyud;->k:Z

    iget-object v6, v1, Lyud;->e:Ljava/lang/CharSequence;

    iget-object v7, v1, Lyud;->h:Lw2i;
    ...
    invoke-direct {v11, v2, v12}, Lcb1;-><init>(Ljava/lang/Object;I)V

    invoke-direct {v9, v10, v11}, Lknc;-><init>(ILre7;)V

    invoke-direct {v4, v8, v9, v8}, Lenc;-><init>(Lnnc;Lnnc;Lknc;)V
    ...
    :goto_0
    invoke-virtual {v3, v4}, Lsnc;->setRightActions(Lhnc;)V

    iget-object v3, v2, Lone/me/profile/ProfileScreen;->B0:Lcye;

    sget-object v4, Lone/me/profile/ProfileScreen;->N0:[Lbv8;

    const/4 v9, 0x4

    aget-object v9, v4, v9

    invoke-interface {v3, v2, v9}, Lcye;->y(Ljava/lang/Object;Lbv8;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Ld3c;

    iget-boolean v9, v1, Lyud;->g:Z
    ...
    :goto_1
    invoke-virtual {v3, v9}, Ld3c;->setOverlay(Lu2c;)V

    iget-wide v9, v1, Lyud;->a:J

    new-instance v11, Ljava/lang/Long;

    invoke-direct {v11, v9, v10}, Ljava/lang/Long;-><init>(J)V

    iget-object v9, v1, Lyud;->f:Ljava/lang/CharSequence;
    ...
    :cond_2
    invoke-static {v9, v11}, Lag3;->b(Ljava/lang/CharSequence;Ljava/lang/Long;)Lck0;

    move-result-object v9

    const/4 v11, 0x1

    invoke-virtual {v3, v9, v11}, Ld3c;->o(Lck0;Z)V

    iget-object v9, v1, Lyud;->c:Ljava/util/List;

    invoke-virtual {v3, v9}, Ld3c;->setAvatarUrls(Ljava/util/List;)V

    iget-boolean v9, v1, Lyud;->j:Z
    ...
    invoke-direct {v9, v2, v12}, Le8;-><init>(Ljava/lang/Object;I)V

    invoke-static {v3, v9}, Lld7;->N(Landroid/view/View;Landroid/view/View$OnClickListener;)V

    iget-object v1, v1, Lyud;->i:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v7, v12}, Lw2i;->b(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    :goto_7
    iget-object v13, v2, Lone/me/profile/ProfileScreen;->F0:Lcye;

    const/16 v14, 0x8

    aget-object v15, v4, v14

    invoke-interface {v13, v2, v15}, Lcye;->y(Ljava/lang/Object;Lbv8;)Ljava/lang/Object;
    ...
    iget-object v9, v2, Lone/me/profile/ProfileScreen;->E0:Lcye;

    const/4 v12, 0x7

    aget-object v12, v4, v12

    invoke-interface {v9, v2, v12}, Lcye;->y(Ljava/lang/Object;Lbv8;)Ljava/lang/Object;
    ...
    iget-object v13, v9, Lx49;->b:Lo49;
    ...
    invoke-static {v12}, Lo49;->a(Ljava/lang/CharSequence;)V
    ...
    :cond_d
    invoke-virtual {v13, v1}, Lo49;->c(Ljava/lang/CharSequence;)V

    :cond_e
    :goto_b
    iget-object v1, v2, Lone/me/profile/ProfileScreen;->D0:Lcye;

    const/4 v9, 0x6

    aget-object v4, v4, v9

    invoke-interface {v1, v2, v4}, Lcye;->y(Ljava/lang/Object;Lbv8;)Ljava/lang/Object;
    ...
    invoke-virtual {v7, v4}, Lw2i;->b(Landroid/content/Context;)Ljava/lang/CharSequence;
    ...
    :goto_c
    invoke-virtual {v1, v4}, Lsnc;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {v2}, Lone/me/profile/ProfileScreen;->Y0()Landroid/widget/TextView;
    ...
    new-instance v14, Lr0j;

    invoke-direct {v14, v7, v10, v3, v9}, Lr0j;-><init>(Landroid/content/Context;IZLp0j;)V
    ...
    invoke-static {v2, v5, v4}, Lzf2;->y(FFI)I

    move-result v2

    invoke-static {v10}, Lidg;->d(I)I
    ...
    invoke-static {v4, v5, v2}, Lzf2;->y(FFI)I
    ...
    invoke-static {v0, v4, v5, v2}, Lhkh;->V0(Ljava/lang/CharSequence;IILjava/lang/CharSequence;)Ljava/lang/StringBuilder;
    ...
    invoke-direct {v0, v7, v10, v3, v9}, Lr0j;-><init>(Landroid/content/Context;IZLp0j;)V
    ...
    invoke-virtual/range {v16 .. v16}, Lone/me/profile/ProfileScreen;->Z0()Lsnc;
    ...
    invoke-static {v2, v0, v1}, Lone/me/profile/ProfileScreen;->V0(Lone/me/profile/ProfileScreen;Lsnc;Z)V
