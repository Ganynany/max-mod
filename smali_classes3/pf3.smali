...
# direct methods
.method public constructor <init>(JJJILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lk70;Ljava/lang/Long;Z)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Lqp;-><init>(J)V

    iput-wide p3, p0, Lpf3;->d:J

    iput-wide p5, p0, Lpf3;->e:J

    iput p7, p0, Lpf3;->f:I

    iput-object p8, p0, Lpf3;->g:Ljava/lang/String;

    iput-boolean p9, p0, Lpf3;->h:Z

    iput-object p10, p0, Lpf3;->i:Ljava/lang/String;

    iput-object p11, p0, Lpf3;->j:Ljava/util/Map;

    iput-object p12, p0, Lpf3;->k:Ljava/lang/String;

    iput-object p13, p0, Lpf3;->l:Ljava/lang/String;

    iput-object p14, p0, Lpf3;->m:Lk70;

    iput-object p15, p0, Lpf3;->n:Ljava/lang/Long;

    move/from16 p1, p16

    iput-boolean p1, p0, Lpf3;->o:Z
...
.method public final d(Ldxh;)V
    ...
    iget-object v0, p1, Lqf3;->c:Lcp2;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lpf3;->w()V
...
.method public final e(Lkwh;)V
    ...
    iget-object v0, p0, Lpf3;->k:Ljava/lang/String;
    ...
    iget-object v0, p0, Lpf3;->n:Ljava/lang/Long;

    if-nez v0, :cond_0

    iget-object v0, p0, Lpf3;->i:Ljava/lang/String;

    if-eqz v0, :cond_1

    :cond_0
    invoke-virtual {p0}, Lpf3;->g()V
...
.method public final j()[B
    ...
    iget-object v2, p0, Lpf3;->k:Ljava/lang/String;
    ...
    :goto_0
    iget-object v2, p0, Lpf3;->l:Ljava/lang/String;
    ...
    :cond_2
    iget-object v2, p0, Lpf3;->n:Ljava/lang/Long;
    ...
    iget-object v2, p0, Lpf3;->i:Ljava/lang/String;
...
.method public final l()Lq2;
    ...
    iget-object v1, v0, Lpf3;->n:Ljava/lang/Long;
    ...
    :goto_1
    iget-boolean v14, v0, Lpf3;->o:Z

    const-wide/16 v15, 0x0

    iget-wide v3, v0, Lpf3;->e:J

    iget-object v6, v0, Lpf3;->g:Ljava/lang/String;

    iget-boolean v7, v0, Lpf3;->h:Z

    iget-object v8, v0, Lpf3;->i:Ljava/lang/String;

    iget-object v9, v0, Lpf3;->j:Ljava/util/Map;

    iget-object v10, v0, Lpf3;->k:Ljava/lang/String;

    iget-object v11, v0, Lpf3;->l:Ljava/lang/String;

    iget-object v12, v0, Lpf3;->m:Lk70;

    invoke-direct/range {v2 .. v16}, Lzu2;-><init>(JILjava/lang/String;ZLjava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;Lk70;Ljava/lang/Long;ZJ)V
