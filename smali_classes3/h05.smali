...
.method public final a(Ldfe;Lgfe;Lpl;)V
    ...
    :try_start_0
    iget-wide v0, p0, Lh05;->b:J

    iget-wide v2, p2, Liu6;->e:J

    cmp-long p1, v0, v2

    if-lez p1, :cond_1

    iget-wide v4, p2, Liu6;->f:J
    ...
    :goto_0
    iput-wide v0, p2, Liu6;->e:J

    if-eqz p1, :cond_1

    iget-object p1, p2, Liu6;->j:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p3, Lpf4;

    const/4 v0, 0x1

    invoke-direct {p3, p2, v0}, Lpf4;-><init>(Ljava/lang/Object;I)V
