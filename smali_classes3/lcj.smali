...
# direct methods
.method public constructor <init>(JJJJJLjava/lang/String;ZZLjava/lang/String;ZLtp5;)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Lqp;-><init>(J)V

    iput-wide p3, p0, Llcj;->d:J

    iput-wide p5, p0, Llcj;->e:J

    iput-wide p7, p0, Llcj;->f:J

    iput-wide p9, p0, Llcj;->g:J

    iput-object p11, p0, Llcj;->h:Ljava/lang/String;

    iput-boolean p12, p0, Llcj;->i:Z

    iput-boolean p13, p0, Llcj;->j:Z

    iput-object p14, p0, Llcj;->k:Ljava/lang/String;

    iput-boolean p15, p0, Llcj;->l:Z

    move-object/from16 p1, p16

    iput-object p1, p0, Llcj;->m:Ltp5;
    ...
    iput-object p1, p0, Llcj;->n:Ljava/lang/String;
...
.method public final d(Ldxh;)V
    ...
    iget-boolean v2, v0, Llcj;->i:Z

    if-eqz v2, :cond_3

    iget-object v2, v1, Lmcj;->c:Ljava/util/Map;
    ...
    :cond_0
    iget-object v2, v0, Llcj;->h:Ljava/lang/String;
    ...
    iget-object v1, v1, Lmcj;->c:Ljava/util/Map;

    invoke-static {v1}, Lbel;->b(Ljava/util/Map;)Ljava/lang/String;

    move-result-object v17

    iget-boolean v1, v0, Llcj;->j:Z

    xor-int/lit8 v25, v1, 0x1

    new-instance v5, Ldzh;

    iget-wide v6, v0, Llcj;->g:J

    iget-wide v9, v0, Llcj;->d:J
    ...
    iget-object v10, v0, Llcj;->h:Ljava/lang/String;

    iget-object v11, v1, Lmcj;->c:Ljava/util/Map;

    iget-wide v4, v0, Lqp;->a:J

    iget-wide v6, v0, Llcj;->d:J

    iget-wide v8, v0, Llcj;->g:J

    invoke-direct/range {v3 .. v11}, Lncj;-><init>(JJJLjava/lang/String;Ljava/util/Map;)V
...
.method public final e(Lkwh;)V
    ...
    :cond_3
    :try_start_1
    iget-object v0, v1, Locj;->a:Llcj;

    invoke-virtual {v0}, Lqp;->o()Ljk9;

    move-result-object v0

    invoke-virtual {v0, v1}, Ljk9;->e(Ljava/lang/Object;)V
    ...
    iget-object v2, v1, Locj;->a:Llcj;

    iget-wide v3, v2, Llcj;->e:J

    iget-wide v5, v2, Llcj;->f:J
    ...
    invoke-virtual {v0, v3, v4, v2}, Lh2c;->x(JLjava/util/List;)J

    move-result-wide v2

    iput-wide v2, v1, Locj;->b:J
    :try_end_1
    ...
    iget-wide v2, p0, Llcj;->g:J

    iget-object v4, p0, Llcj;->h:Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v3, v4, v5}, Lfja;->p(JLjava/lang/String;Lwd4;)V
...
.method public final l()Lq2;
    ...
    iget-wide v6, p0, Llcj;->f:J

    iget-object v1, p0, Llcj;->k:Ljava/lang/String;

    iget-wide v2, p0, Llcj;->d:J

    iget-wide v4, p0, Llcj;->e:J

    invoke-direct/range {v0 .. v7}, Li2j;-><init>(Ljava/lang/String;JJJ)V
