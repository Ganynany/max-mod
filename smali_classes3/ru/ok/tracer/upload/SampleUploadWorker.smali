...
.method public final g()Lt69;
    ...
    iget-object v1, p0, Lu69;->b:Landroidx/work/WorkerParameters;
    ...
    iget-object v4, v1, Landroidx/work/WorkerParameters;->b:Lg05;

    const-string v5, "tracer_sample_file_path"

    invoke-virtual {v4, v5}, Lg05;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, v5, v6, v7}, Lg05;->c(Ljava/lang/String;J)J
    ...
    invoke-virtual {v1, v5, v7, v8}, Lg05;->c(Ljava/lang/String;J)J
    ...
    invoke-static {v1, v0}, Lnjk;->w(Landroid/content/pm/PackageManager;Ljava/lang/String;)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {v0}, Lvni;->L(Landroid/content/pm/PackageInfo;)J
...
.method public final h(Ljava/lang/String;Ljava/lang/Long;)Ljava/lang/String;
    ...
    iget-object v4, v3, Landroidx/work/WorkerParameters;->b:Lg05;

    const-string v5, "tracer_custom_properties_keys"

    iget-object v4, v4, Lg05;->a:Ljava/util/HashMap;
    ...
    iget-object v9, v3, Landroidx/work/WorkerParameters;->b:Lg05;

    invoke-virtual {v9, v8}, Lg05;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v4, Ldbi;->a:Ldbi;

    sget-object v4, Ldbi;->e:Lodg;
    ...
    :goto_2
    invoke-virtual {v4}, Lodg;->c()Lsuh;

    move-result-object v4

    invoke-virtual {v2}, Ltk9;->isEmpty()Z
    ...
    :cond_6
    iget-object v6, v4, Lsuh;->m:Ljava/util/Map;

    invoke-static {v2, v6}, Lul9;->d0(Ljava/util/Map;Ljava/util/Map;)Ljava/util/LinkedHashMap;

    move-result-object v2

    const/16 v6, 0x2fff

    invoke-static {v4, v5, v2, v6}, Lsuh;->a(Lsuh;ZLjava/util/Map;I)Lsuh;
    ...
    invoke-virtual {v4, v6}, Lg05;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p1, v3, Landroidx/work/WorkerParameters;->b:Lg05;

    const-string p2, "tracer_has_attr1"

    invoke-virtual {p1, p2, v5}, Lg05;->b(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1, p2, v7, v8}, Lg05;->c(Ljava/lang/String;J)J
    ...
    invoke-direct {p1, v4}, Ly6a;-><init>(I)V
    ...
    invoke-static {v4, v5}, Lvnb;->f(Ljava/lang/String;Ljava/lang/String;)Lr18;

    move-result-object v4

    invoke-direct {v0, p1, v4}, Lyn6;-><init>(Ljava/lang/String;Lg28;)V

    invoke-virtual {v2}, Lorg/json/JSONObject;->toString()Ljava/lang/String;

    sget-object p1, Ldbi;->h:Ldth;
    ...
    invoke-virtual {p1, v0}, Ll28;->b(Lyn6;)Lh28;

    move-result-object p1

    :try_start_0
    iget-object v0, p1, Lh28;->c:Lr18;

    new-instance v2, Lorg/json/JSONObject;

    iget-object v0, v0, Lr18;->b:[B

    invoke-static {v0}, Lpkh;->t0([B)Ljava/lang/String;

    move-result-object v0

    invoke-direct {v2, v0}, Lorg/json/JSONObject;-><init>(Ljava/lang/String;)V

    iget-object v0, v3, Landroidx/work/WorkerParameters;->b:Lg05;

    invoke-virtual {v0, v6}, Lg05;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iget-object v3, v3, Landroidx/work/WorkerParameters;->b:Lg05;

    invoke-virtual {v3, p2}, Lg05;->d(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    invoke-static {v2, v0, p2}, Ltnb;->m(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
...
.method public final i(Ljava/io/File;Ljava/lang/String;)V
    ...
    iget-object v1, v0, Landroidx/work/WorkerParameters;->b:Lg05;

    const-string v2, "tracer_feature_uze_gzip"

    const/4 v3, 0x1

    invoke-virtual {v1, v2, v3}, Lg05;->b(Ljava/lang/String;Z)Z
    ...
    iget-object v5, p0, Lu69;->a:Landroid/content/Context;
    ...
    invoke-static {v4, v7, v8, v2}, Lpkh;->w0(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v6}, Li35;->S(Ljava/io/File;)V
    ...
    invoke-static {v6, v1}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v1

    :try_start_0
    invoke-static {p1, v1}, Ly0l;->a(Ljava/io/File;Ljava/io/File;)V
    :try_end_0
    ...
    invoke-direct {v1, v4}, Ly6a;-><init>(I)V

    invoke-virtual {v1}, Ly6a;->f()Lss4;
    ...
    invoke-direct {v4, p1}, Lp2b;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v6, v8, v9, v7, v4}, Lf28;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lg28;)V

    invoke-virtual {v1, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v4, Lc28;

    sget-object v6, Lwte;->b:Lu3;

    invoke-virtual {v6}, Lu3;->d()J
    ...
    invoke-direct {v4, v3, v1}, Lc28;-><init>(Ljava/lang/String;Ljava/util/List;)V

    new-instance v1, Lyn6;

    invoke-direct {v1, p2, v4}, Lyn6;-><init>(Ljava/lang/String;Lg28;)V

    :try_start_1
    sget-object p2, Ldbi;->h:Ldth;
    ...
    invoke-virtual {p2, v1}, Ll28;->b(Lyn6;)Lh28;
    ...
    iget-object v3, p2, Lh28;->b:Ljava/lang/String;

    iget-object v4, p2, Lh28;->c:Lr18;
    ...
    :cond_4
    :goto_3
    iget-object v4, v0, Landroidx/work/WorkerParameters;->b:Lg05;
    ...
    invoke-static {v5, v6, v2}, Lpkh;->y0(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    :try_start_4
    invoke-static {v2, v4, v0}, Ltnb;->m(Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;)V
