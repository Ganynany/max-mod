...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Lgse;->UiUtils_TextAppearance_LongRoundedTitleSubtitleButton_Title:I
    ...
    sget v1, Lgse;->UiUtils_TextAppearance_LongRoundedTitleSubtitleButton_Subtitle:I

    invoke-direct {v0, p1, v1}, Landroid/text/style/TextAppearanceSpan;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->A0:Landroid/text/style/TextAppearanceSpan;

    sget-object v0, Lrse;->LongRoundedTitleSubtitleButton:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lrse;->LongRoundedTitleSubtitleButton_lrts_title:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p2

    sget v0, Lrse;->LongRoundedTitleSubtitleButton_lrts_subtitle:I
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lru/ok/utils/widgets/LongRoundedTitleSubtitleButton;->d(Liyh;)V
...
.method public final d(Liyh;)V
    ...
    invoke-static {v1, v3}, Lkve;->W(IF)I
    ...
    invoke-static {v0, v1, v1, v4}, Lgbb;->L(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;[F)Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-static {v3, v1, v1, v4}, Lgbb;->L(Ljava/lang/Integer;Ljava/lang/Integer;Ljava/lang/Integer;[F)Landroid/graphics/drawable/GradientDrawable;

    move-result-object v3

    invoke-static {v0, v1, v3}, Lgbb;->T(Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;Landroid/graphics/drawable/GradientDrawable;)Landroid/graphics/drawable/StateListDrawable;
