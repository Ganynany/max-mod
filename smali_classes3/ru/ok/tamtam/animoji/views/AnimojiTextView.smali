...
# instance fields
.field public final B0:Lmn;

.field public C0:Lrvc;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p2, p0, p3}, Lkn;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p0, p2, p3}, Lmn;-><init>(Lru/ok/tamtam/animoji/views/AnimojiTextView;Lkn;Ll;)V

    iput-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->B0:Lmn;

    .line 3
    iget-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->C0:Lrvc;
    ...
    .line 8
    iput-object p1, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->C0:Lrvc;
...
.method public final getAnimojiEnabled()Z
    ...
    iget-object v0, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->B0:Lmn;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v2, v3}, Llk;->b(Ljava/lang/String;Ljava/lang/String;)V

    :cond_0
    iget-object v0, v0, Lmn;->o:Ljava/lang/Object;
    ...
    invoke-static {v2, p1}, Llk;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public setText(Ljava/lang/CharSequence;Landroid/widget/TextView$BufferType;)V
    ...
    iput-object v0, p0, Lru/ok/tamtam/animoji/views/AnimojiTextView;->C0:Lrvc;
    ...
    iget-object v2, v0, Lmn;->d:Ljava/lang/Object;
    ...
    invoke-virtual {v4, p1}, Liy5;->f(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
    ...
    invoke-direct {v6, v4}, Lpdf;-><init>(Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, p1, p2}, Lkn;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    goto :goto_6

    :cond_8
    invoke-virtual {v3, v4}, Ljm;->a(Ljava/lang/CharSequence;)Ljava/util/List;
    ...
    :cond_9
    invoke-interface {v1}, Ljy5;->a()Z

    move-result p1

    if-eqz p1, :cond_a

    invoke-interface {v1, v5}, Ljy5;->setEmojiCompatEnabled(Z)V
    ...
    iget-object p1, v0, Lmn;->X:Ljava/lang/Object;
    ...
    invoke-direct {p1, v1}, Llm;-><init>(Lru/ok/tamtam/animoji/views/AnimojiTextView;)V

    iput-object p1, v0, Lmn;->X:Ljava/lang/Object;
    ...
    invoke-static {p1, v3, v0}, Lxsk;->a(Landroid/text/Spannable;Ljava/util/ArrayList;Ljm;)V

    invoke-static {v4}, Lxsk;->c(Ljava/lang/CharSequence;)V

    :goto_5
    invoke-virtual {v2, v4, p2}, Lkn;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
