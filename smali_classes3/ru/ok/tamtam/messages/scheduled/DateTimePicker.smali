...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget p2, Lwhe;->date_picker_today_margin_top:I
    ...
    sget v0, Lvne;->date_time_picker:I

    invoke-static {p1, v0, p0}, Landroid/view/View;->inflate(Landroid/content/Context;ILandroid/view/ViewGroup;)Landroid/view/View;

    sget v0, Lcne;->days_recycler_view:I
    ...
    sget v1, Lcne;->hours_recycler_view:I
    ...
    sget v2, Lcne;->minutes_recycler_view:I
    ...
    sget v3, Lwhe;->date_picker_item_height:I
    ...
    sget-object v5, Lj25;->j:Lj25;

    invoke-direct {v4, v5}, Lt59;-><init>(Lkve;)V

    const/4 v5, 0x1

    invoke-virtual {v4, v5}, Lz4f;->E(Z)V
    ...
    new-instance v7, Lgj1;

    const/4 v8, 0x1

    invoke-direct {v7, p2, v8}, Lgj1;-><init>(II)V

    const/4 v8, -0x1

    invoke-virtual {v0, v7, v8}, Landroidx/recyclerview/widget/RecyclerView;->j(Lf5f;I)V
    ...
    invoke-direct {v9, p0, v10, v4}, Lau;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-direct {v7, p1, v9}, Lru/ok/tamtam/messages/scheduled/SliderLayoutManager;-><init>(Landroid/content/Context;Lr0h;)V
    ...
    invoke-direct {v4, v3}, Lduc;-><init>(I)V

    invoke-virtual {v0, v4}, Landroidx/recyclerview/widget/RecyclerView;->setEdgeEffectFactory(Ld5f;)V
    ...
    invoke-direct {v4, p2, v7}, Lgj1;-><init>(II)V

    invoke-virtual {v1, v4, v8}, Landroidx/recyclerview/widget/RecyclerView;->j(Lf5f;I)V
    ...
    invoke-direct {v7, p0, v0, v9}, La25;-><init>(Lru/ok/tamtam/messages/scheduled/DateTimePicker;La6i;I)V

    invoke-direct {v4, p1, v7}, Lru/ok/tamtam/messages/scheduled/SliderLayoutManager;-><init>(Landroid/content/Context;Lr0h;)V
    ...
    invoke-direct {v0, v3}, Lduc;-><init>(I)V

    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setEdgeEffectFactory(Ld5f;)V

    new-instance v0, La6i;

    invoke-direct {v0}, La6i;-><init>()V

    invoke-virtual {v2, v0}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Lz4f;)V

    invoke-virtual {v2, v6}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Le5f;)V
    ...
    invoke-direct {v1, p2, v4}, Lgj1;-><init>(II)V

    invoke-virtual {v2, v1, v8}, Landroidx/recyclerview/widget/RecyclerView;->j(Lf5f;I)V

    new-instance p2, Lru/ok/tamtam/messages/scheduled/SliderLayoutManager;

    new-instance v1, La25;

    invoke-direct {v1, p0, v0, v4}, La25;-><init>(Lru/ok/tamtam/messages/scheduled/DateTimePicker;La6i;I)V

    invoke-direct {p2, p1, v1}, Lru/ok/tamtam/messages/scheduled/SliderLayoutManager;-><init>(Landroid/content/Context;Lr0h;)V
    ...
    invoke-direct {p2, v3}, Lduc;-><init>(I)V

    invoke-virtual {v2, p2}, Landroidx/recyclerview/widget/RecyclerView;->setEdgeEffectFactory(Ld5f;)V
    ...
    invoke-virtual {p0, p1}, Lru/ok/tamtam/messages/scheduled/DateTimePicker;->onThemeChanged(Lrmc;)V
...
.method public final setListener$scheduled_send_picker_dialog_release(Ld25;)V
    .locals 0

    iput-object p1, p0, Lru/ok/tamtam/messages/scheduled/DateTimePicker;->R0:Ld25;
