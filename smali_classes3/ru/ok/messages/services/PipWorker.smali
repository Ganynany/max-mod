...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/WorkerParameters;)V
    ...
    iput-object p2, p0, Lru/ok/messages/services/PipWorker;->z0:Ldth;
...
.method public final g(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p0, p1}, Leed;-><init>(Lru/ok/messages/services/PipWorker;Lmp4;)V

    :goto_0
    iget-object p1, v0, Leed;->d:Ljava/lang/Object;
    ...
    invoke-static {v5, p1}, Li35;->p0(ILgu5;)J
    ...
    invoke-virtual {p1}, Lf7c;->f()Lbi5;

    move-result-object p1

    invoke-virtual {p1, v3}, Lbi5;->f(Ljava/lang/String;)V

    :cond_5
    :goto_1
    :try_start_2
    iget-boolean p1, p0, Lu69;->c:Z

    if-nez p1, :cond_6

    iget-object p1, p0, Lru/ok/messages/services/PipWorker;->z0:Ldth;
    ...
    invoke-virtual {v0}, Lf7c;->f()Lbi5;

    move-result-object v0

    invoke-virtual {v0, v3}, Lbi5;->g(Ljava/lang/String;)V
...
.method public final i(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object p1, p1, Lpdd;->a:Laed;

    iget-object v0, p1, Laed;->b:Lcec;

    invoke-virtual {v0}, Lcec;->c()V

    iget-object v0, p1, Laed;->b:Lcec;

    iget-object v1, p1, Laed;->c:Lz65;
    ...
    iput-object v3, v1, Lzrb;->e:[I

    iget-object v3, p1, Laed;->d:Ldth;
    ...
    iput-object v3, v1, Lzrb;->f:Landroid/support/v4/media/session/MediaSessionCompat$Token;
    ...
    iput-object v4, v1, Lzrb;->e:[I

    iget-object v4, p1, Laed;->e:Lxta;
    ...
    invoke-static {v7}, Lcm0;->m(I)I

    move-result v8

    invoke-static {v5, v8}, Lcm0;->W(Landroid/content/Intent;I)I
    ...
    invoke-static {v5, v6}, Lcm0;->W(Landroid/content/Intent;I)I
    ...
    iget-object v6, v0, Lsrb;->F:Landroid/app/Notification;

    iput-object v5, v6, Landroid/app/Notification;->deleteIntent:Landroid/app/PendingIntent;

    const/4 v5, 0x2

    invoke-virtual {v0, v5, v3}, Lsrb;->f(IZ)V

    const/16 v3, 0x8

    invoke-virtual {v0, v3, v2}, Lsrb;->f(IZ)V

    iget-object p1, p1, Laed;->a:Landroid/content/Context;
    ...
    invoke-virtual {v0, p1}, Lsrb;->d(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v2}, Lcm0;->W(Landroid/content/Intent;I)I
    ...
    invoke-direct {v3, v2, v4, p1}, Lkrb;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    iget-object p1, v0, Lsrb;->b:Ljava/util/ArrayList;

    invoke-virtual {p1, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0, v1}, Lsrb;->i(Lhsb;)V
    ...
    invoke-direct {v0, v9, p1, v1}, Ld77;-><init>(ILandroid/app/Notification;I)V
