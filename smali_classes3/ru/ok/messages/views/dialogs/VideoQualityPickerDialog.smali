...
.method public final k0()Landroid/app/Dialog;
    ...
    iget-object v6, v6, Lpee;->a:Lkee;

    iget-object v6, v6, Lkee;->a:Liee;
    ...
    invoke-static {v2}, Lhb9;->U(Landroid/content/Context;)Liyh;
    ...
    iget-object v7, v7, Lpee;->a:Lkee;

    iget-boolean v9, v7, Lkee;->f:Z

    iget-object v10, v7, Lkee;->a:Liee;

    iget-object v10, v10, Liee;->a:Ljava/lang/String;
    ...
    iget-wide v13, v7, Lkee;->e:J

    const/4 v7, 0x0

    invoke-static {v13, v14, v8, v7}, Ln3i;->v(JZLandroid/content/Context;)Ljava/lang/String;

    move-result-object v7

    if-eqz v9, :cond_3

    invoke-static {v12, v7}, Lzf2;->p(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v1, v2, v3}, Lum9;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v2}, Lum9;->a(Ljava/lang/String;)Lum9;
    ...
    invoke-direct {v3, p0, v0}, Lddj;-><init>(Lru/ok/messages/views/dialogs/VideoQualityPickerDialog;Ljava/util/ArrayList;)V

    iget-object v0, v1, Llf;->a:Lgf;

    iput-object v2, v0, Lgf;->n:[Ljava/lang/CharSequence;

    iput-object v3, v0, Lgf;->p:Landroid/content/DialogInterface$OnClickListener;

    iput v5, v0, Lgf;->s:I

    iput-boolean v8, v0, Lgf;->r:Z
    ...
    invoke-direct {v2, p0, v3}, Lu94;-><init>(Landroidx/fragment/app/DialogFragment;I)V

    iget-object v3, v1, Llf;->a:Lgf;

    iput-object v0, v3, Lgf;->k:Ljava/lang/CharSequence;

    iput-object v2, v3, Lgf;->l:Landroid/content/DialogInterface$OnClickListener;

    invoke-virtual {v1}, Lum9;->create()Lmf;
