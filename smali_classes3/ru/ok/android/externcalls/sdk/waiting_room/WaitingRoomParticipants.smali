...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Ljte;)V",
        "Lm91;",
        "call",
        "Ltpi;",
        "setCall",
        ...
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lgyg;",
        "Li52;",
        "fromId",
        "Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$WaitingParticipantsPage;",
        ...
        "internalId",
        "fromInternalLong",
        "(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Ltt1;)Li52;",
        "",
        "Lh52;",
        "waitingParticipants",
        "Lkotlin/Function1;",
...
# instance fields
.field private volatile call:Lm91;

.field private final compositeDisposable:Lq44;
...
.field private final loadEventSubject:Ldce;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$Listener;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;Ljte;)V
    .locals 2
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Ljte;

    new-instance p1, Ldce;

    invoke-direct {p1}, Ldce;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Ldce;

    new-instance p2, Lq44;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lq44;
    ...
    invoke-direct {p4, p1, v0, v1}, Llxb;-><init>(Ldce;Lqqf;I)V

    invoke-static {}, Ldrf;->b()Lqqf;

    move-result-object p1

    invoke-virtual {p4, p1}, Lxwb;->h(Lqqf;)Lvyb;
    ...
    invoke-direct {v0, p1, p4, v1}, Lbyb;-><init>(Lxwb;Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p3}, Lxf7;-><init>(Ljava/lang/Object;)V

    new-instance p3, Laxb;

    const/4 p4, 0x1

    invoke-direct {p3, v0, p1, p4}, Laxb;-><init>(Lxwb;Ljava/lang/Object;I)V

    invoke-static {}, Ltg;->a()Lqqf;

    move-result-object p1

    invoke-virtual {p3, p1}, Lxwb;->h(Lqqf;)Lvyb;
    ...
    invoke-virtual {p1, p3}, Lxwb;->i(Lwd4;)Lcx8;
...
.method public static synthetic a(Lm91;Li52;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lmyg;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6(Lm91;Li52;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Loyg;)V
...
.method public static synthetic b(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Lmyg;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Loyg;)V

    return-void
.end method

.method public static synthetic c(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Loyg;Lc62;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Loyg;Lc62;)V

    return-void
.end method

.method public static synthetic d(Loyg;)V
    .locals 0

    invoke-static {p0}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Loyg;)V

    return-void
.end method

.method public static synthetic e(Loyg;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle$lambda$1$lambda$0(Loyg;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V

    return-void
.end method

.method private final fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Ltt1;)Li52;
    .locals 3
    ...
    invoke-direct {v0, p2, v1, v2}, Li52;-><init>(Ltt1;J)V
...
.method private final getInternalIdsToResolve(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v1, v1, Lh52;->a:Li52;

    iget-object v1, v1, Li52;->b:Ltt1;
    ...
    invoke-virtual {v2, v1}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final getResolvedWaitingParticipantIds(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v2, v1, Lh52;->a:Li52;

    iget-object v2, v2, Li52;->b:Ltt1;
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
.method private final loadWaitingParticipantIds()Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipantsUpdate;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lm91;
    ...
    :try_start_0
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lgyg;

    move-result-object v6

    invoke-virtual {v6}, Lgyg;->e()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Ltt1;

    invoke-direct {p0, v3, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->fromInternalLong(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Ltt1;)Li52;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->log:Ljte;
    ...
    :goto_0
    :try_start_1
    invoke-direct {p0, v0, v6}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadWaitingParticipantIdsPageSingle(Lm91;Li52;)Lgyg;
    ...
    invoke-static {v3, v0, v2, v4}, Lqvi;->m(Ljava/lang/String;Ljava/lang/String;Ljte;Ljava/lang/String;)V
...
.method private final loadWaitingParticipantIdsPageSingle(Lm91;Li52;)Lgyg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1, p2, p0, v1}, Lwlf;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lbzb;

    const/4 p2, 0x1

    invoke-direct {p1, v0, p2}, Lbzb;-><init>(Ljava/lang/Object;I)V

    return-object p1
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6(Lm91;Li52;Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Loyg;)V
    .locals 7
    ...
    invoke-direct {v0, p2, v1, p3}, Lgzc;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p2, Ly9i;

    const/16 v1, 0xf

    invoke-direct {p2, p3, v1}, Ly9i;-><init>(Ljava/lang/Object;I)V

    iget-object p3, p0, Lm91;->k:Lmvg;
    ...
    iget-object v5, p1, Li52;->b:Ltt1;

    invoke-virtual {v5}, Ltt1;->b()Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, p1}, Lsj7;->b(ILjava/lang/String;)V
    :try_end_0
    ...
    invoke-direct {p1, p0, v0, p2, v2}, Lu81;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p0, Lf91;

    const/4 v0, 0x0

    invoke-direct {p0, p2, v0}, Lf91;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p3, v1, v4, p1, p0}, Lmvg;->d(Lqvg;ZLjvg;Ljvg;)V
...
.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Loyg;Lc62;)V
    .locals 8

    iget-object v2, p2, Lc62;->a:Ljava/util/ArrayList;
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Loyg;Lc62;Loyg;)V
    ...
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$loadWaitingParticipantIdsPageSingle$lambda$6$lambda$4$$inlined$resolveInternalIds$2;-><init>(Loyg;)V
    ...
    invoke-virtual {p0, p1}, Lmyg;->b(Ljava/lang/Object;)V

    return-void
.end method

.method private static final loadWaitingParticipantIdsPageSingle$lambda$6$lambda$5(Loyg;)V
    .locals 2
    ...
    invoke-virtual {p0, v0}, Lmyg;->c(Ljava/lang/Throwable;)Z
...
.method private final putIdMappingsToCache(Ljava/util/List;)V
    ...
    iget-object v1, v0, Lh52;->b:Lni1;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/id/CallExternalIdConverter;->convert(Lni1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    iget-object v0, v0, Lh52;->a:Li52;

    iget-object v0, v0, Li52;->b:Ltt1;

    invoke-virtual {v2, v1, v0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->addMapping(Lru/ok/android/externcalls/sdk/id/ParticipantId;Ltt1;)V
...
.method private final resolveInternalIdSingle(Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)Lgyg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private static final resolveInternalIdSingle$lambda$1(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;Loyg;)V
    .locals 4
    ...
    invoke-direct {v1, p2, v2}, Lud4;-><init>(Ljava/lang/Object;I)V

    new-instance v2, Lxyg;

    const/16 v3, 0x1d

    invoke-direct {v2, p2, v3, p1}, Lxyg;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    invoke-interface {p0, v0, v1, v2}, Lru/ok/android/externcalls/sdk/id/mapping/IdMappingResolver;->withInternalId(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lxd4;Ljava/lang/Runnable;)V

    return-void
.end method

.method private static final resolveInternalIdSingle$lambda$1$lambda$0(Loyg;Lru/ok/android/externcalls/sdk/waiting_room/ConversationWaitingParticipantId;)V
    .locals 3
    ...
    invoke-virtual {p0, v0}, Lmyg;->a(Ljava/lang/Throwable;)V

    return-void
.end method

.method private final resolveInternalIds(Ljava/util/List;Lre7;Lre7;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v2, p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$1;-><init>(Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;Ljava/util/List;Lre7;Lre7;)V

    new-instance p1, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;

    invoke-direct {p1, p3}, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants$resolveInternalIds$2;-><init>(Lre7;)V
...
.method private final scheduleLoad()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->loadEventSubject:Ldce;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->compositeDisposable:Lq44;
...
.method public final setCall(Lm91;)V
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/waiting_room/WaitingRoomParticipants;->call:Lm91;
