...
.method public constructor <init>(Ld6i;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/log/stat/ProductStatisticsManagerImpl;->timeProvider:Ld6i;
...
.method public getTime(J)J
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/log/stat/ProductStatisticsManagerImpl;->timeProvider:Ld6i;

    invoke-interface {p1}, Ld6i;->utcTimeMs()J
