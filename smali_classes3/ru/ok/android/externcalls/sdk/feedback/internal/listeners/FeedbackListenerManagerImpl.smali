...
.method private final processFeedbackForResolvedInternalIds(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Ltt1;
    ...
    invoke-virtual {v2, v3}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-direct/range {v4 .. v11}, Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedback;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/feedback/ParticipantFeedbackSource;ILf75;)V
...
.method private final scheduleRemoving()V
    ...
    invoke-direct {v5, p0, v0, v1, v6}, Lwc0;-><init>(Ljava/lang/Object;JI)V
...
.method private final unrollReceivedFeedback(Lzi1;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p1, p1, Lzi1;->b:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lyi1;->b:Ljava/lang/Object;
    ...
    iget-object v5, v1, Lyi1;->a:Ljava/lang/String;
    ...
    invoke-direct {v6, v4, v5}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;-><init>(Ltt1;Ljava/lang/String;)V
    ...
    :cond_0
    invoke-static {v3, v0}, Lmy3;->x0(Ljava/lang/Iterable;Ljava/util/AbstractCollection;)V
...
.method public onFeedback(Lzi1;)V
    .locals 5

    iget-object v0, p1, Lzi1;->a:Lbdg;
    ...
    invoke-virtual {v1}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lbdg;
    ...
    :cond_0
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl;->unrollReceivedFeedback(Lzi1;)Ljava/util/List;
    ...
    invoke-virtual {v4}, Lru/ok/android/externcalls/sdk/feedback/internal/listeners/FeedbackListenerManagerImpl$CallParticipantFeedback;->getParticipantId()Ltt1;
    ...
    invoke-direct {v3, p0, p1, v0, v4}, Lax5;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lzp5;

    const/16 v4, 0x13

    invoke-direct {p1, p0, v4, v0}, Lzp5;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
