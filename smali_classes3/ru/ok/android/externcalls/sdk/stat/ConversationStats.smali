...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lpe7;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lnr4;Lru/ok/android/externcalls/sdk/Conversation$CallType;Ld6i;Ljte;ZZ)V",
...
# direct methods
.method public constructor <init>(Lpe7;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lnr4;Lru/ok/android/externcalls/sdk/Conversation$CallType;Ld6i;Ljte;ZZ)V
    .locals 1
    ...
    invoke-direct {v0, p5, p1}, Lru/ok/android/externcalls/sdk/stat/connect/ConversationConnectedToSignalingStat;-><init>(Ld6i;Lpe7;)V
    ...
    invoke-direct {v0, p2, p3}, Lru/ok/android/externcalls/sdk/stat/reconnect/ConversationReconnectStat;-><init>(Lru/ok/android/externcalls/sdk/log/ExtLogger;Lnr4;)V
    ...
    invoke-direct {p2, p5, p1}, Lru/ok/android/externcalls/sdk/stat/warmup/ConversationPreparedStat;-><init>(Ld6i;Lpe7;)V
    ...
    invoke-direct {p2, p4, p5, p1}, Lru/ok/android/externcalls/sdk/stat/start/ConversationStartedStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;Ld6i;Lpe7;)V
    ...
    invoke-direct {p2, p1, p5, p6, p8}, Lru/ok/android/externcalls/sdk/stat/signaling/SignalingTransportStat;-><init>(Lpe7;Ld6i;Ljte;Z)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/kws/ConversationKwsStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p4, p7, p1}, Lru/ok/android/externcalls/sdk/stat/init/CallInitStat;-><init>(Lru/ok/android/externcalls/sdk/Conversation$CallType;ZLpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidatePairChangedStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/icerestart/IceRestartStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1, p5}, Lru/ok/android/externcalls/sdk/stat/topology/ServerTopologyRequestedStat;-><init>(Lpe7;Ld6i;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/connection/PeerConnectionChangedStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/negotiation/NegotiationErrorStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/mldownload/MLDownloadStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/p2prelay/P2PRelayRequestedStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/accept/AcceptCallStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/audio/AudioErrorStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateGatheringFailedStat;-><init>(Lpe7;)V
    ...
    invoke-direct {p2, p1}, Lru/ok/android/externcalls/sdk/stat/candidate/IceCandidateAddFailedStat;-><init>(Lpe7;)V
