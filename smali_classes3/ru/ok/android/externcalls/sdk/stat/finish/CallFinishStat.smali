...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "Ltpi;",
        "report",
        "(Lli1;Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;Ljava/util/List;Ljava/lang/String;Z)V",
        "onCallFinished",
...
.method public constructor <init>(Lpe7;)V
    ...
    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/stat/internal/SingleShotStat;-><init>(Lpe7;)V

    return-void
.end method

.method public static final synthetic access$report(Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;Lli1;Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;Ljava/util/List;Ljava/lang/String;Z)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;->report(Lli1;Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;Ljava/util/List;Ljava/lang/String;Z)V
...
.method private final report(Lli1;Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;Ljava/util/List;Ljava/lang/String;Z)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p3, v0}, Liy3;->u0(Ljava/lang/Iterable;I)I
    ...
    :cond_2
    invoke-static {p2}, Lgy3;->b1(Ljava/lang/Iterable;)Ljava/util/List;
    ...
    invoke-virtual {p1, p2, p4, p5}, Lmi1;->c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    return-void
.end method

.method public static synthetic report$default(Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;Lli1;Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;Ljava/util/List;Ljava/lang/String;ZILjava/lang/Object;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/stat/finish/CallFinishStat;->report(Lli1;Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;Ljava/util/List;Ljava/lang/String;Z)V
...
.method public final onCallFinished(Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;Ljava/util/List;Ljava/lang/String;Z)V
    ...
    invoke-virtual {p0, v0}, Lru/ok/android/externcalls/sdk/stat/internal/SingleShotStat;->reportOnce(Lre7;)V
