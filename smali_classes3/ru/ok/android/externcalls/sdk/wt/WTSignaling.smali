...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "peerIdGenerator",
        "<init>",
        "(JLivg;Lkwg;Ljava/util/concurrent/ExecutorService;Ljte;Lgd9;Lkte;JZLo36;ZLd6i;Lmwg;ZZZZLpe7;)V",
        "isFallbackSupported",
        "()Z",
        "",
        "code",
...
# instance fields
.field private final client$delegate:Lpx8;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/wt/WTSignaling$Companion;-><init>(Lf75;)V
...
.method private constructor <init>(JLivg;Lkwg;Ljava/util/concurrent/ExecutorService;Ljte;Lgd9;Lkte;JZLo36;ZLd6i;Lmwg;ZZZZLpe7;)V
    .locals 22
    ...
    invoke-direct {v1, v2, v0, v3}, Lru/ok/android/externcalls/sdk/wt/WTSignaling$client$2;-><init>(Lgd9;Lru/ok/android/externcalls/sdk/wt/WTSignaling;Lmwg;)V
    ...
    .line 9
    iput-object v2, v0, Lru/ok/android/externcalls/sdk/wt/WTSignaling;->client$delegate:Lpx8;
...
.method public synthetic constructor <init>(JLivg;Lkwg;Ljava/util/concurrent/ExecutorService;Ljte;Lgd9;Lkte;JZLo36;ZLd6i;Lmwg;ZZZZLpe7;Lf75;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p20}, Lru/ok/android/externcalls/sdk/wt/WTSignaling;-><init>(JLivg;Lkwg;Ljava/util/concurrent/ExecutorService;Ljte;Lgd9;Lkte;JZLo36;ZLd6i;Lmwg;ZZZZLpe7;)V

    return-void
.end method

.method public static final synthetic access$getHostnameVerifier(Lru/ok/android/externcalls/sdk/wt/WTSignaling;)Lnwg;
    .locals 0

    invoke-virtual {p0}, Lpwg;->getHostnameVerifier()Lnwg;
...
.method public static final synthetic access$init(Lru/ok/android/externcalls/sdk/wt/WTSignaling;)V
    ...
    invoke-virtual {p0}, Lpwg;->init()V

    return-void
.end method

.method private final getClient()Lb18;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/wt/WTSignaling;->client$delegate:Lpx8;
...
.method public safelyCreateNewSocket(Ljava/lang/String;Lowg;)V
    .locals 6

    new-instance v0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;

    invoke-virtual {p0}, Lpwg;->getLog()Ljte;

    move-result-object v2

    invoke-direct {p0}, Lru/ok/android/externcalls/sdk/wt/WTSignaling;->getClient()Lb18;
    ...
    invoke-direct {v4, v1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportCompressorDecompressor;-><init>(Ljte;)V

    new-instance v5, Lru/ok/android/externcalls/sdk/wt/WTSignaling$safelyCreateNewSocket$1;

    invoke-direct {v5, p2}, Lru/ok/android/externcalls/sdk/wt/WTSignaling$safelyCreateNewSocket$1;-><init>(Lowg;)V

    move-object v1, p1

    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;-><init>(Ljava/lang/String;Ljte;Lb18;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$CompressorDecompressor;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
...
.method public safelyDoIfSocketExists(Lre7;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
