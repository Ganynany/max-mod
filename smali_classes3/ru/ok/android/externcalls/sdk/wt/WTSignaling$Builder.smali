...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "fallbackParams",
        "setFallbackParams",
        "(Lmwg;)Lru/ok/android/externcalls/sdk/wt/WTSignaling$Builder;",
...
# instance fields
.field private fallbackParams:Lmwg;
...
# virtual methods
.method public bridge synthetic build()Llvg;
    .locals 1
...
.method public build()Lru/ok/android/externcalls/sdk/wt/WTSignaling;
    ...
    .line 2
    invoke-virtual {v0}, Lnvg;->getSignalingStat()Lkwg;
    ...
    .line 3
    invoke-virtual {v0}, Lnvg;->getExecutor()Ljava/util/concurrent/ExecutorService;
    ...
    .line 4
    invoke-virtual {v0}, Lnvg;->getLog()Ljte;
    ...
    .line 5
    invoke-virtual {v0}, Lnvg;->getTimeProvider()Ld6i;
    ...
    .line 6
    invoke-virtual {v0}, Lnvg;->getLogConfiguration()Lkte;
    ...
    .line 7
    invoke-virtual {v0}, Lnvg;->getEndpointParameters()Lo36;
    ...
    invoke-direct {v10, v9}, Lru/ok/android/externcalls/sdk/wt/WTSignaling$Builder$build$logger$1;-><init>(Ljte;)V
    ...
    .line 11
    invoke-virtual {v10, v1}, Ldr0;->logRaw(Z)V

    .line 12
    invoke-virtual {v10, v1}, Ldr0;->logDebug(Z)V

    .line 13
    invoke-virtual {v10, v1}, Ldr0;->logFlowControl(Z)V
    ...
    .line 15
    invoke-virtual {v0}, Lnvg;->getTimeoutMS()J

    move-result-wide v4

    .line 16
    invoke-virtual {v0}, Lnvg;->getConnectFailureListener()Livg;
    ...
    .line 20
    invoke-virtual {v0}, Lnvg;->getServerPingTimeoutMs()J

    move-result-wide v12

    .line 21
    invoke-virtual {v0}, Lnvg;->isFastRecoverEnabled()Z
    ...
    .line 23
    invoke-virtual {v0}, Lnvg;->isReplaceParametersInEndpointEnabled()Z
    ...
    .line 25
    iget-object v1, v0, Lru/ok/android/externcalls/sdk/wt/WTSignaling$Builder;->fallbackParams:Lmwg;

    .line 26
    invoke-virtual {v0}, Lnvg;->isSummaryStatsEnabled()Z

    move-result v19

    .line 27
    invoke-virtual {v0}, Lnvg;->isSignalingLogThrottlingEnabled()Z

    move-result v20

    .line 28
    invoke-virtual {v0}, Lnvg;->isEndpointValidationEnabled()Z

    move-result v21

    .line 29
    invoke-virtual {v0}, Lnvg;->isUseOfIPEnabled()Z

    move-result v22

    .line 30
    invoke-virtual {v0}, Lnvg;->getPeerIdGenerator()Lpe7;
    ...
    .line 31
    invoke-direct/range {v3 .. v24}, Lru/ok/android/externcalls/sdk/wt/WTSignaling;-><init>(JLivg;Lkwg;Ljava/util/concurrent/ExecutorService;Ljte;Lgd9;Lkte;JZLo36;ZLd6i;Lmwg;ZZZZLpe7;Lf75;)V
...
.method public final setFallbackParams(Lmwg;)Lru/ok/android/externcalls/sdk/wt/WTSignaling$Builder;
    .locals 0

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/wt/WTSignaling$Builder;->fallbackParams:Lmwg;
