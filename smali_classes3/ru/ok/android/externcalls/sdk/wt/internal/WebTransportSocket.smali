...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "listener",
        "<init>",
        "(Ljava/lang/String;Ljte;Lb18;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$CompressorDecompressor;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "Ltpi;",
        "connect",
        ...
        "session",
        "configureSession",
        "(Lvbg;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "openSession",
        "T",
        "action",
        "context",
        ...
        "handler",
        "handleAsync",
        "(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lff7;)V",
        "Le4k;",
        "stream",
        "sendStreamData",
        "(Le4k;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "readStreamData",
        "(Lvbg;Le4k;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V",
        "message",
        "send",
        "(Ljava/lang/String;)V",
        "",
...
# instance fields
.field private final client:Lb18;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Ljava/lang/String;Ljte;Lb18;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$CompressorDecompressor;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 0
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->client:Lb18;
    ...
    invoke-direct {p0, p2, p3, p5, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lff7;)V

    return-void
.end method

.method public static synthetic a(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Le4k;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->configureSession$lambda$5(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Le4k;)V
...
.method public static final synthetic access$sendStreamData(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Le4k;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->sendStreamData(Le4k;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
...
.method public static synthetic c(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Ljava/lang/String;Lff7;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->handleAsync$lambda$7(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Ljava/lang/String;Lff7;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V

    return-void
.end method

.method private final configureSession(Lvbg;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 2
    ...
    invoke-direct {v0, p0, v1, p2}, Lfs2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    check-cast p1, Lmcg;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iput-object v0, p1, Lmcg;->j:Ljava/util/function/BiConsumer;

    new-instance p2, Ld4k;

    const/4 v0, 0x0

    invoke-direct {p2, p0, v0}, Ld4k;-><init>(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;I)V

    iput-object p2, p1, Lmcg;->i:Ljava/util/function/Consumer;
    ...
    iput-object p2, p1, Lmcg;->h:Ljava/util/function/Consumer;
...
.method private static final configureSession$lambda$3(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Ljava/lang/Long;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;
...
.method private static final configureSession$lambda$4(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Le4k;)V
    .locals 1

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;

    const-string p1, "WebTransportSocket"

    const-string v0, "Got new BIDI stream"

    invoke-interface {p0, p1, v0}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method private static final configureSession$lambda$5(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Le4k;)V
    .locals 1
...
.method private final connect(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->client:Lb18;

    invoke-direct {v1, v0, v2}, Lvu3;-><init>(Ljava/net/URI;Lb18;)V

    invoke-virtual {v1, v0}, Lvu3;->b(Ljava/net/URI;)Lmcg;

    move-result-object v0

    iput-object v0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->session:Lvbg;

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->configureSession(Lvbg;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->openSession(Lvbg;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    :try_end_0
...
.method public static synthetic d(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Le4k;)V
    .locals 0

    invoke-static {p0, p1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->configureSession$lambda$4(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Le4k;)V

    return-void
.end method

.method private final handleAsync(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lff7;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-direct/range {v1 .. v7}, Ld72;-><init>(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V
...
.method private static final handleAsync$lambda$7(Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;Ljava/lang/String;Lff7;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 5
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;
    ...
    :try_start_0
    invoke-interface {p2, p3, p4}, Lff7;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {p0, v4, p1}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :try_start_1
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;

    invoke-virtual {p1, v1}, Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    invoke-interface {p3, v4, v1, p2}, Ljte;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private final openSession(Lvbg;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 9
    ...
    invoke-virtual {v0, v1, v2, v3}, Lmcg;->a(Llcg;Ljava/util/function/Predicate;Ljava/util/function/Predicate;)Z

    iget-object v2, v0, Lmcg;->d:Lvu3;

    iget-object v3, v2, Lvu3;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v3}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_0
    iget-object v3, v2, Lvu3;->c:Ljava/util/concurrent/ConcurrentHashMap;

    iget-wide v4, v0, Lmcg;->c:J
    ...
    invoke-direct {v4, v0, v5}, Lp4;-><init>(Ljava/lang/Object;I)V
    ...
    :cond_0
    :goto_0
    iget-object v2, v2, Lvu3;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v2}, Ljava/util/concurrent/locks/ReentrantLock;->unlock()V

    invoke-interface {p2}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;->onOpen()V

    iget-object v2, v0, Lmcg;->e:Llcg;

    sget-object v3, Llcg;->a:Llcg;
    ...
    iget-object v1, v0, Lmcg;->a:Lf18;

    check-cast v1, Le18;

    iget-object v1, v1, Le18;->e:Ljava/lang/Object;

    check-cast v1, Ldfe;

    const/4 v2, 0x1

    invoke-virtual {v1, v2}, Ldfe;->c(Z)Lhfe;

    move-result-object v1

    iget-object v2, v1, Lhfe;->e:Lkih;

    new-instance v3, Lh18;

    invoke-direct {v3, v1, v2}, Lh18;-><init>(Lhfe;Lkih;)V

    invoke-virtual {v3}, Lh18;->a()Ljava/io/OutputStream;
    ...
    invoke-static {v5, v6, v4}, Lvdl;->c(JLjava/nio/ByteBuffer;)I
    ...
    invoke-static {v4, v5, v2}, Lvdl;->c(JLjava/nio/ByteBuffer;)I
    ...
    :cond_2
    iget-object v1, v0, Lmcg;->k:Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-virtual {v1, v3}, Ljava/util/concurrent/ConcurrentLinkedQueue;->add(Ljava/lang/Object;)Z

    iget-object v0, v0, Lmcg;->l:Ljava/util/concurrent/ConcurrentLinkedQueue;
    ...
    invoke-direct {v0, v3, v1}, Lkcg;-><init>(Lj28;I)V
    ...
    invoke-direct {p0, v2, v0, p2, v1}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->handleAsync(Ljava/lang/String;Ljava/lang/Object;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;Lff7;)V

    invoke-direct {p0, p1, v0, p2}, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->readStreamData(Lvbg;Le4k;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    ...
    :goto_3
    iget-object p2, v2, Lvu3;->b:Ljava/util/concurrent/locks/ReentrantLock;
...
.method private final readStreamData(Lvbg;Le4k;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 6
    ...
    :try_start_0
    invoke-interface {p2}, Le4k;->b()Ljava/io/InputStream;
    ...
    :goto_0
    :try_start_1
    invoke-static {p2}, Lvdl;->h(Ljava/io/InputStream;)I
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;

    const-string p3, "stream closed, leave recv loop"

    invoke-interface {p2, v0, p3}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2
    ...
    invoke-interface {p3, v0, v1, p2}, Ljte;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {p3, v0, p1}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V

    throw p2
.end method

.method private final sendStreamData(Le4k;Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket$Listener;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :goto_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;
    ...
    :cond_0
    :try_start_4
    invoke-interface {p1}, Le4k;->a()Ljava/io/OutputStream;
    ...
    sget-object v5, Lyo2;->a:Ljava/nio/charset/Charset;
    ...
    :try_start_6
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->log:Ljte;

    const-string v3, "Error on write to wt stream"

    invoke-interface {v1, v0, v3, p1}, Ljte;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-interface {v1, v0, p2}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final close(ILjava/lang/String;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/wt/internal/WebTransportSocket;->session:Lvbg;
    ...
    invoke-virtual {v0, v1, v2, p2}, Lmcg;->b(JLjava/lang/String;)V
