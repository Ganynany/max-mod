...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeProvider",
        "<init>",
        "(Lilf;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ljte;Ld6i;)V",
        "",
        "cid",
        "",
        "peerId",
        ...
        "joinToConversation",
        "(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lgyg;",
        "anonToken",
        "",
        "isFastRetryEnabled",
        "Lru/ok/android/externcalls/sdk/api/ConversationParams;",
        "getConversationParams",
        "(Ljava/lang/String;ZLjava/lang/String;)Lgyg;",
        "initialJoinLink",
        "joinConversationByLink",
        "(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lgyg;",
        "servers",
        "createLink",
        ...
        "startConversation",
        "(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lgyg;",
        "createJoinLink",
        "(Ljava/lang/String;)Lgyg;",
        "Lmwi;",
        "type",
        "Ljl7;",
        "requestUploadUrl",
        "(Ljava/lang/String;Lmwi;Ljava/lang/String;)Lgyg;",
        "",
        "keys",
        "",
        "getSettings",
        ...
        "(Lorg/json/JSONObject;)Lgyg;",
        "cId",
        "Lds7;",
        "reason",
        "Lru/ok/android/externcalls/sdk/api/request/HangupConversation$Response;",
        "hangupConversation",
        "(Ljava/lang/String;Lds7;Ljava/lang/String;)Lgyg;",
        "",
        "Ltt1;",
...
.field private rtcLog:Ljte;

.field private final rxApiClient:Lilf;

.field private timeProvider:Ld6i;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Lilf;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ljte;Ld6i;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lilf;
    ...
    .line 5
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Ljte;

    .line 6
    iput-object p5, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->timeProvider:Ld6i;

    return-void
.end method

.method public constructor <init>(Lilf;Lru/ok/android/externcalls/sdk/api/OkApiService;Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ljte;Ld6i;ILf75;)V
    .locals 6
...
.method public static synthetic getConversationParams$default(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Ljava/lang/String;ZLjava/lang/String;ILjava/lang/Object;)Lgyg;
    .locals 1
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->getConversationParams(Ljava/lang/String;ZLjava/lang/String;)Lgyg;
...
# virtual methods
.method public final createJoinLink(Ljava/lang/String;)Lgyg;
    .locals 2
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lilf;
    ...
    invoke-virtual {v0, v1}, Lilf;->a(Lvo;)Lazg;

    move-result-object p1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Ljte;

    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForFastWorkRequired(Lgyg;Ljte;)Lgyg;
...
.method public final getConversationParams(Ljava/lang/String;ZLjava/lang/String;)Lgyg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object p2, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rtcLog:Ljte;

    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForFastWorkRequired(Lgyg;Ljte;)Lgyg;
...
.method public final getExternalIdsByOkIds(Ljava/util/Collection;)Lgyg;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0, v0}, Lgy3;->n1(Ljava/lang/Iterable;II)Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lilf;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/api/request/BatchRequestKt;->toBatchRequest(Ljava/util/List;)Lvo;

    move-result-object v1

    invoke-virtual {p1, v1}, Lilf;->a(Lvo;)Lazg;

    move-result-object p1

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->timeProvider:Ld6i;
    ...
    invoke-direct {v4, v3, v5, v1}, Lr5h;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance v5, Ll34;

    const/4 v6, 0x6

    invoke-direct {v5, p1, v6, v4}, Ll34;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V

    new-instance p1, Ln4e;

    invoke-direct {p1, v3, v2, v1}, Ln4e;-><init>(Li6f;Lre7;Ld6i;)V

    new-instance v1, Lzo9;

    invoke-direct {v1, v5, p1}, Lzo9;-><init>(Lgyg;Lwd4;)V
...
.method public final getOkIdByExternalId(Ljava/lang/String;)Lgyg;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, v4, v2, v3}, Lru/ok/android/externcalls/sdk/api/request/GetOkIdByExternalId$Request;-><init>(Ljava/lang/String;ZILf75;)V
...
.method public final getOkIdsByExternalIds(Ljava/util/Collection;)Lgyg;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final getSettings(Ljava/util/Set;)Ljava/util/Map;
    ...
    iget-object p1, v0, Lilf;->a:Lio;

    invoke-interface {p1, v1}, Lio;->a(Lvo;)Ljava/lang/Object;
...
.method public final hangupConversation(Ljava/lang/String;Lds7;Ljava/lang/String;)Lgyg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, p2, p3}, Lru/ok/android/externcalls/sdk/api/request/HangupConversation$Request;-><init>(Ljava/lang/String;Lds7;Ljava/lang/String;)V
...
.method public final joinConversationByLink(Ljava/lang/String;Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lgyg;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForJoining(Lgyg;Ljte;)Lgyg;
...
.method public final joinToConversation(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lgyg;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v5}, Lru/ok/android/externcalls/sdk/api/request/JoinConversation$Request;-><init>(Ljava/lang/String;JLru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Lff7;)V

    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;->rxApiClient:Lilf;

    invoke-virtual {p1, v0}, Lilf;->a(Lvo;)Lazg;
...
.method public final removeJoinLink(Ljava/lang/String;)Lgyg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final requestUploadUrl(Ljava/lang/String;Lmwi;Ljava/lang/String;)Lgyg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v1, p1, p2, p3}, Lil7;-><init>(Ljava/lang/String;Lmwi;Ljava/lang/String;)V
...
.method public final sendSupportedCodecsStatistics(Lorg/json/JSONObject;)Lgyg;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForBackgroundWork(Lgyg;Ljte;)Lgyg;
...
.method public final startConversation(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;)Lgyg;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v7}, Lru/ok/android/externcalls/sdk/api/request/StartConversation$Request;-><init>(Ljava/lang/String;Ljava/lang/String;ZLru/ok/android/externcalls/sdk/ConversationParticipant;Ljava/util/List;Lru/ok/android/externcalls/sdk/conversation/StartCallApiParams;Ljf7;)V
    ...
    invoke-static {p1, p2}, Lru/ok/android/externcalls/sdk/api/retry/RetryKt;->retryApiCallForOutgoing(Lgyg;Ljte;)Lgyg;
