...
.field private final valueParser:Lut8;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lut8;"
        }
...
# direct methods
.method public constructor <init>(Ljava/lang/String;Lut8;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/UnwrappingParser;->valueParser:Lut8;
...
.method public parse(Ldu8;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/UnwrappingParser;->valueParser:Lut8;

    invoke-interface {v0, p1}, Lut8;->parse(Ldu8;)Ljava/lang/Object;
