...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "timeProvider",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ld6i;)V",
        "Lj0c;",
        "okApiChain",
        "Ln0c;",
        "intercept",
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0, v0, v1, v0}, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;-><init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ld6i;ILf75;)V

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ld6i;)V
    .locals 0
    ...
    .line 7
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;->timeProvider:Ld6i;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ld6i;ILf75;)V
    .locals 0
    ...
    .line 4
    :cond_1
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;-><init>(Lru/ok/android/externcalls/sdk/stat/api/ApiStats;Ld6i;)V
...
.method public intercept(Lj0c;)Ln0c;
    .locals 7
    ...
    iget-object v1, v0, Lm0c;->a:Lvo;

    invoke-static {v1}, Lru/ok/android/externcalls/sdk/api/interceptor/InterceptorUtilsKt;->getMethod(Lfp;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lru/ok/android/externcalls/sdk/api/interceptor/ExecutionTimeInterceptor;->timeProvider:Ld6i;

    invoke-interface {v2}, Ld6i;->getMsSinceBoot()J

    move-result-wide v3

    invoke-virtual {p1, v0}, Lekb;->g(Lm0c;)Ln0c;
