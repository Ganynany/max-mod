...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Ljava/lang/String;)Lrvc;",
        "Lfp;",
        "request",
        "getParams",
        "(Lfp;)Ljava/lang/String;",
        "jsonString",
        "eraseSecrets",
        ...
        "exception",
        "debugIoException",
        "(Loo;Lfp;Ljava/io/IOException;)V",
        "Ljte;",
        "Lpp;",
...
.field private final sessionStore:Lpp;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Ljte;Lpp;)V
    .locals 4

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ljte;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lpp;
...
.method private final eraseSecrets(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ljte;
...
.method private final extractHostAndScheme(Ljava/lang/String;)Lrvc;
    .locals 2
...
.method private final getParams(Lfp;)Ljava/lang/String;
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getRawParams(Lfp;)Ljava/lang/String;
...
.method private final getRawParams(Lfp;)Ljava/lang/String;
    .locals 3
    ...
    invoke-direct {v1, v0}, Lted;-><init>(Ljava/io/Writer;)V

    :try_start_0
    invoke-virtual {v1}, Lted;->q()V

    invoke-interface {p1, v1}, Lfp;->writeParams(Llu8;)V

    invoke-virtual {v1}, Lted;->n()V

    invoke-virtual {v1}, Lted;->flush()V
    :try_end_0
    ...
    :catch_0
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ljte;

    const-string v1, "CallsApiDebug"

    const-string v2, "failed to log request params"

    invoke-interface {p1, v1, v2}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
...
.method private final transformUriForLog(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->sessionStore:Lpp;
    ...
    iget-object v0, v0, Lop;->c:Ljava/lang/String;
    ...
    :cond_1
    invoke-direct {p0, v0}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->extractHostAndScheme(Ljava/lang/String;)Lrvc;
...
.method public debugApiRequest(Loo;Lfp;Lqo;)V
    ...
    instance-of p1, p2, Lip;

    if-eqz p1, :cond_0

    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->getParams(Lfp;)Ljava/lang/String;

    move-result-object p1

    const-string p3, "start with params "

    invoke-static {p3, p1}, Lzf2;->p(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    iget-object p3, p0, Lru/ok/android/externcalls/sdk/api/log/LoggingApiRequestDebugger;->log:Ljte;
    ...
    invoke-static {v0, p2, v1, p1}, Lhb2;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugApiResponseFail(Loo;Lfp;Ldu8;)Ldu8;
    ...
    invoke-interface {p3}, Ldu8;->g0()Ljava/lang/String;
    ...
    invoke-static {v1, p2, v2, p3}, Lhb2;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string p3, "CallsApiDebug"

    invoke-interface {v0, p3, p2}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1}, Leu8;->l(Ljava/lang/String;)Leu8;
...
.method public debugApiResponseOk(Loo;Lfp;Ldu8;)Ldu8;
    ...
    invoke-static {v0, p3}, Lzf2;->p(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public debugIoException(Loo;Lfp;Ljava/io/IOException;)V
    ...
    invoke-static {v0, p2, v1}, Lbp8;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p2

    const-string v0, "CallsApiDebug"

    invoke-interface {p1, v0, p2, p3}, Ljte;->logException(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
