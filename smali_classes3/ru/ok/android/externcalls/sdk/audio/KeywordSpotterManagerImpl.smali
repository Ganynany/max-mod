...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "logger",
        "<init>",
        "(Lm91;Lru/ok/android/externcalls/sdk/stat/kws/ConversationKwsStat;Lru/ok/android/externcalls/sdk/audio/internal/KeywordSpotterConfigProvider;Ld6i;Ljte;)V",
        "",
        "timeout",
        "Ltpi;",
        "scheduleTurnOff",
...
.field private shutDownDisposable:Lll5;
...
.field private turnOffDisposable:Lll5;

.field private final turnOffInMs:Lyv0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Lm91;Lru/ok/android/externcalls/sdk/stat/kws/ConversationKwsStat;Lru/ok/android/externcalls/sdk/audio/internal/KeywordSpotterConfigProvider;Ld6i;Ljte;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->call:Lm91;
    ...
    iput-object p4, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->timeProvider:Ld6i;

    iput-object p5, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Ljte;

    new-instance p1, Lyv0;

    const/4 p2, 0x0

    invoke-direct {p1, p2}, Lyv0;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffInMs:Lyv0;

    sget-object p1, Lo06;->a:Lo06;

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffDisposable:Lll5;

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->shutDownDisposable:Lll5;

    invoke-interface {p3}, Lru/ok/android/externcalls/sdk/config/ConfigProvider;->getConfig()Ldo9;
    ...
    new-instance p4, Ltw8;

    invoke-direct {p4, p0}, Ltw8;-><init>(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)V

    new-instance p5, Leo9;

    invoke-direct {p5, p2, p3, p4}, Leo9;-><init>(Lwd4;Lwd4;Lc8;)V

    invoke-virtual {p1, p5}, Ldo9;->e(Luo9;)V

    iput-object p5, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->initDisposable:Lll5;
    ...
    invoke-direct {p1, p0}, Ltw8;-><init>(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)V
...
.method public static final synthetic access$getCall$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Lm91;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->call:Lm91;

    return-object p0
.end method

.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Ljte;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Ljte;
...
.method public static final synthetic access$getTimeProvider$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Ld6i;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->timeProvider:Ld6i;

    return-object p0
.end method

.method public static final synthetic access$getTurnOffInMs$p(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;)Lyv0;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffInMs:Lyv0;
...
.method private static final consumer$lambda$3(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;[Ljava/lang/Double;)V
    ...
    iget-object v3, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Ljte;
...
.method private final scheduleTurnOff(J)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->logger:Ljte;
    ...
    invoke-direct {v0, p1, p2, v1}, Lzzg;-><init>(JLqqf;)V

    invoke-static {}, Ltg;->a()Lqqf;

    move-result-object p1

    invoke-virtual {v0, p1}, Lgyg;->h(Lqqf;)Lazg;
    ...
    invoke-virtual {p1, p2, v0}, Lgyg;->j(Lwd4;Lwd4;)Lp62;
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->initDisposable:Lll5;

    invoke-interface {v0}, Lll5;->dispose()V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffDisposable:Lll5;

    invoke-interface {v0}, Lll5;->dispose()V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->shutDownDisposable:Lll5;
...
.method public setKeywordSpotterParams(Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManager$KeywordSpotterParams;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->call:Lm91;
    ...
    invoke-direct {v1, v2, v3, v4}, Luw8;-><init>(ZLjava/lang/String;Lorg/webrtc/NativeDoubleArrayConsumer$Consumer;)V
    ...
    :cond_1
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->timeProvider:Ld6i;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffInMs:Lyv0;

    invoke-static {}, Ltg;->a()Lqqf;

    move-result-object v0

    invoke-virtual {p1, v0}, Lxwb;->h(Lqqf;)Lvyb;
    ...
    invoke-direct {v3, v0, v1, v2}, Lcx8;-><init>(Lwd4;Lwd4;Lc8;)V

    invoke-virtual {p1, v3}, Lxwb;->j(Lqzb;)V

    iput-object v3, p0, Lru/ok/android/externcalls/sdk/audio/KeywordSpotterManagerImpl;->turnOffDisposable:Lll5;
