...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "signalingProvider",
        "<init>",
        "(Lm91;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lnr4;Ljte;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V",
        "Lf9h;",
        "operation",
        "",
        "param",
        ...
        "(Lkah;ILjava/util/concurrent/TimeUnit;)V",
        "removeStatListener",
        "(Lkah;)V",
        "Lm91;",
        "getUnderlyingCall",
...
.field private final underlyingCall:Lm91;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Lm91;Lru/ok/android/externcalls/sdk/log/ExtLogger;Lnr4;Ljte;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Lm91;
    ...
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->cidProvider:Lnr4;

    iput-object p4, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Ljte;

    new-instance p1, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;

    invoke-virtual {p0}, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->getUnderlyingCall()Lm91;

    move-result-object p2

    invoke-direct {p1, p2, p5}, Lru/ok/android/externcalls/sdk/dev/internal/MediaDumpManagerImpl;-><init>(Lm91;Lru/ok/android/externcalls/sdk/signaling/SignalingProvider;)V
...
.method public enableFullAudioDump(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v2, v0, Lm91;->c:Ljava/util/concurrent/ExecutorService;
...
.method public getUnderlyingCall()Lm91;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->underlyingCall:Lm91;

    return-object v0
.end method

.method public registerStatListener(Lkah;ILjava/util/concurrent/TimeUnit;)V
    .locals 3
    ...
    iget-object v0, v0, Lm91;->M0:Le18;

    int-to-long v1, p2

    iget-object p2, v0, Le18;->b:Ljava/lang/Object;

    check-cast p2, Ljava/util/HashMap;

    new-instance v0, Luek;

    invoke-direct {v0, v1, v2, p3}, Luek;-><init>(JLjava/util/concurrent/TimeUnit;)V
...
.method public removeStatListener(Lkah;)V
    .locals 1
...
.method public report(Lf9h;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->cidProvider:Lnr4;

    check-cast v1, Lor4;

    iget-object v1, v1, Lor4;->b:Ljava/lang/String;

    invoke-virtual {v0, p1, v1, p2}, Lru/ok/android/externcalls/sdk/log/ExtLogger;->logSimple(Lf9h;Ljava/lang/String;Ljava/lang/String;)V
...
.method public reportError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/dev/internal/DebugManagerImpl;->log:Ljte;
...
.method public updateCameraToggles(Lre7;)V
    .locals 3
    ...
    iget-object v0, v0, Lm91;->h0:Lpc2;

    iget-object v0, v0, Lpc2;->Z:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v2, v0, Lzt4;->b:Ljava/lang/Object;

    check-cast v2, Lcg2;

    invoke-interface {p1, v2}, Lre7;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcg2;

    iput-object p1, v0, Lzt4;->b:Ljava/lang/Object;
