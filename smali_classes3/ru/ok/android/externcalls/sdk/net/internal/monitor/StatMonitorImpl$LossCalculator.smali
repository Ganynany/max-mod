...
# instance fields
.field private final lossCalc:Lzg9;
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lzg9;
...
.method private final calculateLoss(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/lang/Float;
    ...
    :cond_0
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$LossCalculator;->lossCalc:Lzg9;
    ...
    invoke-virtual {v0, v1, v2, p1, p2}, Lzg9;->a(JJ)D
    ...
    invoke-static {p1, p2, v0}, Ld2c;->w(FFF)F
...
.method private final synthetic findSender(Ljava/util/List;)Lx5h;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    iget-object v1, v1, Lx5h;->m:Ljava/lang/Boolean;
...
.method public final synthetic getLoss(Ljava/util/List;)Ljava/lang/Float;
    ...
    iget-object p1, v0, Lx5h;->i:Ljava/math/BigInteger;

    iget-object v0, v0, Lx5h;->h:Ljava/math/BigInteger;
