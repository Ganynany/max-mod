...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "mapToMonitoringStat",
        "(Llte;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;",
        "Lxwb;",
        "observeStat",
        "()Lxwb;",
        "rtcStat",
...
.field private final statSubject:Lyv0;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Ljte;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Ljte;

    new-instance p1, Lyv0;

    const/4 v0, 0x0

    invoke-direct {p1, v0}, Lyv0;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lyv0;
...
.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Ljte;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Ljte;

    return-object p0
.end method

.method private final mapToMonitoringStat(Llte;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
    .locals 8
    ...
    invoke-direct/range {v1 .. v7}, Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;-><init>(Ljava/lang/Integer;Ljava/lang/Float;Ljava/lang/Float;Ljava/lang/String;ILf75;)V

    return-object v1

    :cond_0
    iget-object v1, v0, Lsh2;->h:Ljava/lang/String;
    ...
    :try_start_0
    invoke-static {v1}, Lnkh;->m0(Ljava/lang/String;)Z
    ...
    :goto_1
    iget-object p1, p1, Llte;->b:Ljava/util/List;

    invoke-static {p1, v0}, Lm4l;->c(Ljava/util/List;Lsh2;)Ljava/util/ArrayList;
    ...
    invoke-static {v5}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Ljte;
    ...
    invoke-static {p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->access$getLogger$p(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;)Ljte;
    ...
    :cond_c
    iget-object p1, v5, Lx5h;->i:Ljava/math/BigInteger;

    iget-object v2, v5, Lx5h;->h:Ljava/math/BigInteger;
    ...
    :goto_7
    iget-object p1, v0, Lsh2;->b:Ljava/lang/String;
    ...
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->logger:Ljte;
    ...
    invoke-interface {p1, v2, v1}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public observeStat()Lxwb;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->statSubject:Lyv0;
    ...
    invoke-direct {v1, v0, v2}, Lqxb;-><init>(Lxwb;I)V

    return-object v1
.end method

.method public onRtcStats(Llte;)V
    .locals 1

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitorImpl;->mapToMonitoringStat(Llte;)Lru/ok/android/externcalls/sdk/net/internal/monitor/NetworkStat;
