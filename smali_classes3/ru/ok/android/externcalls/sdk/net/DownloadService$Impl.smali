...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "download",
        "(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lgyg;",
        "Ljte;",
        "Companion",
        "calls-sdk_release"
    }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Ljte;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ljte;

    return-void
.end method

.method public static synthetic a(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Lmyg;)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Loyg;)V

    return-void
.end method

.method public static final synthetic access$getLogger$p(Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;)Ljte;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ljte;

    return-object p0
.end method

.method private static final download$lambda$3(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;Loyg;)V
    .locals 8
    ...
    invoke-static {p1, v0, v0}, Lacl;->a(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Lmyg;->a(Ljava/lang/Throwable;)V
    :try_end_1
    ...
    :cond_0
    :try_start_2
    invoke-static {p1}, Lscl;->c(Ljava/io/File;)V
    ...
    invoke-virtual {p2}, Lru/ok/android/externcalls/sdk/net/FileValidationConfig;->getHashAlgorithm()Lrs7;

    move-result-object p0

    iget-object p0, p0, Lrs7;->a:Ljava/lang/String;
    ...
    invoke-virtual {p0, p2}, Lmyg;->b(Ljava/lang/Object;)V
    :try_end_6
    ...
    :goto_4
    iget-object p0, v2, Lru/ok/android/externcalls/sdk/net/DownloadService$Impl;->logger:Ljte;
    ...
    invoke-static {v1, v3, p3, p1, v0}, Lhb2;->z(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-interface {p0, p3, p1}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v4, p0}, Lscl;->b(Ljava/io/File;Lre7;)V

    check-cast p4, Lmyg;

    invoke-virtual {p4, p2}, Lmyg;->a(Ljava/lang/Throwable;)V
...
.method private final downloadInner(Ljava/lang/String;Ljava/io/File;Ljava/security/MessageDigest;)V
    ...
    invoke-direct {v2, p3, v0}, Lexi;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v5, p2}, Lfq6;->h(Ljava/io/InputStream;[Ljava/io/OutputStream;)V
    :try_end_3
...
# virtual methods
.method public download(Ljava/lang/String;Ljava/io/File;Lru/ok/android/externcalls/sdk/net/FileValidationConfig;)Lgyg;
    .locals 1
    ...
    invoke-direct {v0, p1, p2, p3, p0}, Lko;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
