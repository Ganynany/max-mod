...
.method public static fromExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByExternal(Lru/ok/android/externcalls/sdk/id/ParticipantId;)Ltt1;

    move-result-object p0

    if-eqz p0, :cond_0

    invoke-virtual {v0, p0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setInternalId(Ltt1;)V

    :cond_0
    return-object v0
.end method

.method public static fromInternal(Ltt1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    .locals 1
    ...
    invoke-virtual {p1, p0}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
...
# virtual methods
.method public deAnonymize(Lyt1;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/ParticipantId;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lyt1;
...
.method public getAcceptCallEpochMs()J
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lyt1;

    if-eqz v0, :cond_0

    iget-wide v0, v0, Lyt1;->n:J
...
.method public getAcceptedCallClientType()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Lyt1;->l:Ljava/lang/String;
...
.method public getAcceptedCallPlatform()Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, v0, Lyt1;->m:Ljava/lang/String;

    return-object v0
.end method

.method public getAudioOptionState()Ls1a;
    .locals 1
    ...
    iget-object v0, v0, Lyt1;->b:Lpeb;

    iget-object v0, v0, Lpeb;->a:Ls1a;
...
.method public getCallParticipant()Lyt1;
    .locals 1
...
.method public getInternalId()Ltt1;
    .locals 1

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Ltt1;
...
.method public getMovies()Ljava/util/List;
    ...
    :cond_0
    iget-object v0, v0, Lyt1;->r:Ljava/util/List;

    return-object v0
.end method

.method public getNetworkStatus()Lyjb;
    .locals 1
    ...
    :cond_0
    iget-object v0, v0, Lyt1;->j:Lyjb;

    return-object v0
.end method

.method public getScreenshareOptionState()Ls1a;
    .locals 1
...
.method public getVideoOptionState()Ls1a;
    .locals 1
...
.method public getWatchTogetherOptionState()Ls1a;
    .locals 1
...
.method public hasRegisteredPeers()Z
    ...
    iget-object v0, v0, Lyt1;->f:Ljava/util/HashMap;
...
.method public setCallParticipant(Lyt1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    .locals 0
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Ltt1;
...
.method public setDeviceIndex(ILru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    iget-wide v2, v0, Ltt1;->a:J

    iget v0, v0, Ltt1;->b:I

    invoke-direct {v1, v0, p1, v2, v3}, Ltt1;-><init>(IIJ)V

    iput-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Ltt1;
    ...
    iget-wide v3, v1, Ltt1;->a:J

    iget v1, v1, Ltt1;->b:I

    invoke-direct {v2, v1, p1, v3, v4}, Ltt1;-><init>(IIJ)V

    iput-object v2, v0, Lyt1;->a:Ltt1;

    iget-object v1, v0, Lyt1;->q:Lni1;

    if-eqz v1, :cond_3

    new-instance v2, Lni1;

    iget-object v3, v1, Lni1;->a:Ljava/lang/String;

    iget v1, v1, Lni1;->b:I

    invoke-direct {v2, v3, v1, p1}, Lni1;-><init>(Ljava/lang/String;II)V

    iput-object v2, v0, Lyt1;->q:Lni1;
...
.method public setInternalId(Ltt1;)V
    .locals 1
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->internalId:Ltt1;

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v1, p0, Lru/ok/android/externcalls/sdk/ConversationParticipant;->callParticipant:Lyt1;
