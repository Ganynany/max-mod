...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "log",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Ljte;)V",
        "Ltpi;",
        "drainEmitters",
        "()V",
        "requestReadSettings",
...
.field private final requestSettingsDisposable:Lll5;

.field private final wantedSettings:Lyv0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lyv0;"
        }
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Lru/ok/android/externcalls/sdk/api/OkApiServiceInternal;Ljte;)V
    .locals 6
    ...
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Ljte;
    ...
    iput-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lyv0;
    ...
    invoke-direct/range {v0 .. v5}, Lyyb;-><init>(Lxwb;JLjava/util/concurrent/TimeUnit;Lqqf;)V
    ...
    invoke-virtual {v0, p1}, Lxwb;->a(Lcqd;)Lbyb;
    ...
    invoke-direct {v0, p1, p2, v1}, Lbyb;-><init>(Lxwb;Ljava/lang/Object;I)V

    invoke-static {}, Ltg;->a()Lqqf;

    move-result-object p1

    invoke-virtual {v0, p1}, Lxwb;->h(Lqqf;)Lvyb;
    ...
    invoke-direct {v2, p2, v0, v1}, Lcx8;-><init>(Lwd4;Lwd4;Lc8;)V

    invoke-virtual {p1, v2}, Lxwb;->j(Lqzb;)V

    iput-object v2, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Lll5;
...
.method public static final synthetic access$getLog$p(Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;)Ljte;
    .locals 0

    iget-object p0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Ljte;
...
.method public static synthetic b(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Lmyg;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Loyg;)V
...
.method private static final get$lambda$1(Ljava/lang/String;Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;Loyg;)V
    .locals 2

    new-instance v0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;

    invoke-direct {v0, p0, p2}, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl$KeyListener;-><init>(Ljava/lang/String;Loyg;)V
    ...
    invoke-direct {v0, p0, v1}, Llh2;-><init>(Ljava/lang/Object;I)V

    invoke-static {p2, v0}, Lpl5;->g(Ljava/util/concurrent/atomic/AtomicReference;Llh2;)V
...
.method private final requestReadSettings()V
    ...
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->wantedSettings:Lyv0;

    invoke-virtual {v1, v0}, Lyv0;->d(Ljava/lang/Object;)V
...
# virtual methods
.method public get(Ljava/lang/String;)Lgyg;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->log:Ljte;
    ...
    invoke-direct {v0, p1, v1, p0}, Lrta;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method public final release()V
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/settings/RemoteSettingsImpl;->requestSettingsDisposable:Lll5;
