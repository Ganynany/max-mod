...
.method private handleCallAccepted(Lyt1;)V
    .locals 3
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->X(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lm91;
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lyt1;
...
.method private handleHangup(Lm91;Ljava/lang/Object;)V
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    iget-object v1, p1, Lm91;->K:Lds7;

    invoke-static {v0, v1, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl;->y0(Lru/ok/android/externcalls/sdk/ConversationImpl;Lds7;Ljava/lang/Object;)Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;
    ...
    iget-object v1, p1, Lm91;->f1:Lm4k;
...
.method private handleMuteParticipant(Lifb;)V
    .locals 2

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->shouldNotifyLegacyListener(Lifb;)Z
    ...
    iget-object v1, p1, Lifb;->a:Lhfb;

    invoke-interface {v0, v1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteChanged(Lhfb;)V
    ...
    iget-object p1, p1, Lifb;->a:Lhfb;

    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteChanged(Lhfb;)V

    return-void
.end method

.method private handleMuteStateInitialized(Lifb;)V
    .locals 1

    iget-boolean v0, p1, Lifb;->b:Z
    ...
    invoke-interface {v0, p1}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onMuteStateInitialized(Lhfb;)V
    ...
    invoke-virtual {v0, p1}, Lru/ok/android/externcalls/sdk/media/mute/internal/listener/MediaMuteListenerManagerImpl;->onMuteStateInitialized(Lhfb;)V

    return-void
.end method

.method private handleRolesChanged(Lyt1;)V
    .locals 2
    ...
    invoke-virtual {v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->getCallParticipant()Lyt1;
    ...
    invoke-virtual {v0, p1, v1}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lyt1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
...
.method private maybeInitP2PRelaySwitchTrigger()V
    ...
    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->d0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lqt1;
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->l0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Ljte;

    move-result-object v1

    invoke-direct {v7, v0, v1}, Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProviderImpl;-><init>(Lru/ok/android/externcalls/sdk/api/RemoteSettings;Ljte;)V
    ...
    invoke-static {v1}, Lru/ok/android/externcalls/sdk/ConversationImpl;->X(Lru/ok/android/externcalls/sdk/ConversationImpl;)Lm91;
    ...
    invoke-direct {v5, v1, v6}, Lx81;-><init>(Lm91;I)V
    ...
    invoke-direct/range {v2 .. v7}, Lru/ok/android/externcalls/sdk/p2prelay/P2pRelaySwitchTrigger;-><init>(Lru/ok/android/externcalls/sdk/net/internal/monitor/StatMonitor;Ljte;Lpe7;Lru/ok/android/externcalls/sdk/stat/ConversationStats;Lru/ok/android/externcalls/sdk/p2prelay/P2PRelaySwitchConfigProvider;)V
...
.method private shouldNotifyLegacyListener(Lifb;)Z
    .locals 3
    ...
    iget-object v0, p1, Lhfb;->a:Ljava/util/AbstractMap;

    iget-object p1, p1, Lhfb;->b:Ljava/util/Set;
...
.method public onAsrOnlineAvailableChanged()V
    ...
    iget-object v1, v1, Lm91;->t:Ljava/util/EnumSet;
...
.method public onCallParticipantFingerprint(Lyt1;J)V
    .locals 3
...
.method public onCallParticipantNetworkStatusChanged(Ljava/util/List;)V
    ...
    invoke-virtual {v3, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-virtual {v2, v1, v3}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->setCallParticipant(Lyt1;Lru/ok/android/externcalls/sdk/id/local/LocalIdMappings;)V
    ...
    invoke-virtual {v1, v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getParticipantRoomId(Lru/ok/android/externcalls/sdk/ConversationParticipant;)Lbdg;
    ...
    invoke-virtual {v3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lbdg;
...
.method public onCustomData(Ltt1;Lorg/json/JSONObject;)V
    .locals 0
...
.method public onEvent(Lm91;Luh1;Ljava/lang/Object;)V
    .locals 6

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->this$0:Lru/ok/android/externcalls/sdk/ConversationImpl;

    invoke-static {v0}, Lru/ok/android/externcalls/sdk/ConversationImpl;->l0(Lru/ok/android/externcalls/sdk/ConversationImpl;)Ljte;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStopped(Lg8b;)V

    return-void

    :pswitch_2
    instance-of p1, p3, Lf8b;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStatesUpdatedChanged(Lf8b;)V

    return-void

    :pswitch_3
    instance-of p1, p3, Ld8b;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->onVideoStarted(Ld8b;)V
    ...
    :pswitch_6
    instance-of p1, p3, Lifb;

    if-eqz p1, :cond_6

    check-cast p3, Lifb;

    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteStateInitialized(Lifb;)V
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleMuteParticipant(Lifb;)V

    return-void

    :pswitch_8
    instance-of p1, p3, Ltt1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-direct {p0, p2}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lyt1;)V
    ...
    invoke-direct {p0, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleRolesChanged(Lyt1;)V
    ...
    :pswitch_d
    invoke-virtual {p1, v1}, Lm91;->H(Z)V
    ...
    :pswitch_e
    invoke-virtual {p1, v2}, Lm91;->H(Z)V
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeaturesPerRoleChanged(Lxi1;)V

    return-void

    :pswitch_13
    instance-of p1, p3, Lwi1;
    ...
    invoke-virtual {p1, p3}, Lru/ok/android/externcalls/sdk/feature/internal/listener/ConversationFeatureListenersImpl;->onFeatureSetChanged(Lwi1;)V
    ...
    :cond_3
    invoke-direct {p0, v3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleCallAccepted(Lyt1;)V
    ...
    iget-object v0, p1, Lm91;->f1:Lm4k;
    ...
    invoke-direct {p3, v0, v1, v3}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener$CallEndInfo;-><init>(Lds7;Ljava/util/Set;Ljava/lang/String;)V
    ...
    iget-object p2, p1, Lm91;->f1:Lm4k;
    ...
    invoke-virtual {p2, p3}, Lm4k;->G(Lru/ok/android/externcalls/sdk/events/end/ConversationEndReason;)V
    ...
    :pswitch_1c
    invoke-direct {p0, p1, p3}, Lru/ok/android/externcalls/sdk/ConversationImpl$ListenerImpl;->handleHangup(Lm91;Ljava/lang/Object;)V
    ...
    iget-object v1, p1, Lm91;->f0:Lsqg;

    iget-object p1, v1, Lsqg;->a:Ljava/util/concurrent/ExecutorService;
...
.method public onStateChanged(Ltt1;Lvt1;)V
    .locals 2
    ...
    invoke-static {p1, v0}, Lru/ok/android/externcalls/sdk/ConversationParticipant;->fromInternal(Ltt1;Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;)Lru/ok/android/externcalls/sdk/ConversationParticipant;
    ...
    invoke-interface {v1, v0, p2}, Lru/ok/android/externcalls/sdk/events/ConversationEventsListener;->onStateChanged(Lru/ok/android/externcalls/sdk/ConversationParticipant;Lvt1;)V
    ...
    invoke-virtual {v0, p1, p2}, Lru/ok/android/externcalls/sdk/participant/state/internal/ParticipantStatesManagerImpl;->onStateChanged(Ltt1;Lvt1;)V
