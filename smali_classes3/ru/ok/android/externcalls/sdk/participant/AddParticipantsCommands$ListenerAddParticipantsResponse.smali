...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "externalIds",
        "<init>",
        "(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lre7;Lre7;Ljava/util/Collection;)V",
...
.field private final onError:Lre7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lre7;"
        }
...
.field private final onSuccess:Lre7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lre7;"
        }
...
# direct methods
.method public constructor <init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lre7;Lre7;Ljava/util/Collection;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p2, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onSuccess:Lre7;

    .line 3
    iput-object p3, p0, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onError:Lre7;
...
.method public synthetic constructor <init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lre7;Lre7;Ljava/util/Collection;ILf75;)V
    .locals 1
    ...
    .line 6
    :cond_2
    invoke-direct {p0, p1, p2, p3, p4}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;-><init>(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;Lre7;Lre7;Ljava/util/Collection;)V
...
.method public onResponse(Lorg/json/JSONObject;)V
    ...
    :cond_0
    invoke-static {v9}, Lo3l;->v(Lorg/json/JSONObject;)Ltt1;
    ...
    invoke-static {v11}, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;->access$getCall$p(Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands;)Lm91;

    move-result-object v11

    invoke-virtual {v11, v10, v9}, Lm91;->A(Ltt1;Lorg/json/JSONObject;)I
    ...
    :cond_3
    iget-object v2, v1, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onSuccess:Lre7;
    ...
    invoke-static {v0, v8}, Lo3l;->D(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v10}, Lo3l;->D(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v11}, Lo3l;->A(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {v0, v12}, Lo3l;->A(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iget-object v14, v13, Lni1;->a:Ljava/lang/String;

    new-instance v15, Lru/ok/android/externcalls/sdk/id/ParticipantId;

    iget-object v6, v13, Lni1;->a:Ljava/lang/String;

    iget v7, v13, Lni1;->b:I
    ...
    invoke-virtual {v0, v11}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    :cond_11
    invoke-static {v7, v9}, Lgy3;->Y0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v10}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    :cond_13
    invoke-static {v9, v6}, Lgy3;->Y0(Ljava/util/Collection;Ljava/lang/Iterable;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v7, v9}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-virtual {v3, v7}, Lru/ok/android/externcalls/sdk/id/IdMappingWrapper;->getByInternal(Ltt1;)Lru/ok/android/externcalls/sdk/id/ParticipantId;
    ...
    invoke-interface {v2, v3}, Lre7;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_1
    ...
    :goto_c
    iget-object v2, v1, Lru/ok/android/externcalls/sdk/participant/AddParticipantsCommands$ListenerAddParticipantsResponse;->onError:Lre7;
