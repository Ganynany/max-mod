...
# instance fields
.field private final conversation:Lpe7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lpe7;"
        }
...
.field private final factory:Lre7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lre7;"
        }
...
.field private final onOwnCameraRendererSet:Lpe7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lpe7;"
        }
...
# direct methods
.method public constructor <init>(Lpe7;Lre7;Lpe7;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->conversation:Lpe7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->factory:Lre7;

    iput-object p3, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->onOwnCameraRendererSet:Lpe7;
...
.method public createVideoViewInstance(Landroid/content/Context;)Landroid/view/View;
    ...
    .line 2
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->factory:Lre7;
...
.method public getOwnVideoTrack()Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->conversation:Lpe7;
...
.method public setParticipantView(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Landroid/view/View;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)V
    ...
    .line 10
    iget-object v1, p0, Lru/ok/android/externcalls/sdk/video/internal/ParticipantVideoViewManagerImpl;->onOwnCameraRendererSet:Lpe7;
    ...
    invoke-interface {p1}, Lru/ok/android/externcalls/sdk/video/VideoRenderManager;->getCallRenderer()Lrr1;
    ...
    invoke-interface {p2, p1, v0, p3}, Lru/ok/android/externcalls/sdk/ui/RendererView;->init(Lrr1;Lorg/webrtc/RendererCommon$RendererEvents;Lru/ok/android/externcalls/sdk/ui/FrameDecorator;)Z
