...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "store",
        "<init>",
        "(Lpe7;Lm91;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V",
        "Lz42;",
        "key",
        "",
...
.field private final state:Lpe7;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lpe7;"
        }
...
# direct methods
.method public constructor <init>(Lpe7;Lm91;Lru/ok/android/externcalls/sdk/renderer/ConversationRenderers;Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lpe7;

    iput-object p2, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lm91;
...
.method private final setRenderers(Lz42;Ljava/util/List;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private final setRenderersForMe(Lz42;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderers(Lz42;Ljava/util/List;)V

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lm91;
    ...
    invoke-virtual {v1, p1, p2}, Ll32;->Q(Lz42;Ljava/util/List;)V

    iget-object v0, v0, Lm91;->y0:Lpk;

    invoke-virtual {v0, p1, p2}, Lpk;->b(Lz42;Ljava/util/List;)V

    return-void

    :cond_2
    iget-object p1, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->call:Lm91;
    ...
    invoke-direct {v1, v2, v3}, Lpaa;-><init>(IZ)V

    iput-object v0, v1, Lpaa;->a:Ljava/lang/Object;

    sget-object v0, Lsej;->c:Lsej;

    iput-object v0, v1, Lpaa;->b:Ljava/lang/Object;

    invoke-virtual {v1}, Lpaa;->f()Lz42;

    move-result-object v0

    iget-object p1, p1, Lm91;->y0:Lpk;

    invoke-virtual {p1, v0, p2}, Lpk;->b(Lz42;Ljava/util/List;)V
    ...
    :cond_7
    iget-object p1, p1, Lm91;->g0:Lnqg;

    iput-object p2, p1, Lnqg;->p:Lorg/webrtc/VideoSink;

    iget-object p1, p1, Lnqg;->o:Loa9;

    if-eqz p1, :cond_8

    invoke-virtual {p1, p2}, Loa9;->j(Lorg/webrtc/VideoSink;)V
...
.method private final setRenderersForOthers(Lz42;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public getCallRenderer()Lrr1;
    .locals 2

    iget-object v0, p0, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->state:Lpe7;
...
.method public setRenderers(Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;Ljava/util/List;)V
    ...
    .line 4
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getType()Lsej;

    move-result-object v2

    .line 5
    iput-object v2, v1, Lpaa;->b:Ljava/lang/Object;
    ...
    .line 8
    iput-object v2, v1, Lpaa;->a:Ljava/lang/Object;

    .line 9
    invoke-virtual {p1}, Lru/ok/android/externcalls/sdk/layout/ConversationVideoTrackParticipantKey;->getMovieId()Lw7b;

    move-result-object v2

    .line 10
    iput-object v2, v1, Lpaa;->c:Ljava/lang/Object;
    ...
    .line 14
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForMe(Lz42;Ljava/util/List;)V

    return-void

    .line 15
    :cond_1
    invoke-direct {p0, v1, p2}, Lru/ok/android/externcalls/sdk/video/internal/VideoRenderManagerImpl;->setRenderersForOthers(Lz42;Ljava/util/List;)V
