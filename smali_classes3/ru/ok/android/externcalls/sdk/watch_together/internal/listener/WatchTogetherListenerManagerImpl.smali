...
.method private final getPosition(Ljava/lang/Long;)Lz7b;
    .locals 4
    ...
    invoke-direct {v0, v1, v2}, Lx7b;-><init>(J)V

    return-object v0

    :cond_1
    :goto_0
    sget-object p1, Ly7b;->a:Ly7b;
...
.method private final sendActualState(Lru/ok/android/externcalls/sdk/watch_together/listener/WatchTogetherListener;)V
    ...
    invoke-direct {v1, p0, v2, p1}, Lcmj;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
...
.method private final updateState(Lf8b;)V
    .locals 12
    ...
    iget-object p1, p1, Lf8b;->a:Ljava/util/ArrayList;
    ...
    iget-object v3, v1, Le8b;->a:Lz42;

    iget-object v3, v3, Lz42;->b:Ltt1;
    ...
    iget-object v11, v3, Lz42;->c:Lw7b;
    ...
    sget-object v5, Lc8b;->$EnumSwitchMapping$1:[I
    ...
    iget-object v9, v8, Lt7b;->d:Lb8b;

    if-ne v9, v3, :cond_6

    iget-object v8, v8, Lt7b;->a:Lw7b;

    invoke-virtual {v8, v11}, Lw7b;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v2, v1, Le8b;->d:Ljava/lang/Long;

    invoke-direct {p0, v2}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->getPosition(Ljava/lang/Long;)Lz7b;

    move-result-object v5

    iget-boolean v2, v1, Le8b;->c:Z

    xor-int/2addr v6, v2

    iget v7, v1, Le8b;->b:F

    invoke-static {v7}, Lj8b;->a(F)V

    iget-boolean v8, v1, Le8b;->e:Z

    const/4 v10, 0x0

    invoke-direct/range {v3 .. v10}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lz7b;ZFZLt7b;Lf75;)V
    ...
    invoke-virtual {v2}, Lru/ok/android/externcalls/sdk/participant/collection/ParticipantStore;->getActiveRoomId()Lbdg;

    move-result-object v2

    invoke-direct {v1, v4, v2, v9}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lbdg;Lt7b;)V
...
.method public final onVideoStarted(Ld8b;)V
    .locals 12
    ...
    iget-object v11, v7, Lt7b;->a:Lw7b;
    ...
    invoke-direct/range {v1 .. v8}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieState;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lz7b;ZFZLt7b;Lf75;)V
    ...
    iget-object p1, p1, Ld8b;->b:Lbdg;

    invoke-direct {v1, v0, p1, v7}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStartedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lbdg;Lt7b;)V
...
.method public final onVideoStatesUpdatedChanged(Lf8b;)V
    .locals 0

    invoke-direct {p0, p1}, Lru/ok/android/externcalls/sdk/watch_together/internal/listener/WatchTogetherListenerManagerImpl;->updateState(Lf8b;)V
...
.method public final onVideoStopped(Lg8b;)V
    .locals 4
    ...
    iget-object v2, p1, Lg8b;->b:Lbdg;

    iget-object v3, p1, Lg8b;->c:Lw7b;

    iget-object p1, p1, Lg8b;->d:Lb8b;

    invoke-direct {v1, v0, v2, v3, p1}, Lru/ok/android/externcalls/sdk/watch_together/listener/states/MovieStoppedData;-><init>(Lru/ok/android/externcalls/sdk/id/ParticipantId;Lbdg;Lw7b;Lb8b;)V
