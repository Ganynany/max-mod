...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "(Lio;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;",
        "Ltpi;",
        "drop",
        "()V",
...
.method private final uploadFileWithContent(Lio;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    .locals 9
    ...
    invoke-static {p2}, Lfq6;->d(Ljava/io/File;)Z
    ...
    invoke-virtual {v5, p1, v6, v7}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics_release(Lio;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lu21;)V
...
.method public drop()V
    ...
    :cond_0
    invoke-static {v4}, Lfq6;->b(Ljava/io/File;)V
...
.method public final ensureStorageIsOfCorrectType(Z)Ljava/io/File;
    ...
    :try_start_0
    invoke-static {v0}, Lfq6;->b(Ljava/io/File;)V
    :try_end_0
...
.method public final uploadFile(Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;
    ...
    invoke-static {p1}, Lfq6;->e(Ljava/io/File;)J
    ...
    :cond_1
    invoke-virtual {v2}, Lru/ok/android/externcalls/analytics/config/CallAnalyticsConfig;->getOkApi()Lh0c;

    move-result-object v0

    invoke-virtual {v0}, Lh0c;->b()Lio;

    move-result-object v0

    invoke-direct {p0, v0, p1}, Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader;->uploadFileWithContent(Lio;Ljava/io/File;)Lru/ok/android/externcalls/analytics/internal/upload/AbstractUploader$UploadResult;

    move-result-object v0

    invoke-static {p1}, Lfq6;->b(Ljava/io/File;)V
