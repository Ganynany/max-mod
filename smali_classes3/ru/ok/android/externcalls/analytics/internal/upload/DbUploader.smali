...
.field private final multiUploadHelper$delegate:Lpx8;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader$Companion;-><init>(Lf75;)V
...
.method public constructor <init>(Ljavax/inject/Provider;Ljava/util/concurrent/locks/Lock;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;ILjava/lang/Long;)V
    ...
    iput-object p1, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lpx8;
...
.method public static final synthetic access$uploadImpl(Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;Lio;Ljava/util/Iterator;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->uploadImpl(Lio;Ljava/util/Iterator;)V
...
.method private final getMultiUploadHelper()Lru/ok/android/externcalls/analytics/internal/upload/MultiUploadHelper;
    ...
    iget-object v0, p0, Lru/ok/android/externcalls/analytics/internal/upload/DbUploader;->multiUploadHelper$delegate:Lpx8;
...
.method private final uploadImpl(Lio;Ljava/util/Iterator;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v6, p1, v7, v8}, Lru/ok/android/externcalls/analytics/internal/upload/UploadHelper;->executeApiMethod$calls_sdk_analytics_release(Lio;Lru/ok/android/externcalls/analytics/internal/event/EventChannel;Lu21;)V
...
.method public upload()V
    ...
    invoke-virtual {v0, v2, v6}, Lru/ok/android/externcalls/analytics/internal/storage/DatabaseHelper;->grab(ILre7;)V
