...
.method private final writeValue(Llu8;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
    .locals 2
    ...
    invoke-virtual {p1, v0, v1}, Li2;->F(D)V
    ...
    invoke-virtual {p1, p2}, Li2;->I(I)V
    ...
    invoke-interface {p1, p2}, Llu8;->i(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-iurDigI(Llu8;Ljava/util/Collection;)V
    ...
    invoke-direct {p0, p1, p2}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue-4i0utlQ(Llu8;Ljava/util/Map;)V

    :cond_5
    return-void
.end method

.method private final writeValue-4i0utlQ(Llu8;Ljava/util/Map;)V
    .locals 2
...
.method private final writeValue-iurDigI(Llu8;Ljava/util/Collection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public final serialize(Llu8;Lru/ok/android/externcalls/analytics/events/CallAnalyticsEvent;)V
    .locals 2
    ...
    invoke-direct {p0, p1, v0}, Lru/ok/android/externcalls/analytics/internal/event/EventSerializer;->writeValue(Llu8;Lru/ok/android/externcalls/analytics/events/EventItemValue;)V
