...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v3, p0, Lbe0;->C0:Landroid/graphics/Paint;

    new-instance v6, Landroid/graphics/Paint;

    invoke-direct {v6, v3}, Landroid/graphics/Paint;-><init>(Landroid/graphics/Paint;)V

    iput-object v6, p0, Lbe0;->D0:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lbe0;->E0:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lbe0;->F0:Landroid/graphics/Paint;

    new-instance v3, Landroid/graphics/Path;

    invoke-direct {v3}, Landroid/graphics/Path;-><init>()V

    iput-object v3, p0, Lbe0;->G0:Landroid/graphics/Path;
    ...
    invoke-direct {v1, p0, v2}, Lm60;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iput-object p1, p0, Lbe0;->H0:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {p0, p1}, Lbe0;->onThemeChanged(Lrmc;)V
...
.method public final a()V
    ...
    iget-object v0, p0, Lbe0;->z0:Ljava/util/List;
    ...
    iget-object v8, p0, Lbe0;->G0:Landroid/graphics/Path;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, p0, Lbe0;->G0:Landroid/graphics/Path;
    ...
    :cond_0
    iget-boolean v2, p0, Lbe0;->B0:Z

    const/4 v3, 0x2

    const/4 v4, 0x6

    iget-object v5, p0, Lbe0;->C0:Landroid/graphics/Paint;

    const/4 v6, 0x0

    if-nez v2, :cond_3

    iget-boolean v2, p0, Lbe0;->K0:Z
    ...
    invoke-static {v4, v8, v3, v7}, Lvl4;->c(FFII)I
    ...
    iget-wide v8, p0, Lbe0;->o:J

    long-to-float v4, v8

    iget-wide v8, p0, Lbe0;->J0:J
    ...
    iget-object v9, p0, Lbe0;->D0:Landroid/graphics/Paint;
    ...
    iget-object v2, p0, Lbe0;->F0:Landroid/graphics/Paint;

    invoke-virtual {p1, v8, v0, v1, v2}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V

    iget-object v1, p0, Lbe0;->E0:Landroid/graphics/Paint;
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p1, p0, Lbe0;->L0:Lae0;

    if-eqz p1, :cond_0

    invoke-virtual {p0}, Lbe0;->getPeaksCount()I
    ...
    sget-object p2, Lone/me/sdk/messagewrite/recordcontrols/RecordControlsWidget;->p1:[Lbv8;
    ...
    iget-object p1, v1, Lzd0;->g:Lkotlinx/coroutines/internal/ContextScope;
    ...
    invoke-direct/range {v0 .. v5}, Lxd0;-><init>(Lzd0;IFFLkotlin/coroutines/Continuation;)V
...
.method public final onThemeChanged(Lrmc;)V
    ...
    :goto_0
    iget-object v1, p0, Lbe0;->C0:Landroid/graphics/Paint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setColor(I)V

    invoke-interface {p1}, Lrmc;->getIcon()Lhmc;

    iget-object v0, p0, Lbe0;->E0:Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lbe0;->F0:Landroid/graphics/Paint;

    invoke-virtual {v0, p1}, Landroid/graphics/Paint;->setColor(I)V

    iget-object p1, p0, Lbe0;->D0:Landroid/graphics/Paint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-boolean v0, p0, Lbe0;->B0:Z

    if-nez v0, :cond_1

    iget-boolean v0, p0, Lbe0;->K0:Z
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lbe0;->b(Landroid/view/MotionEvent;)F

    move-result v0

    iget-wide v3, p0, Lbe0;->J0:J
    ...
    iput-wide v0, p0, Lbe0;->o:J

    iget-object v0, p0, Lbe0;->L0:Lae0;
    ...
    invoke-virtual {v1}, Lbe0;->getDuration()J
    ...
    invoke-static {v3, v4}, Lqal;->b(J)Ljava/lang/String;
    ...
    iget-object v0, v0, Lxmj;->B0:Landroid/widget/TextView;
    ...
    iget-object v3, v0, Lf2f;->K0:Ljye;
    ...
    invoke-interface {v0, v3, v4}, Lo69;->seekTo(J)V
...
.method public final setLinesColor(I)V
    ...
    iget-object v0, p0, Lbe0;->C0:Landroid/graphics/Paint;
...
.method public final setListener(Lae0;)V
    .locals 0

    iput-object p1, p0, Lbe0;->L0:Lae0;
...
.method public final setPauseRecordingData(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lbe0;->z0:Ljava/util/List;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lbe0;->A0:Z

    iget-object p1, p0, Lbe0;->H0:Landroid/animation/ValueAnimator;

    invoke-virtual {p1}, Landroid/animation/ValueAnimator;->cancel()V

    const/4 p1, 0x0

    iput p1, p0, Lbe0;->I0:F

    iget-object p1, p0, Lbe0;->G0:Landroid/graphics/Path;
...
.method public final setShiftOffset(J)V
    ...
    iget-object v0, p0, Lbe0;->H0:Landroid/animation/ValueAnimator;
