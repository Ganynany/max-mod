...
# direct methods
.method public constructor <init>(JJJJJLjava/lang/String;Ljava/lang/String;Lmna;Ljava/util/List;Ljava/util/List;Z)V
    .locals 0

    invoke-direct/range {p0 .. p2}, Lqp;-><init>(J)V

    iput-wide p3, p0, Lu9b;->d:J

    iput-wide p5, p0, Lu9b;->e:J

    iput-wide p7, p0, Lu9b;->f:J

    iput-wide p9, p0, Lu9b;->g:J

    iput-object p13, p0, Lu9b;->h:Lmna;

    iput-object p14, p0, Lu9b;->i:Ljava/util/List;

    iput-object p15, p0, Lu9b;->j:Ljava/util/List;

    move/from16 p1, p16

    iput-boolean p1, p0, Lu9b;->k:Z
    ...
    :cond_0
    iput-object p11, p0, Lu9b;->l:Ljava/lang/String;
    ...
    :cond_1
    iput-object p12, p0, Lu9b;->m:Ljava/lang/String;
...
.method public final d(Ldxh;)V
    ...
    iget-object v0, v7, Lhja;->A0:Lmna;
    ...
    invoke-direct/range {v4 .. v9}, Lot;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    iget-object p1, v5, Lfja;->a:Lq05;
    ...
    invoke-direct {v0, v5, v4}, Lagf;-><init>(ILpe7;)V

    invoke-virtual {p1, v0}, Lmgf;->u(Ljava/util/concurrent/Callable;)Ljava/lang/Object;

    iget-object p1, v8, Lqp;->c:Lrp;
    ...
    :goto_3
    invoke-virtual {p1}, Lrp;->c()Ljs2;

    move-result-object p1

    iget-wide v4, v8, Lu9b;->d:J

    invoke-virtual {p1, v4, v5}, Ljs2;->M(J)Lbp2;

    move-result-object p1

    iget-object v0, v7, Lhja;->Y0:Laf5;

    invoke-virtual {v0}, Laf5;->b()Z
    ...
    invoke-virtual {p1, v4, v5}, Ljs2;->H(J)V
    ...
    iget-wide v3, v7, Ltq0;->a:J

    const/4 v5, 0x0

    iget-wide v1, v8, Lu9b;->d:J
...
.method public final e(Lkwh;)V
    ...
    invoke-virtual {p1, v1}, Lg80;->b(Lhja;)V

    goto :goto_3

    :cond_3
    invoke-virtual {p0}, Lu9b;->g()V
    ...
    iget-wide v4, p0, Lu9b;->d:J

    iget-wide v6, p0, Lqp;->a:J

    move-object v8, p1

    invoke-direct/range {v3 .. v8}, Lgw5;-><init>(JJLkwh;)V
...
.method public final f()I
    ...
    :goto_1
    invoke-virtual {v5}, Lrp;->c()Ljs2;

    move-result-object v5

    iget-wide v6, v0, Lu9b;->d:J

    invoke-virtual {v5, v6, v7}, Ljs2;->M(J)Lbp2;
    ...
    :goto_2
    invoke-virtual {v8}, Lrp;->g()Lxzh;

    move-result-object v8

    sget-object v9, Ld3d;->z0:Ld3d;

    iget-wide v10, v0, Lqp;->a:J

    invoke-virtual {v8, v10, v11, v9}, Lxzh;->h(JLd3d;)Ljava/util/List;
    ...
    iget-object v9, v9, Lizh;->f:Lc3d;

    check-cast v9, Lu9b;

    iget-wide v14, v9, Lu9b;->d:J

    cmp-long v14, v14, v6

    if-nez v14, :cond_3

    iget-wide v14, v9, Lu9b;->e:J
    ...
    iget-object v3, v1, Lhja;->E0:Lz70;

    iget-object v4, v1, Lhja;->A0:Lmna;
    ...
    invoke-virtual {v5}, Lbp2;->M()Z

    move-result v4

    if-nez v4, :cond_5

    invoke-virtual {v5}, Lbp2;->c0()Z
    ...
    iget-boolean v14, v0, Lu9b;->k:Z

    if-eqz v14, :cond_10

    sget-object v15, Lr70;->c:Lr70;

    invoke-virtual {v1, v15}, Lhja;->v(Lr70;)Z
    ...
    iget-object v15, v3, Lz70;->a:Ljava/util/List;
    ...
    invoke-virtual {v1, v10, v11}, Lxzh;->j(J)Lizh;
    ...
    iget-wide v3, v0, Lu9b;->f:J

    invoke-virtual {v1, v3, v4, v2}, Lh2c;->x(JLjava/util/List;)J
    ...
    :goto_7
    invoke-virtual {v2}, Lrp;->g()Lxzh;

    move-result-object v1

    invoke-virtual {v1, v10, v11}, Lxzh;->c(J)V

    invoke-static {v13, v9}, Lgbb;->k(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final g()V
    ...
    sget-object v3, Lmja;->o:Lmja;

    invoke-virtual {v2, v0, v3}, Lfja;->r(Lhja;Lmja;)V
    ...
    iget-object v9, p0, Lu9b;->i:Ljava/util/List;

    iget-boolean v10, p0, Lu9b;->k:Z

    iget-wide v2, p0, Lu9b;->e:J

    iget-wide v4, p0, Lu9b;->d:J

    iget-object v6, p0, Lu9b;->m:Ljava/lang/String;

    iget-object v7, p0, Lu9b;->j:Ljava/util/List;

    iget-object v8, p0, Lu9b;->h:Lmna;

    invoke-virtual/range {v1 .. v10}, Liw5;->a(JJLjava/lang/String;Ljava/util/List;Lmna;Ljava/util/List;Z)V
...
.method public final j()[B
    ...
    iput-object v1, v2, Ly70;->a:Ljava/util/List;

    invoke-virtual {v2}, Ly70;->c()Lz70;

    move-result-object v1

    invoke-static {v1}, Lru/ok/tamtam/nano/a;->f(Lz70;)Lru/ok/tamtam/nano/Protos$Attaches;
    ...
    :cond_0
    iget-object v1, p0, Lu9b;->j:Ljava/util/List;
...
.method public final l()Lq2;
    ...
    invoke-static {v3, v4}, Lpl9;->d(Lz70;Ljj6;)Lo50;
    ...
    :goto_3
    iget-object v3, v2, Lhja;->U0:Ljava/util/List;

    if-eqz v3, :cond_6

    invoke-static {v3}, Lpl9;->r(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Lu9b;->l:Ljava/lang/String;

    iget-object v12, v2, Lhja;->X0:Lbf5;

    iget-wide v7, p0, Lu9b;->g:J

    invoke-direct/range {v4 .. v12}, Lyb9;-><init>(JJLjava/lang/String;Lo50;Ljava/util/ArrayList;Lbf5;)V
