...
.field public final e:Lieb;


# direct methods
.method public constructor <init>(Landroid/widget/EditText;Lo9h;ZLhal;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lem9;->a:Landroid/widget/EditText;

    iput-object p2, p0, Lem9;->b:Lo9h;

    iput-boolean p3, p0, Lem9;->c:Z

    iput-object p4, p0, Lem9;->d:Lhal;

    new-instance p1, Lieb;

    invoke-direct {p1}, Lieb;-><init>()V

    iput-object p1, p0, Lem9;->e:Lieb;
...
.method public final a(ILandroid/text/Editable;II)V
    ...
    invoke-static {p2, p3, p4, v1, p1}, Li35;->e0(Landroid/text/Editable;IIZLfm9;)V

    return-void

    :cond_0
    sget v0, Lbne;->markdown_italic:I

    if-ne p1, v0, :cond_1

    new-instance p1, Lpm8;

    invoke-direct {p1}, Lpm8;-><init>()V
    ...
    :cond_1
    sget v0, Lbne;->markdown_underline:I
    ...
    invoke-direct {p1, v2}, Lxjh;-><init>(I)V

    invoke-static {p2, p3, p4, v2, p1}, Li35;->e0(Landroid/text/Editable;IIZLfm9;)V

    return-void

    :cond_2
    sget v0, Lbne;->markdown_mono:I

    if-ne p1, v0, :cond_3

    new-instance p1, La7b;

    invoke-direct {p1}, La7b;-><init>()V
    ...
    :cond_3
    sget v0, Lbne;->markdown_strikethrough:I

    if-ne p1, v0, :cond_4

    new-instance p1, Lxjh;

    invoke-direct {p1, v1}, Lxjh;-><init>(I)V
    ...
    :cond_4
    sget v0, Lbne;->markdown_heading:I
    ...
    :cond_5
    sget v0, Lbne;->markdown_quote:I

    sget-object v3, Ltpi;->a:Ltpi;

    iget-object v4, p0, Lem9;->a:Landroid/widget/EditText;
    ...
    sget v0, Lene;->text_change_is_programmatic_tag:I
    ...
    invoke-virtual {p0}, Lem9;->b()Loge;

    move-result-object p4

    new-instance v0, Lpge;

    invoke-direct {v0, p4}, Lpge;-><init>(Loge;)V

    const/16 p4, 0x11

    invoke-static {p2, v0, p1, p3, p4}, Lld7;->U(Landroid/text/Spannable;Lfm9;III)V
    ...
    invoke-static {p2, v3, v5, v6}, Li35;->f0(Landroid/text/Spannable;Lfm9;II)V
    :try_end_0
    ...
    :cond_f
    :goto_5
    sget p1, Lene;->text_change_is_programmatic_tag:I

    invoke-virtual {v4, p1, v8}, Landroid/view/View;->setTag(ILjava/lang/Object;)V

    invoke-static {p2}, Lpkk;->b(Landroid/text/Editable;)V

    return-void

    :goto_6
    sget p2, Lene;->text_change_is_programmatic_tag:I
    ...
    :cond_10
    sget v0, Lbne;->markdown_regular:I
    ...
    invoke-static {p2, v6, v7, v9}, Li35;->f0(Landroid/text/Spannable;Lfm9;II)V
    ...
    :goto_a
    invoke-static {p2, p3, p4}, Li35;->R(Landroid/text/Spannable;II)V
...
.method public final b()Loge;
    ...
    iget-object v1, v0, Lem9;->a:Landroid/widget/EditText;
    ...
    invoke-static {v3, v4}, Lhb9;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct/range {v2 .. v18}, Loge;-><init>(Landroid/content/Context;Lo9h;Lfmc;Ly2i;Landroid/graphics/drawable/Drawable;IIIIIIIIIIF)V
    ...
    invoke-direct {v1, v3, v4}, Lbfe;-><init>(Ljava/lang/Object;I)V

    iput-object v1, v2, Loge;->f:Lbfe;
...
.method public final c()Z
    ...
    iget-object v0, p0, Lem9;->a:Landroid/widget/EditText;
...
.method public final d(Landroid/text/Editable;II)V
    ...
    iget-object p1, v5, Li49;->c:Ljava/lang/String;

    iget-object v0, v2, Lhal;->b:Ljava/lang/Object;

    check-cast v0, Lone/me/sdk/messagewrite/MessageWriteWidget;

    sget-object v1, Lone/me/sdk/messagewrite/MessageWriteWidget;->V0:[Lbv8;

    iget-object v0, v0, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lpx8;
    ...
    invoke-direct {v1, p2, p3, p1}, Lcc;-><init>(IILjava/lang/String;)V
    ...
    :cond_2
    iget-object p1, v2, Lhal;->b:Ljava/lang/Object;
    ...
    iget-object p1, p1, Lone/me/sdk/messagewrite/MessageWriteWidget;->c:Lpx8;
    ...
    iget-object p1, p1, Lgm9;->c:Ld66;

    new-instance v0, Lcc;

    invoke-direct {v0, p2, p3, v1}, Lcc;-><init>(IILjava/lang/String;)V
...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p0, p2, v0, v1, v2}, Lem9;->a(ILandroid/text/Editable;II)V
    ...
    :cond_1
    sget v5, Lbne;->markdown_italic:I
    ...
    :cond_2
    sget v5, Lbne;->markdown_underline:I
    ...
    :cond_4
    sget v5, Lbne;->markdown_strikethrough:I
    ...
    :cond_5
    sget v5, Lbne;->markdown_link:I

    if-ne v4, v5, :cond_6

    invoke-virtual {p0, v0, v1, v2}, Lem9;->d(Landroid/text/Editable;II)V

    return v6

    :cond_6
    sget v5, Lbne;->markdown_heading:I
    ...
    :cond_8
    sget v5, Lbne;->markdown_regular:I
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iget-object p1, p0, Lem9;->e:Lieb;

    invoke-virtual {p1}, Lieb;->c()V

    const v0, 0x1020020

    invoke-virtual {p1, v0}, Lieb;->a(I)V

    const v0, 0x1020021

    invoke-virtual {p1, v0}, Lieb;->a(I)V

    invoke-virtual {p0}, Lem9;->c()Z
    ...
    invoke-virtual {p1, v3}, Lieb;->a(I)V
...
.method public final onPrepareActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    :cond_4
    sget-object v1, Lam9;->X:Lam9;

    iget v2, v1, Lam9;->a:I

    iget-object v3, p0, Lem9;->a:Landroid/widget/EditText;
    ...
    invoke-virtual {p1, v2}, Lieb;->a(I)V
    ...
    invoke-direct {p1, p2, v1}, Low;-><init>(Ljava/lang/Object;I)V
