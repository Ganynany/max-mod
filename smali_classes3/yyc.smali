...
.method public final accept(Ljava/lang/Object;)V
    ...
    iput-object v6, v2, Lmzc;->V:Lorg/webrtc/RtpSender;

    iput-object v6, v2, Lmzc;->X:Lorg/webrtc/RtpSender;
    ...
    iget-object v0, v2, Lmzc;->D:Ljte;

    const-string v10, "audioShareTransceiver found"

    invoke-interface {v0, v9, v10}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v11, v2, Lmzc;->D:Ljte;
    ...
    invoke-interface {v11, v9, v0}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V

    :goto_1
    iget-object v0, v2, Lmzc;->y:Lnqg;
    ...
    iput-object v7, v2, Lmzc;->V:Lorg/webrtc/RtpSender;

    iget-object v11, v2, Lmzc;->t:Lqia;

    const-string v12, "audio-share"

    invoke-virtual {v11, v7, v12}, Lqia;->w(Lorg/webrtc/RtpSender;Ljava/lang/String;)V

    invoke-virtual {v7, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v7, v2, Lmzc;->D:Ljte;
    ...
    invoke-interface {v7, v9, v0}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v9, v7}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {v11 .. v17}, Lqia;->x(Lorg/webrtc/RtpSender;Ljava/lang/String;IILjava/lang/Double;Z)V

    iput-object v12, v2, Lmzc;->X:Lorg/webrtc/RtpSender;

    invoke-virtual {v12, v0, v10}, Lorg/webrtc/RtpSender;->setTrack(Lorg/webrtc/MediaStreamTrack;Z)Z

    iget-object v5, v2, Lmzc;->X:Lorg/webrtc/RtpSender;

    iget-boolean v7, v2, Lmzc;->k0:Z
    ...
    invoke-interface {v5, v9, v0}, Ljte;->log(Ljava/lang/String;Ljava/lang/String;)V

    :try_start_2
    iget-object v0, v2, Lmzc;->X:Lorg/webrtc/RtpSender;

    const/4 v5, 0x1

    invoke-virtual {v2, v3, v10, v5, v0}, Lmzc;->m(Lorg/webrtc/PeerConnection;ZZLorg/webrtc/RtpSender;)V
    :try_end_2
    ...
    :cond_9
    :goto_8
    invoke-virtual {v2, v3}, Lmzc;->v(Lorg/webrtc/PeerConnection;)V

    sget-object v0, Lyib;->b:Lyib;

    iget-object v4, v2, Lmzc;->F:Lqt1;

    iget-object v4, v4, Lqt1;->t:Lyib;
    ...
    iget-object v4, v2, Lmzc;->P:Lorg/webrtc/PeerConnection;
    ...
    invoke-direct {v3, v0, v5, v6, v4}, Lzib;-><init>(Lyib;Ljava/lang/String;Lorg/webrtc/SessionDescription;Lorg/webrtc/SessionDescription;)V

    invoke-virtual {v2, v3}, Lmzc;->h(Lzib;)V
    ...
    invoke-direct {v0, v2, v4}, Ljzc;-><init>(Lmzc;I)V
    ...
    invoke-virtual {v0, v2, v3}, Lmzc;->t(Lorg/webrtc/PeerConnection;Z)V

    invoke-virtual {v0, v2, v3}, Lmzc;->l(Lorg/webrtc/PeerConnection;Z)V
