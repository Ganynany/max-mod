...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p0, v2}, Lt8;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p0, Lfs0;->b:Lt8;

    new-instance v0, Lm;

    const/16 v2, 0xd

    invoke-direct {v0, p0, v2}, Lm;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object v0, p0, Lfs0;->c:Ljava/lang/Object;
...
.method private final getAgslDelegate()Lbf;
    .locals 1

    iget-object v0, p0, Lfs0;->c:Ljava/lang/Object;
...
# virtual methods
.method public abstract a(Laf;FF)V
.end method

.method public final b()V
    .locals 1

    iget-boolean v0, p0, Lfs0;->o:Z
    ...
    :cond_1
    iget-object v0, p0, Lfs0;->d:Lin7;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lin7;->a()V
...
.method public final c()V
    ...
    iput-boolean v0, p0, Lfs0;->o:Z

    iget-boolean v1, p0, Lfs0;->a:Z

    if-eqz v1, :cond_6

    invoke-direct {p0}, Lfs0;->getAgslDelegate()Lbf;

    move-result-object v1

    iget-object v2, v1, Lbf;->a:Lt8;

    iget-object v3, v1, Lbf;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iget-object v3, v2, Lt8;->b:Ljava/lang/Object;

    check-cast v3, Lfs0;

    invoke-virtual {v3}, Lfs0;->getSpec()Lrpi;
    ...
    sget-object v4, Lbf;->g:Ljava/util/LinkedHashMap;
    ...
    invoke-static {v3}, Lze;->c(Ljava/lang/Object;)Landroid/graphics/RuntimeShader;
    ...
    :goto_0
    iput-object v3, v1, Lbf;->b:Landroid/graphics/RuntimeShader;

    if-nez v3, :cond_8

    sget-object v3, Long;->a:Ljava/lang/Object;

    iget-object v2, v2, Lt8;->b:Ljava/lang/Object;

    check-cast v2, Lfs0;

    invoke-virtual {v2}, Lfs0;->getSpec()Lrpi;
    ...
    invoke-virtual {v2}, Lu2g;->p()Ljava/util/List;
    ...
    :goto_2
    iget-object v4, v4, Lspi;->a:Ljava/lang/String;
    ...
    invoke-static {v9, v6, v7, v4, v8}, Lhb2;->p(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v0, Long;->a:Ljava/lang/Object;
    ...
    invoke-direct {v4, v5}, Lj0g;-><init>(I)V
    ...
    invoke-virtual {v2, v6, v4}, Ln6f;->c(Ljava/lang/String;Lre7;)Ljava/lang/String;
    ...
    invoke-direct {v2, v5}, Lj0g;-><init>(I)V
    ...
    invoke-virtual {v0, v4, v2}, Ln6f;->c(Ljava/lang/String;Lre7;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lze;->d(Ljava/lang/String;)Landroid/graphics/RuntimeShader;

    move-result-object v0

    iput-object v0, v1, Lbf;->b:Landroid/graphics/RuntimeShader;

    return-void

    :cond_6
    iget-object v1, p0, Lfs0;->d:Lin7;
    ...
    iget-object v3, p0, Lfs0;->b:Lt8;

    invoke-direct {v1, v2, v3}, Lin7;-><init>(Landroid/content/Context;Lt8;)V

    iput-object v1, p0, Lfs0;->d:Lin7;
    ...
    invoke-virtual {v1, v0}, Lin7;->setStarted(Z)V
...
.method public final d()V
    ...
    iget-object v1, v0, Lbf;->c:Ljava/lang/Object;
    ...
    iget-object v1, v0, Lbf;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_0
    iput-object v2, v0, Lbf;->b:Landroid/graphics/RuntimeShader;

    sget-object v2, Lbf;->g:Ljava/util/LinkedHashMap;

    iget-object v0, v0, Lbf;->a:Lt8;

    iget-object v0, v0, Lt8;->b:Ljava/lang/Object;

    check-cast v0, Lfs0;

    invoke-virtual {v0}, Lfs0;->getSpec()Lrpi;
...
.method public abstract getSpec()Lrpi;
.end method
...
.method public final onDrawForeground(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v1, Lbf;->b:Landroid/graphics/RuntimeShader;
    ...
    :cond_2
    iget-object v4, v0, Lbf;->e:[F

    iget-object v5, v0, Lbf;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v4}, Lze;->C(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, v0, Lbf;->f:Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, v2, v3}, Lfs0;->a(Laf;FF)V
