...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmi1;->i:Ljava/util/List;

    return-void
.end method

.method public constructor <init>(Lru/ok/android/externcalls/analytics/CallAnalyticsSender;Ld6i;Lzbe;Liif;Lps9;Ljte;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lmi1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;

    iput-object p2, p0, Lmi1;->b:Ld6i;

    iput-object p3, p0, Lmi1;->c:Lzbe;

    iput-object p4, p0, Lmi1;->d:Liif;

    iput-object p5, p0, Lmi1;->e:Lps9;

    iput-object p6, p0, Lmi1;->f:Ljte;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lmi1;->h:Ljava/util/ArrayList;
...
.method public final b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v0, p0, Lmi1;->h:Ljava/util/ArrayList;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lmi1;->h:Ljava/util/ArrayList;

    invoke-static {v1}, Lgy3;->i1(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object v1

    iget-object v2, p0, Lmi1;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, v1, Lrek;->c:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object v3, v1, Lrek;->d:Ljava/lang/Long;
    ...
    :cond_0
    iget-object v3, p0, Lmi1;->b:Ld6i;

    invoke-interface {v3}, Ld6i;->getServerTimeMs()Ljava/lang/Long;
    ...
    invoke-interface {v3}, Ld6i;->localTimeMs()J
    ...
    iget-object v6, v1, Lrek;->a:Ljava/lang/String;

    iget-object v1, v1, Lrek;->b:Lru/ok/android/externcalls/analytics/events/EventItemValue;
    ...
    iget-object v2, p0, Lmi1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final c(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V
    ...
    iget-object v1, p0, Lmi1;->b:Ld6i;

    invoke-interface {v1}, Ld6i;->getServerTimeMs()Ljava/lang/Long;

    move-result-object v1

    invoke-direct {v0, p1, p2, p3, v1}, Lrek;-><init>(Ljava/lang/String;Lru/ok/android/externcalls/analytics/events/EventItemValue;Lru/ok/android/externcalls/analytics/events/EventItemsMap;Ljava/lang/Long;)V

    iget-object v2, p0, Lmi1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;

    if-nez v2, :cond_0

    iget-object p1, p0, Lmi1;->h:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_0
    iget-object p2, p0, Lmi1;->h:Ljava/util/ArrayList;
    ...
    invoke-interface {v0}, Ld6i;->localTimeMs()J
    ...
    iget-object p2, p0, Lmi1;->a:Lru/ok/android/externcalls/analytics/CallAnalyticsSender;
...
.method public final onTopologyUpdated(Lnai;Lnai;)V
    ...
    iget-object p1, p0, Lmi1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
    ...
    iget-object p2, p0, Lmi1;->c:Lzbe;

    invoke-virtual {p2, p1}, Lzbe;->r(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iget-object p2, p0, Lmi1;->d:Liif;

    iget-object p2, p2, Liif;->a:Ljava/lang/Object;

    check-cast p2, Lor4;

    iget-object p2, p2, Lor4;->b:Ljava/lang/String;
    ...
    iget-object p2, p0, Lmi1;->e:Lps9;

    invoke-virtual {p2, p1}, Lps9;->n(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    invoke-virtual {p0, p1}, Lmi1;->b(Lru/ok/android/externcalls/analytics/events/EventItemsMap;)V

    iput-object p1, p0, Lmi1;->g:Lru/ok/android/externcalls/analytics/events/EventItemsMap;
