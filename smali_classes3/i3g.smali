...
# direct methods
.method public constructor <init>(Lv5d;Ljava/util/concurrent/ExecutorService;)V
    .locals 0

    invoke-direct {p0, p2}, Lxwg;-><init>(Ljava/util/concurrent/Executor;)V

    iput-object p1, p0, Li3g;->o:Lv5d;

    iput-object p2, p0, Li3g;->X:Ljava/util/concurrent/ExecutorService;
...
.method public final L(Lfyg;I)V
    ...
    invoke-virtual {p1, p2}, Lh3g;->I(Lgh7;)V
...
.method public final x(Landroid/view/ViewGroup;I)Lw5f;
    ...
    iget-object v2, p0, Li3g;->o:Lv5d;

    invoke-direct {p1, v2, p2, v0, v1}, Lh3g;-><init>(Lv5d;Lone/me/sdk/uikit/common/views/OneMeDraweeView;Landroidx/appcompat/widget/AppCompatTextView;Landroid/widget/LinearLayout;)V
