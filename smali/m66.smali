...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lm66;->o:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lm66;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    sput-object v0, Lm66;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public final C0()J
    ...
    :cond_0
    invoke-virtual {p0}, Lm66;->G0()V

    :goto_0
    sget-object v0, Lm66;->o:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_5
    sget-object v5, Lo66;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_b
    sget-object v3, Lo66;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :cond_c
    sget-object v0, Lm66;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
...
.method public F0(Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p1}, Lm66;->H0(Ljava/lang/Runnable;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0}, Ln66;->f0()Ljava/lang/Thread;
    ...
    invoke-virtual {v0, p1}, Ls85;->F0(Ljava/lang/Runnable;)V
...
.method public final G0()V
    ...
    invoke-virtual {p0, v3}, Lm66;->H0(Ljava/lang/Runnable;)Z
...
.method public final H0(Ljava/lang/Runnable;)Z
    ...
    sget-object v2, Lm66;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    :cond_7
    sget-object v2, Lo66;->b:Lkotlinx/coroutines/internal/Symbol;
...
.method public final J0(JLk66;)V
    .locals 5

    sget-object v0, Lm66;->Y:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
    ...
    sget-object v3, Lm66;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_3
    invoke-virtual {p3, p1, p2, v0, p0}, Lk66;->b(JLl66;Lm66;)I
    ...
    :cond_5
    invoke-virtual {p0, p1, p2, p3}, Ln66;->E0(JLk66;)V
...
.method public final dispatch(Lxs4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {p0, p2}, Lm66;->F0(Ljava/lang/Runnable;)V

    return-void
.end method

.method public invokeOnTimeout(JLjava/lang/Runnable;Lxs4;)Lol5;
    .locals 0

    invoke-static {p1, p2, p3, p4}, Lt9l;->b(JLjava/lang/Runnable;Lxs4;)Lol5;
...
.method public final scheduleResumeAfterDelay(JLhh2;)V
    ...
    sget-object v0, Lo66;->a:Lkotlinx/coroutines/internal/Symbol;
    ...
    invoke-direct {v2, p0, v0, v1, p3}, Li66;-><init>(Lm66;JLhh2;)V

    invoke-virtual {p0, p1, p2, v2}, Lm66;->J0(JLk66;)V

    new-instance p1, Lsg2;

    const/4 p2, 0x1

    invoke-direct {p1, v2, p2}, Lsg2;-><init>(Ljava/lang/Object;I)V
...
.method public shutdown()V
    ...
    sget-object v0, Lx4i;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v4, Lo66;->b:Lkotlinx/coroutines/internal/Symbol;
    ...
    :goto_2
    sget-object v2, Lm66;->X:Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;
    ...
    :cond_7
    invoke-virtual {p0, v0, v1, v2}, Ln66;->E0(JLk66;)V
