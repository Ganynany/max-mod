...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    sget-boolean p1, Lxqf;->a:Z

    invoke-virtual {v0, p1}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;->setRemoveOnCancelPolicy(Z)V

    iput-object v0, p0, Lymb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final b(Ljava/lang/Runnable;)Lll5;
    ...
    invoke-virtual {p0, p1, v0, v1, v2}, Lymb;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lll5;
...
.method public final dispose()V
    ...
    iget-object v0, p0, Lymb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public final e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lml5;)Lopf;
    .locals 3

    new-instance v0, Lopf;

    invoke-direct {v0, p1, p5}, Lopf;-><init>(Ljava/lang/Runnable;Lml5;)V

    if-eqz p5, :cond_0

    invoke-interface {p5, v0}, Lml5;->a(Lll5;)Z
    ...
    iget-object v1, p0, Lymb;->a:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    :goto_0
    invoke-virtual {v0, p1}, Lopf;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    ...
    invoke-interface {p5, v0}, Lml5;->b(Lll5;)Z
