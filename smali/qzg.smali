...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqzg;->e:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-direct {v2, v3, v0, v1}, Lslf;-><init>(Ljava/lang/String;IZ)V

    sput-object v2, Lqzg;->d:Lslf;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lqzg;->c:Ljava/util/concurrent/atomic/AtomicReference;

    sget-boolean v1, Lxqf;->a:Z

    new-instance v1, Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    const/4 v2, 0x1

    sget-object v3, Lqzg;->d:Lslf;

    invoke-direct {v1, v2, v3}, Ljava/util/concurrent/ScheduledThreadPoolExecutor;-><init>(ILjava/util/concurrent/ThreadFactory;)V

    sget-boolean v2, Lxqf;->a:Z
...
.method public final a()Loqf;
    ...
    iget-object v1, p0, Lqzg;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v0, v1}, Lpzg;-><init>(Ljava/util/concurrent/ScheduledExecutorService;)V
...
.method public final d(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Lll5;
    ...
    sget-object v7, Lo06;->a:Lo06;

    iget-object v6, p0, Lqzg;->c:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-direct {v6, p1, v1}, Lyh8;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    :goto_0
    invoke-virtual {v6, v0}, Lyh8;->a(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
