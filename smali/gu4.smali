...
# static fields
.field public static final b:Lu6;

.field public static final c:Ly66;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v0, v2}, Ln14;-><init>(Ljava/lang/Object;I)V

    new-instance v0, Ly66;

    const/4 v2, 0x2

    invoke-direct {v0, v1, v2}, Ly66;-><init>(Ljava/util/Comparator;I)V

    new-instance v1, Ly66;

    const/4 v2, 0x3

    invoke-direct {v1, v0, v2}, Ly66;-><init>(Ljava/util/Comparator;I)V

    sput-object v1, Lgu4;->c:Ly66;
...
.method public static a(Ljava/io/File;)Lbu4;
    .locals 13
    ...
    invoke-static {v1, v2, v4, v3}, Lhkh;->N0(Ljava/lang/CharSequence;CII)I
    ...
    invoke-static {v0}, Lbp8;->C(Ljava/lang/String;)I
    ...
    invoke-static {p0, v0}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {p0, v2}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v2

    const-string v3, "all_stacktraces"

    invoke-static {p0, v3}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    const-string v7, "all_logs"

    invoke-static {p0, v7}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct/range {v3 .. v12}, Lbu4;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
...
# virtual methods
.method public b(ILjava/lang/Throwable;Lsuh;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)Lbu4;
    .locals 9
    ...
    :try_start_0
    invoke-static {p2, v1}, Lld7;->e(Ljava/lang/Throwable;Ljava/lang/Appendable;)V
    :try_end_0
...
.method public c(I[BLsuh;Ljava/util/List;Ljava/util/Map;Ljava/util/List;)Lbu4;
    .locals 17
    ...
    iget-object v3, v10, Lgu4;->a:Landroid/content/Context;
    ...
    invoke-static {v0, v6, v7, v5}, Lpkh;->w0(Ljava/lang/String;CCZ)Ljava/lang/String;
    ...
    invoke-static {v4, v0}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v0, v3}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    :cond_1
    :try_start_0
    invoke-static {v11}, Li35;->S(Ljava/io/File;)V

    const-string v0, "stacktrace"

    invoke-static {v11, v0}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v11, v3}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    invoke-static/range {p3 .. p3}, Lag3;->U(Lsuh;)Lorg/json/JSONObject;
    ...
    invoke-static {v3, v4}, Lhq6;->S(Ljava/io/File;Ljava/lang/String;)V

    const-string v4, "tags"

    invoke-static {v11, v4}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v4, v6}, Lhq6;->S(Ljava/io/File;Ljava/lang/String;)V

    :cond_3
    const-string v6, "all_stacktraces"

    invoke-static {v11, v6}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v15, v13, v5, v8}, Lld7;->g(Ljava/lang/StackTraceElement;Ljava/lang/Appendable;II)V
    :try_end_4
    ...
    invoke-static {v11, v7}, Lhq6;->R(Ljava/io/File;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-virtual {v13, v9, v5}, Lkc9;->a(Ljava/io/OutputStream;I)V
    :try_end_8
    ...
    :try_start_b
    invoke-static {v9, v1}, Lgbb;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    invoke-direct/range {v0 .. v9}, Lbu4;-><init>(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_b
    ...
    :catch_1
    :goto_b
    invoke-static {v11}, Lhq6;->M(Ljava/io/File;)Z
