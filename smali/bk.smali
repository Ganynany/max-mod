...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lbk;->b:Landroid/content/res/Resources;
...
.method public final a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-static {v1}, Ld2c;->g(Landroid/content/res/XmlResourceParser;)Ljava/util/LinkedHashMap;
    ...
    :cond_4
    invoke-virtual {v0, v1, v3, v9}, Lbk;->a(Landroid/content/res/XmlResourceParser;Landroid/animation/AnimatorSet;I)Landroid/animation/Animator;
    ...
    invoke-virtual {v0, v3, v1}, Lbk;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    invoke-virtual {v0, v7, v3}, Lbk;->b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V

    sget-object v11, Lqj;->f:Lqj;

    iget-object v12, v0, Lbk;->a:Landroid/content/Context;
    ...
    instance-of v12, v3, Lfk;

    if-nez v12, :cond_6

    instance-of v3, v3, Lgk;
    ...
    :cond_8
    :goto_3
    invoke-static {v11}, Lso4;->s(Ljava/lang/String;)Landroid/graphics/Path;
...
.method public final b(Landroid/animation/ValueAnimator;Landroid/content/res/XmlResourceParser;)V
    ...
    :cond_0
    instance-of v1, p2, Lgk;

    if-eqz v1, :cond_2

    new-instance p2, Ldk;

    invoke-direct {p2, v5}, Ldk;-><init>(F)V
    ...
    invoke-direct {p2, v4}, Lck;-><init>(I)V

    :cond_2
    :goto_1
    instance-of v1, p2, Ldk;

    instance-of v6, p2, Lfk;

    const/4 v7, 0x0

    if-eqz v6, :cond_11

    instance-of p2, v2, Lfk;
    ...
    iget-object v1, v1, Lfk;->a:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v1}, Lso4;->r(Ljava/lang/String;)[Loyc;
    ...
    iget-object v5, v5, Lfk;->a:Ljava/lang/String;
    ...
    :cond_7
    invoke-static {v5}, Lso4;->r(Ljava/lang/String;)[Loyc;
    ...
    invoke-direct {v6}, Lgae;-><init>()V

    if-eqz v5, :cond_f

    invoke-static {v1, v5}, Lso4;->i([Loyc;[Loyc;)Z
    ...
    iget-object p2, v2, Lfk;->a:Ljava/lang/String;
    ...
    iget-object v7, v3, Lfk;->a:Ljava/lang/String;
    ...
    invoke-static {v0, p2, v1, v7}, Lhb2;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
