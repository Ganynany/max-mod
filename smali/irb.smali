...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lqdc;Lz65;Ls8c;Lgrd;)V
    .locals 0
    ...
    iput-object p2, p0, Lirb;->b:Lqdc;

    iput-object p3, p0, Lirb;->c:Lz65;

    iput-object p4, p0, Lirb;->d:Ls8c;

    iput-object p5, p0, Lirb;->e:Lgrd;
...
.method public final a()Lhrb;
    ...
    iget-object v1, p0, Lirb;->c:Lz65;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v1, "ru.oneme.app.new.activeCalls"

    invoke-virtual {v0, v1}, Lhrb;->c(Ljava/lang/String;)V

    iget-object v1, p0, Lirb;->a:Landroid/content/Context;

    sget v2, Lrre;->tt_notif_category_active_calls:I

    invoke-virtual {v1, v2}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v0, v1}, Lhrb;->f(Ljava/lang/String;)V

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lhrb;->j(Z)V

    invoke-virtual {v0, v1}, Lhrb;->k(Z)V

    invoke-virtual {v0, v1}, Lhrb;->e(Z)V

    invoke-virtual {v0, v1}, Lhrb;->g(Z)V

    invoke-virtual {v0}, Lhrb;->d()V

    invoke-virtual {v0}, Lhrb;->a()Lhrb;
...
.method public final b()Lhrb;
    ...
    sget v2, Lrre;->tt_notif_category_incoming_calls:I
    ...
    invoke-virtual {v0, v1}, Lhrb;->h(Landroid/net/Uri;)V

    invoke-virtual {v0, v3}, Lhrb;->g(Z)V

    invoke-virtual {v0}, Lhrb;->b()V

    invoke-virtual {v0, v3}, Lhrb;->e(Z)V
...
.method public final c()Lhrb;
    ...
    invoke-virtual {v2, v3}, Lnyi;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v4}, Lirb;->i(Z)Landroid/net/Uri;

    move-result-object v4

    iget-object v5, p0, Lirb;->c:Lz65;

    invoke-virtual {v5}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const-string v5, "ru.oneme.app.chats"

    invoke-virtual {v0, v5}, Lhrb;->c(Ljava/lang/String;)V

    iget-object v5, p0, Lirb;->a:Landroid/content/Context;

    sget v6, Lrre;->tt_notif_category_chats:I

    invoke-virtual {v5, v6}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v0, v5}, Lhrb;->f(Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Lhrb;->j(Z)V
    ...
    invoke-virtual {v2, v5, v3}, Ltx8;->getBoolean(Ljava/lang/String;Z)Z

    move-result v2

    invoke-virtual {v0, v2}, Lhrb;->k(Z)V

    invoke-virtual {v0, v4}, Lhrb;->h(Landroid/net/Uri;)V
...
.method public final d()Lhrb;
    ...
    invoke-virtual {p0, v3}, Lirb;->i(Z)Landroid/net/Uri;
    ...
    sget v6, Lrre;->tt_notif_category_dialogs:I
...
.method public final e()Lhrb;
    ...
    sget v2, Lrre;->tt_notif_category_inapp:I
    ...
    invoke-virtual {v0, v2}, Lhrb;->h(Landroid/net/Uri;)V

    iget-object v2, p0, Lirb;->e:Lgrd;
    ...
    invoke-virtual {v2, v3, v1}, Ltx8;->getBoolean(Ljava/lang/String;Z)Z
    ...
    invoke-virtual {v0, v1}, Lhrb;->l([J)V
...
.method public final f(Lhrb;)V
    ...
    iget-object v1, p1, Lhrb;->a:Ljava/lang/String;
    ...
    iget-boolean v0, p1, Lhrb;->c:Z

    const/4 v2, 0x4

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Lhrb;->f:Z
    ...
    iget-object v0, p0, Lirb;->d:Ls8c;

    invoke-virtual {v0, v1}, Ls8c;->b(Ljava/lang/String;)Ljava/lang/String;
...
.method public final g()V
    ...
    invoke-direct {v3, v2}, Lkw;-><init>(I)V
    ...
    invoke-virtual {v3, v4}, Lkw;->add(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v3, v1}, Lkw;->contains(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0, v4, v1}, Ls8c;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {v0, v3, v1}, Ls8c;->a(ILjava/lang/String;)V
    ...
    invoke-virtual {p0}, Lirb;->c()Lhrb;

    move-result-object v3

    invoke-virtual {p0, v3}, Lirb;->f(Lhrb;)V
    ...
    iget-object v6, p0, Lirb;->e:Lgrd;

    iget-object v7, v6, Lgrd;->c:Lnyi;

    const-string v8, "app.notification.ringtone"

    invoke-virtual {v7, v8}, Lnyi;->n(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lhrb;->c(Ljava/lang/String;)V

    sget v9, Lrre;->tt_notif_category_misc:I

    invoke-virtual {v5, v9}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v3, v9}, Lhrb;->f(Ljava/lang/String;)V

    invoke-virtual {v3, v7}, Lhrb;->j(Z)V
    ...
    invoke-virtual {v6, v7, v4}, Ltx8;->getBoolean(Ljava/lang/String;Z)Z

    move-result v6

    invoke-virtual {v3, v6}, Lhrb;->k(Z)V

    invoke-virtual {v3, v8}, Lhrb;->h(Landroid/net/Uri;)V

    invoke-virtual {v3}, Lhrb;->a()Lhrb;
    ...
    sget v6, Lrre;->tt_notif_category_file_loading:I

    invoke-virtual {v5, v6}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v3, v6}, Lhrb;->f(Ljava/lang/String;)V

    invoke-virtual {v3, v2}, Lhrb;->j(Z)V

    invoke-virtual {v3, v2}, Lhrb;->k(Z)V

    invoke-virtual {v3, v2}, Lhrb;->g(Z)V
    ...
    sget v6, Lrre;->tt_notif_category_media:I
    ...
    invoke-virtual {v3, v4}, Lhrb;->j(Z)V

    const/4 v4, 0x0

    invoke-virtual {v3, v4}, Lhrb;->h(Landroid/net/Uri;)V
    ...
    sget v4, Lrre;->tt_notif_category_live_location:I

    invoke-virtual {v5, v4}, Landroid/content/Context;->getString(I)Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v3, v4}, Lhrb;->f(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v2}, Lirb;->f(Lhrb;)V
...
.method public final i(Z)Landroid/net/Uri;
    ...
    iget-object v0, p0, Lirb;->e:Lgrd;

    if-eqz p1, :cond_0

    iget-object p1, v0, Lgrd;->c:Lnyi;

    const-string v0, "app.notification.ringtone"

    invoke-virtual {p1, v0}, Lnyi;->n(Ljava/lang/String;)Ljava/lang/String;
...
.method public final j()Landroid/app/NotificationManager;
    ...
    iget-object v0, p0, Lirb;->f:Landroid/app/NotificationManager;
    ...
    iput-object v0, p0, Lirb;->f:Landroid/app/NotificationManager;
...
.method public final k()Z
    ...
    invoke-virtual {p0, v0}, Lirb;->h(Ljava/lang/String;)Landroid/app/NotificationChannel;
