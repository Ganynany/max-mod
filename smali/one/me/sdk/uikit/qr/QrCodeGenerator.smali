...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lzce;->a:Lx65;

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b:Lx65;
    ...
    sget-object v2, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b:Lx65;
...
.method public static b(Lade;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lmx8;Landroid/content/Context;Lrmc;)Lyce;
    .locals 19

    invoke-virtual/range {p0 .. p0}, Lade;->d()I

    move-result v0

    add-int/lit8 v0, v0, 0x2

    invoke-virtual/range {p0 .. p0}, Lade;->c()I
    ...
    invoke-virtual/range {p0 .. p0}, Lade;->f()I
    ...
    invoke-static/range {v7 .. v12}, Ly2i;->c(Ly2i;Landroid/content/Context;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Ldv5;I)V

    invoke-interface/range {p5 .. p5}, Lrmc;->getText()Lhmc;
    ...
    invoke-static/range {v3 .. v12}, Lmx8;->a(Lmx8;Ljava/lang/CharSequence;Landroid/text/TextPaint;IIZLandroid/text/TextUtils$TruncateAt;FZI)Landroid/text/Layout;
    ...
    invoke-static/range {v13 .. v18}, Ly2i;->c(Ly2i;Landroid/content/Context;Landroid/text/TextPaint;Landroid/util/DisplayMetrics;Ldv5;I)V
    ...
    invoke-virtual/range {p0 .. p0}, Lade;->h()I
    ...
    invoke-direct/range {p0 .. p5}, Lyce;-><init>(Landroid/text/Layout;Landroid/text/Layout;III)V
...
.method public static c(Lone/me/sdk/uikit/qr/QrCodeGenerator;Ljava/lang/String;ILrmc;)Lrvc;
    .locals 10
    ...
    invoke-interface {p3}, Lrmc;->i()Lu9k;
    ...
    invoke-direct {p0, p1, p3}, Lrvc;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-static {v3, p1}, Lidg;->q(ILjava/lang/String;)Ljava/lang/String;
...
.method public static e(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILrmc;)V
    .locals 16
    ...
    invoke-interface/range {p8 .. p8}, Lrmc;->i()Lu9k;

    move-result-object v7

    iget-object v7, v7, Lu9k;->d:Ljava/lang/Object;

    check-cast v7, Lgmc;

    iget v7, v7, Lgmc;->a:I

    invoke-static {v7, v0}, Lcm0;->P(ILandroid/graphics/drawable/Drawable;)V
    ...
    iget-object v13, v4, Lgmc;->g:[I

    const/4 v14, 0x0

    invoke-static {v14, v13}, Llw;->m0(I[I)Ljava/lang/Integer;
    ...
    :goto_0
    invoke-static {v3, v13}, Llw;->m0(I[I)Ljava/lang/Integer;
    ...
    invoke-static {v9, v13}, Llw;->m0(I[I)Ljava/lang/Integer;
    ...
    :goto_2
    invoke-static {v12, v13}, Llw;->m0(I[I)Ljava/lang/Integer;
...
# virtual methods
.method public final g(Landroid/content/Context;ILgq6;Ljwh;Lmx8;Lfde;Ljava/lang/String;Landroid/graphics/drawable/Drawable;Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lmp4;)Ljava/lang/Object;
    .locals 45
    ...
    invoke-direct {v3, v1, v2}, Lbde;-><init>(Lone/me/sdk/uikit/qr/QrCodeGenerator;Lmp4;)V

    goto :goto_0

    :goto_1
    iget-object v2, v14, Lbde;->A0:Ljava/lang/Object;

    iget v3, v14, Lbde;->C0:I
    ...
    iget-object v0, v14, Lbde;->z0:Landroid/graphics/Bitmap;

    iget-object v3, v14, Lbde;->Z:Landroid/graphics/Bitmap;

    iget-object v4, v14, Lbde;->Y:Ljava/lang/String;

    iget-object v5, v14, Lbde;->X:Lfde;

    iget-object v6, v14, Lbde;->o:Lgq6;

    iget-object v7, v14, Lbde;->d:Landroid/content/Context;
    ...
    :cond_3
    invoke-virtual {v10, v6}, Lov3;->j(Landroid/content/Context;)Lumc;

    move-result-object v2

    iget-object v7, v2, Lumc;->a:Lrmc;

    new-instance v18, Lade;
    ...
    invoke-direct/range {v18 .. v27}, Lade;-><init>(IIIIIIIII)V
    ...
    invoke-static/range {v2 .. v7}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->b(Lade;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lmx8;Landroid/content/Context;Lrmc;)Lyce;

    move-result-object v9

    invoke-virtual {v2, v9}, Lade;->a(Lyce;)I

    move-result v3

    invoke-virtual {v2}, Lade;->i()I
    ...
    :goto_2
    invoke-virtual {v2, v3}, Lade;->j(F)Lade;
    ...
    invoke-static {v1, v15, v6, v7}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->c(Lone/me/sdk/uikit/qr/QrCodeGenerator;Ljava/lang/String;ILrmc;)Lrvc;

    move-result-object v6

    iget-object v4, v6, Lrvc;->a:Ljava/lang/Object;

    move-object/from16 v31, v4

    check-cast v31, Landroid/graphics/Bitmap;

    iget-object v4, v6, Lrvc;->b:Ljava/lang/Object;
    ...
    invoke-static {v3, v1}, Lyce;->a(Lyce;I)Lyce;

    move-result-object v1

    invoke-virtual {v2, v1}, Lade;->a(Lyce;)I
    ...
    invoke-virtual/range {v18 .. v18}, Lade;->i()I
    ...
    invoke-interface {v7}, Lrmc;->b()Lbmc;
    ...
    invoke-interface {v7}, Lrmc;->m()Lnmc;

    move-result-object v8

    iget-object v8, v8, Lnmc;->e:Lsr0;
    ...
    invoke-virtual/range {v18 .. v18}, Lade;->c()I
    ...
    :try_start_3
    invoke-static/range {v2 .. v10}, Lone/me/sdk/uikit/qr/QrCodeGenerator;->e(Landroid/graphics/Bitmap;Landroid/graphics/drawable/Drawable;Landroid/graphics/Canvas;[IIIIILrmc;)V

    move/from16 v34, v8

    invoke-virtual/range {v19 .. v19}, Lyce;->d()Landroid/text/Layout;

    move-result-object v29

    invoke-virtual/range {v19 .. v19}, Lyce;->c()Landroid/text/Layout;

    move-result-object v30

    invoke-virtual/range {v18 .. v18}, Lade;->e()I

    move-result v32

    invoke-virtual/range {v19 .. v19}, Lyce;->b()I

    move-result v33

    invoke-virtual/range {v19 .. v19}, Lyce;->e()I
    ...
    :try_start_5
    invoke-virtual/range {v18 .. v18}, Lade;->b()I
    ...
    invoke-virtual/range {v18 .. v18}, Lade;->g()I
    ...
    invoke-virtual/range {p3 .. p3}, Lgq6;->k()Ljava/io/File;
    ...
    invoke-static {v2, v1}, Lgq6;->g(Ljava/lang/String;Ljava/lang/String;)Ljava/io/File;

    move-result-object v3

    invoke-virtual {v0, v6}, Lov3;->h(Landroid/content/Context;)Lbs3;
    ...
    invoke-static {v2}, Ljrk;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_8
    invoke-direct/range {v2 .. v8}, Lcde;-><init>(Ljava/io/File;Ljava/io/File;Lgq6;Landroid/content/Context;Landroid/graphics/Bitmap;Lkotlin/coroutines/Continuation;)V
    :try_end_8
    .catch Ljava/util/concurrent/CancellationException; {:try_start_8 .. :try_end_8} :catch_2
    .catchall {:try_start_8 .. :try_end_8} :catchall_4

    :try_start_9
    iput-object v6, v15, Lbde;->d:Landroid/content/Context;
    :try_end_9
    ...
    :try_start_a
    iput-object v5, v15, Lbde;->o:Lgq6;
    :try_end_a
    ...
    :try_start_b
    iput-object v3, v15, Lbde;->X:Lfde;
    :try_end_b
    ...
    :try_start_c
    iput-object v4, v15, Lbde;->Y:Ljava/lang/String;
    :try_end_c
    ...
    :try_start_d
    iput-object v8, v15, Lbde;->Z:Landroid/graphics/Bitmap;

    iput-object v7, v15, Lbde;->z0:Landroid/graphics/Bitmap;

    const/4 v10, 0x1

    iput v10, v15, Lbde;->C0:I

    invoke-static {v9, v2, v15}, Lkve;->X(Lxs4;Lff7;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-direct {v9, v2, v7, v0}, Lwce;-><init>(Landroid/net/Uri;Landroid/graphics/Bitmap;Lrmc;)V

    new-instance v0, Lrvc;

    invoke-direct {v0, v3, v9}, Lrvc;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    sput-object v0, Lone/me/sdk/uikit/qr/QrCodeGenerator;->f:Lrvc;
    :try_end_e
    ...
    invoke-static {v4, v3, v0}, Lgbb;->o(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-virtual {v5}, Lgq6;->k()Ljava/io/File;
