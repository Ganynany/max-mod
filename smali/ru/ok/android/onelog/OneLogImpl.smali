...
.field private volatile forceFallbackLogs:Lzoh;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lzoh;"
        }
...
.method public getApiClient()Lio;
    .locals 2
...
.method public setForceFallbackLogs(Lzoh;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public startUpload(Ljava/lang/String;)V
    ...
    invoke-direct {v1, p1, v2}, Lks8;-><init>(Ljava/lang/Object;I)V
...
.method public upload(Ljava/util/Collection;)V
    ...
    .line 2
    invoke-virtual {p0}, Lru/ok/android/onelog/OneLogImpl;->getApiClient()Lio;

    move-result-object v0

    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lio;Ljava/util/Collection;)V
...
.method public upload(Lru/ok/android/onelog/OneLogItem;)V
    ...
    invoke-static {v0, p1}, Lru/ok/android/onelog/Uploader;->execute(Lio;Lru/ok/android/onelog/OneLogItem;)V
