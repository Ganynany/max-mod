...
.method public constructor <init>(Lbif;I)V
    ...
    :goto_1
    invoke-direct {p0, p1, v0, p2}, Ldrd;-><init>(Lgt4;II)V

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object p1, p0, Lnpf;->Z:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance p1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {p1, v1}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    iput-object p1, p0, Lnpf;->z0:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public n(Ljava/lang/Long;)V
    ...
    iget-object v2, p0, Ldrd;->Y:Ljava/lang/String;
    ...
    invoke-virtual {v3, v1, v2, v5, v4}, Lhcc;->c(Lpc9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    :cond_1
    :goto_0
    iget-object v2, p0, Lnpf;->Z:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v3, Lja1;

    const/16 v5, 0x15

    invoke-direct {v3, v5}, Lja1;-><init>(I)V

    new-instance v5, Lzee;

    const/4 v6, 0x1

    invoke-direct {v5, v3, v6}, Lzee;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v3, p0, Lnpf;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v5, p1, v6}, Lvh8;->i(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_5
    :goto_1
    iget-object v2, p0, Lnpf;->z0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v3, p0, Lnpf;->z0:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {v3, p1, v5}, Lvh8;->i(Ljava/lang/String;Ljava/lang/Long;Ljava/lang/String;)Ljava/lang/String;
...
.method public final o(Ljava/lang/Long;Ljava/lang/String;Ljava/lang/Object;)Llpf;
    .locals 7

    sget-object v0, Lpc9;->X:Lpc9;

    invoke-virtual {p0}, Lnpf;->m()Z
    ...
    invoke-static {p3, v1}, Lbp8;->h(Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p3

    invoke-virtual {p2, v0, p1, p3, v2}, Lhcc;->c(Lpc9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v2

    :cond_1
    invoke-virtual {p0, p3}, Lnpf;->l(Ljava/lang/Object;)Z
    ...
    iget-object v4, p0, Lnpf;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_6
    :goto_1
    iget-object v0, p0, Lnpf;->z0:Ljava/util/concurrent/ConcurrentHashMap;

    new-instance v1, Lds2;

    const/16 v2, 0x8

    invoke-direct {v1, p3, v2, p2}, Lds2;-><init>(Ljava/lang/Object;ILjava/lang/Object;)V
    ...
    iget-object v0, p0, Lnpf;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct/range {v1 .. v6}, Lkpf;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;I)V

    new-instance p1, Lzee;

    const/4 p2, 0x3

    invoke-direct {p1, v1, p2}, Lzee;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {p1, p0, v5, v2, v4}, Llpf;-><init>(Lnpf;Ljava/lang/Long;Ljava/lang/Object;Ljava/lang/String;)V

    return-object p1
.end method

.method public abstract p(Ljava/lang/Long;)J
.end method
...
.method public final toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lnpf;->Z:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, Lnpf;->z0:Ljava/util/concurrent/ConcurrentHashMap;
