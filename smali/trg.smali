...
.field public final Z:Lzj0;

.field public final a:Landroid/content/Context;

.field public final b:I

.field public final c:Lsrg;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {v1, p1}, Lsrg;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Ltrg;->c:Lsrg;
    ...
    invoke-static {p1}, Laib;->R(Landroid/content/Context;)Ldi5;

    move-result-object v2

    sget-object v3, Ldi5;->d:Ldi5;
    ...
    invoke-direct {v2, v0, p0}, Lzj0;-><init>(Ljava/lang/Integer;Ltrg;)V

    iput-object v2, p0, Ltrg;->Z:Lzj0;
    ...
    invoke-virtual {p0, p1}, Ltrg;->onThemeChanged(Lrmc;)V
...
.method public final getAlpha()I
    ...
    iget-object v0, p0, Ltrg;->c:Lsrg;

    invoke-virtual {v0}, Lsrg;->getAlpha()I
...
.method public final isRunning()Z
    ...
    iget-boolean v0, p0, Ltrg;->Y:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Ltrg;->c:Lsrg;

    invoke-virtual {v0}, Lsrg;->isRunning()Z
...
.method public final onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, v1, p1}, Ltrg;->a(ILandroid/graphics/Rect;)V
...
.method public final onThemeChanged(Lrmc;)V
    ...
    invoke-virtual {v0, p1}, Lsrg;->onThemeChanged(Lrmc;)V
    ...
    sget-object v1, Ltrg;->z0:[Lbv8;

    const/4 v2, 0x0

    aget-object v1, v1, v2

    iget-object v1, p0, Ltrg;->Z:Lzj0;
...
.method public final setAlpha(I)V
    ...
    invoke-virtual {v0, p1}, Lsrg;->setAlpha(I)V
...
.method public final setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    invoke-virtual {v0, p1}, Lsrg;->setColorFilter(Landroid/graphics/ColorFilter;)V
...
.method public final setVisible(ZZ)Z
    ...
    invoke-virtual {p0}, Ltrg;->start()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0}, Ltrg;->stop()V
...
.method public final start()V
    ...
    invoke-virtual {v0}, Lsrg;->start()V
