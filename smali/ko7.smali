...
.field public static final d:Lko7;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lko7;->c:Ljava/lang/Object;

    new-instance v0, Lko7;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lko7;->d:Lko7;
...
.method public final d(Lcom/google/android/gms/common/api/GoogleApiActivity;ILcom/google/android/gms/common/api/GoogleApiActivity;)V
    ...
    invoke-super {p0, p2, p1, v0}, Llo7;->b(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;

    move-result-object v0

    invoke-static {v0, p1}, Ldgk;->a(Landroid/content/Intent;Lcom/google/android/gms/common/api/GoogleApiActivity;)Ldgk;
    ...
    :cond_2
    invoke-static {p1, p2}, Lrfk;->c(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p1, p2}, Lrfk;->b(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p1, p2}, Lrfk;->f(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {v1, p3}, Lu46;->a(Landroid/app/Dialog;Landroid/content/DialogInterface$OnCancelListener;)Lu46;
...
.method public final e(Landroid/content/Context;ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {p2, p0, p1}, Lfgk;-><init>(Lko7;Landroid/content/Context;)V
    ...
    :cond_2
    invoke-static {p1, p2}, Lrfk;->e(Landroid/content/Context;I)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1, p2}, Lrfk;->d(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-direct {v5, p1, v6}, Lsrb;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-boolean v1, v5, Lsrb;->u:Z

    const/16 v6, 0x10

    invoke-virtual {v5, v6, v1}, Lsrb;->f(IZ)V

    invoke-static {v0}, Lsrb;->c(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, v5, Lsrb;->e:Ljava/lang/CharSequence;

    new-instance v0, Lqrb;

    invoke-direct {v0}, Lqrb;-><init>()V

    invoke-virtual {v0, v2}, Lqrb;->d(Ljava/lang/String;)V

    invoke-virtual {v5, v0}, Lsrb;->i(Lhsb;)V

    invoke-virtual {p1}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    sget-object v6, Ld2c;->f:Ljava/lang/Boolean;
    ...
    iget-object v2, v5, Lsrb;->F:Landroid/app/Notification;

    iput v0, v2, Landroid/app/Notification;->icon:I

    iput v6, v5, Lsrb;->k:I

    invoke-static {p1}, Ld2c;->S(Landroid/content/Context;)Z

    move-result v0

    if-eqz v0, :cond_4

    sget v0, Ljje;->common_full_open_on_phone:I

    sget v2, Lvre;->common_open_on_phone:I

    invoke-virtual {v3, v2}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v2

    iget-object v3, v5, Lsrb;->b:Ljava/util/ArrayList;

    new-instance v7, Lkrb;

    invoke-direct {v7, v0, v2, p3}, Lkrb;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    :cond_4
    iput-object p3, v5, Lsrb;->g:Landroid/app/PendingIntent;
    ...
    iget-object v7, v5, Lsrb;->F:Landroid/app/Notification;

    iput v0, v7, Landroid/app/Notification;->icon:I

    sget v0, Lvre;->common_google_play_services_notification_ticker:I

    invoke-virtual {v3, v0}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v0

    iget-object v3, v5, Lsrb;->F:Landroid/app/Notification;
    ...
    iget-object v0, v5, Lsrb;->F:Landroid/app/Notification;

    iput-wide v7, v0, Landroid/app/Notification;->when:J

    iput-object p3, v5, Lsrb;->g:Landroid/app/PendingIntent;

    invoke-virtual {v5, v2}, Lsrb;->d(Ljava/lang/CharSequence;)V

    :goto_0
    sget-object p3, Lko7;->c:Ljava/lang/Object;
    ...
    sget v2, Lvre;->common_google_play_services_notification_channel_name:I
    ...
    :cond_7
    :goto_1
    iput-object p3, v5, Lsrb;->z:Ljava/lang/String;

    invoke-virtual {v5}, Lsrb;->a()Landroid/app/Notification;
    ...
    :cond_8
    sget-object p2, Lyo7;->a:Ljava/util/concurrent/atomic/AtomicBoolean;
