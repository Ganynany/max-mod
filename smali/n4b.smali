...
.field public final d:Ld9c;


# direct methods
.method public constructor <init>(Lcf9;Ld9c;)V
    .locals 2
    ...
    invoke-direct {p0, v0, v1}, Lk4b;-><init>(II)V

    iput-object p1, p0, Ln4b;->c:Lcf9;

    iput-object p2, p0, Ln4b;->d:Ld9c;
...
.method public final b(Llph;)V
    ...
    iget-object v2, p0, Ln4b;->d:Ld9c;

    invoke-direct {v0, v2}, Lnq3;-><init>(Ld9c;)V

    new-instance v2, Ljava/util/ArrayList;

    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    invoke-interface {p1}, Llph;->u()V

    :try_start_0
    const-string v3, "SELECT * FROM chats"

    invoke-interface {p1, v3}, Llph;->Y(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :try_start_2
    invoke-virtual {v0, v8}, Lnq3;->c([B)Lit2;
    ...
    invoke-static {v1, v6}, Lgbb;->f0(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_3
    ...
    invoke-interface {p1, v4, v3}, Llph;->P(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v3, v1, v2, v4}, Lhcc;->c(Lpc9;Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    :try_start_7
    invoke-static {v3, v0}, Lgbb;->f(Ljava/io/Closeable;Ljava/lang/Throwable;)V
