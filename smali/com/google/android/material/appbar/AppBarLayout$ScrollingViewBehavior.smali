...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 5
    invoke-direct {p0, v0}, Lkij;-><init>(I)V
    ...
    .line 9
    sget-object v1, Lmse;->ScrollingViewBehavior_Layout:[I
    ...
    .line 11
    sget p2, Lmse;->ScrollingViewBehavior_Layout_behavior_overlapTop:I
...
.method public static w(Ljava/util/List;)Liq;
    .locals 4
...
.method public d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    :cond_0
    instance-of p1, p3, Liq;

    if-eqz p1, :cond_1

    check-cast p3, Liq;

    iget-boolean p1, p3, Liq;->F0:Z

    if-eqz p1, :cond_1

    invoke-virtual {p3, p2}, Liq;->g(Landroid/view/View;)Z

    move-result p1

    invoke-virtual {p3, p1}, Liq;->f(Z)Z
...
.method public final i(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    invoke-static {v2}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->w(Ljava/util/List;)Liq;
    ...
    invoke-virtual {p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->getLastWindowInsets()Lz7k;
    ...
    :cond_2
    :goto_0
    invoke-virtual {v2}, Liq;->getTotalScrollRange()I
...
.method public final m(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->w(Ljava/util/List;)Liq;
    ...
    invoke-virtual {v0, v1, p2, p1}, Liq;->e(ZZZ)V
...
.method public final x(Landroid/view/View;)I
    ...
    invoke-static {v0, v1, p1}, Ld2c;->t(III)I
