...
.method private a(Ljava/lang/String;Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    invoke-direct {v1, v4}, Lne5;-><init>(I)V

    invoke-virtual {v1, p1}, Lne5;->h(Ljava/lang/String;)V

    .line 32
    const-string p1, "GET"

    invoke-virtual {v1, p1, v3}, Lne5;->e(Ljava/lang/String;Lag3;)V
    ...
    .line 34
    invoke-interface {p2}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lq0c;
    ...
    :goto_2
    :try_start_2
    invoke-virtual {p1}, Lucf;->close()V
    :try_end_2
...
.method private a(Ljava/lang/String;[BZLcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;)Lcom/my/tracker/core/net/HttpResult;
    ...
    .line 100
    sget-object v4, Lwaa;->c:Ljava/util/regex/Pattern;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0

    .line 101
    :try_start_6
    invoke-static {p2}, Lhsg;->Q(Ljava/lang/String;)Lwaa;
    ...
    invoke-virtual {v6, p1, v5}, Lheg;->t(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 105
    invoke-static {v5, p2, p1}, Lt6b;->l(ILwaa;[B)Lhbf;
    ...
    invoke-virtual {v4, p2, p1}, Lne5;->e(Ljava/lang/String;Lag3;)V
    ...
    .line 110
    invoke-interface {p4}, Lcom/my/tracker/MyTrackerConfig$OkHttpClientProvider;->getOkHttpClient()Lq0c;
    ...
    .line 128
    invoke-virtual {v3}, Lucf;->close()V
