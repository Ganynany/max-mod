...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "continuation",
        "<init>",
        "(Lzs4;Lkotlin/coroutines/Continuation;)V",
...
.field public final dispatcher:Lzs4;
...
.method public constructor <init>(Lzs4;Lkotlin/coroutines/Continuation;)V
    ...
    invoke-direct {p0, v0}, Lal5;-><init>(I)V

    iput-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lzs4;
    ...
    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lxs4;

    move-result-object p1

    invoke-static {p1}, Lkotlinx/coroutines/internal/ThreadContextKt;->threadContextElements(Lxs4;)Ljava/lang/Object;
...
.method private final getReusableCancellableContinuation()Ljh2;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private final synthetic loop$atomicfu$ATOMIC_FIELD_UPDATER$Any(Ljava/util/concurrent/atomic/AtomicReferenceFieldUpdater;Ljava/lang/Object;Lre7;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final claimReusableCancellableContinuation$kotlinx_coroutines_core()Ljh2;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final dispatchYield$kotlinx_coroutines_core(Lxs4;Ljava/lang/Object;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput p2, p0, Lal5;->resumeMode:I

    iget-object p2, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lzs4;

    invoke-virtual {p2, p1, p0}, Lzs4;->dispatchYield(Lxs4;Ljava/lang/Runnable;)V
...
.method public final release$kotlinx_coroutines_core()V
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getReusableCancellableContinuation()Ljh2;
...
.method public final resumeCancellableWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lzs4;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lxs4;

    move-result-object v2

    invoke-static {v1, v2}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeIsDispatchNeeded(Lzs4;Lxs4;)Z
    ...
    iput v2, p0, Lal5;->resumeMode:I

    iget-object p1, p0, Lkotlinx/coroutines/internal/DispatchedContinuation;->dispatcher:Lzs4;

    invoke-virtual {p0}, Lkotlinx/coroutines/internal/DispatchedContinuation;->getContext()Lxs4;

    move-result-object v0

    invoke-static {p1, v0, p0}, Lkotlinx/coroutines/internal/DispatchedContinuationKt;->safeDispatch(Lzs4;Lxs4;Ljava/lang/Runnable;)V
    ...
    invoke-virtual {v1, p0}, Ln66;->e0(Lal5;)V

    return-void

    :cond_1
    invoke-virtual {v1, v2}, Ln66;->r0(Z)V
    ...
    invoke-interface {v3, v4}, Lxs4;->get(Lws4;)Lvs4;
    ...
    invoke-interface {v3}, Lvn8;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object p1

    invoke-virtual {p0, v0, p1}, Lal5;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V
    ...
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lxs4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v4, v3}, Lkve;->U(Lkotlin/coroutines/Continuation;Lxs4;Ljava/lang/Object;)Lnpi;
    ...
    :cond_4
    invoke-static {v4, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lxs4;Ljava/lang/Object;)V

    :cond_5
    :goto_1
    invoke-virtual {v1}, Ln66;->D0()Z
    ...
    :goto_2
    invoke-virtual {v1, v2}, Ln66;->I(Z)V
    ...
    :goto_3
    :try_start_4
    invoke-virtual {p0, p1}, Lal5;->handleFatalException$kotlinx_coroutines_core(Ljava/lang/Throwable;)V
    :try_end_4
...
.method public final resumeCancelled$kotlinx_coroutines_core(Ljava/lang/Object;)Z
    ...
    invoke-interface {v0}, Lvn8;->getCancellationException()Ljava/util/concurrent/CancellationException;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lal5;->cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/lang/Throwable;)V

    new-instance p1, Lpdf;

    invoke-direct {p1, v0}, Lpdf;-><init>(Ljava/lang/Throwable;)V
...
.method public final resumeUndispatchedWith$kotlinx_coroutines_core(Ljava/lang/Object;)V
    ...
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lxs4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {v0, v2, v1}, Lkve;->U(Lkotlin/coroutines/Continuation;Lxs4;Ljava/lang/Object;)Lnpi;
    ...
    :cond_1
    invoke-static {v2, v1}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lxs4;Ljava/lang/Object;)V
...
.method public resumeWith(Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, v0}, Ln66;->r0(Z)V
    ...
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->updateThreadContext(Lxs4;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :try_start_2
    invoke-static {v2, v3}, Lkotlinx/coroutines/internal/ThreadContextKt;->restoreThreadContext(Lxs4;Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {v1, v0}, Ln66;->I(Z)V
...
.method public final tryReleaseClaimedContinuation$kotlinx_coroutines_core(Lhh2;)Ljava/lang/Throwable;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
