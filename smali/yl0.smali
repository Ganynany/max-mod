...
.method public constructor <init>(Lpx8;Lpx8;)V
    ...
    iput-object p1, p0, Lyl0;->a:Lpx8;

    iput-object p2, p0, Lyl0;->b:Lpx8;

    return-void
.end method

.method public static final a(Lyl0;[BLtzi;)Lurh;
    .locals 2
    ...
    invoke-virtual {p2}, Ltzi;->c()I

    move-result v0

    invoke-virtual {p2}, Ltzi;->a()I

    move-result v1

    invoke-direct {p0, p1, v0, v1}, Lurh;-><init>(Ljava/lang/String;II)V

    invoke-virtual {p2}, Ltzi;->b()I

    move-result p1

    invoke-virtual {p0, p1}, Lurh;->setAlpha(I)V

    new-instance p1, Landroid/graphics/PorterDuffXfermode;

    invoke-virtual {p2}, Ltzi;->d()Z
    ...
    invoke-virtual {p0, p1}, Lurh;->c(Landroid/graphics/Xfermode;)V
...
.method public static b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Lpgf;->r(II)V
    ...
    invoke-direct/range {v11 .. v18}, Lszi;-><init>(FFFFF[F[I)V
...
# virtual methods
.method public final c(Landroid/content/Context;Ldm0;)Ljava/util/LinkedHashMap;
    .locals 28
    ...
    sget-object v9, Lyo2;->a:Ljava/nio/charset/Charset;
    ...
    new-instance v14, Ldm0;

    invoke-virtual {v10, v2}, Lorg/json/JSONObject;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v15

    iget-object v8, v11, Lwl0;->a:Ljava/lang/String;
    ...
    invoke-direct {v14, v2}, Ldm0;-><init>(Ljava/lang/String;)V

    sget-object v2, Lbs3;->A0:Lov3;

    move-object/from16 v8, p1

    invoke-virtual {v2, v8}, Lov3;->h(Landroid/content/Context;)Lbs3;
    ...
    iget-boolean v2, v11, Lwl0;->b:Z

    invoke-static {v15, v2}, Lwa0;->q(Lumc;Z)Lrmc;

    move-result-object v2

    invoke-interface {v2}, Lrmc;->z()Limc;

    move-result-object v2

    iget-object v2, v2, Limc;->a:Lkdi;
    :try_end_1
    .catch Lorg/json/JSONException; {:try_start_1 .. :try_end_1} :catch_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0

    iget-object v11, v2, Lkdi;->f:Ljava/lang/Object;

    check-cast v11, [I

    iget v13, v2, Lkdi;->b:I

    if-eqz v0, :cond_4

    :try_start_2
    invoke-virtual {v0, v14}, Ldm0;->equals(Ljava/lang/Object;)Z
    ...
    invoke-static {v13}, Lc1l;->c(I)I

    move-result v26

    invoke-direct/range {v20 .. v26}, Ltzi;-><init>(Ljava/lang/String;IIIZI)V
    :try_end_2
    ...
    invoke-direct {v13, v11, v8}, Lrzi;-><init>([IF)V
    ...
    iget-object v8, v2, Lkdi;->e:Ljava/lang/Object;

    check-cast v8, [I

    invoke-static {v4, v8}, Lyl0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v4}, Lyl0;->b(Lorg/json/JSONArray;[I)Ljava/util/ArrayList;
    ...
    invoke-direct {v4, v2, v0}, Lrzi;-><init>([IF)V
    ...
    invoke-static {v0, v11}, Llw;->m0(I[I)Ljava/lang/Integer;
    ...
    :goto_12
    new-instance v20, Luzi;

    invoke-direct/range {v20 .. v26}, Luzi;-><init>(Ltzi;Lrzi;Lrzi;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/lang/Integer;)V
...
.method public final d(Landroid/content/Context;Ltzi;Lcrh;)Ljava/lang/Object;
    .locals 3

    iget-object v0, p0, Lyl0;->a:Lpx8;
    ...
    invoke-direct {v1, p0, p1, p2, v2}, Lxl0;-><init>(Lyl0;Landroid/content/Context;Ltzi;Lkotlin/coroutines/Continuation;)V
