...
.field public D0:La2i;

.field public E0:Ly2i;

.field public F0:Ldv5;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmmb;->P0:Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lmmb;->Q0:Landroid/text/TextPaint;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v0, Lmmb;->P0:Ljava/util/regex/Pattern;

    iput-object v0, p0, Lmmb;->a:Ljava/util/regex/Pattern;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Lmmb;->b:Landroid/graphics/Rect;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Lmmb;->A0:F

    sget-object v0, Ldv5;->b:Ldv5;

    iput-object v0, p0, Lmmb;->F0:Ldv5;

    const/4 v0, -0x1

    iput v0, p0, Lmmb;->G0:I

    const/high16 v0, -0x1000000

    iput v0, p0, Lmmb;->I0:I

    sget-object v0, Lmmb;->Q0:Landroid/text/TextPaint;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTypeface()Landroid/graphics/Typeface;

    move-result-object v1

    iput-object v1, p0, Lmmb;->J0:Landroid/graphics/Typeface;

    invoke-virtual {v0}, Landroid/graphics/Paint;->getLetterSpacing()F

    move-result v1

    iput v1, p0, Lmmb;->K0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->getTextSize()F

    move-result v1

    iput v1, p0, Lmmb;->L0:F

    invoke-virtual {v0}, Landroid/graphics/Paint;->isElegantTextHeight()Z

    move-result v0

    iput-boolean v0, p0, Lmmb;->M0:Z

    const/4 v0, 0x2

    iput v0, p0, Lmmb;->N0:I

    new-instance v0, Llmb;

    invoke-direct {v0, p0, p1}, Llmb;-><init>(Lmmb;Landroid/content/Context;)V

    iput-object v0, p0, Lmmb;->O0:Llmb;
...
.method private final getFullyVisibleLinesCount()I
    ...
    invoke-virtual {p0, v0, v1}, Lmmb;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
...
.method private final getLinesCount()I
    ...
    invoke-direct {p0}, Lmmb;->getFullyVisibleLinesCount()I
...
.method public static final h(Lmmb;Landroid/text/TextPaint;)V
    .locals 1

    iget-object v0, p0, Lmmb;->J0:Landroid/graphics/Typeface;

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v0, p0, Lmmb;->K0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setLetterSpacing(F)V

    iget v0, p0, Lmmb;->L0:F

    invoke-virtual {p1, v0}, Landroid/graphics/Paint;->setTextSize(F)V

    iget p0, p0, Lmmb;->I0:I
...
.method private final setContent(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Lmmb;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lmmb;->l()V

    iput-object p1, p0, Lmmb;->d:Ljava/lang/CharSequence;

    const/4 p1, 0x0

    iput-object p1, p0, Lmmb;->D0:La2i;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lmmb;->z0:Z
...
.method private final setLayoutInternal(Landroid/text/Layout;)V
    ...
    :goto_0
    iput-object v0, p0, Lmmb;->c:Landroid/text/StaticLayout;
    ...
    :goto_1
    iput-object v0, p0, Lmmb;->d:Ljava/lang/CharSequence;
    ...
    :cond_2
    iput-object v1, p0, Lmmb;->o:Ljava/lang/CharSequence;
...
.method private final setStaticLayoutsTextColor(I)V
    ...
    iget-object v0, p0, Lmmb;->c:Landroid/text/StaticLayout;
    ...
    :cond_0
    iget-object v0, p0, Lmmb;->D0:La2i;

    if-eqz v0, :cond_1

    iget-object v1, v0, La2i;->a:Lj2i;

    invoke-virtual {v1}, Lj2i;->a()Landroid/text/Layout;
    ...
    iget-object v0, v0, La2i;->b:Lj2i;

    invoke-virtual {v0}, Lj2i;->a()Landroid/text/Layout;
...
.method public final a(Ldv5;)V
    ...
    iget-object v0, p0, Lmmb;->E0:Ly2i;
    ...
    :cond_0
    iget-object v1, p0, Lmmb;->F0:Ldv5;
    ...
    :cond_1
    iput-object p1, p0, Lmmb;->F0:Ldv5;

    invoke-virtual {p0, v0, p1}, Lmmb;->i(Ly2i;Ldv5;)V
...
.method public final d(Ly2i;Ldv5;)V
    .locals 0

    iput-object p1, p0, Lmmb;->E0:Ly2i;

    iput-object p2, p0, Lmmb;->F0:Ldv5;

    invoke-virtual {p0, p1, p2}, Lmmb;->i(Ly2i;Ldv5;)V
...
.method public final e()Landroid/graphics/Rect;
    ...
    iget-object v1, p0, Lmmb;->b:Landroid/graphics/Rect;
...
.method public final g(Ljava/lang/String;)F
    ...
    :try_start_0
    invoke-static {p0, v0}, Lmmb;->h(Lmmb;Landroid/text/TextPaint;)V
...
.method public getLineHeight()I
    ...
    iget v0, p0, Lmmb;->B0:F

    int-to-float v1, v1

    iget v2, p0, Lmmb;->A0:F
...
.method public final i(Ly2i;Ldv5;)V
    .locals 16
    ...
    iget-object v3, v0, Ly2i;->e:Ljava/lang/String;
    ...
    invoke-static {v5}, Lzf2;->c(I)I

    move-result v5

    invoke-static {v2, v3, v5}, Lxni;->a(Landroid/content/Context;Landroid/graphics/Typeface;I)Landroid/graphics/Typeface;

    move-result-object v2

    iput-object v2, v1, Lmmb;->J0:Landroid/graphics/Typeface;
    ...
    invoke-virtual/range {p1 .. p2}, Ly2i;->h(Ldv5;)J

    move-result-wide v5

    invoke-static {v5, v6, v2}, Ljj5;->d(JLandroid/util/DisplayMetrics;)F

    move-result v3

    iput v3, v1, Lmmb;->K0:F

    invoke-virtual/range {p1 .. p2}, Ly2i;->j(Ldv5;)J
    ...
    iput v3, v1, Lmmb;->L0:F

    invoke-virtual/range {p1 .. p2}, Ly2i;->i(Ldv5;)J
    ...
    sget-object v2, Lmmb;->Q0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v2}, Lmmb;->h(Lmmb;Landroid/text/TextPaint;)V
    ...
    iput v0, v1, Lmmb;->B0:F

    const/4 v0, 0x0

    iput-boolean v0, v1, Lmmb;->M0:Z

    const/4 v0, 0x1

    iput-boolean v0, v1, Lmmb;->z0:Z
...
.method public final j()V
    ...
    invoke-interface {v1, p0}, Lhij;->attach(Landroid/view/View;)V
...
.method public final k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    sget-object v4, Lmmb;->Q0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v4}, Lmmb;->h(Lmmb;Landroid/text/TextPaint;)V
    :try_end_0
...
.method public final l()V
    ...
    invoke-interface {v1, p0}, Lhij;->detach(Landroid/view/View;)V
...
.method public final onAttachedToWindow()V
    ...
    iget-object v2, v1, Lj2i;->c:Ljava/util/concurrent/CopyOnWriteArraySet;

    iget-object v3, p0, Lmmb;->O0:Llmb;
    ...
    iget-object v0, v0, Lj2i;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
...
.method public final onDetachedFromWindow()V
    ...
    iget-object v1, p0, Lmmb;->O0:Llmb;

    if-eqz v0, :cond_0

    iget-object v0, v0, La2i;->a:Lj2i;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, v1, Lmmb;->z0:Z

    const/4 v3, 0x1

    if-nez v0, :cond_2

    iget-object v0, v1, Lmmb;->D0:La2i;
    ...
    :goto_0
    iget-object v0, v0, Lj2i;->b:Ldv5;

    iget-object v4, v1, Lmmb;->F0:Ldv5;
    ...
    iput-boolean v0, v1, Lmmb;->H0:Z

    iget-object v4, v1, Lmmb;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v5, v4}, Lmmb;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v6

    invoke-direct {v1}, Lmmb;->getLinesCount()I
    ...
    invoke-virtual {v1, v5, v9}, Lmmb;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    iget-object v7, v1, Lmmb;->a:Ljava/util/regex/Pattern;
    ...
    :cond_a
    :goto_5
    iput-object v3, v1, Lmmb;->o:Ljava/lang/CharSequence;

    goto :goto_6

    :cond_b
    iput-object v4, v1, Lmmb;->o:Ljava/lang/CharSequence;

    :goto_6
    iget-object v3, v1, Lmmb;->o:Ljava/lang/CharSequence;
    ...
    :goto_7
    invoke-virtual {v1, v5, v8}, Lmmb;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;

    move-result-object v3

    iput-object v3, v1, Lmmb;->c:Landroid/text/StaticLayout;

    iput-boolean v0, v1, Lmmb;->z0:Z

    :cond_d
    :goto_8
    iget-object v0, v1, Lmmb;->c:Landroid/text/StaticLayout;

    if-eqz v0, :cond_e

    sget-object v3, Lmmb;->Q0:Landroid/text/TextPaint;
    ...
    :try_start_0
    invoke-static {v1, v3}, Lmmb;->h(Lmmb;Landroid/text/TextPaint;)V
...
.method public final onMeasure(II)V
    ...
    :goto_2
    iput p2, p0, Lmmb;->G0:I

    iput-boolean v0, p0, Lmmb;->H0:Z

    iget-object v3, p0, Lmmb;->D0:La2i;

    if-eqz v3, :cond_3

    iget-boolean v3, p0, Lmmb;->z0:Z

    if-nez v3, :cond_3

    iget-object v3, p0, Lmmb;->c:Landroid/text/StaticLayout;
    ...
    :cond_6
    invoke-virtual {p0, p2, v0}, Lmmb;->k(ILjava/lang/CharSequence;)Landroid/text/StaticLayout;
    ...
    invoke-virtual {p0}, Lmmb;->getMaxLinesValue()I
...
.method public final onSizeChanged(IIII)V
    ...
    iget-object p2, p0, Lmmb;->D0:La2i;
    ...
    :cond_0
    iget-object p1, p2, La2i;->b:Lj2i;

    goto :goto_0

    :goto_1
    iget-object p2, p0, Lmmb;->c:Landroid/text/StaticLayout;

    if-eq p2, p1, :cond_1

    invoke-direct {p0, p1}, Lmmb;->setLayoutInternal(Landroid/text/Layout;)V
...
.method public final onWindowVisibilityChanged(I)V
    ...
    invoke-super {p0, p1}, Lszb;->onWindowVisibilityChanged(I)V
...
.method public setLayout(La2i;)V
    .locals 4
    ...
    iget-object v2, v0, La2i;->a:Lj2i;

    iget-object v3, v2, Lj2i;->c:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    iput-object v0, p0, Lmmb;->o:Ljava/lang/CharSequence;
    ...
    :goto_1
    iput-object p1, p0, Lmmb;->c:Landroid/text/StaticLayout;
...
.method public setTextColor(I)V
    ...
    iput p1, p0, Lmmb;->I0:I

    invoke-direct {p0, p1}, Lmmb;->setStaticLayoutsTextColor(I)V
...
.method public setTextValue(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {p0, p1}, Lmmb;->setContent(Ljava/lang/CharSequence;)V
