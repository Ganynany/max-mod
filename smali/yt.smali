...
# direct methods
.method public synthetic constructor <init>(Lf5b;Lpx8;)V
    .locals 0
...
.method public final invoke()Ljava/lang/Object;
    ...
    invoke-static/range {v3 .. v10}, Lu9c;->f(Lu9c;Ljava/lang/String;IIZZII)Ljava/util/concurrent/ExecutorService;

    move-result-object v1

    invoke-virtual {v3, v1, v4}, Lu9c;->i(Ljava/util/concurrent/ExecutorService;Ljava/lang/String;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    invoke-direct {v0, v1, v2}, Lz76;-><init>(Ljava/util/concurrent/Executor;Z)V
    ...
    sget-object v1, Ldrf;->a:Lqzg;

    new-instance v1, Lz76;

    const/4 v2, 0x0

    invoke-direct {v1, v0, v2}, Lz76;-><init>(Ljava/util/concurrent/Executor;Z)V
    ...
    invoke-direct {v0, v1}, Lqdg;-><init>(Lmyh;)V
    ...
    iget-object v3, v3, Lgq6;->c:Landroid/content/Context;

    invoke-static {v3}, Lgq6;->c(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1}, Lq40;-><init>(Ljava/io/File;Lkjf;)V
    ...
    invoke-direct {v0, v3}, Lhk0;-><init>(Lpx8;)V
    ...
    invoke-direct {v0, v3}, Lyta;-><init>(Lpx8;)V
    ...
    const-string v0, "https://download.max.ru/#android?version=26.10.1"
