...
.method public static a([Lru/ok/tamtam/nano/Protos$MessageElement;)Ljava/util/ArrayList;
    ...
    invoke-static {v5, v3}, Lgbb;->n(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :pswitch_1
    sget-object v3, Lqja;->B0:Lqja;

    goto :goto_1

    :pswitch_2
    sget-object v3, Lqja;->Z:Lqja;

    goto :goto_1

    :pswitch_3
    sget-object v3, Lqja;->A0:Lqja;

    goto :goto_1

    :pswitch_4
    sget-object v3, Lqja;->z0:Lqja;
    ...
    :pswitch_6
    sget-object v3, Lqja;->X:Lqja;

    goto :goto_1

    :pswitch_7
    sget-object v3, Lqja;->o:Lqja;

    goto :goto_1

    :pswitch_8
    sget-object v3, Lqja;->c:Lqja;

    goto :goto_1

    :pswitch_9
    sget-object v3, Lqja;->d:Lqja;

    goto :goto_1

    :pswitch_a
    sget-object v3, Lqja;->b:Lqja;

    goto :goto_1

    :pswitch_b
    sget-object v3, Lqja;->a:Lqja;
...
.method public static b(Ljava/util/List;)[B
    ...
    invoke-static {p0}, Lsja;->c(Ljava/util/List;)Lru/ok/tamtam/nano/Protos$MessageElements;

    move-result-object p0

    invoke-static {p0}, Lema;->toByteArray(Lema;)[B
...
.method public static c(Ljava/util/List;)Lru/ok/tamtam/nano/Protos$MessageElements;
    ...
    iget-wide v5, v3, Lrja;->a:J

    iget-object v7, v3, Lrja;->f:Ljava/util/Map;

    iput-wide v5, v4, Lru/ok/tamtam/nano/Protos$MessageElement;->entityId:J

    iget-object v5, v3, Lrja;->b:Ljava/lang/String;
